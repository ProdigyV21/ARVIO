...
Once confirmed, follow the [docs/development.md](./development.md) guide to compile and run the application.
...
- [docs/setup.md](./setup.md) - Environment installation checklist (this document).
