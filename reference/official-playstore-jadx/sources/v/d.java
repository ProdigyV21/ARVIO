...
public abstract /* synthetic */ class d {
    ...
    public static List i(PathBuilder pathBuilder, float f10, float f11) {
        pathBuilder.verticalLineTo(f10);
        pathBuilder.horizontalLineToRelative(f11);
        pathBuilder.close();
        return pathBuilder.getNodes();
    ...
    public static List o(PathBuilder pathBuilder, float f10, float f11) {
        pathBuilder.lineTo(f10, f11);
        pathBuilder.close();
        return pathBuilder.getNodes();
    }

    public static List p(PathBuilder pathBuilder, float f10, float f11, float f12) {
        pathBuilder.verticalLineToRelative(f10);
        pathBuilder.horizontalLineToRelative(f11);
        pathBuilder.verticalLineTo(f12);
        pathBuilder.close();
    ...
    public static List w(PathBuilder pathBuilder, float f10, float f11, float f12) {
        pathBuilder.lineTo(f10, f11);
        pathBuilder.horizontalLineTo(f12);
        pathBuilder.close();
        return pathBuilder.getNodes();
