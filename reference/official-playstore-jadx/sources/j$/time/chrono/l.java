...
public final class l extends a implements Serializable {
    ...
    public static final l f18160m;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public volatile transient boolean f18161d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public transient int[] f18162e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public transient int f18163f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public transient int f18164g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public transient int f18165h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public transient int f18166i;
    ...
    public final void V() {
        ...
        try {
            ...
            int[][] iArrA0 = a0();
            int I = (int) LocalDate.of(1882, 11, 12).I();
            for (int i10 = 1300; i10 <= 1600; i10++) {
                int[] iArr = iArrA0[i10 - 1300];
                if (iArr.length != 12) {
            ...
            int[] iArrW = W(I, map);
            this.f18162e = iArrW;
            this.f18164g = iArrW[3612];
            for (int i11 = 1300; i11 < 1600; i11++) {
                int iB0 = b0(i11, 12);
                this.k = Math.min(this.k, iB0);
                this.f18168l = Math.max(this.f18168l, iB0);
            }
            this.f18161d = true;
        } catch (Exception e5) {
            throw new DateTimeException("Unable to initialize HijrahCalendar: Hijrah-umalqura", e5);
        }
    }
    ...
    public final ChronoLocalDate m() {
        return new n(this, LocalDate.d0(Clock.b()).H(j$.time.temporal.a.EPOCH_DAY));
    }

    @Override // j$.time.chrono.Chronology
    public final ChronoLocalDate E(TemporalAccessor temporalAccessor) {
        if (!(temporalAccessor instanceof n)) {
            return new n(this, temporalAccessor.H(j$.time.temporal.a.EPOCH_DAY));
        }
    ...
    public final boolean T(long j10) {
        V();
        return j10 >= ((long) X(0)) && j10 <= ((long) (X(this.f18162e.length - 1) - 1)) && b0((int) j10, 12) > 354;
    }
    ...
    @Override // j$.time.chrono.Chronology
    public final List w() {
        return j$.com.android.tools.r8.a.M(o.values());
    }
    ...
    public final j$.time.temporal.s u(j$.time.temporal.a aVar) {
        V();
        if (aVar != null) {
            switch (k.f18159a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.s.g(1L, this.f18166i, this.f18167j);
                case 2:
                    return j$.time.temporal.s.f(1L, this.f18168l);
                case 3:
                    return j$.time.temporal.s.f(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.s.f(X(0), X(this.f18162e.length - 1) - 1);
                case 6:
    ...
    public final long Y(int i10, int i11, int i12) {
        ...
        int i13 = (i11 - 1) + ((i10 * 12) - this.f18165h);
        if (i13 < 0 || i13 >= this.f18162e.length) {
            throw new DateTimeException("Invalid Hijrah date, year: " + i10 + ", month: " + i11);
        }
        if (i12 < 1 || i12 > Z(i10, i11)) {
            throw new DateTimeException("Invalid Hijrah day of month: " + i12);
        }
        return (i12 - 1) + this.f18162e[i13];
    }

    public final int X(int i10) {
        return (i10 + this.f18165h) / 12;
    }

    public final int Z(int i10, int i11) {
        int i12 = (i11 - 1) + ((i10 * 12) - this.f18165h);
        if (i12 >= 0) {
            int[] iArr = this.f18162e;
            if (i12 < iArr.length) {
    ...
    public final int[] W(int i10, Map map) {
        int[] iArr = new int[3613];
        this.f18166i = Integer.MAX_VALUE;
        this.f18167j = Integer.MIN_VALUE;
        int i11 = 0;
        for (int i12 = 1300; i12 <= 1600; i12++) {
            ...
            while (i13 < 12) {
                ...
                i10 += i14;
                this.f18166i = Math.min(this.f18166i, i14);
                this.f18167j = Math.max(this.f18167j, i14);
                i13++;
                i11 = i15;
            }
        }
