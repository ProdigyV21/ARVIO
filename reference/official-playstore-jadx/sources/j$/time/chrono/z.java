...
public final class z extends c {
    ...
    public final transient LocalDate f18192a;
    ...
    public final int hashCode() {
        x.f18190d.getClass();
        return this.f18192a.hashCode() ^ (-1990173233);
    }

    @Override // j$.time.chrono.c, j$.time.chrono.ChronoLocalDate
    public final j L() {
        return Z() >= 1 ? a0.ROC : a0.BEFORE_ROC;
    }
    ...
    public final j$.time.temporal.s n(j$.time.temporal.o oVar) {
        ...
        int i10 = y.f18191a[aVar.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3) {
            return this.f18192a.n(oVar);
        }
        if (i10 != 4) {
            return x.f18190d.u(aVar);
        }
        j$.time.temporal.s sVar = j$.time.temporal.a.YEAR.f18349b;
        return j$.time.temporal.s.f(1L, Z() <= 0 ? (-sVar.f18373a) + 1912 : sVar.f18376d - 1911);
    }

    @Override // j$.time.temporal.TemporalAccessor
    public final long H(j$.time.temporal.o oVar) {
        if (oVar instanceof j$.time.temporal.a) {
            int i10 = y.f18191a[((j$.time.temporal.a) oVar).ordinal()];
            if (i10 == 4) {
                int iZ = Z();
                if (iZ < 1) {
                    iZ = 1 - iZ;
            ...
            if (i10 == 5) {
                return ((((long) Z()) * 12) + ((long) this.f18192a.getMonthValue())) - 1;
            }
            if (i10 == 6) {
                return Z();
            }
            if (i10 != 7) {
                return this.f18192a.H(oVar);
            }
            return Z() < 1 ? 0 : 1;
        }
        return oVar.C(this);
    ...
    public final int Z() {
        return this.f18192a.getYear() - 1911;
    }
    ...
    */
    public final j$.time.chrono.z c(long r8, j$.time.temporal.o r10) {
        /*
            r7 = this;
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.y.f18191a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L63
        L25:
            j$.time.chrono.x r10 = j$.time.chrono.x.f18190d
            ...
            r2 = 12
            long r0 = r0 * r2
            j$.time.LocalDate r10 = r7.f18192a
            ...
            j$.time.chrono.z r8 = r7.b0(r8)
            return r8
        L4d:
            j$.time.chrono.x r2 = j$.time.chrono.x.f18190d
            ...
            if (r0 == r3) goto L6e
        L63:
            j$.time.LocalDate r0 = r7.f18192a
            j$.time.LocalDate r8 = r0.c(r8, r10)
            j$.time.chrono.z r8 = r7.b0(r8)
            return r8
        L6e:
            j$.time.LocalDate r8 = r7.f18192a
            int r9 = r7.Z()
            int r9 = 1912 - r9
        ...
        La3:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.z.c(long, j$.time.temporal.o):j$.time.chrono.z");
    }
    ...
    public final ChronoLocalDate Y(long j10) {
        return b0(this.f18192a.i0(j10));
    }

    @Override // j$.time.chrono.c
    public final ChronoLocalDate X(long j10) {
        return b0(this.f18192a.plusMonths(j10));
    }

    @Override // j$.time.chrono.c
    public final ChronoLocalDate W(long j10) {
        return b0(this.f18192a.plusDays(j10));
    }
    ...
    public final Temporal v(long j10, ChronoUnit chronoUnit) {
        return (z) super.v(j10, chronoUnit);
    }

    @Override // j$.time.chrono.c, j$.time.chrono.ChronoLocalDate
    public final ChronoLocalDate v(long j10, j$.time.temporal.q qVar) {
        return (z) super.v(j10, qVar);
    }

    public final z b0(LocalDate localDate) {
        return localDate.equals(this.f18192a) ? this : new z(localDate);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof z) {
            return this.f18192a.equals(((z) obj).f18192a);
        }
        return false;
    }
