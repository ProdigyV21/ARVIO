...
public interface Stream<T> extends g {
    ...
    public final /* synthetic */ class Wrapper implements java.util.stream.Stream {
        ...
        public static /* synthetic */ java.util.stream.Stream convert(Stream stream) {
            ...
            return stream instanceof w6 ? ((w6) stream).f18943a : new Wrapper();
        }
        ...
        public final /* synthetic */ Object collect(java.util.stream.Collector collector) {
            return Stream.this.collect(collector == null ? null : collector instanceof j ? ((j) collector).f18736a : new i(collector));
        }
        ...
        public final /* synthetic */ DoubleStream mapToDouble(ToDoubleFunction toDoubleFunction) {
            return c0.e(Stream.this.mapToDouble(toDoubleFunction));
        }
        ...
        public final /* synthetic */ LongStream mapToLong(ToLongFunction toLongFunction) {
            return l1.e(Stream.this.mapToLong(toLongFunction));
        }
        ...
        public final /* synthetic */ BaseStream onClose(Runnable runnable) {
            return f.e(Stream.this.onClose(runnable));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream parallel() {
            return f.e(Stream.this.parallel());
        }
        ...
        public final /* synthetic */ BaseStream sequential() {
            return f.e(Stream.this.sequential());
        }
        ...
        public final /* synthetic */ BaseStream unordered() {
            return f.e(Stream.this.unordered());
        }
    }

    IntStream B(j$.util.function.i iVar);
