...
public class MediaConstraints {
    ...
    public static class KeyValuePair {
        ...
        public String toString() {
            return androidx.compose.foundation.c.t(this.key, ": ", this.value);
        }
    }
    ...
    public String toString() {
        return androidx.compose.material3.d.n("mandatory: ", stringifyKeyValuePairList(this.mandatory), ", optional: ", stringifyKeyValuePairList(this.optional));
    }
}
