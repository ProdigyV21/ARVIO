...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, int i10) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: com.discord.org.webrtc.SurfaceTextureHelper.1
            ...
            public SurfaceTextureHelper call() {
                try {
                    ...
                    Logging.e(SurfaceTextureHelper.TAG, str + " create failure", e5);
                    return null;
                }
            }
        });
    ...
    public void returnTextureFrame() {
        this.handler.post(new v(this, 3));
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new v(this, 1));
    }
    ...
    public void setFrameRotation(int i10) {
        this.handler.post(new o(this, i10, 1));
    }

    public void setTextureSize(int i10, int i11) {
        if (i10 <= 0) {
            throw new IllegalArgumentException(a0.c.i(i10, "Texture width must be positive, but was "));
        }
        if (i11 <= 0) {
            throw new IllegalArgumentException(a0.c.i(i11, "Texture height must be positive, but was "));
        }
        this.surfaceTexture.setDefaultBufferSize(i10, i11);
        this.handler.post(new w(i10, i11, 0, this));
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new v(this, 2));
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        EglBase eglBaseD = f.d(context, EglBase.CONFIG_PIXEL_BUFFER);
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: com.discord.org.webrtc.x
                @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                    this.f12549i.lambda$new$0(surfaceTexture2);
                }
            }, handler);
        } catch (RuntimeException e5) {
            this.eglBase.release();
