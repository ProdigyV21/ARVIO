    ...
    public void enable(int i10) {
        ...
        if (isAcousticEchoCancelerSupported()) {
            ...
            if (acousticEchoCancelerCreate != null) {
                ...
                boolean z5 = this.shouldEnableAec && isAcousticEchoCancelerSupported();
                if (this.aec.setEnabled(z5) != 0) {
                    Logging.e(TAG, "Failed to set the AcousticEchoCanceler state");
                }
                Logging.d(TAG, "AcousticEchoCanceler: was " + (enabled ? "enabled" : "disabled") + ", enable: " + z5 + ", is now: " + (this.aec.getEnabled() ? "enabled" : "disabled"));
            } else {
