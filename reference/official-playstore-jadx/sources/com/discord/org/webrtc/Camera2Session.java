...
class Camera2Session implements CameraSession {
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        private String getErrorDescription(int i10) {
            return i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? i10 != 5 ? a0.c.i(i10, "Unknown camera error: ") : "Camera service has encountered a fatal error." : "Camera device has encountered a fatal error." : "Camera device could not be opened due to a device policy." : "Camera device could not be opened because there are too many other open camera devices." : "Camera device is in use already.";
        }
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. " + e5);
            }
        }
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public /* synthetic */ void lambda$onConfigured$0(VideoFrame videoFrame) {
            ...
            VideoFrame videoFrame2 = new VideoFrame(d.a((TextureBufferImpl) videoFrame.getBuffer(), Camera2Session.this.isCameraFrontFacing, -Camera2Session.this.cameraOrientation), Camera2Session.this.getFrameOrientation(), videoFrame.getTimestampNs());
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new b(this, 1));
                Logging.d(Camera2Session.TAG, "Camera device successfully started.");
                Camera2Session.this.callback.onDone(Camera2Session.this);
            } catch (CameraAccessException e5) {
                Camera2Session.this.reportError("Failed to start capture request. " + e5);
            }
        }
    ...
    private void openCamera() {
        ...
        try {
            ...
            reportError("Failed to open camera: " + e5);
        }
    }
    ...
    private void start() {
        ...
        try {
            ...
            reportError(androidx.compose.material3.d.C("getCameraCharacteristics(): ", e5.getMessage()));
        }
    }
