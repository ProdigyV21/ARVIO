...
final class DefaultEbmlReader implements EbmlReader {
    ...
    public static final class MasterElement {
        ...
        public /* synthetic */ MasterElement(int i10, long j10, int i11) {
            this(i10, j10);
        }
    ...
    @Override // com.arflix.tv.player.dvmkv.EbmlReader
        ...
        while (true) {
            ...
            if (elementType != 0) {
                if (elementType == 1) {
                    ...
                    this.masterElementsStack.push(new MasterElement(this.elementId, this.elementContentSize + position, i10));
