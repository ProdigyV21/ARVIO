...
@e(c = "com.arflix.tv.data.repository.simkl.SimklSyncService$refreshSnapshot$2$showsRequest$1", f = "SimklSyncService.kt", l = {159}, m = "invokeSuspend", v = 2)
public final class SimklSyncService$refreshSnapshot$2$showsRequest$1 extends j implements p<k0, d<? super SimklSyncService.SnapshotFetch<SimklAllItemsResponse>>, Object> {
    final /* synthetic */ String $authHeader;
    int label;
    final /* synthetic */ SimklSyncService this$0;

    /* JADX INFO: renamed from: com.arflix.tv.data.repository.simkl.SimklSyncService$refreshSnapshot$2$showsRequest$1$1, reason: invalid class name */
    @Metadata(d1 = {"\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001H\n"}, d2 = {"<anonymous>", "Lcom/arflix/tv/data/api/SimklAllItemsResponse;"}, k = 3, mv = {2, 3, 0}, xi = 48)
    @e(c = "com.arflix.tv.data.repository.simkl.SimklSyncService$refreshSnapshot$2$showsRequest$1$1", f = "SimklSyncService.kt", l = {160}, m = "invokeSuspend", v = 2)
    public static final class AnonymousClass1 extends j implements l<d<? super SimklAllItemsResponse>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                this.L$1 = "shows";
                this.label = 1;
                objB = com.arflix.tv.data.api.e.b(simklApi, str2, clientId, "shows", null, null, null, null, null, null, this, 504, null);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SimklSyncService$refreshSnapshot$2$showsRequest$1(SimklSyncService simklSyncService, String str, d<? super SimklSyncService$refreshSnapshot$2$showsRequest$1> dVar) {
        super(2, dVar);
        this.this$0 = simklSyncService;
        this.$authHeader = str;
    }
    ...
    public final d<t0> create(Object obj, d<?> dVar) {
        return new SimklSyncService$refreshSnapshot$2$showsRequest$1(this.this$0, this.$authHeader, dVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object objFetchSnapshotPart = simklSyncService.fetchSnapshotPart("Shows", anonymousClass1, this);
        e7.a aVar = e7.a.f15033i;
    ...
    public final Object invoke(k0 k0Var, d<? super SimklSyncService.SnapshotFetch<SimklAllItemsResponse>> dVar) {
        return ((SimklSyncService$refreshSnapshot$2$showsRequest$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
