...
@f7.e(c = "com.arflix.tv.data.repository.MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1", f = "MediaRepository.kt", l = {1646}, m = "invokeSuspend", v = 2)
public final class MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1 extends f7.j implements r7.p<ka.k0, d7.d<? super List<? extends TmdbMediaItem>>, Object> {
    final /* synthetic */ ka.k0 $$this$coroutineScope;
    int label;
    final /* synthetic */ MediaRepository this$0;

    /* JADX INFO: renamed from: com.arflix.tv.data.repository.MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1$1, reason: invalid class name */
    @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n"}, d2 = {"<anonymous>", "Lcom/arflix/tv/data/api/TmdbListResponse;", "page", ""}, k = 3, mv = {2, 3, 0}, xi = 48)
    @f7.e(c = "com.arflix.tv.data.repository.MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1$1", f = "MediaRepository.kt", l = {1646}, m = "invokeSuspend", v = 2)
    public static final class AnonymousClass1 extends f7.j implements r7.p<Integer, d7.d<? super TmdbListResponse>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            this.I$0 = i10;
            this.label = 1;
            Object trendingMovies = tmdbApi.getTrendingMovies(str, contentLanguage, i10, this);
            e7.a aVar = e7.a.f15033i;
            return trendingMovies == aVar ? aVar : trendingMovies;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1(MediaRepository mediaRepository, ka.k0 k0Var, d7.d<? super MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1> dVar) {
        super(2, dVar);
        this.this$0 = mediaRepository;
    ...
    @Override // f7.a
    public final d7.d<t0> create(Object obj, d7.d<?> dVar) {
        return new MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1(this.this$0, this.$$this$coroutineScope, dVar);
    }
    ...
    public final Object invoke(ka.k0 k0Var, d7.d<? super List<TmdbMediaItem>> dVar) {
        return ((MediaRepository$getHomeCategoriesInternal$2$trendingMovies$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
