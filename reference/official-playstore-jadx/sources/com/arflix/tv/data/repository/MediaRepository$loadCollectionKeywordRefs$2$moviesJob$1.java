...
@f7.e(c = "com.arflix.tv.data.repository.MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1", f = "MediaRepository.kt", l = {2218}, m = "invokeSuspend", v = 2)
public final class MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1 extends f7.j implements r7.p<ka.k0, d7.d<? super List<? extends x6.x>>, Object> {
    ...
    /* JADX INFO: renamed from: com.arflix.tv.data.repository.MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1$1, reason: invalid class name */
    @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n"}, d2 = {"<anonymous>", "Lcom/arflix/tv/data/api/TmdbListResponse;", "page", ""}, k = 3, mv = {2, 3, 0}, xi = 48)
    @f7.e(c = "com.arflix.tv.data.repository.MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1$1", f = "MediaRepository.kt", l = {2222}, m = "invokeSuspend", v = 2)
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1(MediaRepository mediaRepository, int i10, String str, String str2, d7.d<? super MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1> dVar) {
        super(2, dVar);
        this.this$0 = mediaRepository;
        this.$limit = i10;
        this.$sortBy = str;
    ...
    @Override // f7.a
    public final d7.d<t0> create(Object obj, d7.d<?> dVar) {
        return new MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1(this.this$0, this.$limit, this.$sortBy, this.$keyword, dVar);
    }
    ...
    public final Object invoke(ka.k0 k0Var, d7.d<? super List<? extends x6.x>> dVar) {
        return ((MediaRepository$loadCollectionKeywordRefs$2$moviesJob$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
