...
@f7.e(c = "com.arflix.tv.data.repository.TraktRepository$loadLocalContinueWatching$2$1$1", f = "TraktRepository.kt", l = {4806, 2490}, m = "invokeSuspend", v = 2)
public final class TraktRepository$loadLocalContinueWatching$2$1$1 extends f7.j implements r7.p<ka.k0, d7.d<? super ContinueWatchingItem>, Object> {
    ...
    public TraktRepository$loadLocalContinueWatching$2$1$1(ua.f fVar, TraktRepository traktRepository, ContinueWatchingItem continueWatchingItem, ConcurrentHashMap<x6.x, ka.p0<TmdbSeasonDetails>> concurrentHashMap, d7.d<? super TraktRepository$loadLocalContinueWatching$2$1$1> dVar) {
        super(2, dVar);
        this.$semaphore = fVar;
    ...
    public final d7.d<t0> create(Object obj, d7.d<?> dVar) {
        return new TraktRepository$loadLocalContinueWatching$2$1$1(this.$semaphore, this.this$0, this.$item, this.$seasonCache, dVar);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r9) {
        ...
        L74:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.arflix.tv.data.repository.TraktRepository$loadLocalContinueWatching$2$1$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }

    @Override // r7.p
    public final Object invoke(ka.k0 k0Var, d7.d<? super ContinueWatchingItem> dVar) {
        return ((TraktRepository$loadLocalContinueWatching$2$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
