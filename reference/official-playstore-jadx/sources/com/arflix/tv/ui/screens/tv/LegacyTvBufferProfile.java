...
final /* data */ class LegacyTvBufferProfile {
    ...
    public LegacyTvBufferProfile(int i10, int i11, int i12, int i13, int i14, int i15) {
    ...
    public static /* synthetic */ LegacyTvBufferProfile copy$default(LegacyTvBufferProfile legacyTvBufferProfile, int i10, int i11, int i12, int i13, int i14, int i15, int i16, Object obj) {
        if ((i16 & 1) != 0) {
            i10 = legacyTvBufferProfile.minBufferMs;
        }
        if ((i16 & 2) != 0) {
            i11 = legacyTvBufferProfile.maxBufferMs;
        }
        if ((i16 & 4) != 0) {
            i12 = legacyTvBufferProfile.bufferForPlaybackMs;
        }
        if ((i16 & 8) != 0) {
            i13 = legacyTvBufferProfile.bufferForPlaybackAfterRebufferMs;
        }
        if ((i16 & 16) != 0) {
            i14 = legacyTvBufferProfile.targetBufferBytes;
        }
        if ((i16 & 32) != 0) {
            i15 = legacyTvBufferProfile.backBufferMs;
        }
        int i17 = i14;
        int i18 = i15;
        return legacyTvBufferProfile.copy(i10, i11, i12, i13, i17, i18);
    }
    ...
    public final LegacyTvBufferProfile copy(int minBufferMs, int maxBufferMs, int bufferForPlaybackMs, int bufferForPlaybackAfterRebufferMs, int targetBufferBytes, int backBufferMs) {
        return new LegacyTvBufferProfile(minBufferMs, maxBufferMs, bufferForPlaybackMs, bufferForPlaybackAfterRebufferMs, targetBufferBytes, backBufferMs);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LegacyTvBufferProfile)) {
            return false;
        }
        LegacyTvBufferProfile legacyTvBufferProfile = (LegacyTvBufferProfile) other;
        return this.minBufferMs == legacyTvBufferProfile.minBufferMs && this.maxBufferMs == legacyTvBufferProfile.maxBufferMs && this.bufferForPlaybackMs == legacyTvBufferProfile.bufferForPlaybackMs && this.bufferForPlaybackAfterRebufferMs == legacyTvBufferProfile.bufferForPlaybackAfterRebufferMs && this.targetBufferBytes == legacyTvBufferProfile.targetBufferBytes && this.backBufferMs == legacyTvBufferProfile.backBufferMs;
    }
    ...
    public String toString() {
        ...
        StringBuilder sbV = androidx.compose.foundation.c.v("LegacyTvBufferProfile(minBufferMs=", i10, ", maxBufferMs=", i11, ", bufferForPlaybackMs=");
