...
@f7.e(c = "com.arflix.tv.ui.screens.home.HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1", f = "HomeViewModel.kt", l = {2417}, m = "invokeSuspend", v = 2)
public final class HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1 extends f7.j implements r7.p<ka.k0, d7.d<? super Category>, Object> {
    final /* synthetic */ CatalogConfig $cfg;
    int label;
    final /* synthetic */ HomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1(HomeViewModel homeViewModel, CatalogConfig catalogConfig, d7.d<? super HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1> dVar) {
        super(2, dVar);
    ...
    public final d7.d<t0> create(Object obj, d7.d<?> dVar) {
        return new HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1(this.this$0, this.$cfg, dVar);
    }
    ...
    public final Object invoke(ka.k0 k0Var, d7.d<? super Category> dVar) {
        return ((HomeViewModel$loadHomeData$1$categories$1$3$1$results$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
