...
public final class CollectionDetailsScreenKt$CollectionItemsGrid__F44eQ8$lambda$5$0$$inlined$itemsIndexed$default$2 extends kotlin.jvm.internal.r implements r7.p<s0, Integer, o0> {
    final /* synthetic */ List $items;
    final /* synthetic */ r7.q $span;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CollectionDetailsScreenKt$CollectionItemsGrid__F44eQ8$lambda$5$0$$inlined$itemsIndexed$default$2(r7.q qVar, List list) {
        super(2);
        this.$span = qVar;
        this.$items = list;
    }
    ...
    public /* synthetic */ Object invoke(Object obj, Object obj2) {
        return new o0(m6200invokex45P8T4((s0) obj, ((Number) obj2).intValue()));
    }

    /* JADX INFO: renamed from: invoke-x45P8T4, reason: not valid java name */
    public final long m6200invokex45P8T4(s0 s0Var, int i10) {
