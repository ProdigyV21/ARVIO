...
public class CrashlyticsReportJsonTransform {
    private static final com.google.firebase.encoders.a CRASHLYTICS_REPORT_JSON_ENCODER;
    ...
    static {
        ...
        dVar.f16225d = true;
        CRASHLYTICS_REPORT_JSON_ENCODER = new e(dVar, 22);
    }
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "buildIdMappingForArch":
                    builder.setBuildIdMappingForArch(parseArray(jsonReader, new a(i10)));
                    break;
                case "pid":
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "appProcessDetails":
                    builder.setAppProcessDetails(parseArray(jsonReader, new a(i10)));
                    break;
                case "background":
                ...
                case "execution":
                    ...
                    break;
                case "internalKeys":
                    builder.setInternalKeys(parseArray(jsonReader, new a(i11)));
                    break;
                case "customAttributes":
                    builder.setCustomAttributes(parseArray(jsonReader, new a(i11)));
                    break;
                case "uiOrientation":
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "frames":
                    builder.setFrames(parseArray(jsonReader, new a(i10)));
                    break;
                case "reason":
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                ...
                case "device":
                    ...
                    break;
                case "events":
                    builder.setEvents(parseArray(jsonReader, new a(i10)));
                    break;
                case "os":
    ...
    public String applicationExitInfoToJson(CrashlyticsReport.ApplicationExitInfo applicationExitInfo) {
        return CRASHLYTICS_REPORT_JSON_ENCODER.x(applicationExitInfo);
    }
    ...
    public String eventToJson(CrashlyticsReport.Session.Event event) {
        return CRASHLYTICS_REPORT_JSON_ENCODER.x(event);
    }
    ...
    public String reportToJson(CrashlyticsReport crashlyticsReport) {
        return CRASHLYTICS_REPORT_JSON_ENCODER.x(crashlyticsReport);
    }
}
