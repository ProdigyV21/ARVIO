...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Builder {
        ...
        public CrashlyticsReport.Session.Event build() {
            String strM = this.timestamp == null ? " timestamp" : "";
            if (this.type == null) {
                strM = d.m(strM, " type");
            }
            if (this.app == null) {
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((((int) (j10 ^ (j10 >>> 32))) ^ 1000003) * 1000003) ^ this.type.hashCode()) * 1000003) ^ this.app.hashCode()) * 1000003) ^ this.device.hashCode()) * 1000003;
