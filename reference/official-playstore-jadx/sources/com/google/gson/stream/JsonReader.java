...
public class JsonReader implements Closeable {
    ...
    */
    ...
    public String locationString() {
        StringBuilder sbV = c.v(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        sbV.append(getPath());
        return sbV.toString();
    }
    ...
    public double nextDouble() throws IOException {
        ...
        this.peeked = 11;
        double d4 = Double.parseDouble(this.peekedString);
        if (!this.lenient && (Double.isNaN(d4) || Double.isInfinite(d4))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + d4 + locationString());
        }
