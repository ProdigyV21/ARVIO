...
public final class SentryAndroidOptions extends y6 {
    ...
    public SentryAndroidOptions() {
        ...
        this.debugImagesLoader = v.f16792m;
        ...
        this.screenshot = new m1();
        this.enableAnrFingerprinting = true;
        setSentryClientName("sentry.java.android/8.40.0");
    ...
    private io.sentry.protocol.t createSdkVersion() {
        ...
        if (sdkVersion == null) {
            sdkVersion = new io.sentry.protocol.t("sentry.java.android", "8.40.0");
        } else {
            sdkVersion.f17695i = "sentry.java.android";
            sdkVersion.f17696l = "8.40.0";
        }
        u5.d().b("maven:io.sentry:sentry-android-core", "8.40.0");
        return sdkVersion;
    }
    ...
    public boolean isAnrProfilingEnabled() {
        Double d4 = this.anrProfilingSampleRate;
    ...
    public void setAnrProfilingSampleRate(Double d4) {
        if (androidx.work.impl.t.x(d4, true)) {
            this.anrProfilingSampleRate = d4;
            return;
        }
