...
public final class AuthImpl$exchangeCodeForSession$$inlined$postJson$1 extends r implements l<HttpRequestBuilder, t0> {
    final /* synthetic */ Object $body;
    final /* synthetic */ ContentType $contentType;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AuthImpl$exchangeCodeForSession$$inlined$postJson$1(ContentType contentType, Object obj) {
        super(1);
    ...
    public final void invoke(HttpRequestBuilder httpRequestBuilder) {
        ...
        httpRequestBuilder.getHeaders().remove("Authorization");
