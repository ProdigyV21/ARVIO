...
public final class AuthImpl$resetPasswordForEmail$$inlined$postJson$1 extends r implements l<HttpRequestBuilder, t0> {
    final /* synthetic */ Object $body;
    final /* synthetic */ ContentType $contentType;
    final /* synthetic */ String $redirectUrl$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AuthImpl$resetPasswordForEmail$$inlined$postJson$1(ContentType contentType, Object obj, String str) {
        super(1);
    ...
    public final void invoke(HttpRequestBuilder httpRequestBuilder) {
        ...
        if (str != null) {
            httpRequestBuilder.getUrl().getEncodedParameters().append("redirect_to", str);
        }
