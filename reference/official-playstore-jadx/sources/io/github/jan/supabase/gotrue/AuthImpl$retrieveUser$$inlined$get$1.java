...
public final class AuthImpl$retrieveUser$$inlined$get$1 extends r implements l<HttpRequestBuilder, t0> {
    final /* synthetic */ String $jwt$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AuthImpl$retrieveUser$$inlined$get$1(String str) {
        super(1);
    ...
    public final void invoke(HttpRequestBuilder httpRequestBuilder) {
        ...
        httpRequestBuilder.getHeaders().set("Authorization", "Bearer " + this.$jwt$inlined);
    }
}
