...
public final class KtorSupabaseHttpClient$httpClient$2 extends r implements l<HttpClientConfig<?>, t0> {
    ...
    public KtorSupabaseHttpClient$httpClient$2(KtorSupabaseHttpClient ktorSupabaseHttpClient, List<? extends l<? super HttpClientConfig<?>, t0>> list) {
        super(1);
