...
@e(c = "io.ktor.util.ByteChannelsKt$split$1$1$1", f = "ByteChannels.kt", l = {27}, m = "invokeSuspend")
public final class ByteChannelsKt$split$1$1$1 extends j implements p<k0, d<? super t0>, Object> {
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((ByteChannelsKt$split$1$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
