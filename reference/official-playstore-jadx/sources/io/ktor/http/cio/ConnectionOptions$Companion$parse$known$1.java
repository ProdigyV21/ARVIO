...
public final class ConnectionOptions$Companion$parse$known$1 extends r implements p<Character, Integer, Boolean> {
    public static final ConnectionOptions$Companion$parse$known$1 INSTANCE = new ConnectionOptions$Companion$parse$known$1();

    public ConnectionOptions$Companion$parse$known$1() {
        super(2);
    }
