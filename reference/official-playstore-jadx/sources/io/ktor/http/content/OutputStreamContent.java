...
public final class OutputStreamContent extends OutgoingContent.WriteChannelContent {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (r02 == 0) {
                    ...
                    this.label = 1;
                    Object objInvoke = pVar.invoke(outputStream$default, this);
                    a aVar = a.f15033i;
                    r02 = outputStream$default;
                    if (objInvoke == aVar) {
                        return aVar;
                    }
                } else {
    ...
    public /* synthetic */ OutputStreamContent(p pVar, ContentType contentType, HttpStatusCode httpStatusCode, Long l10, int i10, h hVar) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public OutputStreamContent(p<? super OutputStream, ? super d<? super t0>, ? extends Object> pVar, ContentType contentType, HttpStatusCode httpStatusCode, Long l10) {
        this.body = pVar;
