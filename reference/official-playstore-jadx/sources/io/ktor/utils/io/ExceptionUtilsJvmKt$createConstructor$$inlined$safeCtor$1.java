...
public final class ExceptionUtilsJvmKt$createConstructor$$inlined$safeCtor$1 extends r implements l<Throwable, Throwable> {
    ...
    public final Throwable invoke(Throwable th) {
        Object c0Var;
        try {
            c0Var = (Throwable) this.$constructor$inlined.newInstance(th.getMessage(), th);
        } catch (Throwable th2) {
            c0Var = new c0(th2);
        }
