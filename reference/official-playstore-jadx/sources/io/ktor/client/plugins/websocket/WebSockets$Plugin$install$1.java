...
public final class WebSockets$Plugin$install$1 extends j implements q<PipelineContext<Object, HttpRequestBuilder>, Object, d<? super t0>, Object> {
    ...
    public WebSockets$Plugin$install$1(boolean z, WebSockets webSockets, d<? super WebSockets$Plugin$install$1> dVar) {
        super(3, dVar);
    ...
    public final Object invoke(PipelineContext<Object, HttpRequestBuilder> pipelineContext, Object obj, d<? super t0> dVar) {
        ...
        return webSockets$Plugin$install$1.invokeSuspend(t0.f22605a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (!URLProtocolKt.isWebsocket(((HttpRequestBuilder) pipelineContext.getContext()).getUrl().getProtocol())) {
            WebSocketsKt.getLOGGER().h("Skipping WebSocket plugin for non-websocket request: " + ((HttpRequestBuilder) pipelineContext.getContext()).getUrl());
            return t0Var;
        }
        WebSocketsKt.getLOGGER().h("Sending WebSocket request " + ((HttpRequestBuilder) pipelineContext.getContext()).getUrl());
        ((HttpRequestBuilder) pipelineContext.getContext()).setCapability(WebSocketCapability.INSTANCE, t0Var);
        ...
        this.label = 1;
        Object objProceedWith = pipelineContext.proceedWith(webSocketContent, this);
        a aVar = a.f15033i;
