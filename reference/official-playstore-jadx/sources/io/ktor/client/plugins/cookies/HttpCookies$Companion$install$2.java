...
@e(c = "io.ktor.client.plugins.cookies.HttpCookies$Companion$install$2", f = "HttpCookies.kt", l = {MenuKt.InTransitionDuration}, m = "invokeSuspend")
public final class HttpCookies$Companion$install$2 extends j implements q<PipelineContext<Object, HttpRequestBuilder>, Object, d<? super t0>, Object> {
    ...
    public final Object invoke(PipelineContext<Object, HttpRequestBuilder> pipelineContext, Object obj, d<? super t0> dVar) {
        ...
        return httpCookies$Companion$install$2.invokeSuspend(t0.f22605a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            Object objSendCookiesWith$ktor_client_core = httpCookies.sendCookiesWith$ktor_client_core(httpRequestBuilder, this);
            a aVar = a.f15033i;
            if (objSendCookiesWith$ktor_client_core == aVar) {
                return aVar;
            }
        } else {
            if (i10 != 1) {
