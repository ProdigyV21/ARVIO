...
public final class HttpRequestRetry$Configuration$retryOnException$1 extends r implements q<HttpRequestRetry.ShouldRetryContext, HttpRequestBuilder, Throwable, Boolean> {
    ...
    public final Boolean invoke(HttpRequestRetry.ShouldRetryContext shouldRetryContext, HttpRequestBuilder httpRequestBuilder, Throwable th) {
        return Boolean.valueOf(HttpRequestRetryKt.isTimeoutException(th) ? this.$retryOnTimeout : !(th instanceof CancellationException));
    }
}
