...
public final class UserAgent$Plugin$install$1 extends j implements q<PipelineContext<Object, HttpRequestBuilder>, Object, d<? super t0>, Object> {
    ...
    public final Object invoke(PipelineContext<Object, HttpRequestBuilder> pipelineContext, Object obj, d<? super t0> dVar) {
        ...
        return userAgent$Plugin$install$1.invokeSuspend(t0.f22605a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        UserAgentKt.LOGGER.h("Adding User-Agent header: " + this.$plugin.getAgent() + " for " + ((HttpRequestBuilder) pipelineContext.getContext()).getUrl());
