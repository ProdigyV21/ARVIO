...
public final class HttpRequestRetry$Configuration$exponentialDelay$1 extends r implements p<HttpRequestRetry.DelayContext, Integer, Long> {
    ...
    public HttpRequestRetry$Configuration$exponentialDelay$1(double d4, long j10, HttpRequestRetry.Configuration configuration, long j11) {
        super(2);
        this.$base = d4;
        this.$maxDelayMs = j10;
