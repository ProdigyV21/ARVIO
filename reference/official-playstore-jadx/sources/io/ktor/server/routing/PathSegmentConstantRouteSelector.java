...
public final /* data */ class PathSegmentConstantRouteSelector extends RouteSelector {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof PathSegmentConstantRouteSelector) && p.a(this.value, ((PathSegmentConstantRouteSelector) other).value);
    }

    @Override // io.ktor.server.routing.RouteSelector
    public RouteSelectorEvaluation evaluate(RoutingResolveContext context, int segmentIndex) {
        return (segmentIndex >= context.getSegments().size() || !p.a(context.getSegments().get(segmentIndex), this.value)) ? RouteSelectorEvaluation.INSTANCE.getFailedPath() : RouteSelectorEvaluation.INSTANCE.getConstantPath();
    }
