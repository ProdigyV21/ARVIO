...
public final class CreatePluginUtilsKt$createApplicationPlugin$1$install$1<PluginConfigT> extends r implements a<PluginConfigT> {
    ...
    public CreatePluginUtilsKt$createApplicationPlugin$1$install$1(l<? super ApplicationConfig, ? extends PluginConfigT> lVar, ApplicationConfig applicationConfig) {
        super(0);
