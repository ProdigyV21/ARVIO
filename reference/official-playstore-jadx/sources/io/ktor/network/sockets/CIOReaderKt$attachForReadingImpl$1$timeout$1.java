...
public final class CIOReaderKt$attachForReadingImpl$1$timeout$1 extends j implements l<d<? super t0>, Object> {
    ...
    public final Object invoke(d<? super t0> dVar) {
        return ((CIOReaderKt$attachForReadingImpl$1$timeout$1) create(dVar)).invokeSuspend(t0.f22605a);
    }
