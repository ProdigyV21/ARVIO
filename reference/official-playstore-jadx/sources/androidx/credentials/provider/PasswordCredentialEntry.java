...
public final class PasswordCredentialEntry extends CredentialEntry {
    ...
    public static final class Api28Impl {
        ...
        public static final PasswordCredentialEntry fromSlice(Slice slice) {
            ...
            for (SliceItem sliceItem : slice.getItems()) {
                if (sliceItem.hasHint(PasswordCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)) {
                    ...
                    if (p.a(sliceItem.getText(), PasswordCredentialEntry.TRUE_STRING)) {
                        z = true;
                    }
            ...
            try {
                return new PasswordCredentialEntry(text2, text3, text4, action, instantOfEpochMilli, icon, z, BeginGetPasswordOption.INSTANCE.createFrom$credentials_release(new Bundle(), text.toString()), z5, text5, text6, z10, true, z11);
            } catch (Exception e5) {
                Log.i(PasswordCredentialEntry.TAG, "fromSlice failed with: " + e5.getMessage());
                return null;
            }
        }
        ...
        public static final Slice toSlice(PasswordCredentialEntry entry) {
            ...
            Slice.Builder builderAddText = new Slice.Builder(Uri.EMPTY, new SliceSpec(type, 1)).addText(typeDisplayName, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)).addText(username, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_TITLE)).addText(displayName, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_SUBTITLE)).addText(charSequence, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_AUTO_ALLOWED)).addText(beginGetCredentialOption.getId(), null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_OPTION_ID)).addIcon(icon, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_ICON)).addText(entryGroupId, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_DEDUPLICATION_ID)).addText(affiliatedDomain, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_AFFILIATED_DOMAIN)).addText(str, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_IS_DEFAULT_ICON_PREFERRED));
            try {
                if (entry.hasDefaultIcon()) {
                    builderAddText.addInt(1, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_DEFAULT_ICON_RES_ID));
                }
            } catch (IllegalStateException unused) {
            }
            if (entry.getIsAutoSelectAllowedFromOption()) {
                builderAddText.addInt(1, null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_AUTO_SELECT_FROM_OPTION));
            }
            if (lastUsedTime != null) {
                builderAddText.addLong(lastUsedTime.toEpochMilli(), null, Collections.singletonList(PasswordCredentialEntry.SLICE_HINT_LAST_USED_TIME_MILLIS));
            }
    ...
    /*  JADX ERROR: NullPointerException in pass: InitCodeVariables
        ...
        */
    public /* synthetic */ PasswordCredentialEntry(java.lang.CharSequence r18, java.lang.CharSequence r19, java.lang.CharSequence r20, android.app.PendingIntent r21, j$.time.Instant r22, android.graphics.drawable.Icon r23, boolean r24, androidx.credentials.provider.BeginGetPasswordOption r25, boolean r26, java.lang.CharSequence r27, java.lang.CharSequence r28, boolean r29, boolean r30, boolean r31, int r32, kotlin.jvm.internal.h r33) {
        /*
            r17 = this;
            r0 = r32
    ...
    public PasswordCredentialEntry(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, PendingIntent pendingIntent, Instant instant, Icon icon, boolean z, BeginGetPasswordOption beginGetPasswordOption, boolean z5, CharSequence charSequence4, CharSequence charSequence5, boolean z10, boolean z11, boolean z12) {
        super(PasswordCredential.TYPE_PASSWORD_CREDENTIAL, beginGetPasswordOption, charSequence4 == null ? charSequence : charSequence4, z5, charSequence5);
        this.username = charSequence;
    ...
    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z, CharSequence charSequence3, boolean z5, int i10, h hVar) {
        this(context, charSequence, pendingIntent, beginGetPasswordOption, (i10 & 16) != 0 ? null : charSequence2, (i10 & 32) != 0 ? null : instant, (i10 & 64) != 0 ? Icon.createWithResource(context, R.drawable.ic_password) : icon, (i10 & 128) != 0 ? false : z, (i10 & 256) != 0 ? null : charSequence3, (i10 & 512) != 0 ? false : z5);
    }

    public PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z, CharSequence charSequence3, boolean z5) {
        this(charSequence, charSequence2, context.getString(R.string.android_credentials_TYPE_PASSWORD_CREDENTIAL), pendingIntent, instant, icon, z, beginGetPasswordOption, z5, null, charSequence3, false, false, false, 14848, null);
    }

    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z, int i10, h hVar) {
        this(context, charSequence, pendingIntent, beginGetPasswordOption, (i10 & 16) != 0 ? null : charSequence2, (i10 & 32) != 0 ? null : instant, (i10 & 64) != 0 ? Icon.createWithResource(context, R.drawable.ic_password) : icon, (i10 & 128) != 0 ? false : z);
    }
    ...
    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z) {
        this(charSequence, charSequence2, context.getString(R.string.android_credentials_TYPE_PASSWORD_CREDENTIAL), pendingIntent, instant, icon, z, beginGetPasswordOption, false, null, null, false, false, false, 15872, null);
    }
}
