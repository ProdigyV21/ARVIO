...
public final class BeginGetCredentialUtil$Companion$convertToJetpackResponse$7 extends r implements l<Action, AuthenticationAction> {
    ...
    public final AuthenticationAction invoke(Action action) {
        return AuthenticationAction.INSTANCE.fromSlice(action.getSlice());
    }
