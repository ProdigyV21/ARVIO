...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context, String str, int i10, int i11, boolean z) {
        this(context, new DefaultHttpDataSource.Factory().setUserAgent(str).setConnectTimeoutMs(i10).setReadTimeoutMs(i11).setAllowCrossProtocolRedirects(z).createDataSource());
    }
