...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                ...
                this.hashCode = Arrays.hashCode(this.data) + c.c((iHashCode + (str == null ? 0 : str.hashCode())) * 31, 31, this.mimeType);
            }
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        ...
        ac.b.s(str2 == null || (str = drmInitData.schemeType) == null || TextUtils.equals(str2, str));
