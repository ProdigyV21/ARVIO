...
public class MatroskaExtractor implements Extractor {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new h(26);
    ...
    public static final class MatroskaSeekMap implements TrackAwareSeekMap, ChunkIndexProvider {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j10, int i10) {
            ...
            if (list != null && !list.isEmpty()) {
                int iBinarySearchFloor = Util.binarySearchFloor((List<? extends Comparable<? super CuePointData>>) list, new CuePointData(j10, -1L, -1L), true, false);
    ...
    */
    ...
    private int writeSampleData(ExtractorInput extractorInput, Track track, int i10, boolean z) throws IOException {
        ...
        int iLimit2 = this.sampleStrippedBytes.limit() + i10;
        if (!CODEC_ID_H264.equals(track.codecId) && !CODEC_ID_H265.equals(track.codecId)) {
            if (track.trueHdSampleRechunker != null) {
                b.s(this.sampleStrippedBytes.limit() == 0);
