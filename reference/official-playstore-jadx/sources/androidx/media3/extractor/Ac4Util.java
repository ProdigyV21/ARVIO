...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, 480, MediaError.DetailedErrorCode.MANIFEST_UNKNOWN, MediaError.DetailedErrorCode.MANIFEST_UNKNOWN, 2048};
    ...
    private static String createCodecsString(int i10, int i11, int i12) {
        return Util.formatInvariant("ac-4.%02d.%02d.%02d", Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12));
    }
    ...
    private static int getAdjustedChannelCount(int i10, boolean z, int i11) {
        int channelCountFromChannelMode = getChannelCountFromChannelMode(i10);
        ...
        return i11 != 0 ? i11 != 1 ? channelCountFromChannelMode : channelCountFromChannelMode - 2 : channelCountFromChannelMode - 4;
    }

    private static int getChannelCountFromChannelMode(int i10) {
        switch (i10) {
            case 0:
                return 1;
            case 1:
    ...
    */
    ...
    private static int readVariableBits(ParsableBitArray parsableBitArray, int i10) {
        int i11 = 0;
        while (true) {
            int bits = parsableBitArray.readBits(i10) + i11;
            if (!parsableBitArray.readBit()) {
                return bits;
            }
            i11 = (bits + 1) << i10;
