...
final class FlacBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public FlacBinarySearchSeeker(FlacStreamMetadata flacStreamMetadata, int i10, long j10, long j11) {
        super(new b(flacStreamMetadata, 7), new FlacTimestampSeeker(flacStreamMetadata, i10), flacStreamMetadata.getDurationUs(), 0L, flacStreamMetadata.totalSamples, j10, j11, flacStreamMetadata.getApproxBytesPerFrame(), Math.max(6, flacStreamMetadata.minFrameSize));
