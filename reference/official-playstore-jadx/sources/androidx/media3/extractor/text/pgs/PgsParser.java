    ...
    public static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i10) {
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                ...
                double d4 = unsignedByte2;
                double d10 = unsignedByte3 - 128;
                double d11 = unsignedByte4 - 128;
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d4 - (0.34414d * d11)) - (d10 * 0.71414d)), 0, 255) << 8) | (parsableByteArray.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d10) + d4), 0, 255) << 16) | Util.constrainValue((int) ((d11 * 1.772d) + d4), 0, 255);
            }
            this.colorsSet = true;
        }
