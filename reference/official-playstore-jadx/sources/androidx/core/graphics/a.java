...
public abstract class a {
    ...
    public static final ThreadLocal f2084a = new ThreadLocal();

    public static int a(double d4, double d10, double d11) {
        double d12 = (((-0.4986d) * d11) + (((-1.5372d) * d10) + (3.2406d * d4))) / 100.0d;
        double d13 = ((0.0415d * d11) + ((1.8758d * d10) + ((-0.9689d) * d4))) / 100.0d;
        double d14 = ((1.057d * d11) + (((-0.204d) * d10) + (0.0557d * d4))) / 100.0d;
    ...
    public static double b(int i10) {
        ThreadLocal threadLocal = f2084a;
    ...
    public static int c(int i10, int i11) {
        ...
        return Color.argb(i12, d(Color.red(i10), iAlpha2, Color.red(i11), iAlpha, i12), d(Color.green(i10), iAlpha2, Color.green(i11), iAlpha, i12), d(Color.blue(i10), iAlpha2, Color.blue(i11), iAlpha, i12));
    }
