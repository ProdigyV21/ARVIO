...
public final class AppBarKt$TopAppBarLayout$3 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ int $$changed;
    final /* synthetic */ int $$changed1;
    final /* synthetic */ long $actionIconContentColor;
    final /* synthetic */ p<Composer, Integer, t0> $actions;
    ...
    public AppBarKt$TopAppBarLayout$3(Modifier modifier, float f10, long j10, long j11, long j12, p<? super Composer, ? super Integer, t0> pVar, TextStyle textStyle, float f11, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i10, boolean z, p<? super Composer, ? super Integer, t0> pVar2, p<? super Composer, ? super Integer, t0> pVar3, int i11, int i12) {
        super(2);
