...
public final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2$1$sheetPlaceable$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ q<Integer, Composer, Integer, t0> $bottomSheet;
    final /* synthetic */ int $layoutHeight;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2$1$sheetPlaceable$1(q<? super Integer, ? super Composer, ? super Integer, t0> qVar, int i10) {
        super(2);
