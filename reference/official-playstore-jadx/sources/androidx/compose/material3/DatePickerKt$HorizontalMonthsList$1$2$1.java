...
public final class DatePickerKt$HorizontalMonthsList$1$2$1 extends r implements l<LazyListScope, t0> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.DatePickerKt$HorizontalMonthsList$1$2$1$1, reason: invalid class name */
    ...
    public static final class AnonymousClass1 extends r implements r7.r<LazyItemScope, Integer, Composer, Integer, t0> {
        ...
        public AnonymousClass1(CalendarModel calendarModel, CalendarMonth calendarMonth, l<? super Long, t0> lVar, CalendarDate calendarDate, Long l10, DatePickerFormatter datePickerFormatter, SelectableDates selectableDates, DatePickerColors datePickerColors) {
            super(4);
        ...
        public final void invoke(LazyItemScope lazyItemScope, int i10, Composer composer, int i11) {
            ...
            DatePickerKt.Month(calendarMonthPlusMonths, lVar, calendarDate.getUtcTimeMillis(), l10, null, null, datePickerFormatter, selectableDates, datePickerColors, composer, 221184);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DatePickerKt$HorizontalMonthsList$1$2$1(i iVar, CalendarModel calendarModel, CalendarMonth calendarMonth, l<? super Long, t0> lVar, CalendarDate calendarDate, Long l10, DatePickerFormatter datePickerFormatter, SelectableDates selectableDates, DatePickerColors datePickerColors) {
        super(1);
        this.$yearRange = iVar;
        this.$calendarModel = calendarModel;
        this.$firstMonth = calendarMonth;
