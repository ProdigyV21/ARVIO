...
@f7.e(c = "androidx.compose.material3.AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1", f = "AppBar.kt", l = {1675}, m = "invokeSuspend")
public final class AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1 extends j implements q<k0, Float, d7.d<? super t0>, Object> {
    final /* synthetic */ TopAppBarScrollBehavior $scrollBehavior;
    /* synthetic */ float F$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1(TopAppBarScrollBehavior topAppBarScrollBehavior, d7.d<? super AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1> dVar) {
        super(3, dVar);
    ...
    public final Object invoke(k0 k0Var, float f10, d7.d<? super t0> dVar) {
        ...
        return appBarKt$SingleRowTopAppBar$appBarDragModifier$2$1.invokeSuspend(t0.f22605a);
    }
}
