...
public final class NavigationRailKt$NavigationRailItem$styledIcon$1 extends r implements p<Composer, Integer, t0> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.NavigationRailKt$NavigationRailItem$styledIcon$1$1, reason: invalid class name */
    ...
    public NavigationRailKt$NavigationRailItem$styledIcon$1(NavigationRailItemColors navigationRailItemColors, boolean z, boolean z5, p<? super Composer, ? super Integer, t0> pVar, boolean z10, p<? super Composer, ? super Integer, t0> pVar2) {
        super(2);
