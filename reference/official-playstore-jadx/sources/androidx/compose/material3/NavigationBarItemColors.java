...
public final class NavigationBarItemColors {
    ...
    public /* synthetic */ NavigationBarItemColors(long j10, long j11, long j12, long j13, long j14, long j15, long j16, kotlin.jvm.internal.h hVar) {
        this(j10, j11, j12, j13, j14, j15, j16);
    }

    /* JADX INFO: renamed from: copy-4JmcsL4, reason: not valid java name */
    public final NavigationBarItemColors m1695copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3473equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m3473equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m3473equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m3473equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m3473equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m3473equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m3473equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
    ...
    public final long m1700getSelectedIndicatorColor0d7_KjU() {
        return this.selectedIndicatorColor;
    }
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z5, Composer composer, int i10) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(!z5 ? this.disabledIconColor : z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z5, Composer composer, int i10) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(!z5 ? this.disabledTextColor : z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
