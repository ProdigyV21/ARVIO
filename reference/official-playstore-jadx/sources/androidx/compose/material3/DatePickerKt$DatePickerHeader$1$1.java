...
public final class DatePickerKt$DatePickerHeader$1$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ p<Composer, Integer, t0> $title;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DatePickerKt$DatePickerHeader$1$1(p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
        this.$title = pVar;
    }
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        MeasurePolicy measurePolicyRememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(bottomStart, false, composer, 6);
