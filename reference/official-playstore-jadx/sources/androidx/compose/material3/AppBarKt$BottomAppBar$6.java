...
public final class AppBarKt$BottomAppBar$6 extends r implements p<Composer, Integer, t0> {
    ...
    public AppBarKt$BottomAppBar$6(WindowInsets windowInsets, PaddingValues paddingValues, q<? super RowScope, ? super Composer, ? super Integer, t0> qVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1243053520, i10, -1, "androidx.compose.material3.BottomAppBar.<anonymous> (AppBar.kt:629)");
        }
        Modifier modifierPadding = PaddingKt.padding(SizeKt.m564height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m2348getContainerHeightD9Ej5fM()), this.$contentPadding);
