...
public final class TabRowKt$ScrollableTabRow$1 extends r implements q<List<? extends TabPosition>, Composer, Integer, t0> {
    ...
    public final void invoke(List<TabPosition> list, Composer composer, int i10) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-913748678, i10, -1, "androidx.compose.material3.ScrollableTabRow.<anonymous> (TabRow.kt:820)");
        }
