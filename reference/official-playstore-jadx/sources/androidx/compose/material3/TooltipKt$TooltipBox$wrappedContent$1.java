...
public final class TooltipKt$TooltipBox$wrappedContent$1 extends r implements p<Composer, Integer, t0> {
    ...
    public TooltipKt$TooltipBox$wrappedContent$1(MutableState<LayoutCoordinates> mutableState, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new TooltipKt$TooltipBox$wrappedContent$1$1$1(mutableState);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(companion, (l) objRememberedValue);
