...
public final class SearchBar_androidKt$SearchBar$7 extends r implements p<Composer, Integer, t0> {
    ...
    public SearchBar_androidKt$SearchBar$7(String str, l<? super String, t0> lVar, l<? super String, t0> lVar2, boolean z, l<? super Boolean, t0> lVar3, Modifier modifier, boolean z5, p<? super Composer, ? super Integer, t0> pVar, p<? super Composer, ? super Integer, t0> pVar2, p<? super Composer, ? super Integer, t0> pVar3, Shape shape, SearchBarColors searchBarColors, float f10, float f11, WindowInsets windowInsets, MutableInteractionSource mutableInteractionSource, q<? super ColumnScope, ? super Composer, ? super Integer, t0> qVar, int i10, int i11, int i12) {
        super(2);
        this.$query = str;
