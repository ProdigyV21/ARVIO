...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo55measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j10) {
        long j11 = InteractiveComponentSizeKt.minimumInteractiveComponentSize;
        ...
        int iMax = z ? Math.max(placeableMo4631measureBRTryo0.getWidth(), measureScope.mo279roundToPx0680j_4(DpSize.m5776getWidthD9Ej5fM(j11))) : placeableMo4631measureBRTryo0.getWidth();
        int iMax2 = z ? Math.max(placeableMo4631measureBRTryo0.getHeight(), measureScope.mo279roundToPx0680j_4(DpSize.m5774getHeightD9Ej5fM(j11))) : placeableMo4631measureBRTryo0.getHeight();
        return MeasureScope.CC.q(measureScope, iMax, iMax2, null, new MinimumInteractiveModifierNode$measure$1(iMax, placeableMo4631measureBRTryo0, iMax2), 4, null);
    }
