...
public final class NavigationRailKt$NavigationRailItem$2$indicator$1 extends r implements p<Composer, Integer, t0> {
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1862011490, i10, -1, "androidx.compose.material3.NavigationRailItem.<anonymous>.<anonymous> (NavigationRail.kt:250)");
        }
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new NavigationRailKt$NavigationRailItem$2$indicator$1$1$1(state);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        BoxKt.Box(BackgroundKt.m178backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(modifierLayoutId, (l) objRememberedValue), this.$colors.getSelectedIndicatorColor(), this.$indicatorShape), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
