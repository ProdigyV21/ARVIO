...
public final class ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1 extends r implements r7.a<t0> {
    ...
    @f7.e(c = "androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1$1", f = "ModalBottomSheet.android.kt", l = {160}, m = "invokeSuspend")
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1$2, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1(SheetState sheetState, k0 k0Var, r7.a<t0> aVar) {
        super(0);
        this.$sheetState = sheetState;
        this.$scope = k0Var;
        this.$onDismissRequest = aVar;
    ...
    public final void m1690invoke() {
        if (((Boolean) this.$sheetState.getAnchoredDraggableState$material3_release().getConfirmValueChange$material3_release().invoke(SheetValue.Hidden)).booleanValue()) {
            m0.p(this.$scope, null, 0, new AnonymousClass1(this.$sheetState, null), 3).invokeOnCompletion(new AnonymousClass2(this.$sheetState, this.$onDismissRequest));
        }
    }
}
