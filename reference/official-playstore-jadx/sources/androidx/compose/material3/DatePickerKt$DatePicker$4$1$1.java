...
public final class DatePickerKt$DatePicker$4$1$1 extends r implements l<DisplayMode, t0> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        m1488invokevCnGnXg(((DisplayMode) obj).getValue());
        return t0.f22605a;
    }

    /* JADX INFO: renamed from: invoke-vCnGnXg, reason: not valid java name */
    public final void m1488invokevCnGnXg(int i10) {
        this.$state.mo1499setDisplayModevCnGnXg(i10);
    }
}
