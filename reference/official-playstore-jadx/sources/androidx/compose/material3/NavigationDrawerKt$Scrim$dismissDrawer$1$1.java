...
@f7.e(c = "androidx.compose.material3.NavigationDrawerKt$Scrim$dismissDrawer$1$1", f = "NavigationDrawer.kt", l = {923}, m = "invokeSuspend")
public final class NavigationDrawerKt$Scrim$dismissDrawer$1$1 extends j implements p<PointerInputScope, d7.d<? super t0>, Object> {
    final /* synthetic */ r7.a<t0> $onClose;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: androidx.compose.material3.NavigationDrawerKt$Scrim$dismissDrawer$1$1$1, reason: invalid class name */
    ...
    public static final class AnonymousClass1 extends r implements l<Offset, t0> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m1725invokek4lQ0M(((Offset) obj).getPackedValue());
            return t0.f22605a;
        }

        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1725invokek4lQ0M(long j10) {
            this.$onClose.invoke();
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavigationDrawerKt$Scrim$dismissDrawer$1$1(r7.a<t0> aVar, d7.d<? super NavigationDrawerKt$Scrim$dismissDrawer$1$1> dVar) {
        super(2, dVar);
        this.$onClose = aVar;
    }
    ...
    public final Object invoke(PointerInputScope pointerInputScope, d7.d<? super t0> dVar) {
        return ((NavigationDrawerKt$Scrim$dismissDrawer$1$1) create(pointerInputScope, dVar)).invokeSuspend(t0.f22605a);
    }
