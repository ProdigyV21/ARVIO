...
public final class TimePickerKt$TimeInputImpl$1$1$2$1 extends r implements l<TextFieldValue, t0> {
    final /* synthetic */ MutableState<TextFieldValue> $hourValue$delegate;
    final /* synthetic */ TimePickerState $state;

    /* JADX INFO: renamed from: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$2$1$1, reason: invalid class name */
    ...
    public final void invoke(TextFieldValue textFieldValue) {
        TimePickerKt.m2188timeInputOnChangegIWD5Rc(Selection.INSTANCE.m1869getHourJiIwxys(), this.$state, textFieldValue, TimePickerKt.TimeInputImpl$lambda$5(this.$hourValue$delegate), this.$state.getIs24hour() ? 23 : 12, new AnonymousClass1(this.$hourValue$delegate));
    }
}
