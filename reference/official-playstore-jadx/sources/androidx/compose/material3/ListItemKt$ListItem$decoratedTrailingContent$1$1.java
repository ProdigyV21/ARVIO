...
public final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ ListItemColors $colors;
    final /* synthetic */ p<Composer, Integer, t0> $it;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ListItemKt$ListItem$decoratedTrailingContent$1$1(ListItemColors listItemColors, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1512306332, i10, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:130)");
        }
        Modifier modifierM533paddingqDBjuR0$default = PaddingKt.m533paddingqDBjuR0$default(Modifier.INSTANCE, ListItemKt.getTrailingContentStartPadding(), 0.0f, 0.0f, 0.0f, 14, null);
        ...
        ListItemKt.m1652ProvideTextStyleFromToken3JVO9M(listItemColors.m1648trailingIconColorvNxB06k$material3_release(true), ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), pVar, composer, 48);
