...
public final class AlertDialogKt$AlertDialogContent$1$1$3$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ p<Composer, Integer, t0> $text;
    final /* synthetic */ ColumnScope $this_Column;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AlertDialogKt$AlertDialogContent$1$1$3$1(ColumnScope columnScope, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        Modifier modifierPadding = PaddingKt.padding(columnScope.weight(Modifier.INSTANCE, 1.0f, false), AlertDialogKt.TextPadding);
        Alignment.Companion companion = Alignment.INSTANCE;
        Modifier modifierAlign = columnScope.align(modifierPadding, companion.getStart());
