...
public final class ScaffoldKt$LegacyScaffoldLayout$1$1$1$bodyContentPlaceables$1 extends r implements p<Composer, Integer, t0> {
    ...
    public ScaffoldKt$LegacyScaffoldLayout$1$1$1$bodyContentPlaceables$1(WindowInsets windowInsets, SubcomposeMeasureScope subcomposeMeasureScope, List<? extends Placeable> list, int i10, List<? extends Placeable> list2, Integer num, q<? super PaddingValues, ? super Composer, ? super Integer, t0> qVar) {
        super(2);
