...
public final class SheetState$Companion$Saver$4 extends r implements l<SheetValue, SheetState> {
    final /* synthetic */ l<SheetValue, Boolean> $confirmValueChange;
    final /* synthetic */ boolean $skipPartiallyExpanded;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SheetState$Companion$Saver$4(boolean z, l<? super SheetValue, Boolean> lVar) {
        super(1);
