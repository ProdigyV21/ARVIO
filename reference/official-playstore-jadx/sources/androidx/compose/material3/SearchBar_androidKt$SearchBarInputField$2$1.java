...
public final class SearchBar_androidKt$SearchBarInputField$2$1 extends r implements l<FocusState, t0> {
    final /* synthetic */ l<Boolean, t0> $onActiveChange;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SearchBar_androidKt$SearchBarInputField$2$1(l<? super Boolean, t0> lVar) {
        super(1);
