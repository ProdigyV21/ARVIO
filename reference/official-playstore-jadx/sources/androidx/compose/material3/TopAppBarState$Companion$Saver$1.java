...
public final class TopAppBarState$Companion$Saver$1 extends r implements p<SaverScope, TopAppBarState, List<? extends Float>> {
    ...
    public final List<Float> invoke(SaverScope saverScope, TopAppBarState topAppBarState) {
        return t7.a.E(Float.valueOf(topAppBarState.getHeightOffsetLimit()), Float.valueOf(topAppBarState.getHeightOffset()), Float.valueOf(topAppBarState.getContentOffset()));
    }
}
