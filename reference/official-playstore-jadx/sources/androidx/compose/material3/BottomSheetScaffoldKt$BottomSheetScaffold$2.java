...
public final class BottomSheetScaffoldKt$BottomSheetScaffold$2 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ BottomSheetScaffoldState $scaffoldState;
    final /* synthetic */ q<SnackbarHostState, Composer, Integer, t0> $snackbarHost;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public BottomSheetScaffoldKt$BottomSheetScaffold$2(q<? super SnackbarHostState, ? super Composer, ? super Integer, t0> qVar, BottomSheetScaffoldState bottomSheetScaffoldState) {
        super(2);
