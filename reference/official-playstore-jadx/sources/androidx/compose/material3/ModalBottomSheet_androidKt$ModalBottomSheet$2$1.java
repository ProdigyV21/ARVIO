...
public final class ModalBottomSheet_androidKt$ModalBottomSheet$2$1 extends r implements r7.a<t0> {
    ...
    @f7.e(c = "androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$2$1$1", f = "ModalBottomSheet.android.kt", l = {177}, m = "invokeSuspend")
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lka/k0;", "Lx6/t0;", "<anonymous>", "(Lka/k0;)V"}, k = 3, mv = {1, 8, 0})
    @f7.e(c = "androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$2$1$2", f = "ModalBottomSheet.android.kt", l = {179}, m = "invokeSuspend")
    public static final class AnonymousClass2 extends j implements p<k0, d7.d<? super t0>, Object> {
        final /* synthetic */ SheetState $sheetState;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(SheetState sheetState, d7.d<? super AnonymousClass2> dVar) {
            super(2, dVar);
            this.$sheetState = sheetState;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                SheetState sheetState = this.$sheetState;
                this.label = 1;
                Object objHide = sheetState.hide(this);
                e7.a aVar = e7.a.f15033i;
                if (objHide == aVar) {
                    return aVar;
                }
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$2$1$3, reason: invalid class name */
    ...
    public static final class AnonymousClass3 extends r implements l<Throwable, t0> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass3(r7.a<t0> aVar) {
            super(1);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$2$1(SheetState sheetState, k0 k0Var, r7.a<t0> aVar) {
        super(0);
        this.$sheetState = sheetState;
        this.$scope = k0Var;
        this.$onDismissRequest = aVar;
    ...
    public final void m1688invoke() {
        if (this.$sheetState.getCurrentValue() == SheetValue.Expanded && this.$sheetState.getHasPartiallyExpandedState()) {
            m0.p(this.$scope, null, 0, new AnonymousClass1(this.$sheetState, null), 3);
        } else {
            m0.p(this.$scope, null, 0, new AnonymousClass2(this.$sheetState, null), 3).invokeOnCompletion(new AnonymousClass3(this.$onDismissRequest));
        }
    }
}
