...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2506getLevel0D9Ej5fM();
    private static final float ContainerHeight = Dp.m5678constructorimpl((float) 152.0d);
    ...
    public final float m2883getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2884getTrailingIconSizeD9Ej5fM() {
