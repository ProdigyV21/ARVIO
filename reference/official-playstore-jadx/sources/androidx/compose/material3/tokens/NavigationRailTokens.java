...
public final class NavigationRailTokens {
    ...
    static {
        ...
        ActiveIndicatorHeight = Dp.m5678constructorimpl((float) 32.0d);
        ShapeKeyTokens shapeKeyTokens = ShapeKeyTokens.CornerFull;
        ActiveIndicatorShape = shapeKeyTokens;
        float f10 = (float) 56.0d;
        ActiveIndicatorWidth = Dp.m5678constructorimpl(f10);
        ...
        ContainerElevation = ElevationTokens.INSTANCE.m2506getLevel0D9Ej5fM();
        ContainerShape = ShapeKeyTokens.CornerNone;
        ContainerWidth = Dp.m5678constructorimpl((float) 80.0d);
        float f11 = (float) 24.0d;
        IconSize = Dp.m5678constructorimpl(f11);
        ...
        MenuIconSize = Dp.m5678constructorimpl(f11);
        MenuPressedIconColor = colorSchemeKeyTokens2;
        NoLabelActiveIndicatorHeight = Dp.m5678constructorimpl(f10);
    ...
    public final float m2665getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2666getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2668getContainerWidthD9Ej5fM() {
    ...
    public final float m2670getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m2671getNoLabelActiveIndicatorHeightD9Ej5fM() {
