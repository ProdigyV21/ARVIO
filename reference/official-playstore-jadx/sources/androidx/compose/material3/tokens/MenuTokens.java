...
public final class MenuTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2508getLevel2D9Ej5fM();
    ...
    private static final float ListItemContainerHeight = Dp.m5678constructorimpl((float) 48.0d);
    ...
    static {
        ...
        ListItemLeadingIconSize = Dp.m5678constructorimpl(f10);
        ...
        ListItemTrailingIconSize = Dp.m5678constructorimpl(f10);
    }
    ...
    public final float m2651getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2652getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2653getListItemTrailingIconSizeD9Ej5fM() {
