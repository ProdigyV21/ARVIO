...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5678constructorimpl((float) 40.0d);
    ...
    static {
        ...
        Size = Dp.m5678constructorimpl((float) 24.0d);
    ...
    public final float m2693getContainerSizeD9Ej5fM() {
    ...
    public final float m2694getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2695getUnselectedOutlineWidthD9Ej5fM() {
