...
public final class SecondaryNavigationTabTokens {
    ...
    static {
        ...
        DividerHeight = Dp.m5678constructorimpl((float) 1.0d);
    ...
    public final float m2811getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2812getContainerHeightD9Ej5fM() {
    ...
    public final float m2813getDividerHeightD9Ej5fM() {
    ...
    public final float m2814getIconSizeD9Ej5fM() {
        return IconSize;
    }
