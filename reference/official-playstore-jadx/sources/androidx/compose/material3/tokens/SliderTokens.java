...
public final class SliderTokens {
    ...
    static {
        ...
        ActiveTrackHeight = Dp.m5678constructorimpl(f10);
        ...
        DisabledHandleElevation = elevationTokens.m2506getLevel0D9Ej5fM();
        DisabledInactiveTrackColor = colorSchemeKeyTokens2;
        FocusHandleColor = colorSchemeKeyTokens;
        HandleColor = colorSchemeKeyTokens;
        HandleElevation = elevationTokens.m2507getLevel1D9Ej5fM();
        float f11 = (float) 20.0d;
        HandleHeight = Dp.m5678constructorimpl(f11);
        HandleShape = shapeKeyTokens;
        HandleWidth = Dp.m5678constructorimpl(f11);
        HoverHandleColor = colorSchemeKeyTokens;
        InactiveTrackColor = ColorSchemeKeyTokens.SurfaceVariant;
        InactiveTrackHeight = Dp.m5678constructorimpl(f10);
        InactiveTrackShape = shapeKeyTokens;
        LabelContainerColor = colorSchemeKeyTokens;
        LabelContainerElevation = elevationTokens.m2506getLevel0D9Ej5fM();
        LabelContainerHeight = Dp.m5678constructorimpl((float) 28.0d);
        ...
        TrackElevation = elevationTokens.m2506getLevel0D9Ej5fM();
        OverlapHandleOutlineColor = colorSchemeKeyTokens3;
        OverlapHandleOutlineWidth = Dp.m5678constructorimpl((float) 1.0d);
        TickMarksActiveContainerColor = colorSchemeKeyTokens3;
        TickMarksContainerShape = shapeKeyTokens;
        TickMarksContainerSize = Dp.m5678constructorimpl((float) 2.0d);
    ...
    public final float m2819getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2820getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2821getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* JADX INFO: renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2822getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2823getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2824getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2825getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* JADX INFO: renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2826getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2827getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2828getStateLayerSizeD9Ej5fM() {
    ...
    public final float m2829getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2830getTrackElevationD9Ej5fM() {
