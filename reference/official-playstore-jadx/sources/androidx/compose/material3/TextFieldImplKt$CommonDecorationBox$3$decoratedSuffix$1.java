...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends r implements p<Composer, Integer, t0> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(float f10, long j10, TextStyle textStyle, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(907456412, i10, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:163)");
        }
        ...
        p<Composer, Integer, t0> pVar = this.$suffix;
