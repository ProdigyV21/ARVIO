...
public final class DatePickerKt$Month$rangeSelectionDrawModifier$1$1 extends r implements l<ContentDrawScope, t0> {
    ...
    public final void invoke(ContentDrawScope contentDrawScope) {
        DateRangePickerKt.m1508drawRangeBackgroundmxwnekA(contentDrawScope, this.$rangeSelectionInfo, this.$colors.getDayInSelectionRangeContainerColor());
