...
public final class DateRangeInputKt$DateRangeInputContent$2$6 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ String $pattern;

    /* JADX INFO: renamed from: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$2$6$1, reason: invalid class name */
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-961726252, i10, -1, "androidx.compose.material3.DateRangeInputContent.<anonymous>.<anonymous> (DateRangeInput.kt:104)");
        }
