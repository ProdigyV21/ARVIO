...
@f7.e(c = "androidx.compose.material3.ChipElevation$animateElevation$2$1", f = "Chip.kt", l = {2165, 2167}, m = "invokeSuspend")
public final class ChipElevation$animateElevation$2$1 extends j implements p<k0, d7.d<? super t0>, Object> {
    ...
    public ChipElevation$animateElevation$2$1(Animatable<Dp, AnimationVector1D> animatable, float f10, boolean z, Interaction interaction, MutableState<Interaction> mutableState, d7.d<? super ChipElevation$animateElevation$2$1> dVar) {
        super(2, dVar);
    ...
    */
    ...
    public final Object invoke(k0 k0Var, d7.d<? super t0> dVar) {
        return ((ChipElevation$animateElevation$2$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
