...
public final class DateRangePickerKt$customScrollActions$scrollUpAction$1 extends r implements r7.a<Boolean> {
    ...
    @f7.e(c = "androidx.compose.material3.DateRangePickerKt$customScrollActions$scrollUpAction$1$1", f = "DateRangePicker.kt", l = {1064}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DateRangePickerKt$customScrollActions$scrollUpAction$1(LazyListState lazyListState, k0 k0Var) {
        super(0);
        this.$state = lazyListState;
