...
public final class DatePickerKt$DateEntryContainer$2$1$1$1$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ p<Composer, Integer, t0> $headline;
    final /* synthetic */ RowScope $this_Row;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DatePickerKt$DateEntryContainer$2$1$1$1$1(RowScope rowScope, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        Modifier modifierA = androidx.compose.foundation.layout.e.a(this.$this_Row, Modifier.INSTANCE, 1.0f, false, 2, null);
        p<Composer, Integer, t0> pVar = this.$headline;
