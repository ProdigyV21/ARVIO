...
public final class NavigationBarKt$NavigationBarItemLayout$1$2$1 extends r implements l<GraphicsLayerScope, t0> {
    final /* synthetic */ boolean $alwaysShowLabel;
    final /* synthetic */ r7.a<Float> $animationProgress;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavigationBarKt$NavigationBarItemLayout$1$2$1(boolean z, r7.a<Float> aVar) {
        super(1);
