...
public final class DatePickerKt$DatePickerContent$1$1$1 extends r implements r7.a<t0> {
    ...
    @f7.e(c = "androidx.compose.material3.DatePickerKt$DatePickerContent$1$1$1$1", f = "DatePicker.kt", l = {1498}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatePickerKt$DatePickerContent$1$1$1(k0 k0Var, LazyListState lazyListState) {
        super(0);
