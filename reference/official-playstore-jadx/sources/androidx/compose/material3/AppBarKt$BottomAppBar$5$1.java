...
public final class AppBarKt$BottomAppBar$5$1 extends r implements q<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.AppBarKt$BottomAppBar$5$1$1, reason: invalid class name */
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
        return m1231invoke3p2s80s((MeasureScope) obj, (Measurable) obj2, ((Constraints) obj3).getValue());
    }

    /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
    public final MeasureResult m1231invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j10) {
        ...
        if (state2 != null) {
            state2.setHeightOffsetLimit(-measureScope.mo285toPx0680j_4(BottomAppBarTokens.INSTANCE.m2348getContainerHeightD9Ej5fM()));
        }
        Placeable placeableMo4631measureBRTryo0 = measurable.mo4631measureBRTryo0(j10);
        float height = placeableMo4631measureBRTryo0.getHeight();
        BottomAppBarScrollBehavior bottomAppBarScrollBehavior2 = this.$scrollBehavior;
        return MeasureScope.CC.q(measureScope, placeableMo4631measureBRTryo0.getWidth(), t7.a.M(height + ((bottomAppBarScrollBehavior2 == null || (state = bottomAppBarScrollBehavior2.getState()) == null) ? 0.0f : state.getHeightOffset())), null, new AnonymousClass1(placeableMo4631measureBRTryo0), 4, null);
    }
}
