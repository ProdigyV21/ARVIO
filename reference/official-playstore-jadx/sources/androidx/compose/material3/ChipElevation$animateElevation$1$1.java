...
@f7.e(c = "androidx.compose.material3.ChipElevation$animateElevation$1$1", f = "Chip.kt", l = {2100}, m = "invokeSuspend")
public final class ChipElevation$animateElevation$1$1 extends j implements p<k0, d7.d<? super t0>, Object> {
    final /* synthetic */ InteractionSource $interactionSource;
    final /* synthetic */ SnapshotStateList<Interaction> $interactions;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChipElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, d7.d<? super ChipElevation$animateElevation$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            k kVar = new k() { // from class: androidx.compose.material3.ChipElevation$animateElevation$1$1.1
                @Override // na.k
    ...
    public final Object invoke(k0 k0Var, d7.d<? super t0> dVar) {
        return ((ChipElevation$animateElevation$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
