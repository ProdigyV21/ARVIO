...
public final class DateRangeInputKt$DateRangeInputContent$2$5 extends r implements p<Composer, Integer, t0> {
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(911487285, i10, -1, "androidx.compose.material3.DateRangeInputContent.<anonymous>.<anonymous> (DateRangeInput.kt:99)");
        }
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new DateRangeInputKt$DateRangeInputContent$2$5$1$1(str2, str3);
