...
public final class AppBarKt$TwoRowsTopAppBar$actionsRow$1 extends r implements p<Composer, Integer, t0> {
    final /* synthetic */ q<RowScope, Composer, Integer, t0> $actions;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AppBarKt$TwoRowsTopAppBar$actionsRow$1(q<? super RowScope, ? super Composer, ? super Integer, t0> qVar) {
        super(2);
        this.$actions = qVar;
    }
