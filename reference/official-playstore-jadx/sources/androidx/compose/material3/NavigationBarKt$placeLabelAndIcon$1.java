...
public final class NavigationBarKt$placeLabelAndIcon$1 extends r implements l<Placeable.PlacementScope, t0> {
    ...
    public NavigationBarKt$placeLabelAndIcon$1(Placeable placeable, boolean z, float f10, Placeable placeable2, int i10, float f11, float f12, Placeable placeable3, int i11, float f13, Placeable placeable4, int i12, float f14, int i13, MeasureScope measureScope) {
        super(1);
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        if (placeable != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, androidx.compose.foundation.c.B(placeable, i10, 2), t7.a.M((f10 - measureScope.mo279roundToPx0680j_4(NavigationBarKt.getIndicatorVerticalPadding())) + this.$offset), 0.0f, 4, null);
