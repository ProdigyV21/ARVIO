...
public final class AlertDialogKt$AlertDialogContent$1$1$2$1 extends r implements p<Composer, Integer, t0> {
    ...
    public AlertDialogKt$AlertDialogContent$1$1$2$1(ColumnScope columnScope, p<? super Composer, ? super Integer, t0> pVar, p<? super Composer, ? super Integer, t0> pVar2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        Modifier modifierAlign = this.$this_Column.align(PaddingKt.padding(Modifier.INSTANCE, AlertDialogKt.TitlePadding), this.$icon == null ? Alignment.INSTANCE.getStart() : Alignment.INSTANCE.getCenterHorizontally());
