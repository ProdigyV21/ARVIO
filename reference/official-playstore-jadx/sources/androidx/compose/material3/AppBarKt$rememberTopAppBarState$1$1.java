...
public final class AppBarKt$rememberTopAppBarState$1$1 extends r implements r7.a<TopAppBarState> {
    ...
    public AppBarKt$rememberTopAppBarState$1$1(float f10, float f11, float f12) {
        super(0);
