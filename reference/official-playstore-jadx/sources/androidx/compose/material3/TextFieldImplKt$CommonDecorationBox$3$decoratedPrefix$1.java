...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1 extends r implements p<Composer, Integer, t0> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1(float f10, long j10, TextStyle textStyle, p<? super Composer, ? super Integer, t0> pVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1824482619, i10, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:149)");
        }
        Modifier modifierAlpha = AlphaKt.alpha(Modifier.INSTANCE, this.$prefixSuffixAlphaProgress);
        long j10 = this.$prefixColor;
        TextStyle textStyle = this.$bodyLarge;
        p<Composer, Integer, t0> pVar = this.$prefix;
        ...
        TextFieldImplKt.m2143DecorationKTwxG1Y(j10, textStyle, pVar, composer, 0, 0);
