...
public final class ChipElevation {
    ...
    public /* synthetic */ ChipElevation(float f10, float f11, float f12, float f13, float f14, float f15, kotlin.jvm.internal.h hVar) {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2071499570, i10, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2095)");
        }
        ...
        Object objL = androidx.compose.foundation.c.l(composer, -1373742197);
        ...
        if (zChangedInstance2 || objRememberedValue4 == companion.getEmpty()) {
            ...
            Object chipElevation$animateElevation$2$1 = new ChipElevation$animateElevation$2$1(animatable, f10, z, interaction, mutableState, null);
            composer.updateRememberedValue(chipElevation$animateElevation$2$1);
            objRememberedValue4 = chipElevation$animateElevation$2$1;
        } else {
            animatable = animatable3;
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5683equalsimpl0(this.elevation, chipElevation.elevation) && Dp.m5683equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m5683equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m5683equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m5683equalsimpl0(this.disabledElevation, chipElevation.disabledElevation);
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1881877139, i10, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2087)");
        }
