...
@f7.e(c = "androidx.compose.runtime.SnapshotStateKt__ProduceStateKt$produceState$4$1", f = "ProduceState.kt", l = {185}, m = "invokeSuspend")
public final class SnapshotStateKt__ProduceStateKt$produceState$4$1 extends f7.j implements p<k0, d7.d<? super t0>, Object> {
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$4$1(p<? super ProduceStateScope<T>, ? super d7.d<? super t0>, ? extends Object> pVar, MutableState<T> mutableState, d7.d<? super SnapshotStateKt__ProduceStateKt$produceState$4$1> dVar) {
        super(2, dVar);
        this.$producer = pVar;
    ...
    public final Object invoke(k0 k0Var, d7.d<? super t0> dVar) {
        return ((SnapshotStateKt__ProduceStateKt$produceState$4$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
