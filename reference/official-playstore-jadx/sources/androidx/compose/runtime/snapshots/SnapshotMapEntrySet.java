...
final class SnapshotMapEntrySet<K, V> extends SnapshotMapSet<K, V, Map.Entry<K, V>> {
    ...
    public boolean contains(Map.Entry<K, V> element) {
        return p.a(getMap().get(element.getKey()), element.getValue());
    }
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        Snapshot current;
        Collection<? extends Object> collection = elements;
        int iQ0 = i0.q0(s.U(collection, 10));
        if (iQ0 < 16) {
            iQ0 = 16;
        }
        ...
        do {
            synchronized (SnapshotStateMapKt.sync) {
                SnapshotStateMap.StateMapStateRecord stateMapStateRecord = (SnapshotStateMap.StateMapStateRecord) SnapshotKt.current((SnapshotStateMap.StateMapStateRecord) map.getFirstStateRecord());
            ...
            while (true) {
                ...
                if (!linkedHashMap.containsKey(next.getKey()) || !p.a(linkedHashMap.get(next.getKey()), next.getValue())) {
    ...
    public final boolean contains(Object obj) {
        ...
        if (!(obj instanceof s7.a) || (obj instanceof g.a)) {
