...
public final class ComposableSingletons$RecomposerKt$lambda1$1 extends r implements p<Composer, Integer, t0> {
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1091980426, i10, -1, "androidx.compose.runtime.ComposableSingletons$RecomposerKt.lambda-1.<anonymous> (Recomposer.kt:406)");
        }
        if (ComposerKt.isTraceInProgress()) {
