...
public final class ComposableSingletons$CompositionKt$lambda2$1 extends r implements p<Composer, Integer, t0> {
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1918065384, i10, -1, "androidx.compose.runtime.ComposableSingletons$CompositionKt.lambda-2.<anonymous> (Composition.kt:757)");
        }
        if (ComposerKt.isTraceInProgress()) {
