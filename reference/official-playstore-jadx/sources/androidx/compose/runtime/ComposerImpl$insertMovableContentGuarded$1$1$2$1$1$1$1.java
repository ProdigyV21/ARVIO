...
public final class ComposerImpl$insertMovableContentGuarded$1$1$2$1$1$1$1 extends r implements r7.a<t0> {
    ...
    public final void m2951invoke() {
        this.this$0.invokeMovableContentLambda(this.$to.getContent$runtime_release(), this.$to.getLocals(), this.$to.getParameter(), true);
    }
}
