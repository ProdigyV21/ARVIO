...
public final class EnterExitTransitionKt$createGraphicsLayerBlock$1$scale$2 extends r implements l<EnterExitState, Float> {
    ...
    public final Float invoke(EnterExitState enterExitState) {
        ...
        if (i10 != 1) {
            if (i10 == 2) {
                Scale scale2 = this.$enter.getData().getScale();
                if (scale2 != null) {
