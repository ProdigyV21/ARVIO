...
public interface VectorizedAnimationSpec<V extends AnimationVector> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <V extends AnimationVector> V getEndVelocity(VectorizedAnimationSpec<V> vectorizedAnimationSpec, V v2, V v10, V v11) {
            return (V) e.a(vectorizedAnimationSpec, v2, v10, v11);
        }
    }
