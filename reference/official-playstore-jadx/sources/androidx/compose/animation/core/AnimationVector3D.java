...
public final class AnimationVector3D extends AnimationVector {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.v3) + a0.c.b(this.v2, Float.floatToIntBits(this.v1) * 31, 31);
    }
