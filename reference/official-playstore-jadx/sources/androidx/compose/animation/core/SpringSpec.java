...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public boolean equals(Object other) {
        if (other instanceof SpringSpec) {
            ...
            if (springSpec.dampingRatio == this.dampingRatio && springSpec.stiffness == this.stiffness && p.a(springSpec.visibilityThreshold, this.visibilityThreshold)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        return Float.floatToIntBits(this.stiffness) + a0.c.b(this.dampingRatio, (t2 != null ? t2.hashCode() : 0) * 31, 31);
    }

    public SpringSpec(float f10, float f11, T t2) {
    ...
    public /* synthetic */ SpringSpec(float f10, float f11, Object obj, int i10, h hVar) {
