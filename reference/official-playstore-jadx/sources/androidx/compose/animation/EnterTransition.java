...
public abstract class EnterTransition {
    ...
    public boolean equals(Object other) {
        return (other instanceof EnterTransition) && p.a(((EnterTransition) other).getData$animation_release(), getData$animation_release());
    }
    ...
    public final EnterTransition plus(EnterTransition enter) {
        ...
        return new EnterTransitionImpl(new TransitionData(fade, slide, changeSize, scale, false, h0.v0(getData$animation_release().getEffectsMap(), enter.getData$animation_release().getEffectsMap()), 16, null));
    }
