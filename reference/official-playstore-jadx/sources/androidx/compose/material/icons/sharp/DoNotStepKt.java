...
public final class DoNotStepKt {
    ...
    public static final ImageVector getDoNotStep(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.DoNotStep", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = a.r(1.39f, 4.22f, 8.24f, 8.24f);
        pathBuilderR.lineToRelative(-0.69f, 0.72f);
        pathBuilderR.lineTo(6.87f, 11.1f);
        pathBuilderR.curveToRelative(-0.11f, 0.4f, -0.26f, 0.78f, -0.45f, 1.12f);
        pathBuilderR.lineToRelative(1.75f, 1.75f);
        pathBuilderR.lineToRelative(-0.69f, 0.72f);
        pathBuilderR.lineToRelative(-1.63f, -1.63f);
        pathBuilderR.curveToRelative(-0.24f, 0.29f, -0.5f, 0.56f, -0.77f, 0.8f);
        pathBuilderR.lineToRelative(1.63f, 1.63f);
        pathBuilderR.lineToRelative(-0.7f, 0.72f);
        pathBuilderR.lineToRelative(-1.74f, -1.74f);
        pathBuilderR.curveTo(2.83f, 15.43f, 1.34f, 15.82f, 1.0f, 15.92f);
        pathBuilderR.lineTo(1.0f, 20.0f);
        pathBuilderR.horizontalLineToRelative(9.5f);
        pathBuilderR.lineToRelative(3.33f, -3.33f);
