...
public final class HlsKt {
    ...
    public static final ImageVector getHls(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Hls", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.D(pathBuilderB, 9.0f, 15.5f, 15.0f, 5.0f);
        a0.a.A(pathBuilderB, -3.5f, 17.0f, -1.0f, 2.0f);
        d.A(pathBuilderB, 11.0f, 1.5f, 9.0f, -5.0f);
        a0.a.A(pathBuilderB, 3.5f, 19.0f, 1.0f, -2.0f);
        f.k(pathBuilderB, 13.0f, -1.5f, 15.0f);
        c.m(pathBuilderB, 14.0f, 15.0f, -1.5f, -2.5f);
