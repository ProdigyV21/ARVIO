...
public final class WifiPasswordKt {
    ...
    public static final ImageVector getWifiPassword(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WifiPassword", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderR, 4.24f, 13.22f, 2.12f, 2.12f);
