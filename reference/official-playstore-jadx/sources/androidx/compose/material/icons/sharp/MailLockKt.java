...
public final class MailLockKt {
    ...
    public static final ImageVector getMailLock(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.MailLock", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.A(pathBuilder, 2.0f, 20.0f, 14.0f, -5.03f);
        pathBuilder.curveToRelative(0.0f, -2.76f, 2.24f, -5.0f, 5.0f, -5.0f);
        a.x(pathBuilder, 22.0f, 20.0f, 8.0f);
        pathBuilder.lineToRelative(-8.0f, 5.0f);
        pathBuilder.lineTo(4.0f, 8.0f);
        pathBuilder.verticalLineTo(6.0f);
        pathBuilder.lineToRelative(8.0f, 5.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.d(pathBuilder, 8.0f, -5.0f, 8.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderI = a.i(23.0f, 15.0f, -0.89f);
        pathBuilderI.curveToRelative(0.0f, -1.0f, -0.68f, -1.92f, -1.66f, -2.08f);
        pathBuilderI.curveTo(20.08f, 11.82f, 19.0f, 12.79f, 19.0f, 14.0f);
        b.z(pathBuilderI, 1.0f, -1.0f, 5.0f, 6.0f);
        e.y(pathBuilderI, -5.0f, 23.0f, 22.0f, 15.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderI, 15.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
