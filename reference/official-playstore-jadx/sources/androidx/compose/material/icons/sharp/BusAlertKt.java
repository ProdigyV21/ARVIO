...
public final class BusAlertKt {
    ...
    public static final ImageVector getBusAlert(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.BusAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.b.r(pathBuilderA, 22.0f, 3.0f, -2.0f, 8.0f);
        e.l(pathBuilderA, 2.0f, 3.0f, -3.06f);
        ...
        a.x(pathBuilderA, 4.0f, 6.5f, 17.0f);
