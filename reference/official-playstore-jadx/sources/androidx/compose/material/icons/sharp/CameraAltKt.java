...
public final class CameraAltKt {
    ...
    public static final ImageVector getCameraAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CameraAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderN = d.n(16.83f, 4.0f, 15.0f, 2.0f, 9.0f);
        b.m(pathBuilderN, 7.17f, 4.0f, 2.0f, 16.0f);
        pathBuilderN.horizontalLineToRelative(20.0f);
        pathBuilderN.verticalLineTo(4.0f);
        pathBuilderN.horizontalLineToRelative(-5.17f);
        pathBuilderN.close();
        pathBuilderN.moveTo(12.0f, 17.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderN, -2.24f, 5.0f, -5.0f, 5.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
