...
public final class FlightTakeoffKt {
    ...
    public static final ImageVector getFlightTakeoff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FlightTakeoff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderK = a.k(2.5f, 19.0f, 19.0f, 2.0f, -19.0f);
        b.f(pathBuilderK, -2.0f, 22.07f, 9.64f);
        ...
        pathBuilderK.lineToRelative(-1.93f, 0.51f);
        ...
        pathBuilderK.lineToRelative(1.82f, 3.16f);
        pathBuilderK.lineToRelative(0.77f, 1.33f);
        pathBuilderK.lineTo(21.0f, 11.49f);
        pathBuilderK.curveToRelative(0.81f, -0.23f, 1.28f, -1.05f, 1.07f, -1.85f);
        pathBuilderK.close();
