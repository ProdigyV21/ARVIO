...
public final class NoCrashKt {
    ...
    public static final ImageVector getNoCrash(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.NoCrash", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.a.p(pathBuilderP, 12.0f, 6.36f, 9.17f, 3.54f);
        pathBuilderP.lineToRelative(1.41f, -1.41f);
        pathBuilderP.lineTo(12.0f, 3.54f);
        pathBuilderP.lineTo(15.54f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderP, 1.41f, 1.41f, 12.0f, 6.36f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
