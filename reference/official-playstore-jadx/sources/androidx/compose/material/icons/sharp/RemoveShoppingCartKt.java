...
public final class RemoveShoppingCartKt {
    ...
    public static final ImageVector getRemoveShoppingCart(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.RemoveShoppingCart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.lineTo(3.62f, 17.0f);
        pathBuilderJ.horizontalLineToRelative(10.84f);
        ...
        d.C(pathBuilderJ, 2.0f, 2.0f, 7.0f, 15.0f);
        pathBuilderJ.moveTo(16.05f, 12.94f);
        pathBuilderJ.horizontalLineToRelative(0.73f);
        pathBuilderJ.lineTo(21.7f, 4.0f);
        d.l(pathBuilderJ, 7.12f, 4.0f, 8.93f, 8.94f);
