...
public final class ScreenRotationKt {
    ...
    public static final ImageVector getScreenRotation(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ScreenRotation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(0.66f, -0.03f);
        b.D(pathBuilderA, -3.81f, -3.81f, -1.33f, 1.32f);
        pathBuilderA.moveTo(9.17f, 0.69f);
        pathBuilderA.lineTo(0.69f, 9.17f);
        pathBuilderA.lineToRelative(14.14f, 14.14f);
        d.C(pathBuilderA, 8.48f, -8.48f, 9.17f, 0.69f);
        pathBuilderA.moveTo(14.83f, 21.19f);
        pathBuilderA.lineTo(2.81f, 9.17f);
        pathBuilderA.lineToRelative(6.36f, -6.36f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderA, 12.02f, 12.02f, -6.36f, 6.36f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
