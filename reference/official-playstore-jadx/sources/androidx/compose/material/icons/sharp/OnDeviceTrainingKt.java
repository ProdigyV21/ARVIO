...
public final class OnDeviceTrainingKt {
    ...
    public static final ImageVector getOnDeviceTraining(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.OnDeviceTraining", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.d(11.0f, 16.0f, 2.0f, 1.0f, -2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderS = c.s(20.0f, 1.01f, 4.0f, 1.0f, 22.0f);
        c.D(pathBuilderS, 16.0f, 1.01f, 18.0f, 18.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.i(pathBuilderS, 6.0f, 6.0f, 12.0f, 18.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
