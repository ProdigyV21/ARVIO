...
public final class AddAlertKt {
    ...
    public static final ImageVector getAddAlert(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AddAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.C(pathBuilderA, 16.0f, 13.01f, -3.0f, 3.0f);
        c.q(pathBuilderA, -2.0f, -3.0f, 8.0f, 13.01f);
