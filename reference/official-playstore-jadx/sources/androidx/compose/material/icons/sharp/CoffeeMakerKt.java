...
public final class CoffeeMakerKt {
    ...
    public static final ImageVector getCoffeeMaker(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CoffeeMaker", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderM = a.m(18.0f, 7.0f, 4.0f, 2.0f, 2.0f);
        b.q(pathBuilderM, 4.0f, 20.0f, 16.0f, -2.0f);
        pathBuilderM.horizontalLineToRelative(-4.03f);
        ...
        a.t(pathBuilderM, 6.0f, 4.0f, 2.0f, 3.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.l(pathBuilderM, 18.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
