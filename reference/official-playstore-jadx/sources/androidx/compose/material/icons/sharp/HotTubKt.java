...
public final class HotTubKt {
    ...
    public static final ImageVector getHotTub(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.HotTub", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.h(pathBuilderA, 2.0f, 12.0f, 10.0f, 20.0f);
        b.y(pathBuilderA, 22.0f, 12.0f, 11.15f, 12.0f);
        ...
        b.B(pathBuilderA, 2.0f, 6.0f, 18.65f, 5.86f);
        ...
        a.z(pathBuilderA, 14.65f, 5.86f, -0.07f, -0.07f);
        pathBuilderA.curveToRelative(-0.57f, -0.62f, -0.82f, -1.41f, -0.67f, -2.2f);
