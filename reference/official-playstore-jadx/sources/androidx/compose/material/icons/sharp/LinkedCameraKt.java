...
public final class LinkedCameraKt {
    ...
    public static final ImageVector getLinkedCamera(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.LinkedCamera", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(12.0f, 14.0f, -3.0f, 0.0f);
        ...
        PathBuilder pathBuilderA = a.a(18.0f, 8.0f, 1.33f);
        ...
        a.p(pathBuilderA, 20.67f, 8.0f, 22.0f, 8.0f);
        ...
        a.p(pathBuilderA, 15.0f, 7.0f, 15.0f, 4.0f);
        pathBuilderA.lineTo(9.0f, 4.0f);
        pathBuilderA.lineTo(7.17f, 6.0f);
        a.h(pathBuilderA, 2.0f, 6.0f, 16.0f, 20.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA, -2.24f, 5.0f, -5.0f, 5.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
