...
public final class DevicesFoldKt {
    ...
    public static final ImageVector getDevicesFold(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.DevicesFold", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderG = a.g(17.0f, 3.0f, -3.03f, -7.0f, 3.0f);
        pathBuilderG.verticalLineTo(3.0f);
        pathBuilderG.verticalLineToRelative(18.0f);
        pathBuilderG.horizontalLineToRelative(12.0f);
        pathBuilderG.verticalLineTo(3.0f);
        a.v(pathBuilderG, 17.0f, 20.0f, 19.0f, -5.33f);
        b.n(pathBuilderG, 17.0f, 18.0f, 5.0f, 3.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderG, 19.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
