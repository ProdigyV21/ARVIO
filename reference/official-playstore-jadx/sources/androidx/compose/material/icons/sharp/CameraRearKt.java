...
public final class CameraRearKt {
    ...
    public static final ImageVector getCameraRear(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CameraRear", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        e.D(pathBuilderS, -2.0f, -5.0f, 19.0f, 0.0f);
        a.h(pathBuilderS, 5.0f, 0.0f, 18.0f, 14.0f);
        c.z(pathBuilderS, 19.0f, 0.0f, 12.0f, 6.0f);
