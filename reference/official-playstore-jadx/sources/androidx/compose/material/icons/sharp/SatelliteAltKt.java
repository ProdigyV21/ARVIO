...
public final class SatelliteAltKt {
    ...
    public static final ImageVector getSatelliteAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SatelliteAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.lineToRelative(-2.65f, -2.65f);
        ...
        pathBuilderR.moveTo(21.0f, 14.0f);
        ...
        pathBuilderR.curveTo(17.87f, 21.0f, 21.0f, 17.87f, 21.0f, 14.0f);
        a.z(pathBuilderR, 17.0f, 14.0f, 2.0f, 0.0f);
        pathBuilderR.curveToRelative(0.0f, 2.76f, -2.24f, 5.0f, -5.0f, 5.0f);
        pathBuilderR.lineToRelative(0.0f, -2.0f);
        pathBuilderR.curveTo(15.66f, 17.0f, 17.0f, 15.66f, 17.0f, 14.0f);
        pathBuilderR.close();
