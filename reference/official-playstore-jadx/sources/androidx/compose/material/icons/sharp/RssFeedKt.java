...
public final class RssFeedKt {
    ...
    public static final ImageVector getRssFeed(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.RssFeed", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderI = a.i(4.0f, 10.1f, 2.83f);
        ...
        d.k(pathBuilderI, 4.0f, 4.44f, 2.83f);
