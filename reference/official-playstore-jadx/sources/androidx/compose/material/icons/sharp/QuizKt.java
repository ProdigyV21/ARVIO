...
public final class QuizKt {
    ...
    public static final ImageVector getQuiz(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Quiz", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderQ = w.a.q(6.0f, 2.0f, 16.0f, 16.0f, 2.0f);
        a.x(pathBuilderQ, 6.0f, 13.51f, 10.16f);
        ...
        pathBuilderQ.curveToRelative(0.37f, 0.6f, 0.58f, 1.73f, 0.01f, 2.57f);
        ...
        pathBuilderQ.curveTo(13.26f, 11.41f, 13.19f, 10.74f, 13.51f, 10.16f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.95f, 13.95f);
        ...
        pathBuilderQ.curveToRelative(0.0f, 0.58f, -0.44f, 1.05f, -1.04f, 1.05f);
        pathBuilderQ.curveTo(13.42f, 15.0f, 12.95f, 14.53f, 12.95f, 13.95f);
        pathBuilderQ.close();
