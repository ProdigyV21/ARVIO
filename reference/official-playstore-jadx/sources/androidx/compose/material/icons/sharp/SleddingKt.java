...
public final class SleddingKt {
    ...
    public static final ImageVector getSledding(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Sledding", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 17.22f, 17.9f, 1.93f, 0.63f);
        ...
        pathBuilderA.lineToRelative(0.46f, -1.43f);
        pathBuilderA.curveToRelative(2.1f, 0.68f, 3.25f, 2.94f, 2.57f, 5.04f);
        ...
        b.y(pathBuilderA, 14.5f, 12.0f, 17.22f, 17.9f);
        pathBuilderA.moveTo(6.0f, 14.25f);
        pathBuilderA.lineToRelative(0.48f, 0.16f);
        pathBuilderA.lineToRelative(0.75f, -2.31f);
        pathBuilderA.lineTo(7.92f, 10.0f);
        a0.b.s(pathBuilderA, 6.0f, 10.82f, 14.25f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderA, -3.97f, 0.89f, 14.63f, 17.05f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
