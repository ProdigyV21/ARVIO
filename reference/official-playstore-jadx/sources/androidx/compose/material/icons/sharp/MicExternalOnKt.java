...
public final class MicExternalOnKt {
    ...
    public static final ImageVector getMicExternalOn(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.MicExternalOn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.y(pathBuilderQ, 20.0f, 2.0f, 20.0f, -2.0f);
        e.x(pathBuilderQ, 4.0f, -4.0f, 18.0f, 6.0f);
        pathBuilderQ.curveToRelative(0.0f, 0.0f, 0.0f, -1.79f, 0.0f, -4.0f);
        pathBuilderQ.horizontalLineTo(5.0f);
        pathBuilderQ.lineTo(4.0f, 8.0f);
        pathBuilderQ.horizontalLineToRelative(6.0f);
        b.m(pathBuilderQ, 9.0f, 18.0f, 8.0f, 2.0f);
