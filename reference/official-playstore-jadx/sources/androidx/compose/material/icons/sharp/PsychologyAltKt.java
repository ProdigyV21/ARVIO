...
public final class PsychologyAltKt {
    ...
    public static final ImageVector getPsychologyAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.PsychologyAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        e.C(pathBuilderA, 1.0f, 0.0f, 4.0f, 3.0f);
        d.D(pathBuilderA, 3.0f, 7.0f, 0.0f, -4.68f);
