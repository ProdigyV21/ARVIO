...
public final class AddModeratorKt {
    ...
    public static final ImageVector getAddModerator(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AddModerator", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.u(pathBuilderA2, 20.0f, 17.5f, -2.5f, 20.0f);
        a0.a.y(pathBuilderA2, -1.0f, -2.5f, 14.0f, -1.0f);
        w.a.C(pathBuilderA2, 2.5f, 14.0f, 1.0f, 2.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.m(pathBuilderA2, 20.0f, 17.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
