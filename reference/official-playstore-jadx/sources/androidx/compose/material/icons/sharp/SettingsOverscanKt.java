...
public final class SettingsOverscanKt {
    ...
    public static final ImageVector getSettingsOverscan(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SettingsOverscan", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderT.moveTo(23.0f, 3.0f);
        v.a.h(pathBuilderT, 1.0f, 3.0f, 18.0f, 22.0f);
        c.z(pathBuilderT, 23.0f, 3.0f, 21.0f, 19.01f);
        pathBuilderT.lineTo(3.0f, 19.01f);
