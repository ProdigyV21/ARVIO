...
public final class GarageKt {
    ...
    public static final ImageVector getGarage(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Garage", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.D(pathBuilderH, 2.0f, 19.0f, 18.5f, -2.0f);
        a.w(pathBuilderH, -2.0f, 7.0f, 2.0f, 5.0f);
        a0.b.k(pathBuilderH, -7.31f, 6.89f, 5.5f, 10.21f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.e(pathBuilderH, 19.0f, 11.19f, 18.5f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
