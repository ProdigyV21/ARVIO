...
public final class PhonelinkRingKt {
    ...
    public static final ImageVector getPhonelinkRing(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.PhonelinkRing", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderR, 16.0f, 1.0f, 2.0f, 1.0f);
        w.a.z(pathBuilderR, 22.0f, 14.0f, 16.0f, 1.0f);
        pathBuilderR.moveTo(14.0f, 20.0f);
