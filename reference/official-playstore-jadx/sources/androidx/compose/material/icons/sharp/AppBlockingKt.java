...
public final class AppBlockingKt {
    ...
    public static final ImageVector getAppBlocking(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AppBlocking", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderU = a.u(19.0f, 23.0f, -6.0f, -2.0f, 1.0f);
        a.t(pathBuilderU, 7.0f, 6.0f, 10.0f, 1.0f);
        pathBuilderU.horizontalLineToRelative(2.0f);
        pathBuilderU.verticalLineTo(0.94f);
        pathBuilderU.lineTo(5.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.d(pathBuilderU, 22.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
