...
public final class CoPresentKt {
    ...
    public static final ImageVector getCoPresent(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CoPresent", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(23.0f, 3.0f, -22.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, 10.0f);
        pathBuilderR.lineToRelative(2.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, -8.0f);
        pathBuilderR.lineToRelative(18.0f, 0.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 0.0f, 16.0f, 2.0f, 0.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderB = a.b(9.0f, 10.0f, -4.0f, 0.0f);
        ...
        PathBuilder pathBuilderA = c.a(15.39f, 16.56f);
        pathBuilderA.curveTo(13.71f, 15.7f, 11.53f, 15.0f, 9.0f, 15.0f);
        pathBuilderA.curveToRelative(-2.53f, 0.0f, -4.71f, 0.7f, -6.39f, 1.56f);
        pathBuilderA.curveTo(1.61f, 17.07f, 1.0f, 18.1f, 1.0f, 19.22f);
        w.a.j(pathBuilderA, 22.0f, 16.0f, -2.78f);
        pathBuilderA.curveTo(17.0f, 18.1f, 16.39f, 17.07f, 15.39f, 16.56f);
        pathBuilderA.close();
