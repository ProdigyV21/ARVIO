...
public final class SpeedKt {
    ...
    public static final ImageVector getSpeed(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Speed", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(20.39f, 8.56f, -1.24f, 1.86f);
        ...
        pathBuilderR.lineToRelative(1.86f, -1.24f);
        pathBuilderR.arcTo(10.0f, 10.0f, 0.0f, false, false, 4.0f, 20.0f);
        pathBuilderR.horizontalLineToRelative(16.0f);
        pathBuilderR.arcToRelative(10.0f, 10.0f, 0.0f, false, false, 0.38f, -11.44f);
        pathBuilderR.close();
