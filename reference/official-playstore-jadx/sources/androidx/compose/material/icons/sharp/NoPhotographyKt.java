...
public final class NoPhotographyKt {
    ...
    public static final ImageVector getNoPhotography(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.NoPhotography", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a0.a.n(pathBuilderJ, 6.0f, 1.83f, 2.0f, 22.0f);
        pathBuilderJ.verticalLineToRelative(14.17f);
        pathBuilderJ.lineToRelative(-5.12f, -5.12f);
