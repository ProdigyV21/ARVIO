...
public final class _123Kt {
    ...
    public static final ImageVector get_123(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._123", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        w.a.B(pathBuilderB, 3.0f, 9.0f, 9.0f, 1.5f);
        d.y(pathBuilderB, 3.0f, 1.0f, 9.0f, 15.0f);
        c.D(pathBuilderB, 4.5f, 13.5f, 19.5f, 15.0f);
        c.o(pathBuilderB, 9.0f, 15.0f, 1.5f, 3.0f);
        v.b.z(pathBuilderB, 1.0f, -2.0f, 1.0f, 2.0f);
