...
public final class SquareFootKt {
    ...
    public static final ImageVector getSquareFoot(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SquareFoot", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.lineToRelative(1.06f, -1.06f);
        a.h(pathBuilderR, 4.0f, 4.0f, 16.0f, 16.0f);
        c.z(pathBuilderR, 17.66f, 17.66f, 7.0f, 17.0f);
