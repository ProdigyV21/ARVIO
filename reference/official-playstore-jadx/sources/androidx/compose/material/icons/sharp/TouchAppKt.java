...
public final class TouchAppKt {
    ...
    public static final ImageVector getTouchApp(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.TouchApp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = e.a(8.25f, 9.24f, 5.5f);
        ...
        pathBuilderA.curveTo(6.25f, 7.06f, 7.04f, 8.43f, 8.25f, 9.24f);
        b.w(pathBuilderA, 13.33f, 11.5f, -1.08f, -6.0f);
        ...
        pathBuilderA.lineToRelative(-4.04f, -0.85f);
        pathBuilderA.lineTo(4.0f, 16.62f);
        pathBuilderA.lineTo(9.38f, 22.0f);
        pathBuilderA.horizontalLineToRelative(8.67f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderA, 1.07f, -7.62f, 13.33f, 11.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
