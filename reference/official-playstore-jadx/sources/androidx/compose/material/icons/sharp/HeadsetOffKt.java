...
public final class HeadsetOffKt {
    ...
    public static final ImageVector getHeadsetOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.HeadsetOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        e.l(pathBuilderA, 1.0f, -4.0f, 0.17f);
        ...
        pathBuilderA.curveTo(9.98f, 2.0f, 8.12f, 2.67f, 6.62f, 3.8f);
        pathBuilderA.lineToRelative(1.43f, 1.43f);
        pathBuilderA.curveTo(9.17f, 4.45f, 10.53f, 4.0f, 12.0f, 4.0f);
        pathBuilderA.close();
        ...
        pathBuilderJ.lineToRelative(3.33f, 3.33f);
        pathBuilderJ.curveTo(3.37f, 8.09f, 3.0f, 9.5f, 3.0f, 11.0f);
        f.u(pathBuilderJ, 9.0f, 6.0f, -8.0f, 5.0f);
        pathBuilderJ.verticalLineToRelative(-1.0f);
        pathBuilderJ.curveToRelative(0.0f, -0.94f, 0.19f, -1.83f, 0.52f, -2.65f);
        b.n(pathBuilderJ, 15.0f, 17.83f, 20.0f, 2.17f);
        e.h(pathBuilderJ, 1.0f, 1.0f, 12.0f, 2.0f);
        pathBuilderJ.horizontalLineToRelative(8.17f);
        pathBuilderJ.lineToRelative(0.31f, 0.31f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderJ, 1.41f, -1.41f, 2.1f, 2.1f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
