...
public final class RocketKt {
    ...
    public static final ImageVector getRocket(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Rocket", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.n(pathBuilderA, 7.0f, 7.69f, 20.52f);
        pathBuilderA.moveTo(20.0f, 22.0f);
        pathBuilderA.verticalLineToRelative(-7.0f);
        pathBuilderA.lineToRelative(-2.02f, -1.35f);
