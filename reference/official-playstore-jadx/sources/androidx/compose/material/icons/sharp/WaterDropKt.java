...
public final class WaterDropKt {
    ...
    public static final ImageVector getWaterDrop(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WaterDrop", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(13.0f, 18.91f);
        pathBuilderA.curveTo(12.68f, 18.97f, 12.35f, 19.0f, 12.0f, 19.0f);
        pathBuilderA.curveToRelative(-2.69f, 0.0f, -4.88f, -1.94f, -5.0f, -5.0f);
        pathBuilderA.horizontalLineToRelative(1.5f);
        pathBuilderA.curveToRelative(0.08f, 2.07f, 1.5f, 3.5f, 3.5f, 3.5f);
        pathBuilderA.curveToRelative(0.35f, 0.0f, 0.69f, -0.04f, 1.0f, -0.13f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderA, 18.91f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
