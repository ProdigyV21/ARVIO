...
public final class SentimentNeutralKt {
    ...
    public static final ImageVector getSentimentNeutral(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SentimentNeutral", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.o(pathBuilderA, 15.0f, 15.5f, 9.0f, 14.0f);
        c.D(pathBuilderA, 6.0f, 15.5f, 15.5f, 11.0f);
