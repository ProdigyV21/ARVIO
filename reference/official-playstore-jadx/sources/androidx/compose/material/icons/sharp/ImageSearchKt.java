...
public final class ImageSearchKt {
    ...
    public static final ImageVector getImageSearch(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ImageSearch", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.h(pathBuilderS, 2.0f, 4.0f, 18.0f, 18.0f);
        c.t(pathBuilderS, -7.0f, -2.0f, -2.0f);
        ...
        d.C(pathBuilderS, 2.75f, -3.54f, 16.5f, 18.0f);
