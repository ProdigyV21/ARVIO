...
public final class _7mpKt {
    ...
    public static final ImageVector get_7mp(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._7mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.moveTo(11.25f, 11.5f);
        b.p(pathBuilderQ, 12.62f, 7.0f, 10.0f, 5.5f);
        a0.b.B(pathBuilderQ, 4.87f, -1.87f, 6.0f, 11.25f);
