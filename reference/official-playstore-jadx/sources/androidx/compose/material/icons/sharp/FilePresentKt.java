...
public final class FilePresentKt {
    ...
    public static final ImageVector getFilePresent(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FilePresent", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.t(pathBuilderH, -4.0f, 2.0f, 15.0f);
        pathBuilderH.moveTo(14.0f, 8.0f);
        pathBuilderH.verticalLineTo(4.0f);
        pathBuilderH.lineToRelative(4.0f, 4.0f);
        pathBuilderH.horizontalLineTo(14.0f);
        pathBuilderH.close();
