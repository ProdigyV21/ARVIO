...
public final class HandymanKt {
    ...
    public static final ImageVector getHandyman(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Handyman", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderG = c.g(16.37f, 12.87f, -0.99f, -2.54f, 2.54f);
        pathBuilderG.verticalLineToRelative(0.99f);
        pathBuilderG.lineToRelative(6.01f, 6.01f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderG, 3.54f, -3.54f, 16.37f, 12.87f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderR.lineToRelative(-6.01f, 6.01f);
        pathBuilderR.lineToRelative(3.54f, 3.54f);
        pathBuilderR.lineToRelative(6.01f, -6.01f);
