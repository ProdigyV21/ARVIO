...
public final class FontDownloadOffKt {
    ...
    public static final ImageVector getFontDownloadOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FontDownloadOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.p(pathBuilderR, 19.17f, 22.0f, 2.0f, 4.83f);
        ...
        a0.b.B(pathBuilderR, 2.08f, 1.09f, -3.07f, 12.1f);
        ...
        c.f(pathBuilderR, 22.0f, 19.17f, 2.0f, 4.83f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 10.35f, 7.52f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
