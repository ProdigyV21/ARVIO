...
public final class _23mpKt {
    ...
    public static final ImageVector get_23mp(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._23mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.D(pathBuilderQ, 6.5f, 18.5f, 13.0f, 10.0f);
        a0.a.C(pathBuilderQ, 3.0f, 9.0f, -2.0f, 8.0f);
        a0.a.C(pathBuilderQ, 2.0f, 7.0f, -3.0f, 5.5f);
        d.z(pathBuilderQ, 4.5f, 6.0f, 13.0f, 10.0f);
