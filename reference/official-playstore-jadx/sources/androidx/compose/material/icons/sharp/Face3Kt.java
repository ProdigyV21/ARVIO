...
public final class Face3Kt {
    ...
    public static final ImageVector getFace3(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Face3", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-0.54f, -5.93f, -5.75f, -10.41f, -11.8f, -9.92f);
        pathBuilderA.curveTo(5.73f, 2.46f, 1.55f, 6.94f, 1.06f, 12.32f);
        pathBuilderA.lineTo(0.0f, 24.0f);
        pathBuilderA.horizontalLineToRelative(24.0f);
