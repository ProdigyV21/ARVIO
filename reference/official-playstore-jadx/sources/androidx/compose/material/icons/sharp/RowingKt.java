...
public final class RowingKt {
    ...
    public static final ImageVector getRowing(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Rowing", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveTo(15.99f, 6.0f, 17.0f, 7.01f, 17.0f, 8.25f);
        pathBuilderJ.lineTo(17.0f, 17.0f);
        pathBuilderJ.lineToRelative(-0.92f, -0.83f);
