...
public final class CameraFrontKt {
    ...
    public static final ImageVector getCameraFront(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CameraFront", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderS, 19.0f, 0.0f, 5.0f, 0.0f);
        w.a.z(pathBuilderS, 18.0f, 14.0f, 19.0f, 0.0f);
        a.C(pathBuilderS, 7.0f, 2.0f, 10.0f, 10.5f);
