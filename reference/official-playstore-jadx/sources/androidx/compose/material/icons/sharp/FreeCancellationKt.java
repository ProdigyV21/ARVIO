...
public final class FreeCancellationKt {
    ...
    public static final ImageVector getFreeCancellation(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FreeCancellation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderC = a.c(11.21f, 20.0f, 5.0f, 10.0f, 14.0f);
        a0.a.l(pathBuilderC, 4.38f, 2.0f, -2.0f, 4.0f);
        w.a.C(pathBuilderC, -3.0f, 2.0f, -2.0f, 2.0f);
        w.a.m(pathBuilderC, 8.0f, 2.0f, 6.0f, 2.0f);
        a.n(pathBuilderC, 3.0f, 18.0f, 10.21f);
        c.z(pathBuilderC, 11.21f, 20.0f, 16.54f, 22.5f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderC, 12.0f, 12.41f, 10.41f, 14.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
