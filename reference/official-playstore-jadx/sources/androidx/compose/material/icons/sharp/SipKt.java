...
public final class SipKt {
    ...
    public static final ImageVector getSip(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Sip", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        w.a.m(pathBuilderQ, 10.0f, 15.0f, 5.0f, -1.5f);
        d.y(pathBuilderQ, 3.5f, -0.75f, 5.0f, 9.0f);
        c.D(pathBuilderQ, 5.0f, 10.5f, 13.0f, 15.0f);
        f.A(pathBuilderQ, -2.0f, 9.0f, 2.0f, 15.0f);
        c.m(pathBuilderQ, 19.0f, 9.0f, 4.0f, -3.5f);
