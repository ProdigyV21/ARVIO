...
public final class EditNotificationsKt {
    ...
    public static final ImageVector getEditNotifications(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.EditNotifications", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        w.a.j(pathBuilderR, 2.0f, 3.0f, 2.2f);
        pathBuilderR.curveToRelative(0.82f, 0.21f, 1.57f, 0.59f, 2.21f, 1.09f);
        b.n(pathBuilderR, 10.6f, 10.4f, 15.0f, 4.6f);
