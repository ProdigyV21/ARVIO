...
public final class _17mpKt {
    ...
    public static final ImageVector get_17mp(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._17mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.v(pathBuilderQ, 3.0f, 7.0f, 5.5f, 3.0f);
        d.B(pathBuilderQ, 6.0f, 8.5f, 7.0f, 7.0f);
        ...
        e.o(pathBuilderQ, 12.0f, 7.0f, 5.5f, 4.87f);
        pathBuilderQ.lineToRelative(-1.87f, 6.0f);
        pathBuilderQ.horizontalLineToRelative(-1.75f);
