...
public final class WheelchairPickupKt {
    ...
    public static final ImageVector getWheelchairPickup(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WheelchairPickup", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.x(pathBuilderA, 10.0f, 10.95f, 7.0f, 3.0f);
        b.z(pathBuilderA, 8.0f, 2.0f, 7.0f, 3.5f);
