...
public final class ParaglidingKt {
    ...
    public static final ImageVector getParagliding(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Paragliding", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(8.52f, 17.94f);
        ...
        pathBuilderA.curveToRelative(0.0f, 2.76f, -1.04f, 3.55f, -1.52f, 3.94f);
        pathBuilderA.curveTo(14.68f, 18.54f, 14.0f, 19.0f, 12.0f, 19.0f);
        pathBuilderA.reflectiveCurveTo(9.32f, 18.54f, 8.52f, 17.94f);
        pathBuilderA.close();
