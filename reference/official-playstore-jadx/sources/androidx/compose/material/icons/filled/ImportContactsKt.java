...
public final class ImportContactsKt {
    ...
    public static final ImageVector getImportContacts(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ImportContacts", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.65f, 0.73f, 0.45f, 0.75f, 0.45f);
        ...
        pathBuilderA.curveTo(22.66f, 21.26f, 23.0f, 20.86f, 23.0f, 20.6f);
        pathBuilderA.verticalLineTo(6.0f);
        pathBuilderA.curveTo(21.51f, 4.88f, 19.37f, 4.5f, 17.5f, 4.5f);
        pathBuilderA.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderA, 18.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
