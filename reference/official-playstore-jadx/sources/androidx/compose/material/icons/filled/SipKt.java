...
public final class SipKt {
    ...
    public static final ImageVector getSip(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Sip", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderQ, 10.0f, 10.5f, 6.5f, 0.75f);
        ...
        b.q(pathBuilderQ, 5.0f, -1.5f, 3.5f, -0.75f);
        pathBuilderQ.horizontalLineTo(6.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.verticalLineTo(10.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        c.D(pathBuilderQ, 4.0f, 10.5f, 13.0f, 15.0f);
        f.A(pathBuilderQ, -2.0f, 9.0f, 2.0f, 15.0f);
        pathBuilderQ.moveTo(19.0f, 12.0f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        d.y(pathBuilderQ, -2.5f, 2.0f, 14.0f, 9.0f);
