...
public final class AddModeratorKt {
    ...
    public static final ImageVector getAddModerator(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AddModerator", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(13.22f, 22.61f);
        pathBuilderA.curveToRelative(-0.4f, 0.15f, -0.8f, 0.29f, -1.22f, 0.39f);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.9f, -0.11f, 1.78f, -0.3f, 2.65f);
        pathBuilderA.curveToRelative(-0.81f, -0.41f, -1.73f, -0.65f, -2.7f, -0.65f);
        pathBuilderA.curveToRelative(-3.31f, 0.0f, -6.0f, 2.69f, -6.0f, 6.0f);
        pathBuilderA.curveToRelative(0.0f, 1.36f, 0.46f, 2.61f, 1.22f, 3.61f);
        d.k(pathBuilderA, 19.0f, 20.0f, 2.99f);
        pathBuilderA.reflectiveCurveToRelative(-1.99f, 0.01f, -2.0f, 0.0f);
        b.r(pathBuilderA, 20.0f, -3.0f, -2.0f, 3.0f);
