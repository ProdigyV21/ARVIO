...
public final class NetworkWifiKt {
    ...
    public static final ImageVector getNetworkWifi(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NetworkWifi", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.C(pathBuilderA, 0.0f, 0.0f, 24.0f, 8.98f);
        ...
        pathBuilderA.curveTo(17.5f, 8.94f, 14.86f, 8.0f, 12.0f, 8.0f);
        pathBuilderA.reflectiveCurveToRelative(-5.5f, 0.94f, -7.65f, 2.51f);
