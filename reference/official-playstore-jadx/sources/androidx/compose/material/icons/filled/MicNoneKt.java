...
public final class MicNoneKt {
    ...
    public static final ImageVector getMicNone(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.MicNone", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(10.8f, 4.9f);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.66f, -0.53f, 1.2f, -1.19f, 1.2f);
        pathBuilderA.curveToRelative(-0.66f, 0.0f, -1.2f, -0.54f, -1.2f, -1.2f);
        c.z(pathBuilderA, 10.8f, 4.9f, 17.3f, 11.0f);
        pathBuilderA.curveToRelative(0.0f, 3.0f, -2.54f, 5.1f, -5.3f, 5.1f);
        pathBuilderA.reflectiveCurveTo(6.7f, 14.0f, 6.7f, 11.0f);
