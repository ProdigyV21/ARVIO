...
public final class SubtitlesOffKt {
    ...
    public static final ImageVector getSubtitlesOff(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SubtitlesOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.n(pathBuilderB, 20.0f, 2.0f, -3.17f);
        ...
        PathBuilder pathBuilderR = a.r(1.04f, 3.87f, 1.2f, 1.2f);
        ...
        c.u(pathBuilderR, 8.0f, 12.0f, 2.0f, 4.0f);
        e.y(pathBuilderR, -2.0f, 8.0f, 14.0f, 16.83f);
        c.o(pathBuilderR, 18.0f, 4.0f, -2.0f, 9.17f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 14.0f, 16.83f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
