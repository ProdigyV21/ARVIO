...
public final class RocketLaunchKt {
    ...
    public static final ImageVector getRocketLaunch(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.RocketLaunch", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.47f, -0.47f, 1.15f, -0.68f, 1.81f, -0.55f);
