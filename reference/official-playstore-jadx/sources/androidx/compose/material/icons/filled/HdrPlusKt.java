...
public final class HdrPlusKt {
    ...
    public static final ImageVector getHdrPlus(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.HdrPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.A(pathBuilderA, 2.0f, 7.0f, -6.0f, 3.5f);
        pathBuilderA.curveToRelative(0.8f, 0.0f, 1.5f, 0.7f, 1.5f, 1.5f);
        v.a.D(pathBuilderA, 15.5f, 12.0f, 12.0f, -1.5f);
        y.a.l(pathBuilderA, 9.5f, -2.0f, 12.0f, 7.0f);
        b.r(pathBuilderA, 6.0f, 1.5f, 2.0f, 2.0f);
        v.a.v(pathBuilderA, 6.0f, 12.0f, 12.0f);
        v.a.A(pathBuilderA, 17.5f, 16.0f, 16.0f, 1.5f);
        w.a.B(pathBuilderA, -1.5f, 16.0f, 13.0f, -1.5f);
        w.a.B(pathBuilderA, 1.5f, 13.0f, 16.0f, 1.49f);
        c.D(pathBuilderA, 1.5f, 16.0f, 17.5f, 10.5f);
