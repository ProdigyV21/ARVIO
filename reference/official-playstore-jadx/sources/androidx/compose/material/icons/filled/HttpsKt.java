...
public final class HttpsKt {
    ...
    public static final ImageVector getHttps(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Https", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.reflectiveCurveToRelative(-0.9f, 2.0f, -2.0f, 2.0f);
        a.p(pathBuilderI, 15.1f, 8.0f, 8.9f, 8.0f);
        pathBuilderI.lineTo(8.9f, 6.0f);
