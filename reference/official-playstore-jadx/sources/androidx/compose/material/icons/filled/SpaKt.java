...
public final class SpaKt {
    ...
    public static final ImageVector getSpa(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Spa", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = c.a(15.49f, 9.63f);
        pathBuilderA2.curveToRelative(-0.18f, -2.79f, -1.31f, -5.51f, -3.43f, -7.63f);
        pathBuilderA2.curveToRelative(-2.14f, 2.14f, -3.32f, 4.86f, -3.55f, 7.63f);
        pathBuilderA2.curveToRelative(1.28f, 0.68f, 2.46f, 1.56f, 3.49f, 2.63f);
        pathBuilderA2.curveToRelative(1.03f, -1.06f, 2.21f, -1.94f, 3.49f, -2.63f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(8.99f, 12.28f);
        pathBuilderA2.curveToRelative(-0.14f, -0.1f, -0.3f, -0.19f, -0.45f, -0.29f);
        pathBuilderA2.curveToRelative(0.15f, 0.11f, 0.31f, 0.19f, 0.45f, 0.29f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(15.41f, 12.03f);
        pathBuilderA2.curveToRelative(-0.13f, 0.09f, -0.27f, 0.16f, -0.4f, 0.26f);
        pathBuilderA2.curveToRelative(0.13f, -0.1f, 0.27f, -0.17f, 0.4f, -0.26f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 15.45f);
        pathBuilderA2.curveTo(9.85f, 12.17f, 6.18f, 10.0f, 2.0f, 10.0f);
        pathBuilderA2.curveToRelative(0.0f, 5.32f, 3.36f, 9.82f, 8.03f, 11.49f);
        pathBuilderA2.curveToRelative(0.63f, 0.23f, 1.29f, 0.4f, 1.97f, 0.51f);
        pathBuilderA2.curveToRelative(0.68f, -0.12f, 1.33f, -0.29f, 1.97f, -0.51f);
        pathBuilderA2.curveTo(18.64f, 19.82f, 22.0f, 15.32f, 22.0f, 10.0f);
        pathBuilderA2.curveToRelative(-4.18f, 0.0f, -7.85f, 2.17f, -10.0f, 5.45f);
        pathBuilderA2.close();
