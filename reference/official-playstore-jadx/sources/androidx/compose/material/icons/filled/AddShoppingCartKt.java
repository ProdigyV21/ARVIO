...
public final class AddShoppingCartKt {
    ...
    public static final ImageVector getAddShoppingCart(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AddShoppingCart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.reflectiveCurveToRelative(2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderI.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        a.z(pathBuilderI, 7.17f, 14.75f, 0.03f, -0.12f);
        pathBuilderI.lineToRelative(0.9f, -1.63f);
        pathBuilderI.horizontalLineToRelative(7.45f);
        ...
        pathBuilderI.horizontalLineToRelative(-0.01f);
        pathBuilderI.lineToRelative(-1.1f, 2.0f);
        pathBuilderI.lineToRelative(-2.76f, 5.0f);
        pathBuilderI.lineTo(8.53f, 11.0f);
        pathBuilderI.lineToRelative(-0.13f, -0.27f);
        pathBuilderI.lineTo(6.16f, 6.0f);
        pathBuilderI.lineToRelative(-0.95f, -2.0f);
        pathBuilderI.lineToRelative(-0.94f, -2.0f);
        a.h(pathBuilderI, 1.0f, 2.0f, 2.0f, 2.0f);
        pathBuilderI.lineToRelative(3.6f, 7.59f);
        pathBuilderI.lineToRelative(-1.35f, 2.45f);
        pathBuilderI.curveToRelative(-0.16f, 0.28f, -0.25f, 0.61f, -0.25f, 0.96f);
        pathBuilderI.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        c.q(pathBuilderI, 12.0f, -2.0f, 7.42f, 15.0f);
        pathBuilderI.curveToRelative(-0.13f, 0.0f, -0.25f, -0.11f, -0.25f, -0.25f);
        pathBuilderI.close();
