...
public final class PivotTableChartKt {
    ...
    public static final ImageVector getPivotTableChart(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PivotTableChart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderI = e.i(10.0f, 8.0f, 11.0f, 21.0f, 5.0f);
        pathBuilderI.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        b.B(pathBuilderI, -9.0f, 5.0f, 3.0f, 8.0f);
        ...
        c.r(pathBuilderI, 3.0f, 5.0f, 21.0f, 3.0f);
        pathBuilderI.lineTo(8.0f, 10.0f);
        pathBuilderI.lineTo(3.0f, 10.0f);
        pathBuilderI.verticalLineToRelative(9.0f);
        pathBuilderI.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        a.z(pathBuilderI, 13.0f, 22.0f, -4.0f, -4.0f);
        b.C(pathBuilderI, 4.0f, -4.0f, 14.0f, 13.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderI, 4.0f, -4.0f, 4.0f, 4.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderH = b.h(14.58f, 19.0f, 13.0f, -2.0f, 1.58f);
        pathBuilderH.curveToRelative(1.33f, 0.0f, 2.42f, -1.08f, 2.42f, -2.42f);
        w.a.j(pathBuilderH, 13.0f, 2.0f, 1.58f);
        pathBuilderH.curveToRelative(0.0f, 2.44f, -1.98f, 4.42f, -4.42f, 4.42f);
        pathBuilderH.close();
