...
public final class TypeSpecimenKt {
    ...
    public static final ImageVector getTypeSpecimen(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.TypeSpecimen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderQ, 16.63f, 14.5f, -0.8f, -2.3f);
        a0.a.n(pathBuilderQ, -3.63f, -0.82f, 2.3f, 9.81f);
        pathBuilderQ.lineToRelative(3.38f, -9.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.r(pathBuilderQ, 1.61f, 3.38f, 9.0f, 16.63f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
