...
public final class SpatialAudioKt {
    ...
    public static final ImageVector getSpatialAudio(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SpatialAudio", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = a.a(16.0f, 1.0f, -2.0f);
        pathBuilderA2.curveToRelative(0.0f, 4.97f, 4.03f, 9.0f, 9.0f, 9.0f);
        pathBuilderA2.verticalLineTo(8.0f);
        pathBuilderA2.curveTo(19.14f, 8.0f, 16.0f, 4.86f, 16.0f, 1.0f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderA3 = a.a(20.0f, 1.0f, -2.0f);
        pathBuilderA3.curveToRelative(0.0f, 2.76f, 2.24f, 5.0f, 5.0f, 5.0f);
        pathBuilderA3.verticalLineTo(4.0f);
        pathBuilderA3.curveTo(21.35f, 4.0f, 20.0f, 2.65f, 20.0f, 1.0f);
        pathBuilderA3.close();
