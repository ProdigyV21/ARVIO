...
public final class UsbKt {
    ...
    public static final ImageVector getUsb(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Usb", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderU.curveToRelative(-1.21f, 0.0f, -2.2f, 0.99f, -2.2f, 2.2f);
        ...
        pathBuilderU.curveToRelative(1.21f, 0.0f, 2.2f, -0.98f, 2.2f, -2.2f);
