...
public final class EditLocationKt {
    ...
    public static final ImageVector getEditLocation(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.EditLocation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 10.44f, 12.0f, 9.0f, 12.0f);
        pathBuilderA.verticalLineToRelative(-1.44f);
        pathBuilderA.lineToRelative(3.35f, -3.34f);
        d.C(pathBuilderA, 1.43f, 1.43f, 10.44f, 12.0f);
        pathBuilderA.moveTo(14.89f, 7.55f);
        ...
        pathBuilderA.curveToRelative(0.15f, 0.15f, 0.15f, 0.39f, 0.0f, 0.54f);
        pathBuilderA.close();
