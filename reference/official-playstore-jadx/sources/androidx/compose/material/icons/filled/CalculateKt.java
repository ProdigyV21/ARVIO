...
public final class CalculateKt {
    ...
    public static final ImageVector getCalculate(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Calculate", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 13.03f, 7.06f, 14.09f, 6.0f);
        ...
        pathBuilderQ.lineToRelative(-1.41f, 1.41f);
        pathBuilderQ.lineToRelative(-1.06f, -1.06f);
        d.C(pathBuilderQ, 1.41f, -1.41f, 13.03f, 7.06f);
        a.C(pathBuilderQ, 6.25f, 7.72f, 5.0f, 1.5f);
        c.D(pathBuilderQ, -5.0f, 7.72f, 11.5f, 16.0f);
        a0.a.y(pathBuilderQ, -2.0f, 2.0f, 8.0f, -2.0f);
        b.q(pathBuilderQ, 6.0f, -1.5f, 2.0f, -2.0f);
        f.w(pathBuilderQ, 1.5f, 2.0f, 2.0f, 16.0f);
        a.C(pathBuilderQ, 18.0f, 17.25f, -5.0f, -1.5f);
        c.D(pathBuilderQ, 5.0f, 17.25f, 18.0f, 14.75f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.f(pathBuilderQ, -5.0f, -1.5f, 5.0f, 14.75f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
