...
public final class SupervisedUserCircleKt {
    ...
    public static final ImageVector getSupervisedUserCircle(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SupervisedUserCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.k(pathBuilderA, 9.6f, 15.89f, 3.75f);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(11.99f, 20.0f);
        ...
        pathBuilderA.curveToRelative(-1.17f, 2.97f, -4.06f, 5.09f, -7.45f, 5.09f);
        pathBuilderA.close();
