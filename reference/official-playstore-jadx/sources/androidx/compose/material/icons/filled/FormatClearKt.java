...
public final class FormatClearKt {
    ...
    public static final ImageVector getFormatClear(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.FormatClear", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderJ = a.j(3.27f, 5.0f, 2.0f, 6.27f);
        pathBuilderJ.lineToRelative(6.97f, 6.97f);
        pathBuilderJ.lineTo(6.5f, 19.0f);
        pathBuilderJ.horizontalLineToRelative(3.0f);
        pathBuilderJ.lineToRelative(1.57f, -3.66f);
        pathBuilderJ.lineTo(16.73f, 21.0f);
        pathBuilderJ.lineTo(18.0f, 19.73f);
        b.y(pathBuilderJ, 3.55f, 5.27f, 3.27f, 5.0f);
        pathBuilderJ.moveTo(6.0f, 5.0f);
        a0.b.k(pathBuilderJ, 0.18f, 8.82f, 8.0f, 2.4f);
        pathBuilderJ.lineToRelative(-0.72f, 1.68f);
        pathBuilderJ.lineToRelative(2.1f, 2.1f);
        b.p(pathBuilderJ, 14.21f, 8.0f, 20.0f, 5.0f);
