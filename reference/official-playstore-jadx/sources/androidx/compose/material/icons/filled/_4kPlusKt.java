...
public final class _4kPlusKt {
    ...
    public static final ImageVector get_4kPlus(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._4kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.g(pathBuilderJ, 10.5f, 13.5f, -1.0f);
        pathBuilderJ.lineTo(9.5f, 15.0f);
        pathBuilderJ.lineTo(8.0f, 15.0f);
        pathBuilderJ.verticalLineToRelative(-1.5f);
        pathBuilderJ.lineTo(5.0f, 13.5f);
        b.A(pathBuilderJ, 5.0f, 9.0f, 1.5f, 3.0f);
        pathBuilderJ.lineTo(8.0f, 12.0f);
        b.A(pathBuilderJ, 8.0f, 9.0f, 1.5f, 3.0f);
        b.B(pathBuilderJ, 1.0f, 1.5f, 16.0f, 15.0f);
