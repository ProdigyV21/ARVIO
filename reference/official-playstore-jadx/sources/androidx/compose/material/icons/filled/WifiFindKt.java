...
public final class WifiFindKt {
    ...
    public static final ImageVector getWifiFind(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.WifiFind", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(11.0f, 14.0f);
        pathBuilderA.curveToRelative(0.0f, -3.36f, 2.64f, -6.0f, 6.0f, -6.0f);
        pathBuilderA.curveToRelative(2.2f, 0.0f, 4.08f, 1.13f, 5.13f, 2.86f);
        ...
        pathBuilderA.lineToRelative(1.86f, -1.87f);
        pathBuilderA.curveTo(12.14f, 18.09f, 11.0f, 16.2f, 11.0f, 14.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(21.0f, 14.0f);
        ...
        pathBuilderA2.lineTo(21.59f, 20.0f);
        pathBuilderA2.lineTo(23.0f, 18.59f);
        pathBuilderA2.lineToRelative(-2.56f, -2.56f);
        ...
        pathBuilderA2.curveToRelative(0.0f, 1.12f, -0.88f, 2.0f, -2.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA2, 15.0f, 15.12f, 15.0f, 14.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
