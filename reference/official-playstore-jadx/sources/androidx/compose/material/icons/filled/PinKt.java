...
public final class PinKt {
    ...
    public static final ImageVector getPin(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Pin", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderQ, 7.64f, 15.0f, 6.49f, -4.5f);
        pathBuilderQ.lineToRelative(-0.9f, 0.66f);
        pathBuilderQ.lineToRelative(-0.58f, -0.89f);
        pathBuilderQ.lineTo(6.77f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.87f);
        pathBuilderQ.verticalLineTo(15.0f);
        pathBuilderQ.close();
        a.A(pathBuilderQ, 13.5f, 15.0f, 9.61f, -1.02f);
        ...
        pathBuilderQ.curveToRelative(0.01f, -0.02f, 0.18f, -0.76f, 1.0f, -1.15f);
        ...
        pathBuilderQ.horizontalLineToRelative(2.37f);
        pathBuilderQ.verticalLineTo(15.0f);
        pathBuilderQ.close();
        ...
        pathBuilderQ.curveToRelative(0.03f, 0.1f, 0.19f, 0.86f, 1.02f, 0.86f);
        ...
        e.g(pathBuilderQ, -0.5f, -1.0f, 0.46f);
