...
public final class SentimentDissatisfiedKt {
    ...
    public static final ImageVector getSentimentDissatisfied(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SentimentDissatisfied", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.73f, 0.0f, 1.39f, 0.19f, 1.97f, 0.53f);
        pathBuilderA.curveToRelative(0.12f, -0.14f, 0.86f, -0.98f, 1.01f, -1.14f);
        pathBuilderA.curveToRelative(-0.85f, -0.56f, -1.87f, -0.89f, -2.98f, -0.89f);
        pathBuilderA.curveToRelative(-1.11f, 0.0f, -2.13f, 0.33f, -2.99f, 0.88f);
        pathBuilderA.curveToRelative(0.97f, 1.09f, 0.01f, 0.02f, 1.01f, 1.14f);
        pathBuilderA.curveToRelative(0.59f, -0.33f, 1.25f, -0.52f, 1.98f, -0.52f);
        pathBuilderA.close();
