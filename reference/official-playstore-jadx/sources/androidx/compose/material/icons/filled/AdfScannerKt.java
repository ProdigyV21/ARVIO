...
public final class AdfScannerKt {
    ...
    public static final ImageVector getAdfScanner(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AdfScanner", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.o(pathBuilderS, 16.0f, 12.0f, 8.0f, 6.0f);
        c.D(pathBuilderS, 8.0f, 12.0f, 18.0f, 17.0f);
