...
public final class _2kKt {
    ...
    public static final ImageVector get_2k(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._2k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderJ, 10.0f, 12.5f, 8.0f, 12.5f);
        c.w(pathBuilderJ, 1.0f, 3.0f, 11.0f, 15.0f);
        pathBuilderJ.lineTo(6.5f, 15.0f);
        ...
        pathBuilderJ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.g(pathBuilderJ, 18.0f, 15.0f, -1.75f);
