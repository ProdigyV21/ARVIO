...
public final class _5kPlusKt {
    ...
    public static final ImageVector get_5kPlus(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._5kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.h(pathBuilderJ, 5.0f, 15.0f, -1.5f, 3.0f);
        pathBuilderJ.verticalLineToRelative(-1.0f);
        pathBuilderJ.lineTo(5.0f, 12.5f);
        b.g(pathBuilderJ, 5.0f, 9.0f, 4.5f, 1.5f);
