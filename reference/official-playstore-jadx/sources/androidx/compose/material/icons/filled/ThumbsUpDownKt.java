...
public final class ThumbsUpDownKt {
    ...
    public static final ImageVector getThumbsUpDown(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ThumbsUpDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderA, 12.0f, 6.0f, 22.5f, 10.0f);
        pathBuilderA.horizontalLineToRelative(-6.75f);
        pathBuilderA.curveToRelative(-0.62f, 0.0f, -1.15f, 0.38f, -1.38f, 0.91f);
        pathBuilderA.lineToRelative(-2.26f, 5.29f);
        pathBuilderA.curveToRelative(-0.07f, 0.17f, -0.11f, 0.36f, -0.11f, 0.55f);
