...
public final class _7kPlusKt {
    ...
    public static final ImageVector get_7kPlus(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._7kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderJ, 8.0f, 15.0f, 6.25f, 15.0f);
        pathBuilderJ.lineToRelative(1.38f, -4.5f);
        pathBuilderJ.lineTo(5.0f, 10.5f);
        ...
        c.z(pathBuilderJ, 8.0f, 15.0f, 16.0f, 15.0f);
