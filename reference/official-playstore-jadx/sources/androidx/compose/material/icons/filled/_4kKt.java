...
public final class _4kKt {
    ...
    public static final ImageVector get_4k(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._4k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.g(pathBuilderJ, 12.0f, 13.5f, -1.0f);
        pathBuilderJ.lineTo(11.0f, 15.0f);
        a.h(pathBuilderJ, 9.5f, 15.0f, -1.5f, -3.0f);
        pathBuilderJ.lineTo(6.5f, 9.0f);
        a.h(pathBuilderJ, 8.0f, 9.0f, 3.0f, 1.5f);
        pathBuilderJ.lineTo(9.5f, 9.0f);
        a.h(pathBuilderJ, 11.0f, 9.0f, 3.0f, 1.0f);
        c.r(pathBuilderJ, 1.5f, 18.0f, 15.0f, -1.75f);
