...
public final class OnDeviceTrainingKt {
    ...
    public static final ImageVector getOnDeviceTraining(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.OnDeviceTraining", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.o(pathBuilderJ, 18.0f, 18.0f, 6.0f, 6.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderJ, 12.0f, 18.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
