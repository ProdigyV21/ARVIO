...
public final class BadgeKt {
    ...
    public static final ImageVector getBadge(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Badge", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderB.reflectiveCurveTo(9.83f, 15.0f, 9.0f, 15.0f);
        pathBuilderB.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderB.reflectiveCurveTo(8.17f, 12.0f, 9.0f, 12.0f);
        c.C(pathBuilderB, 12.0f, 18.0f, 6.0f, -0.75f);
        pathBuilderB.curveToRelative(0.0f, -1.0f, 2.0f, -1.5f, 3.0f, -1.5f);
        pathBuilderB.reflectiveCurveToRelative(3.0f, 0.5f, 3.0f, 1.5f);
        a.D(pathBuilderB, 18.0f, 13.0f, 9.0f, -2.0f);
        f.k(pathBuilderB, 4.0f, 2.0f, 9.0f);
        e.m(pathBuilderB, 18.0f, 16.5f, -4.0f, 15.0f);
        c.D(pathBuilderB, 4.0f, 16.5f, 18.0f, 13.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.v(pathBuilderB, -4.0f, 12.0f, 4.0f, 13.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
