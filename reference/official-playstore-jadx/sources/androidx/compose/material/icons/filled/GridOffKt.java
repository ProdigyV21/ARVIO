...
public final class GridOffKt {
    ...
    public static final ImageVector getGridOff(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.GridOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderG = a.g(8.0f, 4.0f, 1.45f, 2.0f, 2.0f);
        ...
        pathBuilderG.lineToRelative(2.0f, 2.0f);
        d.C(pathBuilderG, 1.27f, -1.27f, 1.27f, 1.27f);
        ...
        pathBuilderG.horizontalLineToRelative(3.45f);
        d.C(pathBuilderG, 0.55f, 0.54f, 14.0f, 20.0f);
        pathBuilderG.moveTo(16.0f, 20.0f);
        pathBuilderG.verticalLineToRelative(-1.46f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.f(pathBuilderG, 17.46f, 20.0f, 16.0f, 20.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
