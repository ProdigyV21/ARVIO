...
public final class CloudOffKt {
    ...
    public static final ImageVector getCloudOff(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.CloudOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-1.48f, 0.0f, -2.85f, 0.43f, -4.01f, 1.17f);
        pathBuilderA.lineToRelative(1.46f, 1.46f);
        pathBuilderA.curveTo(10.21f, 6.23f, 11.08f, 6.0f, 12.0f, 6.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.13f, -0.64f, 2.11f, -1.56f, 2.62f);
        pathBuilderA.lineToRelative(1.45f, 1.45f);
        pathBuilderA.curveTo(23.16f, 18.16f, 24.0f, 16.68f, 24.0f, 15.0f);
        pathBuilderA.curveToRelative(0.0f, -2.64f, -2.05f, -4.78f, -4.65f, -4.96f);
        a.z(pathBuilderA, 3.0f, 5.27f, 2.75f, 2.74f);
        pathBuilderA.curveTo(2.56f, 8.15f, 0.0f, 10.77f, 0.0f, 14.0f);
        ...
        pathBuilderA.lineTo(21.0f, 20.73f);
        b.y(pathBuilderA, 4.27f, 4.0f, 3.0f, 5.27f);
        pathBuilderA.moveTo(7.73f, 10.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.d(pathBuilderA, 1.73f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
