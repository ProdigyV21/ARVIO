...
public final class VideoChatKt {
    ...
    public static final ImageVector getVideoChat(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.VideoChat", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderQ, 17.0f, 13.0f, -2.0f, -1.99f);
        ...
        pathBuilderQ.lineTo(17.0f, 7.0f);
        pathBuilderQ.verticalLineTo(13.0f);
        pathBuilderQ.close();
