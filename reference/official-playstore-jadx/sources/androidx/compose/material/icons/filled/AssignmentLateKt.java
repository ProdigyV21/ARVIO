...
public final class AssignmentLateKt {
    ...
    public static final ImageVector getAssignmentLate(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AssignmentLate", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.B(pathBuilderA, 2.0f, 2.0f, 13.0f, 14.0f);
        c.A(pathBuilderA, -2.0f, 11.0f, 8.0f, 2.0f);
        b.f(pathBuilderA, 6.0f, 12.0f, 5.0f);
