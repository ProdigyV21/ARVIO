...
public final class PanoramaVerticalKt {
    ...
    public static final ImageVector getPanoramaVertical(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PanoramaVertical", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -3.09f, 0.55f, -6.18f, 1.64f, -9.12f);
