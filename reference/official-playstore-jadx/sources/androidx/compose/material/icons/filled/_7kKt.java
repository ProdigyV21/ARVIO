...
public final class _7kKt {
    ...
    public static final ImageVector get_7k(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._7k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderJ, 9.5f, 15.0f, 7.75f, 15.0f);
        pathBuilderJ.lineToRelative(1.38f, -4.5f);
        pathBuilderJ.lineTo(6.5f, 10.5f);
        ...
        c.z(pathBuilderJ, 9.5f, 15.0f, 18.0f, 15.0f);
