...
public final class SupervisorAccountKt {
    ...
    public static final ImageVector getSupervisorAccount(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SupervisorAccount", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(15.12f, 7.0f, 14.0f, 8.12f, 14.0f, 9.5f);
        ...
        pathBuilderA.curveTo(7.34f, 5.0f, 6.0f, 6.34f, 6.0f, 8.0f);
