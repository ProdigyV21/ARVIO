...
public final class NightsStayKt {
    ...
    public static final ImageVector getNightsStay(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NightsStay", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(18.0f, 17.72f, 13.38f, 16.52f, 11.1f, 12.08f);
        pathBuilderA.close();
