...
public final class NoFoodKt {
    ...
    public static final ImageVector getNoFood(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NoFood", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.C(pathBuilderT, -1.38f, 13.79f, 11.35f, 8.52f);
        pathBuilderT.moveTo(1.0f, 21.0f);
        pathBuilderT.verticalLineToRelative(1.0f);
        pathBuilderT.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderT.horizontalLineToRelative(13.0f);
        pathBuilderT.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        e.y(pathBuilderT, -1.0f, 1.0f, 21.9f, 21.9f);
        pathBuilderT.lineTo(2.1f, 2.1f);
        pathBuilderT.lineTo(0.69f, 3.51f);
        pathBuilderT.lineToRelative(5.7f, 5.7f);
        pathBuilderT.curveTo(3.28f, 9.87f, 1.0f, 11.99f, 1.0f, 15.0f);
        a0.a.n(pathBuilderT, 11.17f, 2.0f, 2.0f, 1.0f);
        e.l(pathBuilderT, 2.0f, 15.0f, -0.17f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderT, 4.49f, 4.49f, 21.9f, 21.9f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
