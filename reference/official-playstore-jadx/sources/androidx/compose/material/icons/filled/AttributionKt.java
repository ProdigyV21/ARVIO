...
public final class AttributionKt {
    ...
    public static final ImageVector getAttribution(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Attribution", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(12.0f, 8.5f);
        pathBuilderA.curveToRelative(-0.91f, 0.0f, -2.75f, 0.46f, -2.75f, 1.38f);
        a.y(pathBuilderA, 4.62f, 1.5f, 19.0f, 2.5f);
        f.t(pathBuilderA, -4.5f, 1.5f, 9.88f);
        pathBuilderA.curveTo(14.75f, 8.97f, 12.91f, 8.5f, 12.0f, 8.5f);
        pathBuilderA.close();
