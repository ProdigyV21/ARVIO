...
public final class ChildCareKt {
    ...
    public static final ImageVector getChildCare(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ChildCare", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(22.94f, 12.66f);
        pathBuilderA.curveToRelative(0.04f, -0.21f, 0.06f, -0.43f, 0.06f, -0.66f);
        pathBuilderA.reflectiveCurveToRelative(-0.02f, -0.45f, -0.06f, -0.66f);
        ...
        pathBuilderA.reflectiveCurveToRelative(-0.9f, 2.0f, -2.0f, 2.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(7.5f, 14.0f);
        pathBuilderA.curveToRelative(0.76f, 1.77f, 2.49f, 3.0f, 4.5f, 3.0f);
        pathBuilderA.reflectiveCurveToRelative(3.74f, -1.23f, 4.5f, -3.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.d(pathBuilderA, -9.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
