...
public final class WorkHistoryKt {
    ...
    public static final ImageVector getWorkHistory(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.WorkHistory", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(1.49f, 0.0f, 2.87f, 0.47f, 4.0f, 1.26f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderA, -4.0f, 4.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
