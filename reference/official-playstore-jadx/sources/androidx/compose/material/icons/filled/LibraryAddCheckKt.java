...
public final class LibraryAddCheckKt {
    ...
    public static final ImageVector getLibraryAddCheck(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.LibraryAddCheck", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderJ, 12.47f, 14.0f, 9.0f, 10.5f);
        pathBuilderJ.lineToRelative(1.4f, -1.41f);
        pathBuilderJ.lineToRelative(2.07f, 2.08f);
        pathBuilderJ.lineTo(17.6f, 6.0f);
        b.y(pathBuilderJ, 19.0f, 7.41f, 12.47f, 14.0f);
