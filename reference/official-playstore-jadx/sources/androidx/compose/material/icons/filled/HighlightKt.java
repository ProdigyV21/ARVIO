...
public final class HighlightKt {
    ...
    public static final ImageVector getHighlight(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Highlight", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.v(pathBuilderS, 9.0f, 6.0f, 14.0f);
        a.C(pathBuilderS, 11.0f, 2.0f, 2.0f, 3.0f);
        c.D(pathBuilderS, -2.0f, 2.0f, 3.5f, 5.88f);
        ...
        pathBuilderS.lineToRelative(2.12f, -2.12f);
        pathBuilderS.lineToRelative(1.41f, 1.41f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderS, 18.38f, 8.0f, 16.96f, 6.59f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
