...
public final class ContactPhoneKt {
    ...
    public static final ImageVector getContactPhone(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ContactPhone", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.r(pathBuilderJ, 1.0f, 17.85f, 14.0f, 1.64f);
        pathBuilderJ.lineTo(21.0f, 16.0f);
        pathBuilderJ.lineToRelative(-1.99f, 1.99f);
        pathBuilderJ.curveToRelative(-1.31f, -0.98f, -2.28f, -2.38f, -2.73f, -3.99f);
        ...
        pathBuilderJ.curveToRelative(0.45f, -1.62f, 1.42f, -3.01f, 2.73f, -3.99f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderJ, 0.13f, 1.37f, 0.35f, 2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
