...
public final class LocalLaundryServiceKt {
    ...
    public static final ImageVector getLocalLaundryService(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.LocalLaundryService", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(1.56f, -1.56f, 1.56f, -4.1f, 0.0f, -5.66f);
        b.C(pathBuilderA, -5.66f, 5.66f, 18.0f, 2.01f);
