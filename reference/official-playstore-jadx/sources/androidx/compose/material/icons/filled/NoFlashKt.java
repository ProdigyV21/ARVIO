...
public final class NoFlashKt {
    ...
    public static final ImageVector getNoFlash(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NoFlash", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderJ = a.j(13.93f, 13.93f, 2.45f, 2.45f);
        pathBuilderJ.lineTo(1.04f, 3.87f);
        pathBuilderJ.lineToRelative(5.3f, 5.3f);
        pathBuilderJ.lineTo(6.14f, 9.4f);
        pathBuilderJ.horizontalLineTo(3.6f);
        pathBuilderJ.curveTo(2.72f, 9.4f, 2.0f, 10.12f, 2.0f, 11.0f);
        pathBuilderJ.verticalLineToRelative(9.4f);
        pathBuilderJ.curveTo(2.0f, 21.28f, 2.72f, 22.0f, 3.6f, 22.0f);
        pathBuilderJ.horizontalLineToRelative(12.8f);
        pathBuilderJ.curveToRelative(0.75f, 0.0f, 1.38f, -0.52f, 1.55f, -1.22f);
        pathBuilderJ.lineToRelative(2.18f, 2.18f);
        pathBuilderJ.lineToRelative(1.41f, -1.41f);
        b.y(pathBuilderJ, 18.0f, 18.0f, 13.93f, 13.93f);
        ...
        e.C(pathBuilderJ, 1.75f, 1.28f, 1.4f, 2.54f);
        pathBuilderJ.curveToRelative(0.88f, 0.0f, 1.6f, 0.72f, 1.6f, 1.6f);
