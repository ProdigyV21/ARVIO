...
public final class RemoveShoppingCartKt {
    ...
    public static final ImageVector getRemoveShoppingCart(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.RemoveShoppingCart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderJ = a.j(22.73f, 22.73f, 2.77f, 2.77f);
        pathBuilderJ.lineTo(2.0f, 2.0f);
        pathBuilderJ.lineToRelative(-0.73f, -0.73f);
        pathBuilderJ.lineTo(0.0f, 2.54f);
        ...
        d.l(pathBuilderJ, 21.46f, 24.0f, 1.27f, -1.27f);
        pathBuilderJ.moveTo(7.42f, 15.0f);
        pathBuilderJ.curveToRelative(-0.14f, 0.0f, -0.25f, -0.11f, -0.25f, -0.25f);
        pathBuilderJ.lineToRelative(0.03f, -0.12f);
        pathBuilderJ.lineToRelative(0.9f, -1.63f);
        pathBuilderJ.horizontalLineToRelative(2.36f);
        d.C(pathBuilderJ, 2.0f, 2.0f, 7.42f, 15.0f);
        pathBuilderJ.moveTo(15.55f, 13.0f);
        pathBuilderJ.curveToRelative(0.75f, 0.0f, 1.41f, -0.41f, 1.75f, -1.03f);
        pathBuilderJ.lineToRelative(3.58f, -6.49f);
        pathBuilderJ.curveToRelative(0.08f, -0.14f, 0.12f, -0.31f, 0.12f, -0.48f);
        pathBuilderJ.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        d.l(pathBuilderJ, 6.54f, 4.0f, 9.01f, 9.0f);
