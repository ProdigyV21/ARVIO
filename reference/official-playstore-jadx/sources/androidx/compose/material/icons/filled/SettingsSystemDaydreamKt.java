...
public final class SettingsSystemDaydreamKt {
    ...
    public static final ImageVector getSettingsSystemDaydream(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SettingsSystemDaydream", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderA, 21.0f, 19.01f, 3.0f, 19.01f);
