...
public final class SwipeDownKt {
    ...
    public static final ImageVector getSwipeDown(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SwipeDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.C(pathBuilderA, 1.06f, -1.06f, 3.8f, 12.18f);
        pathBuilderA.moveTo(13.85f, 11.62f);
