...
public final class CompassCalibrationKt {
    ...
    public static final ImageVector getCompassCalibration(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.CompassCalibration", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(12.0f, 10.07f);
        pathBuilderA.curveToRelative(1.95f, 0.0f, 3.72f, 0.79f, 5.0f, 2.07f);
        pathBuilderA.lineToRelative(5.0f, -5.0f);
        pathBuilderA.curveTo(19.44f, 4.59f, 15.9f, 3.0f, 12.0f, 3.0f);
        pathBuilderA.reflectiveCurveTo(4.56f, 4.59f, 2.0f, 7.15f);
        pathBuilderA.lineToRelative(5.0f, 5.0f);
