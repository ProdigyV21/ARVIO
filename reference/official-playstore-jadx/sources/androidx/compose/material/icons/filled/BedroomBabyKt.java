...
public final class BedroomBabyKt {
    ...
    public static final ImageVector getBedroomBaby(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.BedroomBaby", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.curveToRelative(-2.64f, 0.0f, -5.13f, -1.03f, -7.0f, -2.9f);
        pathBuilderQ.lineToRelative(1.06f, -1.06f);
        pathBuilderQ.curveToRelative(0.34f, 0.34f, 0.71f, 0.65f, 1.1f, 0.92f);
        pathBuilderQ.lineTo(8.0f, 13.5f);
        pathBuilderQ.verticalLineTo(9.51f);
        pathBuilderQ.lineTo(6.45f, 10.5f);
        pathBuilderQ.lineToRelative(-0.95f, -1.0f);
        pathBuilderQ.lineTo(7.0f, 7.76f);
        pathBuilderQ.lineTo(6.0f, 7.0f);
        a0.a.n(pathBuilderQ, 3.65f, 1.73f, 3.0f, 17.0f);
        e.l(pathBuilderQ, 1.0f, -1.0f, 2.5f);
        pathBuilderQ.lineToRelative(0.84f, 1.46f);
        pathBuilderQ.curveToRelative(0.39f, -0.28f, 0.76f, -0.58f, 1.1f, -0.92f);
        pathBuilderQ.lineTo(19.0f, 15.1f);
        pathBuilderQ.curveTo(17.13f, 16.97f, 14.64f, 18.0f, 12.0f, 18.0f);
        pathBuilderQ.close();
