...
public final class SwipeDownAltKt {
    ...
    public static final ImageVector getSwipeDownAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SwipeDownAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(12.0f, 9.0f, -3.0f, 0.0f);
        ...
        PathBuilder pathBuilderA = c.a(13.0f, 13.9f);
        ...
        pathBuilderA.reflectiveCurveTo(7.0f, 6.24f, 7.0f, 9.0f);
        ...
        b.s(pathBuilderA, 13.0f, 18.17f, 13.9f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 15.0f, 7.34f, 15.0f, 9.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
