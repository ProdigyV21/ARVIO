...
public final class MonitorHeartKt {
    ...
    public static final ImageVector getMonitorHeart(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.MonitorHeart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(15.11f, 12.45f, 14.0f, 10.24f);
        pathBuilderJ.lineToRelative(-3.11f, 6.21f);
        pathBuilderJ.curveTo(10.72f, 16.79f, 10.38f, 17.0f, 10.0f, 17.0f);
        pathBuilderJ.reflectiveCurveToRelative(-0.72f, -0.21f, -0.89f, -0.55f);
        b.m(pathBuilderJ, 7.38f, 13.0f, 2.0f, 2.0f);
        a.o(pathBuilderJ, 2.0f, 3.0f, 16.0f, -3.0f);
        e.g(pathBuilderJ, 2.0f, -2.0f, -6.0f);
        pathBuilderJ.curveTo(15.62f, 13.0f, 15.28f, 12.79f, 15.11f, 12.45f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderB = a0.b.b(20.0f, 6.0f, 4.0f, 3.0f, 2.0f);
        pathBuilderB.verticalLineToRelative(2.0f);
        pathBuilderB.horizontalLineToRelative(6.0f);
        pathBuilderB.curveToRelative(0.38f, 0.0f, 0.72f, 0.21f, 0.89f, 0.55f);
        ...
        b.p(pathBuilderB, 16.62f, 11.0f, 22.0f, 9.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderB, -2.0f, 6.0f), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB2 = a0.b.b(20.0f, 18.0f, 4.0f, -3.0f, 2.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.p(pathBuilderB2, -3.0f, -2.0f, 18.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 14.89f, 7.55f), defaultFillType5, "", solidColor5, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw5, iM3813getBevelLxFBmk85, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
