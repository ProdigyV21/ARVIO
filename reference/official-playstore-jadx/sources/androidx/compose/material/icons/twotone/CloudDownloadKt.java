...
public final class CloudDownloadKt {
    ...
    public static final ImageVector getCloudDownload(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CloudDownload", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderR, 12.0f, 17.0f, -4.0f, -4.0f);
        a.o(pathBuilderR, 2.55f, -3.0f, 2.91f, 3.0f);
        ...
        b.w(pathBuilderA, 13.45f, 10.0f, -2.9f, 3.0f);
        pathBuilderA.lineTo(8.0f, 13.0f);
        pathBuilderA.lineToRelative(4.0f, 4.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.g(pathBuilderA, 4.0f, -4.0f, -2.55f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
