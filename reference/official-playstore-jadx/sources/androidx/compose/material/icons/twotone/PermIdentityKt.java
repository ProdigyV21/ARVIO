...
public final class PermIdentityKt {
    ...
    public static final ImageVector getPermIdentity(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PermIdentity", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(12.0f, 8.0f, -2.0f, 0.0f);
        ...
        w.a.j(pathBuilderA, 18.0f, 12.0f, -1.0f);
        ...
        a.p(pathBuilderA2, 18.0f, 18.0f, 6.0f, 18.0f);
        pathBuilderA2.verticalLineToRelative(-0.99f);
        pathBuilderA2.curveToRelative(0.2f, -0.72f, 3.3f, -2.01f, 6.0f, -2.01f);
        pathBuilderA2.reflectiveCurveToRelative(5.8f, 1.29f, 6.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.c(pathBuilderA2, 1.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
