...
public final class TimeToLeaveKt {
    ...
    public static final ImageVector getTimeToLeave(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.TimeToLeave", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(5.12f, 11.0f, -0.12f, 0.34f);
        b.A(pathBuilderR, 5.0f, 16.0f, 14.0f, -4.66f);
        d.C(pathBuilderR, -0.12f, -0.34f, 5.12f, 11.0f);
        pathBuilderR.moveTo(7.5f, 15.0f);
        pathBuilderR.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderR.reflectiveCurveTo(6.67f, 12.0f, 7.5f, 12.0f);
        pathBuilderR.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderR.reflectiveCurveTo(8.33f, 15.0f, 7.5f, 15.0f);
        pathBuilderR.close();
        pathBuilderR.moveTo(16.5f, 15.0f);
        pathBuilderR.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        ...
        pathBuilderA.moveTo(6.85f, 6.0f);
        a0.a.n(pathBuilderA, 10.29f, 1.04f, 3.0f, 5.81f);
        b.C(pathBuilderA, 1.04f, -3.0f, 19.0f, 16.0f);
        a0.a.D(pathBuilderA, 5.0f, -4.66f, 0.12f, -0.34f);
        pathBuilderA.horizontalLineToRelative(13.77f);
        pathBuilderA.lineToRelative(0.11f, 0.34f);
        ...
        PathBuilder pathBuilderB = a.b(7.5f, 13.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = a.b(16.5f, 13.5f, -1.5f, 0.0f);
