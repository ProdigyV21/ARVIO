...
public final class FileOpenKt {
    ...
    public static final ImageVector getFileOpen(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FileOpen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(15.0f, 14.0f, 3.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, -5.0f);
        pathBuilderR.lineToRelative(-5.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, -5.0f);
        pathBuilderR.lineToRelative(-7.0f, 0.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 0.0f, 16.0f, 9.0f, 0.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a0.b.v(pathBuilderQ, 8.0f, 6.0f, 6.0f, 6.0f);
        ...
        b.A(pathBuilderQ, 20.41f, 18.0f, 2.24f, -2.0f);
