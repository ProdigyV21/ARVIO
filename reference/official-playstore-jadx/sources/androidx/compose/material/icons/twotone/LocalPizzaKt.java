...
public final class LocalPizzaKt {
    ...
    public static final ImageVector getLocalPizza(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalPizza", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(5.51f, 6.36f, 12.0f, 17.92f);
        pathBuilderJ.lineToRelative(6.49f, -11.55f);
        pathBuilderJ.curveTo(16.68f, 4.85f, 14.38f, 4.0f, 12.0f, 4.0f);
        pathBuilderJ.reflectiveCurveToRelative(-4.68f, 0.85f, -6.49f, 2.36f);
        pathBuilderJ.close();
        pathBuilderJ.moveTo(9.0f, 8.5f);
        pathBuilderJ.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderJ.reflectiveCurveTo(8.17f, 5.5f, 9.0f, 5.5f);
        pathBuilderJ.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderJ.reflectiveCurveTo(9.82f, 8.5f, 9.0f, 8.5f);
        pathBuilderJ.close();
        pathBuilderJ.moveTo(13.5f, 13.0f);
        pathBuilderJ.curveToRelative(0.0f, 0.83f, -0.68f, 1.5f, -1.5f, 1.5f);
        pathBuilderJ.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA, -1.5f, 0.67f, -1.5f, 1.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
