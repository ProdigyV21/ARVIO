...
public final class PersonOutlineKt {
    ...
    public static final ImageVector getPersonOutline(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PersonOutline", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(12.0f, 8.0f, -2.1f, 0.0f);
        ...
        PathBuilder pathBuilderA = c.a(12.0f, 14.9f);
        pathBuilderA.curveToRelative(-2.97f, 0.0f, -6.1f, 1.46f, -6.1f, 2.1f);
        f.t(pathBuilderA, 1.1f, 12.2f, 17.0f);
        pathBuilderA.curveToRelative(0.0f, -0.64f, -3.13f, -2.1f, -6.1f, -2.1f);
        pathBuilderA.close();
        ...
        a.p(pathBuilderA2, 18.1f, 18.1f, 5.9f, 18.1f);
        pathBuilderA2.lineTo(5.9f, 17.0f);
        pathBuilderA2.curveToRelative(0.0f, -0.64f, 3.13f, -2.1f, 6.1f, -2.1f);
        pathBuilderA2.reflectiveCurveToRelative(6.1f, 1.46f, 6.1f, 2.1f);
        b.f(pathBuilderA2, 1.1f, 12.0f, 12.0f);
        ...
        pathBuilderA2.reflectiveCurveToRelative(1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 5.9f);
        pathBuilderA2.curveToRelative(1.16f, 0.0f, 2.1f, 0.94f, 2.1f, 2.1f);
        pathBuilderA2.curveToRelative(0.0f, 1.16f, -0.94f, 2.1f, -2.1f, 2.1f);
        pathBuilderA2.reflectiveCurveTo(9.9f, 9.16f, 9.9f, 8.0f);
        pathBuilderA2.curveToRelative(0.0f, -1.16f, 0.94f, -2.1f, 2.1f, -2.1f);
        pathBuilderA2.close();
