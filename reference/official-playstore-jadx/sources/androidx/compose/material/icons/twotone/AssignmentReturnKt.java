...
public final class AssignmentReturnKt {
    ...
    public static final ImageVector getAssignmentReturn(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AssignmentReturn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.C(pathBuilderA, 16.0f, 14.0f, -4.0f, 3.0f);
        ...
        PathBuilder pathBuilderR = a.r(12.0f, 7.0f, -5.0f, 5.0f);
        b.u(pathBuilderR, 5.0f, 5.0f, -3.0f, 4.0f);
        e.D(pathBuilderR, -4.0f, -4.0f, 19.0f, 3.0f);
