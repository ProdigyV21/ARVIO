...
public final class TimelapseKt {
    ...
    public static final ImageVector getTimelapse(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Timelapse", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(12.0f, 3.99f);
        ...
        pathBuilderA.reflectiveCurveToRelative(-3.58f, -8.0f, -8.0f, -8.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.25f, 16.23f);
        pathBuilderA.curveToRelative(-2.35f, 2.34f, -6.15f, 2.34f, -8.49f, 0.0f);
        pathBuilderA.lineTo(12.0f, 11.99f);
        pathBuilderA.verticalLineToRelative(-6.0f);
        pathBuilderA.curveToRelative(1.54f, 0.0f, 3.07f, 0.59f, 4.24f, 1.76f);
        pathBuilderA.curveToRelative(2.35f, 2.34f, 2.35f, 6.14f, 0.01f, 8.48f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(16.24f, 7.75f);
        pathBuilderA2.curveToRelative(-1.17f, -1.17f, -2.7f, -1.76f, -4.24f, -1.76f);
        pathBuilderA2.verticalLineToRelative(6.0f);
        pathBuilderA2.lineToRelative(-4.24f, 4.24f);
        pathBuilderA2.curveToRelative(2.34f, 2.34f, 6.14f, 2.34f, 8.49f, 0.0f);
        pathBuilderA2.curveToRelative(2.34f, -2.34f, 2.34f, -6.14f, -0.01f, -8.48f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 1.99f);
        ...
        pathBuilderA2.reflectiveCurveToRelative(-4.48f, -10.0f, -10.0f, -10.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 19.99f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA2, -3.58f, 8.0f, -8.0f, 8.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
