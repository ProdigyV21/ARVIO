...
public final class PersonAddKt {
    ...
    public static final ImageVector getPersonAdd(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PersonAdd", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(15.0f, 16.0f);
        ...
        PathBuilder pathBuilderB = a.b(15.0f, 8.0f, -2.0f, 0.0f);
        ...
        pathBuilderA2.reflectiveCurveToRelative(1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(15.0f, 6.0f);
        ...
        c.z(pathBuilderA2, 9.0f, 18.0f, 6.0f, 15.0f);
        e.l(pathBuilderA2, -3.0f, 3.0f, -2.0f);
        pathBuilderA2.lineTo(6.0f, 10.0f);
        pathBuilderA2.lineTo(6.0f, 7.0f);
        pathBuilderA2.lineTo(4.0f, 7.0f);
        d.r(pathBuilderA2, 3.0f, 1.0f, 10.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.s(pathBuilderA2, 3.0f, 3.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
