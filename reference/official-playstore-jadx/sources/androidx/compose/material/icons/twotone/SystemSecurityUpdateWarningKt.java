...
public final class SystemSecurityUpdateWarningKt {
    ...
    public static final ImageVector getSystemSecurityUpdateWarning(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SystemSecurityUpdateWarning", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderK = a.k(11.0f, 7.0f, 2.0f, 6.0f, -2.0f);
        a.D(pathBuilderK, 7.0f, 11.0f, 15.0f, 2.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.p(pathBuilderK, 2.0f, -2.0f, 15.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderJ, 10.0f, 4.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw3 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk83 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderH = d.h(7.0f, 21.0f, 10.0f, -1.0f, 7.0f);
        w.a.k(pathBuilderH, 21.0f, 7.0f, 3.0f, 1.0f);
        pathBuilderH.horizontalLineToRelative(10.0f);
        pathBuilderH.verticalLineTo(3.0f);
        pathBuilderH.horizontalLineTo(7.0f);
        pathBuilderH.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderH.getNodes(), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
