...
public final class SentimentSatisfiedAltKt {
    ...
    public static final ImageVector getSentimentSatisfiedAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SentimentSatisfiedAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA2.curveToRelative(-1.48f, 0.0f, -2.75f, -0.81f, -3.45f, -2.0f);
        pathBuilderA2.lineTo(6.88f, 14.0f);
        pathBuilderA2.curveToRelative(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        pathBuilderA2.reflectiveCurveToRelative(4.32f, -1.45f, 5.12f, -3.5f);
        pathBuilderA2.horizontalLineToRelative(-1.67f);
        pathBuilderA2.curveToRelative(-0.69f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(11.99f, 2.0f);
