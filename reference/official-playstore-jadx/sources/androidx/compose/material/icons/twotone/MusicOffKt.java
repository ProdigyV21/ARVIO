...
public final class MusicOffKt {
    ...
    public static final ImageVector getMusicOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.MusicOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(10.0f, 17.0f, -2.0f, 0.0f);
        ...
        PathBuilder pathBuilderI = e.i(14.0f, 7.0f, 4.0f, 18.0f, 3.0f);
        b.r(pathBuilderI, -6.0f, 4.61f, 2.0f, 2.0f);
        pathBuilderI.moveTo(12.0f, 10.44f);
        pathBuilderI.lineTo(4.41f, 2.86f);
        pathBuilderI.lineTo(3.0f, 4.27f);
        pathBuilderI.lineToRelative(9.0f, 9.0f);
        pathBuilderI.verticalLineToRelative(0.28f);
        ...
        pathBuilderI.verticalLineToRelative(-1.58f);
        pathBuilderI.lineTo(19.73f, 21.0f);
        d.C(pathBuilderI, 1.41f, -1.41f, 12.0f, 10.44f);
        pathBuilderI.moveTo(10.0f, 19.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderI, -0.9f, 2.0f, -2.0f, 2.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
