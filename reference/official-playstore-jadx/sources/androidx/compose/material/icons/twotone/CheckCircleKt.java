...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CheckCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-3.59f, -8.0f, -8.0f, -8.0f);
        a.z(pathBuilderA, 10.0f, 17.0f, -4.0f, -4.0f);
        pathBuilderA.lineToRelative(1.41f, -1.41f);
        pathBuilderA.lineTo(10.0f, 14.17f);
        pathBuilderA.lineToRelative(6.59f, -6.59f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.v(pathBuilderA, 18.0f, 9.0f, -8.0f, 8.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.reflectiveCurveToRelative(-3.59f, 8.0f, -8.0f, 8.0f);
        a.p(pathBuilderA2, 16.59f, 7.58f, 10.0f, 14.17f);
        pathBuilderA2.lineToRelative(-2.59f, -2.58f);
        pathBuilderA2.lineTo(6.0f, 13.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderA2, 4.0f, 4.0f, 8.0f, -8.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
