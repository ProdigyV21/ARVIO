...
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DateRange", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = d.a(7.0f, 11.0f, 2.0f, 2.0f);
        c.z(pathBuilderA, 7.0f, 13.0f, 19.0f, 4.0f);
        c.A(pathBuilderA, -1.0f, 18.0f, 2.0f, -2.0f);
        ...
        b.g(pathBuilderA, 5.0f, 10.0f, 14.0f, 10.0f);
        pathBuilderA.moveTo(19.0f, 8.0f);
        pathBuilderA.lineTo(5.0f, 8.0f);
        b.g(pathBuilderA, 5.0f, 6.0f, 14.0f, 2.0f);
        a.C(pathBuilderA, 15.0f, 11.0f, 2.0f, 2.0f);
        e.r(pathBuilderA, -2.0f, 11.0f, 11.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, f.c(pathBuilderA, 2.0f, -2.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
