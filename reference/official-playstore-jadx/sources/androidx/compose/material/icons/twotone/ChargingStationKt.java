...
public final class ChargingStationKt {
    ...
    public static final ImageVector getChargingStation(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ChargingStation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = f.b(17.0f, 3.0f, 1.0f, 7.0f, 3.0f);
        f.s(pathBuilderB, 17.0f, 17.0f, 20.0f, 7.0f);
        ...
        a.s(pathBuilderS, 14.5f, 17.0f, 3.0f, 7.0f);
        f.t(pathBuilderS, 1.0f, 10.0f, 3.0f);
        v.a.A(pathBuilderS, 17.0f, 20.0f, 7.0f, 1.0f);
        pathBuilderS.horizontalLineToRelative(10.0f);
        pathBuilderS.verticalLineTo(20.0f);
        pathBuilderS.moveTo(17.0f, 1.0f);
        ...
        pathBuilderS.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        a.w(pathBuilderS, 17.0f, 17.0f, 1.0f);
        e.m(pathBuilderS, 7.0f, 18.0f, 10.0f, 6.0f);
        pathBuilderS.horizontalLineTo(7.0f);
