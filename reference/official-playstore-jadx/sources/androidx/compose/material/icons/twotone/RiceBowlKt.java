...
public final class RiceBowlKt {
    ...
    public static final ImageVector getRiceBowl(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.RiceBowl", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.n(pathBuilderA, 14.0f, 18.88f, 20.0f, -4.0f);
        pathBuilderA.verticalLineToRelative(-1.12f);
        ...
        PathBuilder pathBuilderA2 = c.a(19.66f, 14.0f);
        pathBuilderA2.curveToRelative(-0.66f, 1.92f, -2.24f, 3.54f, -4.4f, 4.39f);
        b.n(pathBuilderA2, 14.0f, 18.88f, 20.0f, -4.0f);
        pathBuilderA2.verticalLineToRelative(-1.12f);
        pathBuilderA2.lineToRelative(-1.27f, -0.5f);
        pathBuilderA2.curveToRelative(-2.16f, -0.85f, -3.74f, -2.47f, -4.4f, -4.39f);
        pathBuilderA2.horizontalLineTo(19.66f);
        pathBuilderA2.moveTo(12.0f, 2.0f);
        pathBuilderA2.curveTo(6.48f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        pathBuilderA2.curveToRelative(0.0f, 3.69f, 2.47f, 6.86f, 6.0f, 8.25f);
        a.j(pathBuilderA2, 22.0f, 8.0f, -1.75f);
        pathBuilderA2.curveToRelative(3.53f, -1.39f, 6.0f, -4.56f, 6.0f, -8.25f);
        pathBuilderA2.horizontalLineToRelative(0.0f);
        pathBuilderA2.curveTo(22.0f, 6.48f, 17.52f, 2.0f, 12.0f, 2.0f);
        c.z(pathBuilderA2, 12.0f, 2.0f, 10.0f, 12.0f);
        pathBuilderA2.verticalLineTo(4.26f);
        pathBuilderA2.curveTo(10.64f, 4.1f, 11.31f, 4.0f, 12.0f, 4.0f);
        pathBuilderA2.reflectiveCurveToRelative(1.36f, 0.1f, 2.0f, 0.26f);
        pathBuilderA2.verticalLineTo(12.0f);
        pathBuilderA2.horizontalLineTo(10.0f);
        pathBuilderA2.lineTo(10.0f, 12.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(16.0f, 12.0f);
        pathBuilderA2.verticalLineTo(5.08f);
        pathBuilderA2.curveToRelative(2.39f, 1.39f, 4.0f, 3.96f, 4.0f, 6.92f);
        a.w(pathBuilderA2, 16.0f, 16.0f, 12.0f);
        pathBuilderA2.moveTo(4.0f, 12.0f);
        pathBuilderA2.curveToRelative(0.0f, -2.95f, 1.61f, -5.53f, 4.0f, -6.92f);
        pathBuilderA2.verticalLineTo(12.0f);
