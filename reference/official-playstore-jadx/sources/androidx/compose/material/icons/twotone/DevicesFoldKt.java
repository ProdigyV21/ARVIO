...
public final class DevicesFoldKt {
    ...
    public static final ImageVector getDevicesFold(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DevicesFold", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(a.r(15.0f, 3.0f, -3.0f, 1.29f), 0.0f, 13.68f, 3.0f, -1.29f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.p(pathBuilderA, 12.0f, 4.29f, 15.0f, 3.0f);
        a0.b.o(pathBuilderA, 13.68f, -3.0f, 1.29f, 4.29f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, f.m(pathBuilderA, 5.0f, 3.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
