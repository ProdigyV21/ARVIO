...
public final class RestaurantMenuKt {
    ...
    public static final ImageVector getRestaurantMenu(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.RestaurantMenu", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.C(pathBuilderR, 4.19f, 4.18f, 20.15f, 10.15f);
        ...
        pathBuilderR.lineToRelative(1.41f, -1.41f);
        pathBuilderR.lineTo(13.41f, 13.0f);
        pathBuilderR.lineToRelative(1.47f, -1.47f);
