...
public final class FmdGoodKt {
    ...
    public static final ImageVector getFmdGood(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FmdGood", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA2.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderA2.curveTo(14.0f, 8.9f, 13.1f, 8.0f, 12.0f, 8.0f);
        pathBuilderA2.close();
        ...
        pathBuilderA2.curveTo(20.0f, 5.22f, 16.2f, 2.0f, 12.0f, 2.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 19.33f);
        pathBuilderA2.curveToRelative(-4.05f, -3.7f, -6.0f, -6.79f, -6.0f, -9.14f);
        pathBuilderA2.curveTo(6.0f, 6.57f, 8.65f, 4.0f, 12.0f, 4.0f);
        pathBuilderA2.reflectiveCurveToRelative(6.0f, 2.57f, 6.0f, 6.2f);
        pathBuilderA2.curveTo(18.0f, 12.54f, 16.05f, 15.64f, 12.0f, 19.33f);
        pathBuilderA2.close();
