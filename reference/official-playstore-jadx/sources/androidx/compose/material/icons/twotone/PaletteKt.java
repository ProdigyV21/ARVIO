...
public final class PaletteKt {
    ...
    public static final ImageVector getPalette(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Palette", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(6.5f, 13.0f);
        pathBuilderA.curveTo(5.67f, 13.0f, 5.0f, 12.33f, 5.0f, 11.5f);
        pathBuilderA.reflectiveCurveTo(5.67f, 10.0f, 6.5f, 10.0f);
        ...
        pathBuilderA.curveTo(8.67f, 9.0f, 8.0f, 8.33f, 8.0f, 7.5f);
        pathBuilderA.reflectiveCurveTo(8.67f, 6.0f, 9.5f, 6.0f);
        pathBuilderA.reflectiveCurveTo(11.0f, 6.67f, 11.0f, 7.5f);
        pathBuilderA.reflectiveCurveTo(10.33f, 9.0f, 9.5f, 9.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(14.5f, 9.0f);
        pathBuilderA.curveTo(13.67f, 9.0f, 13.0f, 8.33f, 13.0f, 7.5f);
        pathBuilderA.reflectiveCurveTo(13.67f, 6.0f, 14.5f, 6.0f);
        pathBuilderA.reflectiveCurveTo(16.0f, 6.67f, 16.0f, 7.5f);
        pathBuilderA.reflectiveCurveTo(15.33f, 9.0f, 14.5f, 9.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(19.0f, 11.5f);
        pathBuilderA.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilderA.reflectiveCurveTo(16.0f, 12.33f, 16.0f, 11.5f);
        pathBuilderA.reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 19.0f, 10.67f, 19.0f, 11.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.curveToRelative(0.0f, -0.61f, -0.23f, -1.21f, -0.64f, -1.67f);
        pathBuilderA2.curveToRelative(-0.08f, -0.09f, -0.13f, -0.21f, -0.13f, -0.33f);
        ...
        pathBuilderA2.curveTo(22.0f, 6.04f, 17.51f, 2.0f, 12.0f, 2.0f);
        a.g(pathBuilderA2, 16.0f, 15.0f, -1.77f);
        pathBuilderA2.curveToRelative(-1.38f, 0.0f, -2.5f, 1.12f, -2.5f, 2.5f);
        pathBuilderA2.curveToRelative(0.0f, 0.61f, 0.22f, 1.19f, 0.63f, 1.65f);
        pathBuilderA2.curveToRelative(0.06f, 0.07f, 0.14f, 0.19f, 0.14f, 0.35f);
        pathBuilderA2.curveToRelative(0.0f, 0.28f, -0.22f, 0.5f, -0.5f, 0.5f);
        ...
        pathBuilderA2.reflectiveCurveToRelative(8.0f, 3.14f, 8.0f, 7.0f);
        pathBuilderA2.curveTo(20.0f, 13.21f, 18.21f, 15.0f, 16.0f, 15.0f);
        pathBuilderA2.close();
        ...
        pathBuilderB4.arcToRelative(1.5f, 1.5f, 0.0f, true, true, -3.0f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderB4.getNodes(), defaultFillType6, "", solidColor6, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw6, iM3813getBevelLxFBmk86, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
