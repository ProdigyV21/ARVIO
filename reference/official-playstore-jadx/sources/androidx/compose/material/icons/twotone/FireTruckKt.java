...
public final class FireTruckKt {
    ...
    public static final ImageVector getFireTruck(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FireTruck", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(3.0f, 16.0f, 1.78f);
        ...
        PathBuilder pathBuilderA2 = a.a(14.0f, 16.0f, 0.78f);
        pathBuilderA2.curveToRelative(0.55f, -0.61f, 1.34f, -1.0f, 2.22f, -1.0f);
        pathBuilderA2.reflectiveCurveToRelative(1.67f, 0.39f, 2.22f, 1.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, y.a.f(pathBuilderA2, 21.0f, -3.0f, -7.0f, 16.0f), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        w.a.r(pathBuilderR, 12.0f, 16.0f, 9.22f);
        pathBuilderR.curveTo(8.67f, 15.39f, 7.89f, 15.0f, 7.0f, 15.0f);
        pathBuilderR.reflectiveCurveToRelative(-1.67f, 0.39f, -2.22f, 1.0f);
        c.k(pathBuilderR, 3.0f, -3.0f, 9.0f, 16.0f);
        pathBuilderR.moveTo(14.0f, 7.0f);
        a0.a.n(pathBuilderR, 5.56f, 1.33f, 4.0f, 14.0f);
        f.r(pathBuilderR, 7.0f, 17.0f, 19.0f);
        pathBuilderR.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderR.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderR.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderR.reflectiveCurveTo(17.55f, 19.0f, 17.0f, 19.0f);
        a.g(pathBuilderR, 21.0f, 16.0f, -1.78f);
        pathBuilderR.curveToRelative(-0.55f, -0.61f, -1.34f, -1.0f, -2.22f, -1.0f);
        pathBuilderR.reflectiveCurveToRelative(-1.67f, 0.39f, -2.22f, 1.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, y.a.f(pathBuilderR, 14.0f, -3.0f, 7.0f, 16.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.m(pathBuilderK, 8.5f, 8.5f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
