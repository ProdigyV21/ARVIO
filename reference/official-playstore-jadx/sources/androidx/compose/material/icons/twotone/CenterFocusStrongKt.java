...
public final class CenterFocusStrongKt {
    ...
    public static final ImageVector getCenterFocusStrong(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CenterFocusStrong", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(7.0f, 12.0f);
        ...
        c.q(pathBuilderA, 4.0f, -2.0f, 5.0f, 19.0f);
        d.g(pathBuilderA, -4.0f, 3.0f, 15.0f, 4.0f);
        c.m(pathBuilderA, 3.0f, 5.0f, 4.0f, 2.0f);
        ...
        d.q(pathBuilderA, 2.0f, 21.0f, 5.0f);
        a.C(pathBuilderA, 19.0f, 19.0f, -4.0f, 2.0f);
        pathBuilderA.horizontalLineToRelative(4.0f);
        pathBuilderA.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.t(pathBuilderA, -4.0f, -2.0f, 4.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
