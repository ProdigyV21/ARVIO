...
public final class SimCardAlertKt {
    ...
    public static final ImageVector getSimCardAlert(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SimCardAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.a.C(pathBuilderM, 11.0f, 8.0f, 2.0f, 5.0f);
        c.D(pathBuilderM, -2.0f, 8.0f, 11.0f, 15.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.f(pathBuilderM, 2.0f, 2.0f, -2.0f, 15.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
