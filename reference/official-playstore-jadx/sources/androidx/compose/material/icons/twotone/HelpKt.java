...
public final class HelpKt {
    ...
    public static final ImageVector getHelp(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Help", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.B(pathBuilderA, 2.0f, 2.0f, 13.0f, 15.0f);
        ...
        pathBuilderB.curveToRelative(0.0f, 2.0f, -3.0f, 1.75f, -3.0f, 5.0f);
        pathBuilderB.horizontalLineToRelative(2.0f);
        pathBuilderB.curveToRelative(0.0f, -2.25f, 3.0f, -2.5f, 3.0f, -5.0f);
