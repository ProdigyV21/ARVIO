...
public final class NextPlanKt {
    ...
    public static final ImageVector getNextPlan(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.NextPlan", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 13.0f, 14.0f, 2.26f, -2.26f);
        pathBuilderA.curveTo(14.35f, 10.68f, 13.01f, 10.0f, 11.5f, 10.0f);
        pathBuilderA.curveToRelative(-2.37f, 0.0f, -4.35f, 1.66f, -4.86f, 3.88f);
        pathBuilderA.lineToRelative(-0.96f, -0.32f);
        pathBuilderA.curveTo(6.32f, 10.95f, 8.68f, 9.0f, 11.5f, 9.0f);
        ...
        PathBuilder pathBuilderA3 = c.a(15.97f, 11.03f);
        pathBuilderA3.curveTo(14.87f, 9.79f, 13.28f, 9.0f, 11.5f, 9.0f);
        pathBuilderA3.curveToRelative(-2.82f, 0.0f, -5.18f, 1.95f, -5.82f, 4.56f);
        pathBuilderA3.lineToRelative(0.96f, 0.32f);
        pathBuilderA3.curveTo(7.15f, 11.66f, 9.13f, 10.0f, 11.5f, 10.0f);
        pathBuilderA3.curveToRelative(1.51f, 0.0f, 2.85f, 0.68f, 3.76f, 1.74f);
        e.B(pathBuilderA3, 13.0f, 14.0f, 5.0f, 9.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA3, 15.97f, 11.03f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
