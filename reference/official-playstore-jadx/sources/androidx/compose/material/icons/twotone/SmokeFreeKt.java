...
public final class SmokeFreeKt {
    ...
    public static final ImageVector getSmokeFree(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SmokeFree", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.a.g(pathBuilderS, 14.5f, 8.65f, 1.53f);
        ...
        v.a.g(pathBuilderS, 17.0f, 13.0f, -2.34f);
        c.z(pathBuilderS, 17.0f, 15.34f, 3.41f, 4.59f);
