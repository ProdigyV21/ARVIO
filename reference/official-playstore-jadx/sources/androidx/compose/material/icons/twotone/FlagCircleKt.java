...
public final class FlagCircleKt {
    ...
    public static final ImageVector getFlagCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FlagCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 13.0f, 15.0f, -1.0f, -2.0f);
        b.C(pathBuilderA, 9.5f, 5.0f, 8.0f, 7.0f);
        e.C(pathBuilderA, 6.0f, 1.0f, 2.0f, 3.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, y.a.d(pathBuilderA, 6.0f, 13.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB = y.a.b(15.0f, 9.0f, -1.0f, -2.0f, 8.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.b.i(pathBuilderB, 13.5f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
