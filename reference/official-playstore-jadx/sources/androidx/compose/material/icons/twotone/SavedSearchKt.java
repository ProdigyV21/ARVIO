...
public final class SavedSearchKt {
    ...
    public static final ImageVector getSavedSearch(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SavedSearch", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(9.5f, 6.0f, -0.79f, 2.44f);
        ...
        pathBuilderR.lineToRelative(2.01f, 1.53f);
        pathBuilderR.lineToRelative(-0.77f, -2.47f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 2.01f, -1.59f, -2.46f, 0.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
