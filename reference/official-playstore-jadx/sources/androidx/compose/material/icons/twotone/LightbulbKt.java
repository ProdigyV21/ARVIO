...
public final class LightbulbKt {
    ...
    public static final ImageVector getLightbulb(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Lightbulb", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(8.97f, 4.0f, 6.5f, 6.47f, 6.5f, 9.5f);
        pathBuilderA.curveToRelative(0.0f, 2.47f, 1.49f, 3.89f, 2.35f, 4.5f);
        pathBuilderA.horizontalLineToRelative(6.3f);
        pathBuilderA.curveToRelative(0.86f, -0.61f, 2.35f, -2.03f, 2.35f, -4.5f);
        pathBuilderA.curveTo(17.5f, 6.47f, 15.03f, 4.0f, 12.0f, 4.0f);
        pathBuilderA.close();
        ...
        pathBuilderA2.curveTo(10.0f, 21.1f, 10.9f, 22.0f, 12.0f, 22.0f);
        pathBuilderA2.close();
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.d(8.0f, 17.0f, 8.0f, 2.0f, -8.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m3498getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3803getButtKaPHkGw(), companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.g(pathBuilderA3, 15.15f, 14.0f, -6.3f);
        pathBuilderA3.curveTo(7.99f, 13.39f, 6.5f, 11.97f, 6.5f, 9.5f);
        pathBuilderA3.curveTo(6.5f, 6.47f, 8.97f, 4.0f, 12.0f, 4.0f);
        pathBuilderA3.reflectiveCurveToRelative(5.5f, 2.47f, 5.5f, 5.5f);
        pathBuilderA3.curveTo(17.5f, 11.97f, 16.01f, 13.39f, 15.15f, 14.0f);
        pathBuilderA3.close();
