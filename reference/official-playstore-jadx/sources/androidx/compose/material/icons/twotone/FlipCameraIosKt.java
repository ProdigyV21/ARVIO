...
public final class FlipCameraIosKt {
    ...
    public static final ImageVector getFlipCameraIos(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FlipCameraIos", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a0.a.e(pathBuilderP, 4.0f, 12.0f, 16.0f, 7.0f);
        d.q(pathBuilderP, -4.05f, 14.12f, 5.0f);
        pathBuilderP.moveTo(12.0f, 18.0f);
        pathBuilderP.curveToRelative(-2.76f, 0.0f, -5.0f, -2.24f, -5.0f, -5.0f);
        pathBuilderP.horizontalLineTo(5.0f);
        pathBuilderP.lineToRelative(2.49f, -2.49f);
        pathBuilderP.lineTo(7.5f, 10.5f);
        pathBuilderP.lineTo(10.0f, 13.0f);
        pathBuilderP.horizontalLineTo(9.97f);
        pathBuilderP.horizontalLineTo(8.0f);
        pathBuilderP.curveToRelative(0.0f, 2.21f, 1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderP.curveToRelative(0.58f, 0.0f, 1.13f, -0.13f, 1.62f, -0.35f);
        pathBuilderP.lineToRelative(0.74f, 0.74f);
        pathBuilderP.curveTo(13.65f, 17.76f, 12.86f, 18.0f, 12.0f, 18.0f);
        v.a.z(pathBuilderP, 19.0f, 13.0f, -2.49f, 2.49f);
        pathBuilderP.lineTo(16.5f, 15.5f);
        pathBuilderP.lineTo(14.0f, 13.0f);
        pathBuilderP.horizontalLineToRelative(0.03f);
        pathBuilderP.horizontalLineTo(16.0f);
        pathBuilderP.curveToRelative(0.0f, -2.21f, -1.79f, -4.0f, -4.0f, -4.0f);
        pathBuilderP.curveToRelative(-0.58f, 0.0f, -1.13f, 0.13f, -1.62f, 0.35f);
        pathBuilderP.lineTo(9.64f, 8.62f);
        pathBuilderP.curveTo(10.35f, 8.24f, 11.14f, 8.0f, 12.0f, 8.0f);
        pathBuilderP.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.l(pathBuilderP, 19.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
