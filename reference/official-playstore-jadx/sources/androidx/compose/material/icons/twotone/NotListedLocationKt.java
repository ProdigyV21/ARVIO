...
public final class NotListedLocationKt {
    ...
    public static final ImageVector getNotListedLocation(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.NotListedLocation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = c.a(12.01f, 16.0f);
        pathBuilderA2.curveToRelative(-0.27f, 0.0f, -0.52f, -0.1f, -0.71f, -0.29f);
        pathBuilderA2.curveToRelative(-0.2f, -0.2f, -0.29f, -0.43f, -0.29f, -0.71f);
        pathBuilderA2.curveToRelative(-0.01f, -0.55f, 0.43f, -0.99f, 0.98f, -1.0f);
        pathBuilderA2.curveToRelative(0.01f, 0.0f, 0.01f, 0.0f, 0.02f, 0.0f);
        pathBuilderA2.curveToRelative(0.28f, 0.0f, 0.51f, 0.1f, 0.71f, 0.29f);
        pathBuilderA2.curveToRelative(0.18f, 0.19f, 0.28f, 0.43f, 0.28f, 0.7f);
        pathBuilderA2.reflectiveCurveToRelative(-0.1f, 0.51f, -0.29f, 0.71f);
        pathBuilderA2.reflectiveCurveTo(12.28f, 16.0f, 12.01f, 16.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(11.13f, 12.34f);
        pathBuilderA2.curveToRelative(0.0f, -0.45f, 0.1f, -0.84f, 0.29f, -1.16f);
        pathBuilderA2.curveToRelative(0.19f, -0.33f, 0.53f, -0.7f, 1.0f, -1.12f);
        pathBuilderA2.curveToRelative(0.28f, -0.25f, 0.48f, -0.47f, 0.61f, -0.66f);
        pathBuilderA2.reflectiveCurveToRelative(0.19f, -0.4f, 0.19f, -0.64f);
        pathBuilderA2.curveToRelative(0.0f, -0.29f, -0.11f, -0.53f, -0.32f, -0.74f);
        pathBuilderA2.curveToRelative(-0.21f, -0.2f, -0.5f, -0.3f, -0.85f, -0.3f);
        pathBuilderA2.curveToRelative(-0.37f, 0.0f, -0.74f, 0.1f, -0.96f, 0.3f);
        pathBuilderA2.curveToRelative(-0.21f, 0.2f, -0.4f, 0.45f, -0.4f, 0.98f);
        pathBuilderA2.horizontalLineTo(9.0f);
        pathBuilderA2.curveToRelative(0.0f, -1.01f, 0.46f, -1.73f, 0.97f, -2.21f);
        pathBuilderA2.curveTo(10.53f, 6.28f, 11.25f, 6.0f, 12.0f, 6.0f);
        pathBuilderA2.curveToRelative(0.59f, 0.0f, 1.11f, 0.12f, 1.57f, 0.35f);
        pathBuilderA2.curveTo(14.45f, 6.78f, 15.0f, 7.68f, 15.0f, 8.66f);
        pathBuilderA2.curveToRelative(0.0f, 0.49f, -0.1f, 0.9f, -0.31f, 1.25f);
        pathBuilderA2.reflectiveCurveTo(14.21f, 10.62f, 13.8f, 11.0f);
        pathBuilderA2.curveToRelative(-0.32f, 0.3f, -0.53f, 0.56f, -0.65f, 0.77f);
        pathBuilderA2.reflectiveCurveToRelative(-0.18f, 0.49f, -0.18f, 0.81f);
        f.z(pathBuilderA2, 13.0f, -1.85f, -0.66f, 11.13f);
