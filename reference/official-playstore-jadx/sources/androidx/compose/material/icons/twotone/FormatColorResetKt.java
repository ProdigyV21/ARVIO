...
public final class FormatColorResetKt {
    ...
    public static final ImageVector getFormatColorReset(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FormatColorReset", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(10.93f, 7.83f, 4.77f, 4.77f);
        pathBuilderR.curveToRelative(-0.62f, -1.81f, -2.17f, -4.24f, -3.71f, -6.24f);
        pathBuilderR.curveToRelative(-0.35f, 0.47f, -0.71f, 0.96f, -1.06f, 1.47f);
        pathBuilderR.close();
        pathBuilderR.moveTo(12.0f, 18.0f);
        pathBuilderR.curveToRelative(0.96f, 0.0f, 1.83f, -0.36f, 2.53f, -0.92f);
        pathBuilderR.lineToRelative(-5.72f, -5.72f);
        pathBuilderR.curveTo(8.32f, 12.38f, 8.0f, 13.31f, 8.0f, 14.0f);
