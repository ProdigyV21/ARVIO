...
public final class EventAvailableKt {
    ...
    public static final ImageVector getEventAvailable(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.EventAvailable", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.moveTo(16.49f, 11.53f);
        pathBuilderI.lineToRelative(-1.06f, -1.06f);
        pathBuilderI.lineToRelative(-4.87f, 4.87f);
        pathBuilderI.lineToRelative(-2.11f, -2.11f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderI, -1.06f, 1.06f, 3.17f, 3.17f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
