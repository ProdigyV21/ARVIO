...
public final class GasMeterKt {
    ...
    public static final ImageVector getGasMeter(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.GasMeter", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderQ = a.q(16.0f, 6.0f, 8.0f);
        pathBuilderQ.curveTo(6.9f, 6.0f, 6.0f, 6.9f, 6.0f, 8.0f);
        ...
        pathBuilderQ.curveTo(18.0f, 6.9f, 17.1f, 6.0f, 16.0f, 6.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.0f, 18.0f);
        pathBuilderQ.curveToRelative(-1.38f, 0.0f, -2.5f, -1.1f, -2.5f, -2.46f);
        pathBuilderQ.curveToRelative(0.0f, -1.09f, 0.43f, -1.39f, 2.5f, -3.79f);
        pathBuilderQ.curveToRelative(2.05f, 2.38f, 2.5f, 2.7f, 2.5f, 3.79f);
        pathBuilderQ.curveTo(14.5f, 16.9f, 13.38f, 18.0f, 12.0f, 18.0f);
        f.o(pathBuilderQ, 16.0f, 10.0f, 8.0f, 8.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderQ, 8.0f, 10.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderU = a0.a.u(16.0f, 4.0f, -1.0f, 2.0f, -2.0f);
        ...
        pathBuilderU.horizontalLineToRelative(8.0f);
        pathBuilderU.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderU, 18.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
