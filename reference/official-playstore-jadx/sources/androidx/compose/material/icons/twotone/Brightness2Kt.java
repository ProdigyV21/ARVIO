...
public final class Brightness2Kt {
    ...
    public static final ImageVector getBrightness2(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Brightness2", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(10.9f, 6.23f, 12.0f, 9.05f, 12.0f, 12.0f);
        pathBuilderA.curveToRelative(0.0f, 2.95f, -1.1f, 5.77f, -3.01f, 7.93f);
        pathBuilderA.curveToRelative(0.33f, 0.05f, 0.67f, 0.07f, 1.01f, 0.07f);
        ...
        PathBuilder pathBuilderA2 = c.a(5.0f, 20.65f);
        pathBuilderA2.curveTo(6.47f, 21.5f, 8.18f, 22.0f, 10.0f, 22.0f);
        pathBuilderA2.curveToRelative(5.52f, 0.0f, 10.0f, -4.48f, 10.0f, -10.0f);
        pathBuilderA2.reflectiveCurveTo(15.52f, 2.0f, 10.0f, 2.0f);
        pathBuilderA2.curveToRelative(-1.82f, 0.0f, -3.53f, 0.5f, -5.0f, 1.35f);
        pathBuilderA2.curveTo(7.99f, 5.08f, 10.0f, 8.3f, 10.0f, 12.0f);
        pathBuilderA2.reflectiveCurveToRelative(-2.01f, 6.92f, -5.0f, 8.65f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 12.0f);
        pathBuilderA2.curveToRelative(0.0f, -2.95f, -1.1f, -5.77f, -3.01f, -7.93f);
        pathBuilderA2.curveTo(9.32f, 4.02f, 9.66f, 4.0f, 10.0f, 4.0f);
        ...
        pathBuilderA2.curveTo(10.9f, 17.77f, 12.0f, 14.95f, 12.0f, 12.0f);
        pathBuilderA2.close();
