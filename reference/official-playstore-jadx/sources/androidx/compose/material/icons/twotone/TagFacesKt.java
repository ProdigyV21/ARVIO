...
public final class TagFacesKt {
    ...
    public static final ImageVector getTagFaces(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.TagFaces", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-3.58f, -8.0f, -8.0f, -8.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(15.5f, 8.0f);
        ...
        PathBuilder pathBuilderB = a.b(8.5f, 9.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderA2 = c.a(12.0f, 17.5f);
        pathBuilderA2.curveToRelative(2.33f, 0.0f, 4.31f, -1.46f, 5.11f, -3.5f);
        pathBuilderA2.horizontalLineTo(6.89f);
        pathBuilderA2.curveToRelative(0.8f, 2.04f, 2.78f, 3.5f, 5.11f, 3.5f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderB2 = a.b(15.5f, 9.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderA3 = c.a(11.99f, 2.0f);
        pathBuilderA3.curveTo(6.47f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        pathBuilderA3.reflectiveCurveToRelative(4.47f, 10.0f, 9.99f, 10.0f);
        pathBuilderA3.curveTo(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        pathBuilderA3.reflectiveCurveTo(17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilderA3.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA3, -3.58f, 8.0f, -8.0f, 8.0f), defaultFillType5, "", solidColor5, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw5, iM3813getBevelLxFBmk85, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
