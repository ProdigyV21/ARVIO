...
public final class RingVolumeKt {
    ...
    public static final ImageVector getRingVolume(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.RingVolume", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.66f, 0.37f, 1.28f, 0.79f, 1.87f, 1.27f);
        ...
        pathBuilderA2.curveTo(7.46f, 12.0f, 3.34f, 13.78f, 0.29f, 16.67f);
        ...
        pathBuilderA2.curveToRelative(1.6f, 0.0f, 3.15f, 0.25f, 4.6f, 0.72f);
        pathBuilderA2.verticalLineToRelative(3.1f);
        pathBuilderA2.curveToRelative(0.0f, 0.39f, 0.23f, 0.74f, 0.56f, 0.9f);
        pathBuilderA2.curveToRelative(0.98f, 0.49f, 1.87f, 1.12f, 2.66f, 1.85f);
        ...
        pathBuilderA2.lineToRelative(2.48f, -2.48f);
        pathBuilderA2.curveToRelative(0.18f, -0.18f, 0.29f, -0.43f, 0.29f, -0.71f);
        pathBuilderA2.curveToRelative(0.0f, -0.27f, -0.11f, -0.52f, -0.29f, -0.7f);
        ...
        b.f(pathBuilderA2, 1.7f, 20.47f, 18.49f);
        pathBuilderA2.curveToRelative(-0.59f, -0.48f, -1.21f, -0.9f, -1.87f, -1.27f);
        pathBuilderA2.verticalLineToRelative(-1.7f);
        pathBuilderA2.curveToRelative(1.04f, 0.51f, 2.03f, 1.15f, 2.94f, 1.9f);
        b.C(pathBuilderA2, -1.07f, 1.07f, 16.19f, 8.4f);
        pathBuilderA2.lineToRelative(1.41f, 1.41f);
        pathBuilderA2.reflectiveCurveToRelative(3.45f, -3.52f, 3.56f, -3.55f);
        b.D(pathBuilderA2, -1.41f, -1.41f, -3.56f, 3.55f);
        a.C(pathBuilderA2, 11.0f, 2.0f, 2.0f, 5.0f);
        f.x(pathBuilderA2, -2.0f, 6.4f, 9.81f);
        pathBuilderA2.lineTo(7.81f, 8.4f);
        pathBuilderA2.lineTo(4.26f, 4.84f);
        pathBuilderA2.lineTo(2.84f, 6.26f);
        pathBuilderA2.curveToRelative(0.11f, 0.03f, 3.56f, 3.55f, 3.56f, 3.55f);
        pathBuilderA2.close();
