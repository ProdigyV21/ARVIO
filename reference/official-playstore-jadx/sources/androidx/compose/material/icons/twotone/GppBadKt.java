...
public final class GppBadKt {
    ...
    public static final ImageVector getGppBad(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.GppBad", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderS, 12.0f, 10.59f, 9.91f, 8.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderI.moveTo(15.5f, 9.91f);
        pathBuilderI.lineTo(13.42f, 12.0f);
        pathBuilderI.lineToRelative(2.08f, 2.09f);
        pathBuilderI.lineToRelative(-1.41f, 1.41f);
        pathBuilderI.lineTo(12.0f, 13.42f);
        pathBuilderI.lineTo(9.91f, 15.5f);
        pathBuilderI.lineTo(8.5f, 14.09f);
        pathBuilderI.lineTo(10.59f, 12.0f);
        pathBuilderI.lineTo(8.5f, 9.91f);
        pathBuilderI.lineTo(9.91f, 8.5f);
        pathBuilderI.lineTo(12.0f, 10.59f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderI, 2.09f, -2.09f, 15.5f, 9.91f), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
