...
public final class ModeKt {
    ...
    public static final ImageVector getMode(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Mode", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(w.a.n(14.06f, 9.02f, 5.0f, 18.08f, 19.0f), 0.92f, 9.06f, -9.06f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        b.C(pathBuilderA, -2.34f, -2.34f, 17.81f, 9.94f);
        pathBuilderA.lineToRelative(-3.75f, -3.75f);
        pathBuilderA.lineTo(3.0f, 17.25f);
        pathBuilderA.lineTo(3.0f, 21.0f);
        d.q(pathBuilderA, 3.75f, 17.81f, 9.94f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.f(pathBuilderA, 5.92f, 19.0f, 5.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
