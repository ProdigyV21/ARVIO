...
public final class LocalPhoneKt {
    ...
    public static final ImageVector getLocalPhone(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalPhone", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.f(pathBuilderA, -1.49f, 6.99f, 7.59f);
        pathBuilderA.curveToRelative(-0.24f, -0.83f, -0.39f, -1.7f, -0.45f, -2.59f);
        pathBuilderA.horizontalLineToRelative(-1.5f);
        pathBuilderA.curveToRelative(0.09f, 1.32f, 0.35f, 2.59f, 0.75f, 3.8f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.c(pathBuilderA, 1.2f, -1.21f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA2 = c.a(3.0f, 4.0f);
        ...
        b.C(pathBuilderA2, 1.2f, -1.19f, 6.54f, 5.0f);
        pathBuilderA2.curveToRelative(0.06f, 0.89f, 0.21f, 1.76f, 0.45f, 2.59f);
        pathBuilderA2.lineToRelative(-1.2f, 1.2f);
        pathBuilderA2.curveToRelative(-0.41f, -1.2f, -0.67f, -2.47f, -0.76f, -3.79f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.d(pathBuilderA2, 1.51f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
