...
public final class PivotTableChartKt {
    ...
    public static final ImageVector getPivotTableChart(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PivotTableChart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderC = e.c(18.0f, 9.0f, -4.0f, 4.0f, 3.0f);
        pathBuilderC.verticalLineToRelative(2.0f);
        pathBuilderC.curveToRelative(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        f.y(pathBuilderC, -2.0f, -3.0f, -4.0f, 4.0f);
        b.u(pathBuilderC, 4.0f, 4.0f, -3.0f, 2.0f);
        pathBuilderC.curveToRelative(2.21f, 0.0f, 4.0f, -1.79f, 4.0f, -4.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.c(pathBuilderC, -2.0f, 3.0f, 18.0f, 9.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
