...
public final class ArrowCircleDownKt {
    ...
    public static final ImageVector getArrowCircleDown(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ArrowCircleDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 12.0f, 16.0f, -4.0f, -4.0f);
        e.C(pathBuilderA, 3.0f, 0.0f, -4.0f, 2.0f);
        pathBuilderA.lineToRelative(0.0f, 4.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, w.a.h(pathBuilderA, 3.0f, 12.0f, 16.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        c.z(pathBuilderA2, 12.0f, 2.0f, 13.0f, 12.0f);
        pathBuilderA2.lineToRelative(0.0f, -4.0f);
        a0.a.n(pathBuilderA2, -2.0f, 0.0f, 4.0f, 8.0f);
        pathBuilderA2.lineToRelative(4.0f, 4.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.b(pathBuilderA2, 4.0f, -4.0f, 13.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
