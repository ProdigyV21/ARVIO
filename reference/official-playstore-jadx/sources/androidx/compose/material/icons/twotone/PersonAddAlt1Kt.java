...
public final class PersonAddAlt1Kt {
    ...
    public static final ImageVector getPersonAddAlt1(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PersonAddAlt1", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = c.a(9.0f, 14.0f);
        pathBuilderA2.curveToRelative(-2.67f, 0.0f, -8.0f, 1.34f, -8.0f, 4.0f);
        e.l(pathBuilderA2, 2.0f, 16.0f, -2.0f);
        pathBuilderA2.curveTo(17.0f, 15.34f, 11.67f, 14.0f, 9.0f, 14.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(3.0f, 18.0f);
        pathBuilderA2.curveToRelative(0.2f, -0.71f, 3.3f, -2.0f, 6.0f, -2.0f);
        pathBuilderA2.curveToRelative(2.69f, 0.0f, 5.78f, 1.28f, 6.0f, 2.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderA2, 3.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderR = a.r(20.0f, 10.0f, 0.0f, -3.0f);
