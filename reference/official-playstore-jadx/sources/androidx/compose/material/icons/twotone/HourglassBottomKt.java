...
public final class HourglassBottomKt {
    ...
    public static final ImageVector getHourglassBottom(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.HourglassBottom", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(16.0f, 16.5f, -4.0f, -4.0f);
        ...
        PathBuilder pathBuilderR2 = a.r(16.0f, 16.5f, -4.0f, -4.0f);
        ...
        PathBuilder pathBuilderA = d.a(6.0f, 22.0f, 12.0f, -6.0f);
        ...
        c.e(pathBuilderA, -4.0f, 3.99f, 22.0f);
        e.o(pathBuilderA, 8.0f, 7.5f, 4.0f, 8.0f);
        pathBuilderA.verticalLineToRelative(3.5f);
        d.C(pathBuilderA, -4.0f, 4.0f, 8.0f, 7.5f);
        pathBuilderA.moveTo(8.0f, 16.5f);
        pathBuilderA.lineToRelative(4.0f, -4.0f);
        a0.b.m(pathBuilderA, 4.0f, 4.0f, 20.0f, 8.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderA, 16.5f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
