...
public final class AirportShuttleKt {
    ...
    public static final ImageVector getAirportShuttle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirportShuttle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(3.0f, 14.0f, 0.78f);
        ...
        pathBuilderA.horizontalLineToRelative(7.56f);
        pathBuilderA.curveToRelative(0.55f, -0.61f, 1.34f, -1.0f, 2.22f, -1.0f);
        pathBuilderA.reflectiveCurveToRelative(1.67f, 0.39f, 2.22f, 1.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.b.c(pathBuilderJ, 2.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
