...
public final class PlayArrowKt {
    ...
    public static final ImageVector getPlayArrow(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PlayArrow", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(8.0f, 19.0f, 11.0f, -7.0f);
        d.f(pathBuilderR, 8.0f, 5.0f, 14.0f);
        pathBuilderR.moveTo(10.0f, 8.64f);
        pathBuilderR.lineTo(15.27f, 12.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderR, 10.0f, 15.36f, 10.0f, 8.64f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
