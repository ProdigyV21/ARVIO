...
public final class BatchPredictionKt {
    ...
    public static final ImageVector getBatchPrediction(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.BatchPrediction", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderU = a.u(13.0f, 20.5f, -2.0f, 19.0f, 2.0f);
        v.a.D(pathBuilderU, 20.5f, 13.0f, 18.0f, -2.0f);
        pathBuilderU.curveToRelative(0.0f, -1.5f, -2.5f, -3.0f, -2.5f, -5.0f);
        pathBuilderU.curveToRelative(0.0f, -1.93f, 1.57f, -3.5f, 3.5f, -3.5f);
        pathBuilderU.curveToRelative(1.93f, 0.0f, 3.5f, 1.57f, 3.5f, 3.5f);
        pathBuilderU.curveTo(15.5f, 15.0f, 13.0f, 16.5f, 13.0f, 18.0f);
        pathBuilderU.close();
        ...
        PathBuilder pathBuilderQ = v.a.q(17.0f, 8.0f, 7.0f);
        ...
        v.a.u(pathBuilderQ, 13.0f, 20.5f, -2.0f, 19.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderQ, 17.0f, 3.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
