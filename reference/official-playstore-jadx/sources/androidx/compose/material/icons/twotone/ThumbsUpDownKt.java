...
public final class ThumbsUpDownKt {
    ...
    public static final ImageVector getThumbsUpDown(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ThumbsUpDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.d(pathBuilderA, 22.0f, 12.0f, 5.79f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderN = w.a.n(3.93f, 4.28f, 2.0f, 6.21f, 12.0f);
        b.x(pathBuilderN, 5.92f, 10.0f, 7.13f, 7.0f);
        a0.a.t(pathBuilderN, 3.36f, 14.0f, 16.87f, 17.0f);
        pathBuilderN.horizontalLineToRelative(6.64f);
        pathBuilderN.lineToRelative(-0.57f, 2.72f);
        pathBuilderN.lineTo(22.0f, 17.79f);
        pathBuilderN.verticalLineTo(12.0f);
        pathBuilderN.horizontalLineToRelative(-5.92f);
        pathBuilderN.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderN.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
