...
public final class HouseboatKt {
    ...
    public static final ImageVector getHouseboat(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Houseboat", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(13.0f, 13.0f, 0.0f, -2.0f);
        pathBuilderR.lineToRelative(-2.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, 2.0f);
        pathBuilderR.lineToRelative(-2.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, -4.82f);
        pathBuilderR.lineToRelative(3.0f, -2.2f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 3.0f, 2.2f, 0.0f, 4.82f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        c.m(pathBuilderA, 13.0f, 13.0f, -2.0f, -2.0f);
        w.a.y(pathBuilderA, 2.0f, 9.0f, 8.18f);
