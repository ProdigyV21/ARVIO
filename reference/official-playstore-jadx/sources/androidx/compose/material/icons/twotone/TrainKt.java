...
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Train", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.horizontalLineToRelative(11.13f);
        pathBuilderA.curveToRelative(-0.6f, -0.52f, -2.05f, -1.0f, -5.56f, -1.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(6.0f, 15.5f);
        ...
        pathBuilderA2.curveToRelative(-4.0f, 0.0f, -8.0f, 0.5f, -8.0f, 4.0f);
        pathBuilderA2.verticalLineToRelative(9.5f);
        pathBuilderA2.curveTo(4.0f, 17.43f, 5.57f, 19.0f, 7.5f, 19.0f);
        a.h(pathBuilderA2, 6.0f, 20.5f, 0.5f, 2.0f);
        pathBuilderA2.lineToRelative(2.0f, -2.0f);
        e.C(pathBuilderA2, 4.0f, 2.0f, 2.0f, 2.0f);
        pathBuilderA2.verticalLineToRelative(-0.5f);
        pathBuilderA2.lineTo(16.5f, 19.0f);
        pathBuilderA2.curveToRelative(1.93f, 0.0f, 3.5f, -1.57f, 3.5f, -3.5f);
        pathBuilderA2.lineTo(20.0f, 6.0f);
        pathBuilderA2.curveToRelative(0.0f, -3.5f, -4.0f, -4.0f, -8.0f, -4.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 4.0f);
        pathBuilderA2.curveToRelative(3.51f, 0.0f, 4.96f, 0.48f, 5.57f, 1.0f);
        pathBuilderA2.lineTo(6.43f, 5.0f);
        pathBuilderA2.curveToRelative(0.61f, -0.52f, 2.06f, -1.0f, 5.57f, -1.0f);
        b.w(pathBuilderA2, 6.0f, 7.0f, 5.0f, 3.0f);
        b.y(pathBuilderA2, 6.0f, 10.0f, 6.0f, 7.0f);
        pathBuilderA2.moveTo(18.0f, 15.5f);
        ...
        b.g(pathBuilderA2, 6.0f, 12.0f, 12.0f, 3.5f);
        pathBuilderA2.moveTo(18.0f, 10.0f);
        c.A(pathBuilderA2, -5.0f, 13.0f, 7.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.c(pathBuilderA2, 3.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
