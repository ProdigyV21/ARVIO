...
public final class CoffeeMakerKt {
    ...
    public static final ImageVector getCoffeeMaker(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CoffeeMaker", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(13.0f, 19.0f);
        pathBuilderA.curveToRelative(1.65f, 0.0f, 3.0f, -1.35f, 3.0f, -3.0f);
        e.l(pathBuilderA, -3.0f, -6.0f, 3.0f);
        pathBuilderA.curveTo(10.0f, 17.65f, 11.35f, 19.0f, 13.0f, 19.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = a.a(9.0f, 7.0f, 8.0f);
        pathBuilderA2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        y.a.l(pathBuilderA2, 4.0f, 2.0f, 2.0f, 6.0f);
        pathBuilderA2.curveTo(4.9f, 2.0f, 4.0f, 2.9f, 4.0f, 4.0f);
        pathBuilderA2.verticalLineToRelative(16.0f);
        pathBuilderA2.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        e.g(pathBuilderA2, 14.0f, -2.0f, -4.03f);
        pathBuilderA2.curveTo(17.2f, 19.09f, 18.0f, 17.64f, 18.0f, 16.0f);
        y.a.g(pathBuilderA2, -5.0f, 8.0f, 5.0f);
        pathBuilderA2.curveToRelative(0.0f, 1.64f, 0.81f, 3.09f, 2.03f, 4.0f);
        y.a.t(pathBuilderA2, 6.0f, 4.0f, 2.0f, 2.0f);
        pathBuilderA2.curveTo(8.0f, 6.55f, 8.45f, 7.0f, 9.0f, 7.0f);
        c.y(pathBuilderA2, 10.0f, 16.0f, -3.0f, 6.0f);
        pathBuilderA2.verticalLineToRelative(3.0f);
        pathBuilderA2.curveToRelative(0.0f, 1.65f, -1.35f, 3.0f, -3.0f, 3.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA2, 10.0f, 17.65f, 10.0f, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw3 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk83 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderB = a.b(13.0f, 9.0f, -1.0f, 0.0f);
