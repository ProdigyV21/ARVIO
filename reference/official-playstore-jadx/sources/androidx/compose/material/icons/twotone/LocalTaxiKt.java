...
public final class LocalTaxiKt {
    ...
    public static final ImageVector getLocalTaxi(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalTaxi", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(5.12f, 12.0f, -0.12f, 0.34f);
        b.A(pathBuilderR, 5.0f, 17.0f, 14.0f, -4.66f);
        d.C(pathBuilderR, -0.12f, -0.34f, 5.12f, 12.0f);
        pathBuilderR.moveTo(7.5f, 16.0f);
        pathBuilderR.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderR.reflectiveCurveTo(6.67f, 13.0f, 7.5f, 13.0f);
        pathBuilderR.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderR.reflectiveCurveTo(8.33f, 16.0f, 7.5f, 16.0f);
        pathBuilderR.close();
        pathBuilderR.moveTo(16.5f, 16.0f);
        pathBuilderR.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        ...
        PathBuilder pathBuilderG = a0.b.g(17.5f, 5.0f, 15.0f, 3.0f, 9.0f);
        pathBuilderG.verticalLineToRelative(2.0f);
        pathBuilderG.horizontalLineTo(6.5f);
        pathBuilderG.curveToRelative(-0.66f, 0.0f, -1.21f, 0.42f, -1.42f, 1.01f);
        pathBuilderG.lineTo(3.0f, 12.0f);
        ...
        e.l(pathBuilderG, -1.0f, 12.0f, 1.0f);
        pathBuilderG.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderG.horizontalLineToRelative(1.0f);
        pathBuilderG.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderG.verticalLineToRelative(-8.0f);
        pathBuilderG.lineToRelative(-2.08f, -5.99f);
        pathBuilderG.curveTo(18.72f, 5.42f, 18.16f, 5.0f, 17.5f, 5.0f);
        a.g(pathBuilderG, 6.85f, 7.0f, 10.29f);
        pathBuilderG.lineToRelative(1.04f, 3.0f);
        pathBuilderG.horizontalLineTo(5.81f);
        pathBuilderG.lineToRelative(1.04f, -3.0f);
        pathBuilderG.close();
        a.A(pathBuilderG, 19.0f, 17.0f, 5.0f, -4.66f);
        pathBuilderG.lineToRelative(0.12f, -0.34f);
        pathBuilderG.horizontalLineToRelative(13.77f);
        pathBuilderG.lineToRelative(0.11f, 0.34f);
        ...
        PathBuilder pathBuilderB = a.b(7.5f, 14.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = a.b(16.5f, 14.5f, -1.5f, 0.0f);
