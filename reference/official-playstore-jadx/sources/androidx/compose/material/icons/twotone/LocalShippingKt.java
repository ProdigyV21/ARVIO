...
public final class LocalShippingKt {
    ...
    public static final ImageVector getLocalShipping(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalShipping", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(3.0f, 15.0f, 0.78f);
        ...
        PathBuilder pathBuilderJ = a.j(17.0f, 8.0f, 17.0f, 4.0f);
        pathBuilderJ.lineTo(3.0f, 4.0f);
        ...
        pathBuilderJ.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderJ.reflectiveCurveToRelative(3.0f, -1.34f, 3.0f, -3.0f);
        f.y(pathBuilderJ, 2.0f, -5.0f, -3.0f, -4.0f);
        f.x(pathBuilderJ, -3.0f, 6.0f, 18.0f);
        ...
        pathBuilderJ.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        a.p(pathBuilderJ, 15.0f, 15.0f, 8.22f, 15.0f);
        ...
        pathBuilderJ.lineTo(3.0f, 15.0f);
        b.g(pathBuilderJ, 3.0f, 6.0f, 12.0f, 9.0f);
        pathBuilderJ.moveTo(18.0f, 18.0f);
        pathBuilderJ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderJ.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderJ.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderJ.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        a.p(pathBuilderJ, 17.0f, 12.0f, 17.0f, 9.5f);
        pathBuilderJ.horizontalLineToRelative(2.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderJ, 1.96f, 2.5f, 17.0f, 12.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
