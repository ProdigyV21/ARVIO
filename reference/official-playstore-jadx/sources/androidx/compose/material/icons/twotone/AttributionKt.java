...
public final class AttributionKt {
    ...
    public static final ImageVector getAttribution(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Attribution", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(12.83f, 8.0f, 12.0f, 8.0f);
        pathBuilderA.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderA.reflectiveCurveTo(11.17f, 5.0f, 12.0f, 5.0f);
        a.g(pathBuilderA, 14.75f, 14.5f, -1.5f);
        b.A(pathBuilderA, 13.25f, 19.0f, -2.5f, -4.5f);
        pathBuilderA.horizontalLineToRelative(-1.5f);
        pathBuilderA.lineTo(9.25f, 9.88f);
        pathBuilderA.curveToRelative(0.0f, -0.92f, 1.84f, -1.38f, 2.75f, -1.38f);
        pathBuilderA.reflectiveCurveToRelative(2.75f, 0.47f, 2.75f, 1.38f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.c(pathBuilderA, 4.62f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 8.5f);
        pathBuilderA2.curveToRelative(-0.91f, 0.0f, -2.75f, 0.46f, -2.75f, 1.38f);
        c.w(pathBuilderA2, 4.62f, 1.5f, 10.75f, 19.0f);
        e.g(pathBuilderA2, 2.5f, -4.5f, 1.5f);
        pathBuilderA2.lineTo(14.75f, 9.88f);
        pathBuilderA2.curveToRelative(0.0f, -0.91f, -1.84f, -1.38f, -2.75f, -1.38f);
        pathBuilderA2.close();
