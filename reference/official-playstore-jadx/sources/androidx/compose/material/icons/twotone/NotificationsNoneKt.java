...
public final class NotificationsNoneKt {
    ...
    public static final ImageVector getNotificationsNone(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.NotificationsNone", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.curveToRelative(0.0f, -3.07f, -1.63f, -5.64f, -4.5f, -6.32f);
        ...
        pathBuilderI.curveTo(7.64f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        e.v(pathBuilderI, 5.0f, -2.0f, 2.0f, 1.0f);
        b.r(pathBuilderI, 16.0f, -1.0f, -2.0f, -2.0f);
        pathBuilderI.moveTo(16.0f, 17.0f);
        pathBuilderI.lineTo(8.0f, 17.0f);
        pathBuilderI.verticalLineToRelative(-6.0f);
        pathBuilderI.curveToRelative(0.0f, -2.48f, 1.51f, -4.5f, 4.0f, -4.5f);
        pathBuilderI.reflectiveCurveToRelative(4.0f, 2.02f, 4.0f, 4.5f);
        v.b.f(pathBuilderI, 6.0f, 12.0f, 22.0f);
