...
public final class FenceKt {
    ...
    public static final ImageVector getFence(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Fence", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(16.0f, 6.83f, 1.0f, 1.0f, 10.0f);
        y.a.o(pathBuilderA, -2.0f, 7.83f, 0.41f, -0.41f);
        c.z(pathBuilderA, 16.0f, 6.83f, 12.0f, 6.83f);
        pathBuilderA.lineToRelative(0.59f, 0.59f);
        b.n(pathBuilderA, 13.0f, 7.83f, 10.0f, -2.0f);
        pathBuilderA.verticalLineTo(7.83f);
        d.C(pathBuilderA, 0.41f, -0.41f, 12.0f, 6.83f);
        c.m(pathBuilderA, 11.0f, 14.0f, -2.0f, 2.0f);
        e.y(pathBuilderA, 2.0f, 11.0f, 13.0f, 16.0f);
        a0.b.f(pathBuilderA, 2.0f, -2.0f, -2.0f, 13.0f);
        pathBuilderA.moveTo(7.0f, 7.83f);
        pathBuilderA.lineToRelative(1.0f, -1.0f);
        pathBuilderA.lineToRelative(0.59f, 0.59f);
        c.f(pathBuilderA, 9.0f, 7.83f, 10.0f, 7.0f);
        v.a.D(pathBuilderA, 7.83f, 7.0f, 12.0f, 2.0f);
        d.u(pathBuilderA, 2.0f, 7.0f, 12.0f);
        v.a.C(pathBuilderA, 7.0f, 16.0f, 2.0f, 2.0f);
        c.l(pathBuilderA, 7.0f, 16.0f, 17.0f, 18.0f);
        f.w(pathBuilderA, -2.0f, -2.0f, 2.0f, 18.0f);
        v.a.C(pathBuilderA, 17.0f, 14.0f, -2.0f, -2.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.e(pathBuilderQ, 2.0f, 14.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
