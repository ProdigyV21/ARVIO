...
public final class CleanHandsKt {
    ...
    public static final ImageVector getCleanHands(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CleanHands", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderQ = a.q(9.24f, 9.5f, 7.42f);
        pathBuilderQ.curveTo(7.94f, 8.61f, 8.89f, 8.0f, 10.0f, 8.0f);
        pathBuilderQ.curveToRelative(1.62f, 0.0f, 2.94f, 1.29f, 2.99f, 2.9f);
        c.z(pathBuilderQ, 9.24f, 9.5f, 5.0f, 20.0f);
        pathBuilderQ.verticalLineToRelative(-7.0f);
        pathBuilderQ.horizontalLineTo(3.0f);
        pathBuilderQ.verticalLineToRelative(7.0f);
        pathBuilderQ.horizontalLineTo(5.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(19.9f, 18.57f);
        pathBuilderQ.curveToRelative(-0.16f, -0.33f, -0.51f, -0.56f, -0.9f, -0.56f);
        pathBuilderQ.horizontalLineToRelative(-5.35f);
        pathBuilderQ.curveToRelative(-0.54f, 0.0f, -1.07f, -0.09f, -1.58f, -0.26f);
        pathBuilderQ.lineToRelative(-2.38f, -0.79f);
        pathBuilderQ.lineToRelative(0.63f, -1.9f);
        pathBuilderQ.lineToRelative(2.38f, 0.79f);
        pathBuilderQ.curveTo(13.01f, 15.95f, 15.0f, 16.0f, 15.0f, 16.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.37f, -0.23f, -0.7f, -0.57f, -0.83f);
        b.m(pathBuilderQ, 8.61f, 13.0f, 7.0f, 5.48f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderQ, 6.97f, 1.93f, 19.9f, 18.57f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a0.b.t(pathBuilderR, 11.0f, 6.1f, 4.0f, 2.0f);
        ...
        a0.b.m(pathBuilderR, -7.0f, -1.94f, 22.0f, 1.0f);
        a0.b.l(pathBuilderR, 11.0f, 7.97f, 6.16f, 2.3f);
        ...
        b.m(pathBuilderR, 8.61f, 13.0f, 7.0f, 5.48f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderR, 6.97f, 1.93f, 19.9f, 18.57f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
