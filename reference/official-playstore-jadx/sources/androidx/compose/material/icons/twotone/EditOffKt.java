...
public final class EditOffKt {
    ...
    public static final ImageVector getEditOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.EditOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = b.a(5.0f, 18.08f, 19.0f, 0.92f);
        pathBuilderA.lineToRelative(5.12f, -5.12f);
        d.C(pathBuilderA, -0.92f, -0.92f, 5.0f, 18.08f);
        pathBuilderA.moveTo(14.06f, 9.02f);
        pathBuilderA.lineToRelative(-1.11f, 1.11f);
        pathBuilderA.lineToRelative(0.92f, 0.92f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.b.e(pathBuilderA, 1.11f, -1.11f, 14.06f, 9.02f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        v.b.n(pathBuilderR, 3.0f, 17.25f, 21.0f, 3.75f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.b.e(pathBuilderR, 0.92f, 0.92f, 5.92f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
