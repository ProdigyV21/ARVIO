...
public final class Rotate90DegreesCcwKt {
    ...
    public static final ImageVector getRotate90DegreesCcw(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Rotate90DegreesCcw", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(a.j(7.35f, 9.24f, 3.69f, 12.9f), 3.65f, 3.66f, 11.0f, 12.9f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderJ.moveTo(7.34f, 16.56f);
        pathBuilderJ.lineTo(3.69f, 12.9f);
        pathBuilderJ.lineToRelative(3.66f, -3.66f);
        d.l(pathBuilderJ, 11.0f, 12.9f, -3.66f, 3.66f);
        ...
        pathBuilderJ.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderJ.getNodes(), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
