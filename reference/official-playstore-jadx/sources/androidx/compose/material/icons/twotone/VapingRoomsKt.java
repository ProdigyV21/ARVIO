...
public final class VapingRoomsKt {
    ...
    public static final ImageVector getVapingRooms(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.VapingRooms", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.l(pathBuilderA, 2.0f, 16.5f, 22.0f, 16.0f);
        pathBuilderA.verticalLineToRelative(3.0f);
        ...
        w.a.x(pathBuilderA, 19.5f, 13.36f, 15.0f, 18.0f);
        pathBuilderA.verticalLineToRelative(-1.3f);
        ...
        pathBuilderA.curveTo(17.9f, 10.2f, 19.5f, 11.55f, 19.5f, 13.36f);
        pathBuilderA.close();
