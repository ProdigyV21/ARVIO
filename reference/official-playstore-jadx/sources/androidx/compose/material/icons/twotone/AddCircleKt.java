...
public final class AddCircleKt {
    ...
    public static final ImageVector getAddCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AddCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = d.a(13.0f, 7.0f, -2.0f, 4.0f);
        v.a.h(pathBuilderA2, 7.0f, 11.0f, 2.0f, 4.0f);
        b.z(pathBuilderA2, 4.0f, 2.0f, -4.0f, 4.0f);
        e.D(pathBuilderA2, -2.0f, -4.0f, 12.0f, 2.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA2, -3.59f, 8.0f, -8.0f, 8.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
