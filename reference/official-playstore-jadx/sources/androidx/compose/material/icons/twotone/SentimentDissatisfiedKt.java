...
public final class SentimentDissatisfiedKt {
    ...
    public static final ImageVector getSentimentDissatisfied(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SentimentDissatisfied", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(15.45f, 17.5f);
        pathBuilderA.curveToRelative(-0.7f, -1.19f, -1.97f, -2.0f, -3.45f, -2.0f);
        pathBuilderA.reflectiveCurveToRelative(-2.76f, 0.81f, -3.45f, 2.0f);
        pathBuilderA.lineTo(6.88f, 17.5f);
        pathBuilderA.curveTo(7.68f, 15.45f, 9.67f, 14.0f, 12.0f, 14.0f);
        pathBuilderA.reflectiveCurveToRelative(4.32f, 1.45f, 5.12f, 3.5f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.d(pathBuilderA, -1.67f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.curveToRelative(-2.33f, 0.0f, -4.32f, 1.45f, -5.12f, 3.5f);
        pathBuilderA2.horizontalLineToRelative(1.67f);
        pathBuilderA2.curveToRelative(0.69f, -1.19f, 1.97f, -2.0f, 3.45f, -2.0f);
        pathBuilderA2.reflectiveCurveToRelative(2.75f, 0.81f, 3.45f, 2.0f);
        pathBuilderA2.horizontalLineToRelative(1.67f);
        pathBuilderA2.curveToRelative(-0.8f, -2.05f, -2.79f, -3.5f, -5.12f, -3.5f);
        pathBuilderA2.close();
