...
public final class MoodBadKt {
    ...
    public static final ImageVector getMoodBad(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.MoodBad", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(6.89f, 17.0f);
        pathBuilderA.curveToRelative(0.8f, -2.04f, 2.78f, -3.5f, 5.11f, -3.5f);
        pathBuilderA.reflectiveCurveToRelative(4.31f, 1.46f, 5.11f, 3.5f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 6.89f, 17.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilderA2.close();
        pathBuilderA2.moveTo(12.0f, 13.5f);
        pathBuilderA2.curveToRelative(-2.33f, 0.0f, -4.31f, 1.46f, -5.11f, 3.5f);
        pathBuilderA2.horizontalLineToRelative(10.22f);
