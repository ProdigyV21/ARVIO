...
public final class ContactPhoneKt {
    ...
    public static final ImageVector getContactPhone(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ContactPhone", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderS = c.s(22.0f, 5.0f, 2.0f, 5.0f, 14.0f);
        d.q(pathBuilderS, 20.0f, 22.0f, 5.0f);
        ...
        pathBuilderS.reflectiveCurveToRelative(1.35f, -3.0f, 3.0f, -3.0f);
        a.p(pathBuilderS, 15.0f, 18.0f, 3.0f, 18.0f);
        ...
        c.z(pathBuilderS, 15.0f, 18.0f, 17.85f, 14.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderS, 0.13f, 1.37f, 0.35f, 2.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = a.a(2.0f, 21.0f, 20.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        b.w(pathBuilderA, 2.0f, 5.0f, 20.0f, 14.0f);
        b.y(pathBuilderA, 2.0f, 19.0f, 2.0f, 5.0f);
        pathBuilderA.moveTo(19.49f, 10.0f);
        ...
        f.x(pathBuilderA, 1.64f, 9.0f, 12.0f);
        ...
        b.A(pathBuilderA, 3.0f, 18.0f, 12.0f, -1.41f);
        pathBuilderA.curveTo(15.0f, 14.08f, 11.03f, 13.0f, 9.0f, 13.0f);
        pathBuilderA.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 5.48f, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
