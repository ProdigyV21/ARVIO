...
public final class ReplayCircleFilledKt {
    ...
    public static final ImageVector getReplayCircleFilled(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ReplayCircleFilled", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(18.0f, 12.5f);
        ...
        pathBuilderA.lineToRelative(4.0f, -4.0f);
        pathBuilderA.verticalLineToRelative(3.0f);
        pathBuilderA.curveTo(15.31f, 6.5f, 18.0f, 9.19f, 18.0f, 12.5f);
        pathBuilderA.close();
