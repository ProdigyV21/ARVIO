...
public final class WebAssetOffKt {
    ...
    public static final ImageVector getWebAssetOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.WebAssetOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = b.a(20.0f, 17.17f, 8.0f, -9.17f);
        c.z(pathBuilderA, 20.0f, 17.17f, 5.17f, 8.0f);
        a.n(pathBuilderA, 4.0f, 10.0f, 11.17f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 5.17f, 8.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        v.b.n(pathBuilderQ, 20.0f, 17.17f, 8.0f, -9.17f);
