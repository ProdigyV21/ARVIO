...
public final class CampaignKt {
    ...
    public static final ImageVector getCampaign(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Campaign", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderS = c.s(9.03f, 10.71f, 11.0f, 9.53f, 4.94f);
        pathBuilderS.lineToRelative(-1.97f, -1.18f);
        pathBuilderS.lineTo(8.55f, 13.0f);
        ...
        pathBuilderS.horizontalLineToRelative(0.55f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderS, 9.03f, 10.71f), defaultFillType6, "", solidColor6, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw6, iM3813getBevelLxFBmk86, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
