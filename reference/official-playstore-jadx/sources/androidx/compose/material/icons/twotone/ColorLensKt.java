...
public final class ColorLensKt {
    ...
    public static final ImageVector getColorLens(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ColorLens", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA, 1.5f, 0.67f, 1.5f, 1.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.lineTo(16.0f, 17.0f);
        pathBuilderA2.curveToRelative(3.31f, 0.0f, 6.0f, -2.69f, 6.0f, -6.0f);
        pathBuilderA2.curveToRelative(0.0f, -4.96f, -4.49f, -9.0f, -10.0f, -9.0f);
