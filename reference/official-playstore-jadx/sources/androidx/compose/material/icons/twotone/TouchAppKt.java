...
public final class TouchAppKt {
    ...
    public static final ImageVector getTouchApp(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.TouchApp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.curveToRelative(-2.08f, -0.44f, -2.01f, -0.44f, -2.26f, -0.44f);
        ...
        PathBuilder pathBuilderC = e.c(17.3f, 14.23f, -3.46f, -1.73f, -1.77f);
        ...
        pathBuilderC.verticalLineToRelative(10.61f);
        pathBuilderC.lineToRelative(-4.25f, -0.89f);
        pathBuilderC.lineToRelative(3.68f, 3.68f);
        pathBuilderC.curveToRelative(0.06f, 0.06f, 0.15f, 0.1f, 0.24f, 0.1f);
        pathBuilderC.horizontalLineToRelative(6.3f);
        pathBuilderC.lineToRelative(0.8f, -4.71f);
        pathBuilderC.curveTo(17.91f, 14.86f, 17.69f, 14.43f, 17.3f, 14.23f);
        pathBuilderC.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderC.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
