...
public final class MobileScreenShareKt {
    ...
    public static final ImageVector getMobileScreenShare(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.MobileScreenShare", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.moveTo(12.8f, 10.72f);
        pathBuilderI.verticalLineToRelative(-1.7f);
        pathBuilderI.lineTo(16.0f, 12.0f);
        pathBuilderI.lineToRelative(-3.2f, 2.99f);
        pathBuilderI.verticalLineToRelative(-1.75f);
        pathBuilderI.curveToRelative(-2.22f, 0.0f, -3.69f, 0.68f, -4.8f, 2.18f);
        pathBuilderI.curveToRelative(0.45f, -2.14f, 1.69f, -4.27f, 4.8f, -4.7f);
        pathBuilderI.close();
        ...
        pathBuilderJ.curveToRelative(-1.1f, 0.0f, -1.99f, 0.85f, -1.99f, 1.95f);
        pathBuilderJ.verticalLineToRelative(18.0f);
        pathBuilderJ.curveTo(5.01f, 22.05f, 5.9f, 23.0f, 7.0f, 23.0f);
        ...
        pathBuilderJ.moveTo(12.8f, 13.24f);
        pathBuilderJ.verticalLineToRelative(1.75f);
        pathBuilderJ.lineTo(16.0f, 12.0f);
        pathBuilderJ.lineToRelative(-3.2f, -2.98f);
