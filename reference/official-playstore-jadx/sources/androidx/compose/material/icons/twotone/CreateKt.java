...
public final class CreateKt {
    ...
    public static final ImageVector getCreate(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Create", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a0.b.a(3.0f, 17.25f, 21.0f, 3.75f);
        ...
        d.C(pathBuilderA, 0.92f, 0.92f, 5.92f, 19.0f);
