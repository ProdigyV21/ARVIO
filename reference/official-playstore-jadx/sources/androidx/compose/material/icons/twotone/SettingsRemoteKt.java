...
public final class SettingsRemoteKt {
    ...
    public static final ImageVector getSettingsRemote(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SettingsRemote", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderI = e.i(10.0f, 21.0f, 4.0f, 14.0f, 11.0f);
        b.B(pathBuilderI, -4.0f, 10.0f, 12.0f, 12.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderI, 0.45f, -1.0f, 1.0f, -1.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.x(pathBuilderJ, 10.0f, 11.0f, 4.0f, 10.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
