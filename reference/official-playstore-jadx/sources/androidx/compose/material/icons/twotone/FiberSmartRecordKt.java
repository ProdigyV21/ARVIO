...
public final class FiberSmartRecordKt {
    ...
    public static final ImageVector getFiberSmartRecord(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FiberSmartRecord", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(9.0f, 18.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA, 2.69f, 6.0f, 6.0f, 6.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA2 = c.a(9.0f, 20.0f);
        ...
        pathBuilderA2.reflectiveCurveToRelative(2.69f, -6.0f, 6.0f, -6.0f);
        d.k(pathBuilderA2, 17.0f, 4.26f, 2.09f);
        pathBuilderA2.curveToRelative(2.33f, 0.82f, 4.0f, 3.04f, 4.0f, 5.65f);
        pathBuilderA2.reflectiveCurveToRelative(-1.67f, 4.83f, -4.0f, 5.65f);
        pathBuilderA2.verticalLineToRelative(2.09f);
        pathBuilderA2.curveToRelative(3.45f, -0.89f, 6.0f, -4.01f, 6.0f, -7.74f);
        pathBuilderA2.curveToRelative(0.0f, -3.73f, -2.55f, -6.85f, -6.0f, -7.74f);
        pathBuilderA2.close();
