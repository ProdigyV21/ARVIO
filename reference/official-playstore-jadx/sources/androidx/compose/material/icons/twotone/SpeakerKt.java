...
public final class SpeakerKt {
    ...
    public static final ImageVector getSpeaker(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Speaker", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = b.a(7.0f, 4.0f, 16.0f, 10.0f);
        b.y(pathBuilderA, 17.0f, 4.0f, 7.0f, 4.0f);
        ...
        PathBuilder pathBuilderJ = a.j(17.0f, 2.0f, 7.0f, 2.0f);
        ...
        a.p(pathBuilderJ, 7.0f, 20.0f, 7.0f, 4.0f);
        d.m(pathBuilderJ, 10.0f, 16.0f, 7.0f, 20.0f);
