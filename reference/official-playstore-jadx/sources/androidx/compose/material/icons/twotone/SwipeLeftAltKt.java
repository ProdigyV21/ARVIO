...
public final class SwipeLeftAltKt {
    ...
    public static final ImageVector getSwipeLeftAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SwipeLeftAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(15.0f, 12.0f, -3.0f, 0.0f);
        ...
        PathBuilder pathBuilderA = c.a(10.1f, 13.0f);
        ...
        w.a.e(pathBuilderA, 5.83f, 13.0f, 10.1f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 16.66f, 15.0f, 15.0f, 15.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
