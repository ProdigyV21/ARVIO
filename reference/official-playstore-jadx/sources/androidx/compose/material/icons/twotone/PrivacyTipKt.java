...
public final class PrivacyTipKt {
    ...
    public static final ImageVector getPrivacyTip(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PrivacyTip", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.a.C(pathBuilderN, 13.0f, 17.0f, -2.0f, -6.0f);
        c.D(pathBuilderN, 2.0f, 17.0f, 13.0f, 9.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.v(pathBuilderN, -2.0f, 7.0f, 2.0f, 9.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.f(pathBuilderA, 2.0f, 6.0f, -2.0f, 11.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
