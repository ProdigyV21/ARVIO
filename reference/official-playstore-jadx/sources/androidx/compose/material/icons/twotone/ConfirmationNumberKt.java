...
public final class ConfirmationNumberKt {
    ...
    public static final ImageVector getConfirmationNumber(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ConfirmationNumber", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.C(pathBuilderA, 11.0f, 7.0f, 2.0f, 2.0f);
        d.q(pathBuilderA, -2.0f, 11.0f, 7.0f);
        a.C(pathBuilderA, 11.0f, 11.0f, 2.0f, 2.0f);
        b.B(pathBuilderA, -2.0f, -2.0f, 11.0f, 15.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.h(pathBuilderA, 2.0f, 2.0f, -2.0f, -2.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.C(pathBuilderJ, 11.0f, 15.0f, 2.0f, 2.0f);
        e.r(pathBuilderJ, -2.0f, 11.0f, 11.0f, 2.0f);
        e.D(pathBuilderJ, 2.0f, -2.0f, 11.0f, 7.0f);
