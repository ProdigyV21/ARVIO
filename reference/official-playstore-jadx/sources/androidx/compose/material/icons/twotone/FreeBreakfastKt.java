...
public final class FreeBreakfastKt {
    ...
    public static final ImageVector getFreeBreakfast(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FreeBreakfast", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = d.a(4.0f, 19.0f, 16.0f, 2.0f);
        c.z(pathBuilderA2, 4.0f, 21.0f, 20.0f, 3.0f);
        ...
        b.g(pathBuilderA2, 6.0f, 5.0f, 10.0f, 8.0f);
        pathBuilderA2.moveTo(20.0f, 8.0f);
        c.A(pathBuilderA2, -2.0f, 18.0f, 5.0f, 2.0f);
