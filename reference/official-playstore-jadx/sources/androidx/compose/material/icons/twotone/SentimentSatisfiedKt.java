...
public final class SentimentSatisfiedKt {
    ...
    public static final ImageVector getSentimentSatisfied(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SentimentSatisfied", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA2.curveToRelative(-0.7f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        pathBuilderA2.close();
