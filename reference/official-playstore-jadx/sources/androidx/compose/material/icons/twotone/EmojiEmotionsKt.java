...
public final class EmojiEmotionsKt {
    ...
    public static final ImageVector getEmojiEmotions(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.EmojiEmotions", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(20.0f, 16.42f, 20.0f, 12.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.curveToRelative(-2.28f, 0.0f, -4.22f, -1.66f, -5.0f, -4.0f);
        pathBuilderA.horizontalLineToRelative(10.0f);
        pathBuilderA.curveTo(16.22f, 16.34f, 14.28f, 18.0f, 12.0f, 18.0f);
        pathBuilderA.close();
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 16.33f, 11.0f, 15.5f, 11.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.curveToRelative(0.0f, 5.52f, 4.47f, 10.0f, 9.99f, 10.0f);
        pathBuilderA2.curveTo(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        pathBuilderA2.curveTo(22.0f, 6.48f, 17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilderA2.close();
        ...
        pathBuilderA2.curveTo(20.0f, 16.42f, 16.42f, 20.0f, 12.0f, 20.0f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderA3 = c.a(12.0f, 18.0f);
        pathBuilderA3.curveToRelative(2.28f, 0.0f, 4.22f, -1.66f, 5.0f, -4.0f);
        pathBuilderA3.horizontalLineTo(7.0f);
        pathBuilderA3.curveTo(7.78f, 16.34f, 9.72f, 18.0f, 12.0f, 18.0f);
        pathBuilderA3.close();
