...
public final class PinchKt {
    ...
    public static final ImageVector getPinch(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Pinch", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(21.0f, 15.56f, -4.24f, -1.89f, 15.0f);
        pathBuilderB.verticalLineTo(7.5f);
        pathBuilderB.curveTo(15.0f, 7.22f, 14.78f, 7.0f, 14.5f, 7.0f);
        pathBuilderB.reflectiveCurveTo(14.0f, 7.22f, 14.0f, 7.5f);
        pathBuilderB.verticalLineToRelative(10.61f);
        pathBuilderB.lineToRelative(-4.17f, -0.89f);
        pathBuilderB.lineToRelative(3.7f, 3.78f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, w.a.h(pathBuilderB, 6.55f, 21.0f, 15.56f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = a0.a.a(6.0f, 2.5f, 1.0f, 5.0f, 5.0f);
        pathBuilderA.horizontalLineTo(9.5f);
        pathBuilderA.verticalLineTo(3.56f);
        pathBuilderA.lineTo(3.56f, 9.5f);
        a0.a.x(pathBuilderA, 6.0f, 11.0f, 1.0f, 6.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 20.08f, 21.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
