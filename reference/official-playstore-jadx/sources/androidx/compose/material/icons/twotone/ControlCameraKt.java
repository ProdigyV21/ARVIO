...
public final class ControlCameraKt {
    ...
    public static final ImageVector getControlCamera(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ControlCamera", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(7.3f, 13.77f, 5.54f, 12.0f);
        pathBuilderJ.lineToRelative(1.76f, -1.77f);
        pathBuilderJ.lineToRelative(-1.76f, -1.77f);
        d.l(pathBuilderJ, 2.0f, 12.0f, 3.54f, 3.54f);
        pathBuilderJ.moveTo(15.54f, 18.46f);
        ...
        pathBuilderJ.lineTo(22.0f, 12.0f);
        pathBuilderJ.lineToRelative(-3.54f, -3.54f);
        pathBuilderJ.lineToRelative(-1.76f, 1.77f);
        d.l(pathBuilderJ, 18.46f, 12.0f, -1.76f, 1.77f);
        pathBuilderJ.moveTo(12.0f, 5.54f);
        pathBuilderJ.lineToRelative(1.77f, 1.76f);
        pathBuilderJ.lineToRelative(1.77f, -1.76f);
        pathBuilderJ.lineTo(12.0f, 2.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.v(pathBuilderJ, 8.46f, 5.54f, 1.77f, 1.76f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
