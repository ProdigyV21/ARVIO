...
public final class SellKt {
    ...
    public static final ImageVector getSell(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Sell", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderS = d.s(4.0f, 4.0f, 7.17f, 12.83f, 20.0f);
        pathBuilderS.lineTo(20.0f, 12.83f);
        a.e(pathBuilderS, 11.17f, 4.0f, 4.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderS, 7.33f, 8.0f, 6.5f, 8.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = v.a.r(21.41f, 11.41f, -8.83f, -8.83f);
        ...
        v.a.p(pathBuilderR, 12.83f, 20.0f, 4.0f, 11.17f);
        pathBuilderR.verticalLineTo(4.0f);
        pathBuilderR.horizontalLineToRelative(7.17f);
        pathBuilderR.lineTo(20.0f, 12.83f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 12.83f, 20.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw3 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk83 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderB = v.a.b(6.5f, 6.5f, -1.5f, 0.0f);
