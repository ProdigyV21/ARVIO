...
public final class Brightness5Kt {
    ...
    public static final ImageVector getBrightness5(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Brightness5", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderT.moveTo(12.0f, 6.5f);
        pathBuilderT.curveToRelative(-3.03f, 0.0f, -5.5f, 2.47f, -5.5f, 5.5f);
        pathBuilderT.reflectiveCurveToRelative(2.47f, 5.5f, 5.5f, 5.5f);
        pathBuilderT.reflectiveCurveToRelative(5.5f, -2.47f, 5.5f, -5.5f);
        pathBuilderT.reflectiveCurveToRelative(-2.47f, -5.5f, -5.5f, -5.5f);
        pathBuilderT.close();
        pathBuilderT.moveTo(12.0f, 15.5f);
        pathBuilderT.curveToRelative(-1.93f, 0.0f, -3.5f, -1.57f, -3.5f, -3.5f);
        pathBuilderT.reflectiveCurveToRelative(1.57f, -3.5f, 3.5f, -3.5f);
        pathBuilderT.reflectiveCurveToRelative(3.5f, 1.57f, 3.5f, 3.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderT, -1.57f, 3.5f, -3.5f, 3.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
