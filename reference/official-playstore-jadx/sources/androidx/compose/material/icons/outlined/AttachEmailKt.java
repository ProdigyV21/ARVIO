...
public final class AttachEmailKt {
    ...
    public static final ImageVector getAttachEmail(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AttachEmail", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(3.0f, 6.0f, 8.0f, 5.0f);
        b.u(pathBuilderR, 8.0f, -5.0f, 3.0f, 2.0f);
        ...
        pathBuilderR.curveTo(1.9f, 2.0f, 1.01f, 2.9f, 1.01f, 4.0f);
        pathBuilderR.lineTo(1.0f, 16.0f);
        pathBuilderR.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        d.z(pathBuilderR, 10.0f, -2.0f, 3.0f, 6.0f);
        pathBuilderR.moveTo(19.0f, 4.0f);
        pathBuilderR.lineToRelative(-8.0f, 5.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.w(pathBuilderR, 3.0f, 4.0f, 19.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
