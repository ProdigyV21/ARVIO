...
public final class MilitaryTechKt {
    ...
    public static final ImageVector getMilitaryTech(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MilitaryTech", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.a.z(pathBuilderJ, 11.0f, 11.07f, -2.0f, -1.2f);
        f.k(pathBuilderJ, 4.0f, 2.0f, 11.07f);
        pathBuilderJ.moveTo(15.0f, 9.87f);
        b.o(pathBuilderJ, -2.0f, 1.2f, 4.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderJ, 9.87f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
