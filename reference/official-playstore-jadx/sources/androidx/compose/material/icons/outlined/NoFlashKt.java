...
public final class NoFlashKt {
    ...
    public static final ImageVector getNoFlash(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NoFlash", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderP = a.p(20.4f, 5.6f, 22.0f, 19.0f, 11.0f);
        d.A(pathBuilderP, 7.0f, -1.0f, 2.0f, 4.0f);
        c.z(pathBuilderP, 20.4f, 5.6f, 16.0f, 11.4f);
        pathBuilderP.lineToRelative(0.0f, 1.77f);
        pathBuilderP.lineToRelative(2.0f, 2.0f);
        pathBuilderP.verticalLineTo(11.0f);
        ...
        d.C(pathBuilderP, 1.41f, -1.41f, 2.1f, 2.1f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderP, 2.55f, 2.55f, 15.96f, 20.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
