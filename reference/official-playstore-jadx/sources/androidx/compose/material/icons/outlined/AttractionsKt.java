...
public final class AttractionsKt {
    ...
    public static final ImageVector getAttractions(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Attractions", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(3.07f, 8.98f, 3.85f, 9.58f);
        ...
        pathBuilderA.curveTo(21.17f, 16.12f, 20.93f, 15.02f, 20.15f, 14.42f);
        pathBuilderA.close();
        ...
        pathBuilderA.reflectiveCurveTo(10.48f, 12.85f, 10.48f, 12.02f);
        pathBuilderA.close();
