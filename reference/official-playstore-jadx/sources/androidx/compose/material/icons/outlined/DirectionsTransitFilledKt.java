...
public final class DirectionsTransitFilledKt {
    ...
    public static final ImageVector getDirectionsTransitFilled(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DirectionsTransitFilled", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(3.71f, 0.0f, 5.13f, 0.46f, 5.67f, 1.0f);
        pathBuilderA.horizontalLineTo(13.0f);
        pathBuilderA.horizontalLineToRelative(-2.0f);
        pathBuilderA.horizontalLineTo(6.43f);
        pathBuilderA.curveTo(7.03f, 4.48f, 8.48f, 4.0f, 12.0f, 4.0f);
        b.w(pathBuilderA, 6.0f, 7.0f, 5.0f, 3.0f);
        c.l(pathBuilderA, 6.0f, 7.0f, 18.0f, 15.5f);
        ...
        f.k(pathBuilderA, 12.0f, 12.0f, 15.5f);
        e.m(pathBuilderA, 18.0f, 10.0f, -5.0f, 7.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderA, 5.0f, 10.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
