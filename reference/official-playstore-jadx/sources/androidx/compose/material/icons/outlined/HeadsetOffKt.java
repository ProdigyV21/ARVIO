...
public final class HeadsetOffKt {
    ...
    public static final ImageVector getHeadsetOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.HeadsetOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.m(pathBuilderA, 16.83f, 14.0f, 19.0f, 2.17f);
        ...
        a0.a.y(pathBuilderJ, 4.0f, -8.0f, 5.0f, -1.0f);
        ...
        c.u(pathBuilderJ, 7.0f, 14.0f, 4.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, y.a.d(pathBuilderJ, -4.0f, 7.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
