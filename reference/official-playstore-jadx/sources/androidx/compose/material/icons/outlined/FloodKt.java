...
public final class FloodKt {
    ...
    public static final ImageVector getFlood(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Flood", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA2, 10.42f, 4.41f, 5.74f, 2.09f);
        pathBuilderA2.lineToRelative(2.15f, 8.02f);
        pathBuilderA2.curveToRelative(-1.54f, 0.11f, -1.82f, 0.89f, -2.85f, 0.96f);
        pathBuilderA2.lineToRelative(-1.42f, -5.31f);
        pathBuilderA2.lineToRelative(-3.86f, 1.04f);
        pathBuilderA2.lineToRelative(0.91f, 3.39f);
        pathBuilderA2.curveToRelative(-1.12f, 0.25f, -1.41f, 0.9f, -2.42f, 0.9f);
        pathBuilderA2.curveToRelative(-0.18f, 0.0f, -0.33f, -0.02f, -0.45f, -0.05f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderA2, 6.5f, 9.09f, 10.42f, 4.41f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
