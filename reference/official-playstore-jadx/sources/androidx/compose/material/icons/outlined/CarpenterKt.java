...
public final class CarpenterKt {
    ...
    public static final ImageVector getCarpenter(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Carpenter", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderJ, 5.71f, 5.62f, 7.0f, 4.33f);
        pathBuilderJ.lineToRelative(8.49f, 8.49f);
        d.C(pathBuilderJ, -2.81f, 2.81f, 5.71f, 5.62f);
        pathBuilderJ.moveTo(14.07f, 19.88f);
        pathBuilderJ.lineToRelative(-1.41f, -1.41f);
        pathBuilderJ.lineToRelative(4.24f, -4.24f);
