...
public final class WrongLocationKt {
    ...
    public static final ImageVector getWrongLocation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WrongLocation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.07f, 0.0f, 0.13f, 0.0f, 0.2f);
        ...
        pathBuilderA.curveTo(6.0f, 7.57f, 8.65f, 5.0f, 12.0f, 5.0f);
        pathBuilderA.curveToRelative(0.34f, 0.0f, 0.68f, 0.03f, 1.0f, 0.08f);
        pathBuilderA.verticalLineTo(3.06f);
        pathBuilderA.curveTo(12.67f, 3.02f, 12.34f, 3.0f, 12.0f, 3.0f);
        ...
        PathBuilder pathBuilderB = a.b(12.0f, 11.0f, -2.0f, 0.0f);
        ...
        pathBuilderR.lineToRelative(2.12f, -2.13f);
        pathBuilderR.lineToRelative(2.12f, 2.13f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 1.42f, -1.42f, -2.13f, -2.12f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
