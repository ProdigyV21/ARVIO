...
public final class AssignmentIndKt {
    ...
    public static final ImageVector getAssignmentInd(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AssignmentInd", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        a.p(pathBuilderA, 6.0f, 16.47f, 6.0f, 18.0f);
        ...
        pathBuilderA.reflectiveCurveToRelative(-6.0f, 1.07f, -6.0f, 3.58f);
        pathBuilderA.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 8.31f, 16.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
