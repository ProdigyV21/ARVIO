...
public final class PianoKt {
    ...
    public static final ImageVector getPiano(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Piano", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.u(pathBuilderQ, 14.0f, 14.5f, 0.25f, 19.0f);
        a0.a.i(pathBuilderQ, -4.5f, -4.5f, 10.0f);
        ...
        a.C(pathBuilderQ, 19.0f, 19.0f, -3.25f, -4.5f);
        pathBuilderQ.horizontalLineTo(16.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, f.m(pathBuilderQ, 5.0f, 2.0f, 19.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
