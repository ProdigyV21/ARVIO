...
public final class NotAccessibleKt {
    ...
    public static final ImageVector getNotAccessible(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NotAccessible", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.k(pathBuilderA, 19.0f, 13.0f, -2.0f);
        ...
        pathBuilderA.curveTo(15.29f, 12.12f, 17.25f, 12.99f, 19.0f, 13.0f);
        pathBuilderA.close();
        ...
        a.p(pathBuilderA, 2.81f, 2.81f, 1.39f, 4.22f);
