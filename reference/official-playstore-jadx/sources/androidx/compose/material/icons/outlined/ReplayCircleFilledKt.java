...
public final class ReplayCircleFilledKt {
    ...
    public static final ImageVector getReplayCircleFilled(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ReplayCircleFilled", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -2.24f, -1.85f, -4.09f, -4.16f, -3.99f);
        ...
        pathBuilderA.curveTo(15.28f, 6.4f, 18.0f, 9.18f, 18.0f, 12.5f);
        pathBuilderA.curveTo(18.0f, 15.81f, 15.31f, 18.5f, 12.0f, 18.5f);
        pathBuilderA.close();
