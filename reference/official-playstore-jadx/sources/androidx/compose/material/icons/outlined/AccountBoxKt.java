...
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AccountBox", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.k(pathBuilderQ, 5.0f, 14.0f, 17.86f);
        pathBuilderQ.moveTo(12.0f, 13.0f);
        pathBuilderQ.curveToRelative(1.93f, 0.0f, 3.5f, -1.57f, 3.5f, -3.5f);
        pathBuilderQ.reflectiveCurveTo(13.93f, 6.0f, 12.0f, 6.0f);
        pathBuilderQ.curveToRelative(-1.93f, 0.0f, -3.5f, 1.57f, -3.5f, 3.5f);
        pathBuilderQ.reflectiveCurveTo(10.07f, 13.0f, 12.0f, 13.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.0f, 8.0f);
        pathBuilderQ.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderQ.reflectiveCurveTo(12.83f, 11.0f, 12.0f, 11.0f);
        pathBuilderQ.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderQ, 11.17f, 8.0f, 12.0f, 8.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
