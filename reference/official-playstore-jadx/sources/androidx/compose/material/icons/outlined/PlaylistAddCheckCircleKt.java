...
public final class PlaylistAddCheckCircleKt {
    ...
    public static final ImageVector getPlaylistAddCheckCircle(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PlaylistAddCheckCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderA, 14.0f, 10.0f, 7.0f, 2.0f);
        c.D(pathBuilderA, 7.0f, 10.0f, 14.0f, 7.0f);
        c.k(pathBuilderA, 7.0f, 2.0f, 7.0f, 7.0f);
        a.C(pathBuilderA, 7.0f, 15.0f, 3.0f, -2.0f);
        c.l(pathBuilderA, 7.0f, 15.0f, 19.0f, 13.41f);
        pathBuilderA.lineTo(17.59f, 12.0f);
        pathBuilderA.lineToRelative(-3.54f, 3.54f);
        pathBuilderA.lineToRelative(-1.41f, -1.41f);
        pathBuilderA.lineToRelative(-1.41f, 1.41f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderA, 2.83f, 2.83f, 19.0f, 13.41f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
