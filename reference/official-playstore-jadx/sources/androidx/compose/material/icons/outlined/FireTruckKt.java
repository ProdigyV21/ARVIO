...
public final class FireTruckKt {
    ...
    public static final ImageVector getFireTruck(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FireTruck", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderR, 14.0f, 7.0f, 5.56f);
        pathBuilderR.lineToRelative(1.33f, 4.0f);
        ...
        pathBuilderR.close();
        pathBuilderR.moveTo(19.22f, 16.0f);
        pathBuilderR.curveToRelative(-0.55f, -0.61f, -1.34f, -1.0f, -2.22f, -1.0f);
        pathBuilderR.reflectiveCurveToRelative(-1.67f, 0.39f, -2.22f, 1.0f);
        b.q(pathBuilderR, 14.0f, -3.0f, 7.0f, 3.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderR, 19.22f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.B(pathBuilderK, 8.5f, 8.5f, 8.5f, 6.75f);
        d.u(pathBuilderK, -2.0f, 8.5f, 8.5f);
        a.C(pathBuilderK, 3.5f, 6.5f, 1.75f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.m(pathBuilderK, 3.5f, 6.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
