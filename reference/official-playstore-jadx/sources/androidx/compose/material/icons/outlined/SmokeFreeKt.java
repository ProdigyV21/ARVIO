...
public final class SmokeFreeKt {
    ...
    public static final ImageVector getSmokeFree(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SmokeFree", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.q(pathBuilderS, -2.34f, 17.0f, 15.34f);
        pathBuilderS.moveTo(14.5f, 8.65f);
        pathBuilderS.horizontalLineToRelative(1.53f);
        ...
        pathBuilderS.close();
        pathBuilderS.moveTo(18.85f, 4.73f);
        ...
        v.a.p(pathBuilderS, 3.41f, 4.59f, 2.0f, 6.0f);
        pathBuilderS.lineToRelative(7.0f, 7.0f);
        v.a.h(pathBuilderS, 2.0f, 13.0f, 3.0f, 10.0f);
