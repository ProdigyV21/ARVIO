...
public final class MarkChatUnreadKt {
    ...
    public static final ImageVector getMarkChatUnread(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MarkChatUnread", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.e(pathBuilderA, 4.0f, 12.0f, 16.0f, 7.9f);
        pathBuilderA.curveTo(20.74f, 7.75f, 21.42f, 7.42f, 22.0f, 6.98f);
        pathBuilderA.close();
