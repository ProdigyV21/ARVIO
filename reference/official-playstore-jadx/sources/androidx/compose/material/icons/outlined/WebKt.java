...
public final class WebKt {
    ...
    public static final ImageVector getWeb(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Web", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.w(pathBuilderQ, 4.0f, 9.0f, 10.5f, 3.5f);
        c.l(pathBuilderQ, 4.0f, 9.0f, 4.0f, 14.5f);
        pathBuilderQ.horizontalLineToRelative(10.5f);
        pathBuilderQ.verticalLineTo(18.0f);
        pathBuilderQ.lineTo(4.0f, 18.0f);
        f.r(pathBuilderQ, 14.5f, 20.0f, 18.0f);
        a0.b.m(pathBuilderQ, -3.5f, 0.0f, 9.0f, 20.0f);
