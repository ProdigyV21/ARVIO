...
public final class DevicesOtherKt {
    ...
    public static final ImageVector getDevicesOther(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DevicesOther", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderI, 3.0f, 6.0f, 13.0f, 12.0f);
        ...
        pathBuilderI.reflectiveCurveToRelative(-0.67f, 1.5f, -1.5f, 1.5f);
        a.g(pathBuilderI, 22.0f, 8.0f, -6.0f);
