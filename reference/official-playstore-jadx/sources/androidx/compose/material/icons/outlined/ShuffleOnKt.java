...
public final class ShuffleOnKt {
    ...
    public static final ImageVector getShuffleOn(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ShuffleOn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.y(pathBuilderQ, 4.0f, 5.42f, 5.41f, 4.0f);
        a.C(pathBuilderQ, 20.0f, 20.0f, -6.0f, -2.0f);
        pathBuilderQ.horizontalLineToRelative(2.61f);
        pathBuilderQ.lineToRelative(-3.2f, -3.2f);
        pathBuilderQ.lineToRelative(1.42f, -1.42f);
        pathBuilderQ.lineToRelative(3.13f, 3.13f);
        b.n(pathBuilderQ, 18.0f, 16.55f, 14.0f, 2.0f);
        a.D(pathBuilderQ, 20.0f, 20.0f, 10.0f, -2.0f);
        pathBuilderQ.verticalLineTo(7.42f);
        pathBuilderQ.lineTo(5.41f, 20.0f);
        pathBuilderQ.lineTo(4.0f, 18.59f);
        b.p(pathBuilderQ, 16.58f, 6.0f, 14.0f, 4.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderQ, 6.0f, 10.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
