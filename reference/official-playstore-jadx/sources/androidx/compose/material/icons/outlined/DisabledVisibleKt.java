...
public final class DisabledVisibleKt {
    ...
    public static final ImageVector getDisabledVisible(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DisabledVisible", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(20.76f, 19.02f, 18.95f, 20.0f, 17.0f, 20.0f);
        pathBuilderA.reflectiveCurveToRelative(-3.76f, -0.98f, -4.75f, -2.5f);
        pathBuilderA.curveTo(13.24f, 15.98f, 15.05f, 15.0f, 17.0f, 15.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.reflectiveCurveTo(16.17f, 16.0f, 17.0f, 16.0f);
        pathBuilderA.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderA.reflectiveCurveTo(17.83f, 19.0f, 17.0f, 19.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(21.99f, 12.34f);
