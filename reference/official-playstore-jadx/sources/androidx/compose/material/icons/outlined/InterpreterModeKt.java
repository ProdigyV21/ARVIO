...
public final class InterpreterModeKt {
    ...
    public static final ImageVector getInterpreterMode(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.InterpreterMode", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderA.reflectiveCurveTo(13.0f, 6.9f, 13.0f, 8.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(15.0f, 15.0f);
        pathBuilderA.curveToRelative(-2.37f, 0.0f, -4.29f, 0.73f, -5.48f, 1.34f);
        pathBuilderA.curveTo(9.2f, 16.5f, 9.0f, 16.84f, 9.0f, 17.22f);
        pathBuilderA.verticalLineTo(18.0f);
        pathBuilderA.lineToRelative(7.17f, 0.0f);
        pathBuilderA.curveToRelative(0.5f, 0.86f, 1.25f, 1.56f, 2.15f, 2.0f);
        pathBuilderA.lineTo(7.0f, 20.0f);
        pathBuilderA.verticalLineToRelative(-2.78f);
        pathBuilderA.curveToRelative(0.0f, -1.12f, 0.61f, -2.15f, 1.61f, -2.66f);
        pathBuilderA.curveTo(10.29f, 13.7f, 12.47f, 13.0f, 15.0f, 13.0f);
        pathBuilderA.curveToRelative(0.39f, 0.0f, 0.77f, 0.02f, 1.14f, 0.05f);
        pathBuilderA.curveToRelative(-0.33f, 0.59f, -0.55f, 1.26f, -0.62f, 1.96f);
        pathBuilderA.curveTo(15.35f, 15.0f, 15.18f, 15.0f, 15.0f, 15.0f);
        pathBuilderA.close();
