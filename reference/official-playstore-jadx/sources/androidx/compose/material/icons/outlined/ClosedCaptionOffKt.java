...
public final class ClosedCaptionOffKt {
    ...
    public static final ImageVector getClosedCaptionOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ClosedCaptionOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderQ = a.q(19.0f, 4.0f, 5.0f);
        ...
        pathBuilderQ.curveTo(21.0f, 4.9f, 20.1f, 4.0f, 19.0f, 4.0f);
        f.o(pathBuilderQ, 19.0f, 18.0f, 5.0f, 6.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderQ, 14.0f, 18.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a0.a.A(pathBuilderA, -1.0f, 9.5f, 0.5f, -2.0f);
        c.p(pathBuilderA, -3.0f, 2.0f, 11.0f, 11.0f);
        ...
        PathBuilder pathBuilderA2 = a.a(14.0f, 15.0f, 3.0f);
        pathBuilderA2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        b.z(pathBuilderA2, -1.0f, -1.5f, 0.5f, -2.0f);
        c.p(pathBuilderA2, -3.0f, 2.0f, 11.0f, 18.0f);
        ...
        pathBuilderA2.curveTo(13.0f, 14.55f, 13.45f, 15.0f, 14.0f, 15.0f);
        pathBuilderA2.close();
