...
public final class PriceCheckKt {
    ...
    public static final ImageVector getPriceCheck(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PriceCheck", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = e.a(11.0f, 13.0f, 9.0f);
        ...
        a.t(pathBuilderA, 8.5f, 3.0f, -2.0f, 1.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        a0.a.y(pathBuilderA, 4.0f, 2.0f, 4.0f, 2.0f);
        v.a.o(pathBuilderA, 2.5f, 1.0f, 2.0f, -1.0f);
        pathBuilderA.horizontalLineTo(10.0f);
        pathBuilderA.curveTo(10.55f, 14.0f, 11.0f, 13.55f, 11.0f, 13.0f);
        pathBuilderA.close();
