...
public final class SwitchAccessShortcutAddKt {
    ...
    public static final ImageVector getSwitchAccessShortcutAdd(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SwitchAccessShortcutAdd", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -3.09f, 1.38f, -5.94f, 3.44f, -8.0f);
        b.n(pathBuilderJ, 12.0f, 4.0f, 2.0f, 7.0f);
        d.D(pathBuilderJ, 7.0f, -2.0f, 0.0f, -3.72f);
        pathBuilderJ.curveToRelative(-1.8f, 1.74f, -3.0f, 4.2f, -3.0f, 6.72f);
        ...
        b.w(pathBuilderJ, 24.0f, 14.0f, -2.0f, -2.0f);
