...
public final class CurrencyLiraKt {
    ...
    public static final ImageVector getCurrencyLira(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.CurrencyLira", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = a.a(9.0f, 8.76f, 3.0f, 2.0f, 4.51f);
        pathBuilderA.lineTo(15.0f, 5.0f);
        pathBuilderA.verticalLineToRelative(2.36f);
        pathBuilderA.lineToRelative(-4.0f, 2.51f);
        pathBuilderA.lineToRelative(0.01f, 2.35f);
        pathBuilderA.lineTo(15.0f, 9.72f);
        a.l(pathBuilderA, 2.36f, -4.0f, 2.51f, 19.0f);
        ...
        a.D(pathBuilderA, 9.0f, -5.16f, -3.0f, 1.88f);
        pathBuilderA.lineToRelative(0.0f, -2.36f);
        pathBuilderA.lineToRelative(3.0f, -1.88f);
        pathBuilderA.verticalLineToRelative(-2.36f);
        pathBuilderA.lineTo(6.0f, 13.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderA, 0.0f, -2.36f, 9.0f, 8.76f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
