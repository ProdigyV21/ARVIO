...
public final class LocalGasStationKt {
    ...
    public static final ImageVector getLocalGasStation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.LocalGasStation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderR, 12.0f, 13.5f, 12.0f, 19.0f);
        a.h(pathBuilderR, 6.0f, 19.0f, -7.0f, 6.0f);
        b.f(pathBuilderR, 1.5f, 12.0f, 10.0f);
        pathBuilderR.lineTo(6.0f, 10.0f);
