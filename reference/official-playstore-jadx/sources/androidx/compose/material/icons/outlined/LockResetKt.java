...
public final class LockResetKt {
    ...
    public static final ImageVector getLockReset(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.LockReset", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.06f, 0.01f, 0.12f, 0.01f, 0.19f);
        ...
        pathBuilderA.curveTo(6.01f, 12.11f, 6.0f, 12.06f, 6.0f, 12.0f);
        ...
        pathBuilderA.curveToRelative(-1.9f, 0.0f, -3.62f, -0.76f, -4.88f, -1.99f);
        pathBuilderA.lineTo(6.7f, 18.42f);
        pathBuilderA.curveTo(8.32f, 20.01f, 10.55f, 21.0f, 13.0f, 21.0f);
        pathBuilderA.curveToRelative(4.97f, 0.0f, 9.0f, -4.03f, 9.0f, -9.0f);
        pathBuilderA.reflectiveCurveTo(17.97f, 3.0f, 13.0f, 3.0f);
