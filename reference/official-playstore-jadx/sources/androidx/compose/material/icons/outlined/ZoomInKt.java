...
public final class ZoomInKt {
    ...
    public static final ImageVector getZoomIn(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ZoomIn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderG, 10.0f, 7.0f, 9.0f, 7.0f);
        d.r(pathBuilderG, 2.0f, 7.0f, 9.0f, 1.0f);
        a.o(pathBuilderG, 2.0f, 2.0f, 1.0f, -2.0f);
