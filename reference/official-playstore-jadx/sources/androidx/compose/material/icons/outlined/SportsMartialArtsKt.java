...
public final class SportsMartialArtsKt {
    ...
    public static final ImageVector getSportsMartialArts(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SportsMartialArts", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(19.8f, 2.0f, -8.2f, 6.7f);
        pathBuilderR.lineToRelative(-1.21f, -1.04f);
        pathBuilderR.lineToRelative(3.6f, -2.08f);
        pathBuilderR.lineToRelative(-4.58f, -4.58f);
        pathBuilderR.lineToRelative(-1.41f, 1.41f);
        pathBuilderR.lineToRelative(2.74f, 2.74f);
        pathBuilderR.lineToRelative(-5.74f, 3.31f);
        pathBuilderR.lineToRelative(-1.19f, 4.29f);
        pathBuilderR.lineToRelative(2.46f, 4.25f);
        pathBuilderR.lineToRelative(1.73f, -1.0f);
        pathBuilderR.lineToRelative(-2.03f, -3.52f);
        pathBuilderR.lineToRelative(0.35f, -1.3f);
        pathBuilderR.lineToRelative(3.18f, 1.82f);
        pathBuilderR.lineToRelative(0.5f, 9.0f);
        pathBuilderR.lineToRelative(2.0f, 0.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 0.5f, -10.0f, 8.5f, -8.6f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
