...
public final class HowToVoteKt {
    ...
    public static final ImageVector getHowToVote(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.HowToVote", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.h(pathBuilderG, 5.0f, 20.0f, -1.0f, 14.0f);
        b.f(pathBuilderG, 1.0f, 11.34f, 15.02f);
        ...
        pathBuilderG.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        b.C(pathBuilderG, 4.95f, 4.95f, 13.46f, 4.41f);
