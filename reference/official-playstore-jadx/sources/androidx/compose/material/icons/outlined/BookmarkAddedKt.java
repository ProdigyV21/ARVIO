...
public final class BookmarkAddedKt {
    ...
    public static final ImageVector getBookmarkAdded(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.BookmarkAdded", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderG.moveTo(17.83f, 9.0f);
        pathBuilderG.lineTo(15.0f, 6.17f);
        pathBuilderG.lineToRelative(1.41f, -1.41f);
        pathBuilderG.lineToRelative(1.41f, 1.41f);
        pathBuilderG.lineToRelative(3.54f, -3.54f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderG, 1.41f, 1.41f, 17.83f, 9.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
