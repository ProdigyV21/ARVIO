...
public final class TableRestaurantKt {
    ...
    public static final ImageVector getTableRestaurant(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.TableRestaurant", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.B(pathBuilderR, 9.6f, 0.27f, 2.0f, 6.93f);
        pathBuilderR.moveTo(4.33f, 9.0f);
        pathBuilderR.lineToRelative(0.86f, -3.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.r(pathBuilderR, 13.63f, 0.86f, 3.0f, 4.33f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
