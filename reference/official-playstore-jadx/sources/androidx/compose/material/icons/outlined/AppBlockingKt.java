...
public final class AppBlockingKt {
    ...
    public static final ImageVector getAppBlocking(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AppBlocking", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderC.verticalLineToRelative(-1.0f);
        pathBuilderC.horizontalLineToRelative(-2.0f);
        a.D(pathBuilderC, 18.0f, 7.0f, 3.0f, 10.0f);
        d.u(pathBuilderC, 1.0f, 7.0f, 3.0f);
        a.A(pathBuilderC, 17.0f, 21.0f, 7.0f, -1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderC, 10.0f, 21.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
