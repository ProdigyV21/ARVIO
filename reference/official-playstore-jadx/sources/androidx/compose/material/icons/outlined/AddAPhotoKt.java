...
public final class AddAPhotoKt {
    ...
    public static final ImageVector getAddAPhoto(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AddAPhoto", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderI = e.i(21.0f, 6.0f, -3.17f, 16.0f, 4.0f);
        e.g(pathBuilderI, -6.0f, 2.0f, 5.12f);
        pathBuilderI.lineToRelative(1.83f, 2.0f);
        pathBuilderI.lineTo(21.0f, 8.0f);
        d.r(pathBuilderI, 12.0f, 5.0f, 20.0f, -9.0f);
        pathBuilderI.lineTo(3.0f, 11.0f);
        ...
        pathBuilderI.reflectiveCurveToRelative(1.35f, -3.0f, 3.0f, -3.0f);
        a.g(pathBuilderI, 5.0f, 6.0f, 3.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.j(pathBuilderI, 3.0f, 3.0f, 2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
