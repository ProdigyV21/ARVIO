...
public final class SoapKt {
    ...
    public static final ImageVector getSoap(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Soap", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderA, 20.0f, 4.0f, 16.5f, 1.0f);
        ...
        pathBuilderA.reflectiveCurveTo(17.33f, 1.0f, 16.5f, 1.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(20.75f, 16.0f);
