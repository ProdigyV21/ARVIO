...
public final class MotionPhotosAutoKt {
    ...
    public static final ImageVector getMotionPhotosAuto(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MotionPhotosAuto", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.moveTo(11.29f, 7.5f);
        e.C(pathBuilderR, 1.43f, 3.01f, 8.0f, -1.39f);
        pathBuilderR.lineToRelative(-0.72f, -2.04f);
        w.a.f(pathBuilderR, -3.23f, 9.66f, 15.5f, 8.28f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 11.29f, 7.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
