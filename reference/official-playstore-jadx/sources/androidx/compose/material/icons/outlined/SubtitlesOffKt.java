...
public final class SubtitlesOffKt {
    ...
    public static final ImageVector getSubtitlesOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SubtitlesOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = b.b(20.0f, 4.0f, 6.83f, 2.0f, 2.0f);
        a.D(pathBuilderB, 20.0f, 11.17f, 1.76f, 1.76f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(v.a.r(18.0f, 10.0f, -5.17f, 0.0f), 2.0f, 2.0f, 3.17f, 0.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m3498getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3803getButtKaPHkGw(), companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw2 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk82 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = v.a.r(1.04f, 3.87f, 1.2f, 1.2f);
        ...
        pathBuilderR.lineToRelative(2.96f, 2.96f);
        pathBuilderR.lineToRelative(1.41f, -1.41f);
        b.y(pathBuilderR, 2.45f, 2.45f, 1.04f, 3.87f);
        pathBuilderR.moveTo(4.0f, 6.83f);
        b.m(pathBuilderR, 7.17f, 10.0f, 6.0f, 2.0f);
        c.q(pathBuilderR, 2.0f, -1.17f, 11.17f, 14.0f);
        v.a.n(pathBuilderR, 6.0f, 2.0f, 7.17f);
        pathBuilderR.lineToRelative(2.0f, 2.0f);
        pathBuilderR.horizontalLineTo(4.0f);
        pathBuilderR.verticalLineTo(6.83f);
        pathBuilderR.close();
