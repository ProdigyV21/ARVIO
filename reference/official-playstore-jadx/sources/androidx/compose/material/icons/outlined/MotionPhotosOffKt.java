...
public final class MotionPhotosOffKt {
    ...
    public static final ImageVector getMotionPhotosOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MotionPhotosOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.lineToRelative(2.27f, 2.27f);
        d.C(pathBuilderJ, 1.41f, -1.42f, 2.81f, 2.81f);
        ...
        pathBuilderJ.lineToRelative(10.93f, 10.94f);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.48f, -0.41f, 2.86f, -1.12f, 4.05f);
