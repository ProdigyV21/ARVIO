...
public final class LoupeKt {
    ...
    public static final ImageVector getLoupe(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Loupe", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -5.51f, -4.49f, -10.0f, -10.0f, -10.0f);
        pathBuilderA.close();
