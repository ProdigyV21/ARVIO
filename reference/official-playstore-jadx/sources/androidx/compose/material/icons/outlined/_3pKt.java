...
public final class _3pKt {
    ...
    public static final ImageVector get_3p(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined._3p", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.r(pathBuilderQ, 16.0f, 12.0f, 10.0f);
        pathBuilderQ.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderQ.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderQ.reflectiveCurveToRelative(-2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilderQ.reflectiveCurveTo(10.9f, 10.0f, 12.0f, 10.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(16.0f, 13.43f);
        pathBuilderQ.curveToRelative(0.0f, -0.81f, -0.48f, -1.53f, -1.22f, -1.85f);
        pathBuilderQ.curveTo(13.93f, 11.21f, 12.99f, 11.0f, 12.0f, 11.0f);
        pathBuilderQ.curveToRelative(-0.99f, 0.0f, -1.93f, 0.21f, -2.78f, 0.58f);
        pathBuilderQ.curveTo(8.48f, 11.9f, 8.0f, 12.62f, 8.0f, 13.43f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, f.m(pathBuilderQ, 14.0f, 8.0f, 13.43f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
