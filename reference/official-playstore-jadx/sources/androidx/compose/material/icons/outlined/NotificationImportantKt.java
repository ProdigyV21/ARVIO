...
public final class NotificationImportantKt {
    ...
    public static final ImageVector getNotificationImportant(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NotificationImportant", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.w(pathBuilderA, 11.0f, 8.0f, 2.0f, 4.0f);
        e.r(pathBuilderA, -2.0f, 11.0f, 14.0f, 2.0f);
