...
public final class WatchOffKt {
    ...
    public static final ImageVector getWatchOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WatchOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderA, 10.49f, 4.0f, 3.02f);
        pathBuilderA.lineToRelative(0.38f, 1.27f);
        pathBuilderA.curveToRelative(-0.55f, -0.16f, -1.97f, -0.51f, -3.78f, 0.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 10.49f, 4.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderJ.moveTo(13.51f, 20.0f);
        pathBuilderJ.horizontalLineToRelative(-3.02f);
        pathBuilderJ.lineToRelative(-0.38f, -1.27f);
        pathBuilderJ.curveToRelative(0.55f, 0.15f, 1.97f, 0.51f, 3.78f, 0.0f);
        c.z(pathBuilderJ, 13.51f, 20.0f, 12.0f, 17.0f);
