...
public final class SpatialAudioOffKt {
    ...
    public static final ImageVector getSpatialAudioOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SpatialAudioOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA3 = c.a(17.54f, 10.9f);
        pathBuilderA3.curveToRelative(1.95f, -1.95f, 1.95f, -5.12f, 0.0f, -7.07f);
        pathBuilderA3.lineToRelative(-1.41f, 1.41f);
        pathBuilderA3.curveToRelative(1.17f, 1.17f, 1.17f, 3.07f, 0.0f, 4.24f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA3, 17.54f, 10.9f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
