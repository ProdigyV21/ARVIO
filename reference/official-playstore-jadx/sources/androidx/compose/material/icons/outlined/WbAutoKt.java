...
public final class WbAutoKt {
    ...
    public static final ImageVector getWbAuto(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WbAuto", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderC.moveTo(22.0f, 7.0f);
        ...
        d.C(pathBuilderC, 2.05f, -9.0f, 22.0f, 7.0f);
