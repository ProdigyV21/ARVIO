...
public final class AddLocationAltKt {
    ...
    public static final ImageVector getAddLocationAlt(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AddLocationAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderU.reflectiveCurveToRelative(-0.9f, 2.0f, -2.0f, 2.0f);
        d.k(pathBuilderU, 13.0f, 3.06f, 2.02f);
        pathBuilderU.arcTo(6.53f, 6.53f, 0.0f, false, false, 12.0f, 5.0f);
        pathBuilderU.curveToRelative(-3.35f, 0.0f, -6.0f, 2.57f, -6.0f, 6.2f);
        pathBuilderU.curveToRelative(0.0f, 2.34f, 1.95f, 5.44f, 6.0f, 9.14f);
        pathBuilderU.curveToRelative(4.05f, -3.7f, 6.0f, -6.79f, 6.0f, -9.14f);
        b.A(pathBuilderU, 18.0f, 11.0f, 2.0f, 0.2f);
        ...
        pathBuilderU.curveToRelative(0.34f, 0.0f, 0.67f, 0.02f, 1.0f, 0.06f);
        pathBuilderU.close();
