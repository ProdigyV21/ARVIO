...
public final class SimCardKt {
    ...
    public static final ImageVector getSimCard(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SimCard", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.C(pathBuilderI, 7.0f, 17.0f, 2.0f, 2.0f);
        c.z(pathBuilderI, 7.0f, 19.0f, 15.0f, 17.0f);
        d.x(pathBuilderI, 2.0f, 2.0f, -2.0f);
        a.C(pathBuilderI, 7.0f, 11.0f, 2.0f, 4.0f);
