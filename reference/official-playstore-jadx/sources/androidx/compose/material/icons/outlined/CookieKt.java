...
public final class CookieKt {
    ...
    public static final ImageVector getCookie(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Cookie", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(10.5f, 8.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = a.b(8.5f, 13.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB3 = a.b(15.0f, 15.0f, -1.0f, 0.0f);
        ...
        pathBuilderA.curveToRelative(-2.97f, 1.0f, -5.78f, -1.59f, -5.19f, -4.56f);
        pathBuilderA.curveTo(7.11f, 0.74f, 2.0f, 6.41f, 2.0f, 12.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, -3.31f, 2.73f, -8.18f, 8.08f, -8.02f);
        pathBuilderA.curveToRelative(0.42f, 2.54f, 2.44f, 4.56f, 4.99f, 4.94f);
        pathBuilderA.curveToRelative(0.07f, 0.36f, 0.52f, 2.55f, 2.92f, 3.63f);
        pathBuilderA.curveTo(19.7f, 16.86f, 16.06f, 20.0f, 12.0f, 20.0f);
        pathBuilderA.close();
