...
public final class EuroKt {
    ...
    public static final ImageVector getEuro(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Euro", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.j(pathBuilderA, 15.0f, 1.0f, -2.0f, 8.58f);
        ...
        b.j(pathBuilderA, 15.0f, 1.0f, -2.0f, 9.24f);
        ...
        pathBuilderA.curveTo(18.09f, 17.91f, 16.62f, 18.5f, 15.0f, 18.5f);
        pathBuilderA.close();
