...
public final class SmartToyKt {
    ...
    public static final ImageVector getSmartToy(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SmartToy", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.verticalLineToRelative(-4.0f);
        pathBuilderA.curveToRelative(1.66f, 0.0f, 3.0f, -1.34f, 3.0f, -3.0f);
        pathBuilderA.reflectiveCurveTo(21.66f, 9.0f, 20.0f, 9.0f);
        a.p(pathBuilderA, 18.0f, 19.0f, 6.0f, 19.0f);
        f.k(pathBuilderA, 7.0f, 12.0f, 19.0f);
        pathBuilderA.moveTo(9.0f, 13.0f);
        pathBuilderA.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderA.reflectiveCurveTo(8.17f, 10.0f, 9.0f, 10.0f);
        pathBuilderA.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderA.reflectiveCurveTo(9.83f, 13.0f, 9.0f, 13.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.5f, 11.5f);
        pathBuilderA.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilderA.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderA.reflectiveCurveTo(14.17f, 10.0f, 15.0f, 10.0f);
        pathBuilderA.reflectiveCurveTo(16.5f, 10.67f, 16.5f, 11.5f);
        b.w(pathBuilderA, 8.0f, 15.0f, 8.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.m(pathBuilderA, 8.0f, 15.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
