...
public final class BluetoothDriveKt {
    ...
    public static final ImageVector getBluetoothDrive(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.BluetoothDrive", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderH = b.h(18.0f, 17.0f, 4.0f, -5.0f, 11.0f);
        a0.a.o(pathBuilderH, -2.0f, 4.81f, 1.04f, -3.0f);
        a0.b.i(pathBuilderH, 15.0f, 5.0f, 5.5f);
        ...
        pathBuilderH.horizontalLineToRelative(1.0f);
        pathBuilderH.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.p(pathBuilderH, -8.0f, -2.0f, 17.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderT.lineToRelative(-0.94f, 0.94f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, w.a.c(pathBuilderT, 7.2f, 20.59f, 8.14f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
