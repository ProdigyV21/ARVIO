...
public final class RecentActorsKt {
    ...
    public static final ImageVector getRecentActors(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RecentActors", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.x(pathBuilderB, -2.0f, 14.0f, 5.0f);
        ...
        pathBuilderB.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        a.p(pathBuilderB, 13.0f, 17.0f, 3.0f, 17.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.x(pathBuilderB, 3.0f, 7.0f, 10.0f, 10.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderA = c.a(11.89f, 15.35f);
        pathBuilderA.curveToRelative(0.0f, -1.3f, -2.59f, -1.95f, -3.89f, -1.95f);
        pathBuilderA.reflectiveCurveToRelative(-3.89f, 0.65f, -3.89f, 1.95f);
        pathBuilderA.verticalLineTo(16.0f);
        pathBuilderA.horizontalLineToRelative(7.78f);
