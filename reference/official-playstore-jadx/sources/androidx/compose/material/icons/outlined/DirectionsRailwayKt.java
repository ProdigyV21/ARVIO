...
public final class DirectionsRailwayKt {
    ...
    public static final ImageVector getDirectionsRailway(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DirectionsRailway", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(6.0f, 0.0f, 6.0f, 1.2f, 6.0f, 2.0f);
        pathBuilderA.lineTo(6.0f, 5.0f);
        pathBuilderA.curveToRelative(0.0f, -0.8f, 0.0f, -2.0f, 6.0f, -2.0f);
        d.k(pathBuilderA, 18.0f, 7.0f, 3.0f);
        pathBuilderA.lineTo(6.0f, 10.0f);
        f.n(pathBuilderA, 6.0f, 7.0f, 12.0f);
