...
public final class SnowmobileKt {
    ...
    public static final ImageVector getSnowmobile(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Snowmobile", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.0f, -8.0f, -8.0f, -8.0f, -8.0f);
        e.g(pathBuilderA, -3.0f, 2.0f, 2.25f);
        pathBuilderA.lineToRelative(0.8f, 0.72f);
        ...
        a.s(pathBuilderA, 22.0f, 8.0f, 18.0f, 2.0f);
        ...
        v.a.g(pathBuilderA, 17.0f, 14.0f, -6.7f);
        pathBuilderA.lineToRelative(-7.45f, -2.23f);
