...
public final class WifiFindKt {
    ...
    public static final ImageVector getWifiFind(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WifiFind", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(4.14f, 0.0f, 7.88f, 1.68f, 10.59f, 4.39f);
        ...
        pathBuilderA2.curveToRelative(-1.12f, 0.0f, -2.0f, -0.88f, -2.0f, -2.0f);
        ...
        pathBuilderA2.curveTo(19.0f, 15.12f, 18.12f, 16.0f, 17.0f, 16.0f);
        pathBuilderA2.close();
