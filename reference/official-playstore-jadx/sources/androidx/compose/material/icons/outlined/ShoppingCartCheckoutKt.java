...
public final class ShoppingCartCheckoutKt {
    ...
    public static final ImageVector getShoppingCartCheckout(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ShoppingCartCheckout", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderA, 8.1f, 13.0f, 7.45f);
        ...
        a0.a.i(pathBuilderA, 12.0f, -2.0f, 7.0f);
        c.z(pathBuilderA, 8.1f, 13.0f, 12.0f, 2.0f);
