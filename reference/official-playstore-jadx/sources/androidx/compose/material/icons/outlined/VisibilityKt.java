...
public final class VisibilityKt {
    ...
    public static final ImageVector getVisibility(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Visibility", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(19.17f, 14.87f, 15.79f, 17.0f, 12.0f, 17.0f);
        pathBuilderA.reflectiveCurveToRelative(-7.17f, -2.13f, -8.82f, -5.5f);
        pathBuilderA.curveTo(4.83f, 8.13f, 8.21f, 6.0f, 12.0f, 6.0f);
        pathBuilderA.moveToRelative(0.0f, -2.0f);
        pathBuilderA.curveTo(7.0f, 4.0f, 2.73f, 7.11f, 1.0f, 11.5f);
        ...
        pathBuilderA.reflectiveCurveTo(13.38f, 14.0f, 12.0f, 14.0f);
        pathBuilderA.reflectiveCurveToRelative(-2.5f, -1.12f, -2.5f, -2.5f);
        pathBuilderA.reflectiveCurveTo(10.62f, 9.0f, 12.0f, 9.0f);
        pathBuilderA.moveToRelative(0.0f, -2.0f);
        pathBuilderA.curveToRelative(-2.48f, 0.0f, -4.5f, 2.02f, -4.5f, 4.5f);
        pathBuilderA.reflectiveCurveTo(9.52f, 16.0f, 12.0f, 16.0f);
        pathBuilderA.reflectiveCurveToRelative(4.5f, -2.02f, 4.5f, -4.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 14.48f, 7.0f, 12.0f, 7.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
