...
public final class HeatPumpKt {
    ...
    public static final ImageVector getHeatPump(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.HeatPump", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 8.69f, 9.75f, 1.5f, 1.5f);
        pathBuilderA.horizontalLineTo(8.08f);
        pathBuilderA.curveTo(8.18f, 10.7f, 8.39f, 10.2f, 8.69f, 9.75f);
        a.z(pathBuilderA, 10.19f, 12.75f, -1.5f, 1.5f);
        pathBuilderA.curveToRelative(-0.3f, -0.44f, -0.51f, -0.95f, -0.62f, -1.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderA, 10.19f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
