...
public final class LockPersonKt {
    ...
    public static final ImageVector getLockPerson(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.LockPerson", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(6.0f, 20.0f, 10.0f, 12.0f, 1.0f);
        ...
        v.a.x(pathBuilderA, 6.0f, 9.0f, 6.0f);
