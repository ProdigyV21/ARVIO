...
public final class NightlightRoundKt {
    ...
    public static final ImageVector getNightlightRound(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NightlightRound", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(17.55f, 2.16f, 16.55f, 2.0f, 15.5f, 2.0f);
        pathBuilderA.curveToRelative(-5.52f, 0.0f, -10.0f, 4.48f, -10.0f, 10.0f);
        pathBuilderA.reflectiveCurveTo(9.98f, 22.0f, 15.5f, 22.0f);
