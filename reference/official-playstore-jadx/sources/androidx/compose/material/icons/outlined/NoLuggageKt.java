...
public final class NoLuggageKt {
    ...
    public static final ImageVector getNoLuggage(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NoLuggage", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = a.a(16.0f, 13.17f, -1.5f, -1.5f, 9.0f);
        c.l(pathBuilderA, 16.0f, 13.17f, 19.78f, 22.61f);
        pathBuilderA.lineToRelative(-1.85f, -1.85f);
        pathBuilderA.curveTo(17.65f, 20.91f, 17.34f, 21.0f, 17.0f, 21.0f);
        ...
        b.o(pathBuilderA, -3.42f, -3.42f, 18.0f, -1.5f);
        pathBuilderA.verticalLineToRelative(-3.92f);
        pathBuilderA.lineTo(9.5f, 12.33f);
        pathBuilderA.verticalLineTo(18.0f);
        a0.a.D(pathBuilderA, 8.0f, -7.17f, -1.0f, -1.0f);
        c.n(pathBuilderA, 19.0f, 16.17f, 12.75f, 9.0f);
        pathBuilderA.horizontalLineToRelative(-0.92f);
        pathBuilderA.lineToRelative(0.92f, 0.92f);
        pathBuilderA.verticalLineTo(9.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(19.0f, 8.0f);
        a0.a.l(pathBuilderA, 8.17f, -2.0f, -2.0f, 8.0f);
        pathBuilderA.horizontalLineToRelative(-6.17f);
        pathBuilderA.lineTo(9.84f, 7.01f);
        pathBuilderA.lineTo(9.0f, 6.17f);
        ...
        pathBuilderA.curveTo(18.1f, 6.0f, 19.0f, 6.9f, 19.0f, 8.0f);
        v.a.u(pathBuilderA, 10.5f, 6.0f, 3.0f, 3.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.a.e(pathBuilderA, -3.0f, 6.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
