...
public final class DownloadingKt {
    ...
    public static final ImageVector getDownloading(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Downloading", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 15.59f, 10.59f, 13.0f, 13.17f);
        w.a.j(pathBuilderA, 7.0f, -2.0f, 6.17f);
        pathBuilderA.lineToRelative(-2.59f, -2.59f);
        pathBuilderA.lineTo(7.0f, 12.0f);
        pathBuilderA.lineToRelative(5.0f, 5.0f);
        d.C(pathBuilderA, 5.0f, -5.0f, 15.59f, 10.59f);
