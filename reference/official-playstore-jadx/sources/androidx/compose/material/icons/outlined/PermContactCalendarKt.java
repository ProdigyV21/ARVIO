...
public final class PermContactCalendarKt {
    ...
    public static final ImageVector getPermContactCalendar(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PermContactCalendar", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 5.0f, 19.0f, 5.0f, 5.0f);
        d.m(pathBuilderA, 14.0f, 14.0f, 5.0f, 19.0f);
