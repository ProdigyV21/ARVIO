...
public final class FiberSmartRecordKt {
    ...
    public static final ImageVector getFiberSmartRecord(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FiberSmartRecord", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-2.69f, 6.0f, -6.0f, 6.0f);
        d.k(pathBuilderA, 17.0f, 4.26f, 2.09f);
        pathBuilderA.curveToRelative(2.33f, 0.82f, 4.0f, 3.04f, 4.0f, 5.65f);
        pathBuilderA.reflectiveCurveToRelative(-1.67f, 4.83f, -4.0f, 5.65f);
        pathBuilderA.verticalLineToRelative(2.09f);
        pathBuilderA.curveToRelative(3.45f, -0.89f, 6.0f, -4.01f, 6.0f, -7.74f);
        pathBuilderA.curveToRelative(0.0f, -3.73f, -2.55f, -6.85f, -6.0f, -7.74f);
        pathBuilderA.close();
