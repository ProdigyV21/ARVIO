...
public final class SentimentVerySatisfiedKt {
    ...
    public static final ImageVector getSentimentVerySatisfied(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SentimentVerySatisfied", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        a.p(pathBuilderA, 13.0f, 9.94f, 14.06f, 11.0f);
        pathBuilderA.lineToRelative(1.06f, -1.06f);
        pathBuilderA.lineTo(16.18f, 11.0f);
        pathBuilderA.lineToRelative(1.06f, -1.06f);
        d.C(pathBuilderA, -2.12f, -2.12f, 13.0f, 9.94f);
        pathBuilderA.moveTo(8.88f, 9.94f);
        pathBuilderA.lineTo(9.94f, 11.0f);
        pathBuilderA.lineTo(11.0f, 9.94f);
        pathBuilderA.lineTo(8.88f, 7.82f);
        pathBuilderA.lineTo(6.76f, 9.94f);
        d.l(pathBuilderA, 7.82f, 11.0f, 1.06f, -1.06f);
