...
public final class ElectricCarKt {
    ...
    public static final ImageVector getElectricCar(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ElectricCar", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.n(pathBuilderA, 10.29f, 1.08f, 3.11f, 5.77f);
        c.z(pathBuilderA, 6.85f, 3.0f, 19.0f, 13.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, w.a.i(pathBuilderA, 5.0f, 8.0f, 14.0f, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
