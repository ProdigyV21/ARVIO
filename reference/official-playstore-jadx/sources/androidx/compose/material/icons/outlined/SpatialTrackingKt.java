...
public final class SpatialTrackingKt {
    ...
    public static final ImageVector getSpatialTracking(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SpatialTracking", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = v.a.j(20.05f, 2.41f, 18.64f, 1.0f);
        pathBuilderJ.curveToRelative(-3.51f, 3.51f, -3.51f, 9.21f, 0.0f, 12.73f);
        pathBuilderJ.lineToRelative(1.41f, -1.41f);
        pathBuilderJ.curveTo(17.32f, 9.58f, 17.32f, 5.14f, 20.05f, 2.41f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderR = v.a.r(22.88f, 5.24f, -1.41f, -1.41f);
        pathBuilderR.curveToRelative(-1.95f, 1.95f, -1.95f, 5.12f, 0.0f, 7.07f);
        pathBuilderR.lineToRelative(1.41f, -1.41f);
        pathBuilderR.curveTo(21.71f, 8.32f, 21.71f, 6.41f, 22.88f, 5.24f);
        pathBuilderR.close();
