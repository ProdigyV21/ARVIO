...
public final class NotificationsOffKt {
    ...
    public static final ImageVector getNotificationsOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NotificationsOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.18f, -0.02f, 0.36f, -0.05f, 0.55f, -0.05f);
        a.p(pathBuilderA, 5.41f, 3.35f, 4.0f, 4.76f);
        pathBuilderA.lineToRelative(2.81f, 2.81f);
        pathBuilderA.curveTo(6.29f, 8.57f, 6.0f, 9.74f, 6.0f, 11.0f);
        e.v(pathBuilderA, 5.0f, -2.0f, 2.0f, 1.0f);
        pathBuilderA.horizontalLineToRelative(14.24f);
        pathBuilderA.lineToRelative(1.74f, 1.74f);
        d.C(pathBuilderA, 1.41f, -1.41f, 5.41f, 3.35f);
        pathBuilderA.moveTo(16.0f, 17.0f);
        pathBuilderA.lineTo(8.0f, 17.0f);
        pathBuilderA.verticalLineToRelative(-6.0f);
        pathBuilderA.curveToRelative(0.0f, -0.68f, 0.12f, -1.32f, 0.34f, -1.9f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderA, 16.0f, 16.76f, 16.0f, 17.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
