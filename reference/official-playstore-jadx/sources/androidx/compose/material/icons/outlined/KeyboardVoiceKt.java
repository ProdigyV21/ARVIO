...
public final class KeyboardVoiceKt {
    ...
    public static final ImageVector getKeyboardVoice(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardVoice", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(10.8f, 5.9f);
        ...
        pathBuilderA.reflectiveCurveToRelative(-1.2f, -0.54f, -1.2f, -1.2f);
        c.z(pathBuilderA, 10.8f, 5.9f, 17.3f, 12.0f);
