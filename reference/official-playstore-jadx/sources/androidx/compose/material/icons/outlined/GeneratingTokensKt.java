...
public final class GeneratingTokensKt {
    ...
    public static final ImageVector getGeneratingTokens(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.GeneratingTokens", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(12.31f, 18.0f, 9.0f, 18.0f);
        b.w(pathBuilderA, 12.0f, 10.5f, -2.0f, 5.0f);
        a0.b.C(pathBuilderA, 8.0f, -5.0f, 6.0f, 9.0f);
        c.D(pathBuilderA, 6.0f, 10.5f, 20.25f, 3.75f);
        ...
        pathBuilderA.lineToRelative(2.75f, -1.25f);
        b.y(pathBuilderA, 19.0f, 1.0f, 20.25f, 3.75f);
        pathBuilderA.moveTo(20.25f, 17.75f);
        ...
        pathBuilderA.lineToRelative(2.75f, -1.25f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderA, 19.0f, 15.0f, 20.25f, 17.75f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
