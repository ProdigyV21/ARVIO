...
public final class EvStationKt {
    ...
    public static final ImageVector getEvStation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.EvStation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.curveToRelative(-0.94f, 0.36f, -1.61f, 1.26f, -1.61f, 2.33f);
        pathBuilderR.curveToRelative(0.0f, 1.38f, 1.12f, 2.5f, 2.5f, 2.5f);
        pathBuilderR.curveToRelative(0.36f, 0.0f, 0.69f, -0.08f, 1.0f, -0.21f);
        ...
        b.z(pathBuilderR, 16.0f, 10.0f, -7.5f, 1.5f);
        pathBuilderR.verticalLineToRelative(5.0f);
        pathBuilderR.curveToRelative(0.0f, 1.38f, 1.12f, 2.5f, 2.5f, 2.5f);
        ...
        d.k(pathBuilderR, 12.0f, 11.0f, 8.0f);
        pathBuilderR.lineTo(6.0f, 19.0f);
        b.g(pathBuilderR, 6.0f, 5.0f, 6.0f, 6.0f);
        ...
        pathBuilderR.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderR.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        a.z(pathBuilderR, 10.0f, 6.0f, -4.0f, 7.5f);
        pathBuilderR.horizontalLineToRelative(2.0f);
        pathBuilderR.lineTo(8.0f, 18.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a0.a.g(pathBuilderR, 4.0f, -7.0f, -2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
