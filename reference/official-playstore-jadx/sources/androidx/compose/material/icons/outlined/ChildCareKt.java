...
public final class ChildCareKt {
    ...
    public static final ImageVector getChildCare(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ChildCare", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(22.94f, 11.34f);
        ...
        pathBuilderA.curveToRelative(2.01f, 0.0f, 3.74f, -1.23f, 4.5f, -3.0f);
