...
public final class AirlineSeatReclineNormalKt {
    ...
    public static final ImageVector getAirlineSeatReclineNormal(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AirlineSeatReclineNormal", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 6.0f, 16.0f, 6.0f, 7.0f);
        ...
        c.q(pathBuilderA, 6.0f, -2.0f, 9.0f, 19.0f);
        pathBuilderA.curveToRelative(-1.66f, 0.0f, -3.0f, -1.34f, -3.0f, -3.0f);
        a.p(pathBuilderA, 20.0f, 20.07f, 14.93f, 15.0f);
