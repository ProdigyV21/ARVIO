...
public final class FaceRetouchingNaturalKt {
    ...
    public static final ImageVector getFaceRetouchingNatural(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FaceRetouchingNatural", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(19.89f, 10.75f);
        pathBuilderA.curveTo(19.96f, 11.16f, 20.0f, 11.57f, 20.0f, 12.0f);
        ...
        pathBuilderA.curveToRelative(3.38f, 4.14f, 7.97f, 3.73f, 8.99f, 3.61f);
        pathBuilderA.lineToRelative(-0.89f, -1.93f);
        pathBuilderA.curveToRelative(-0.13f, 0.01f, -4.62f, 0.38f, -7.18f, -3.86f);
        pathBuilderA.curveToRelative(1.01f, -0.16f, 1.71f, -0.15f, 2.59f, -0.01f);
        pathBuilderA.curveToRelative(2.52f, -1.15f, 1.93f, -0.89f, 2.76f, -1.26f);
        pathBuilderA.curveTo(14.78f, 2.3f, 13.43f, 2.0f, 12.0f, 2.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.43f, -0.3f, -2.78f, -0.84f, -4.01f);
        c.z(pathBuilderA, 19.89f, 10.75f, 8.08f, 5.03f);
        pathBuilderA.curveTo(7.45f, 6.92f, 6.13f, 8.5f, 4.42f, 9.47f);
        pathBuilderA.curveTo(5.05f, 7.58f, 6.37f, 6.0f, 8.08f, 5.03f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderB = a.b(15.0f, 13.0f, -1.25f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = a.b(9.0f, 13.0f, -1.25f, 0.0f);
        ...
        PathBuilder pathBuilderR = a.r(23.0f, 4.5f, -2.4f, -1.1f);
        pathBuilderR.lineToRelative(-1.1f, -2.4f);
        pathBuilderR.lineToRelative(-1.1f, 2.4f);
        pathBuilderR.lineToRelative(-2.4f, 1.1f);
        pathBuilderR.lineToRelative(2.4f, 1.1f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 1.1f, 2.4f, 1.1f, -2.4f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
