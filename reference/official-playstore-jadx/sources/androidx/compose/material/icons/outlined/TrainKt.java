...
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Train", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.h(pathBuilderA, 6.0f, 20.5f, 0.5f, 2.0f);
        ...
        b.g(pathBuilderA, 6.0f, 12.0f, 12.0f, 3.5f);
        pathBuilderA.moveTo(18.0f, 10.0f);
        c.A(pathBuilderA, -5.0f, 13.0f, 7.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.c(pathBuilderA, 3.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
