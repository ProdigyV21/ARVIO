...
public final class RoomPreferencesKt {
    ...
    public static final ImageVector getRoomPreferences(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RoomPreferences", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = a.r(21.69f, 16.37f, 1.14f, -1.0f);
        ...
        pathBuilderR.lineTo(19.0f, 12.0f);
        ...
        pathBuilderR.lineToRelative(1.45f, -0.49f);
        pathBuilderR.curveToRelative(0.32f, 0.27f, 0.68f, 0.48f, 1.08f, 0.63f);
        pathBuilderR.lineTo(17.0f, 22.0f);
        pathBuilderR.horizontalLineToRelative(2.0f);
        pathBuilderR.lineToRelative(0.3f, -1.49f);
        pathBuilderR.curveToRelative(0.4f, -0.15f, 0.76f, -0.36f, 1.08f, -0.63f);
        pathBuilderR.lineToRelative(1.45f, 0.49f);
        pathBuilderR.lineToRelative(1.0f, -1.73f);
        pathBuilderR.lineToRelative(-1.14f, -1.0f);
        pathBuilderR.curveTo(21.77f, 17.13f, 21.77f, 16.87f, 21.69f, 16.37f);
        pathBuilderR.close();
        ...
        pathBuilderR.reflectiveCurveTo(19.1f, 19.0f, 18.0f, 19.0f);
        c.y(pathBuilderR, 19.0f, 4.0f, 6.0f, -2.0f);
        b.r(pathBuilderR, 6.0f, -2.0f, 6.0f, -2.0f);
        c.o(pathBuilderR, 5.0f, 7.0f, 14.0f, 5.0f);
        a0.a.A(pathBuilderR, 2.0f, 3.0f, -2.0f, 2.0f);
        f.z(pathBuilderR, 3.0f, 10.0f, 1.0f, 19.0f);
        a.C(pathBuilderR, 12.0f, 13.0f, -2.0f, -2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderR, 2.0f, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
