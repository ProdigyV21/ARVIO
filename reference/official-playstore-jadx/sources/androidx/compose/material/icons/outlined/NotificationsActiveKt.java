...
public final class NotificationsActiveKt {
    ...
    public static final ImageVector getNotificationsActive(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NotificationsActive", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        v.b.f(pathBuilderA, 6.0f, 7.58f, 4.08f);
        pathBuilderA.lineTo(6.15f, 2.65f);
        ...
        a.g(pathBuilderA, 19.97f, 10.5f, 2.0f);
