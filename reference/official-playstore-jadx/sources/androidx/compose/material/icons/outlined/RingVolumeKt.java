...
public final class RingVolumeKt {
    ...
    public static final ImageVector getRingVolume(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RingVolume", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.f(pathBuilderA, 1.7f, 20.47f, 18.49f);
        pathBuilderA.curveToRelative(-0.59f, -0.48f, -1.21f, -0.9f, -1.87f, -1.27f);
        pathBuilderA.verticalLineToRelative(-1.7f);
        pathBuilderA.curveToRelative(1.04f, 0.51f, 2.03f, 1.15f, 2.94f, 1.9f);
        b.C(pathBuilderA, -1.07f, 1.07f, 21.16f, 6.26f);
        pathBuilderA.lineToRelative(-1.41f, -1.41f);
        pathBuilderA.lineToRelative(-3.56f, 3.55f);
        pathBuilderA.lineToRelative(1.41f, 1.41f);
        pathBuilderA.reflectiveCurveToRelative(3.45f, -3.52f, 3.56f, -3.55f);
        b.w(pathBuilderA, 11.0f, 2.0f, 2.0f, 5.0f);
        f.x(pathBuilderA, -2.0f, 6.4f, 9.81f);
