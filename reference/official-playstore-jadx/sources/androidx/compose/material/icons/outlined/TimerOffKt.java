...
public final class TimerOffKt {
    ...
    public static final ImageVector getTimerOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.TimerOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(1.5f, 1.5f);
        pathBuilderA.curveTo(10.17f, 6.19f, 11.06f, 6.0f, 12.0f, 6.0f);
        pathBuilderA.close();
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(a.r(11.0f, 8.17f, 2.0f, 2.0f), 0.0f, -2.17f, -2.0f, 0.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m3498getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3803getButtKaPHkGw(), companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.47f, 0.45f, -2.83f, 1.22f, -3.95f);
        pathBuilderJ.lineToRelative(9.73f, 9.73f);
        pathBuilderJ.curveTo(14.83f, 19.55f, 13.47f, 20.0f, 12.0f, 20.0f);
        pathBuilderJ.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderJ.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
