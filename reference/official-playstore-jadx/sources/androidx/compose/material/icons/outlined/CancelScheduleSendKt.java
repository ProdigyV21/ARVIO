...
public final class CancelScheduleSendKt {
    ...
    public static final ImageVector getCancelScheduleSend(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.CancelScheduleSend", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(10.06f, 1.34f);
        pathBuilderA.curveToRelative(-0.42f, 0.44f, -0.78f, 0.93f, -1.09f, 1.46f);
        ...
        a.z(pathBuilderA, 3.0f, 8.25f, 0.01f, -2.22f);
        d.C(pathBuilderA, 7.51f, 3.22f, 3.0f, 8.25f);
        pathBuilderA.moveTo(9.1f, 15.36f);
        pathBuilderA.lineTo(3.0f, 17.97f);
        pathBuilderA.verticalLineToRelative(-2.22f);
        pathBuilderA.lineToRelative(6.17f, -0.82f);
        pathBuilderA.curveTo(9.14f, 15.07f, 9.12f, 15.21f, 9.1f, 15.36f);
        pathBuilderA.close();
