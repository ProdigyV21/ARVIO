...
public final class DrawKt {
    ...
    public static final ImageVector getDraw(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Draw", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.moveTo(14.61f, 11.81f);
        b.m(pathBuilderR, 7.41f, 19.0f, 6.0f, -1.41f);
        d.C(pathBuilderR, 7.19f, -7.19f, 14.61f, 11.81f);
        pathBuilderR.moveTo(13.19f, 7.56f);
        b.n(pathBuilderR, 4.0f, 16.76f, 21.0f, 4.24f);
        pathBuilderR.lineToRelative(9.19f, -9.19f);
        b.y(pathBuilderR, 13.19f, 7.56f, 13.19f, 7.56f);
