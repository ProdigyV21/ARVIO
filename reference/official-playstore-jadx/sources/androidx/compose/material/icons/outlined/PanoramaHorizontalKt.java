...
public final class PanoramaHorizontalKt {
    ...
    public static final ImageVector getPanoramaHorizontal(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PanoramaHorizontal", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderI.reflectiveCurveToRelative(-6.18f, -0.55f, -9.12f, -1.64f);
        pathBuilderI.curveTo(2.77f, 4.02f, 2.66f, 4.0f, 2.57f, 4.0f);
