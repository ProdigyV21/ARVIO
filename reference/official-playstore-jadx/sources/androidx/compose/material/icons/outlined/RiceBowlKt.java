...
public final class RiceBowlKt {
    ...
    public static final ImageVector getRiceBowl(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RiceBowl", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderA, 12.0f, 2.0f, 10.0f, 12.0f);
        pathBuilderA.verticalLineTo(4.26f);
        pathBuilderA.curveTo(10.64f, 4.1f, 11.31f, 4.0f, 12.0f, 4.0f);
        pathBuilderA.reflectiveCurveToRelative(1.36f, 0.1f, 2.0f, 0.26f);
        ...
        pathBuilderA.verticalLineTo(5.08f);
        pathBuilderA.curveToRelative(2.39f, 1.39f, 4.0f, 3.96f, 4.0f, 6.92f);
        a.w(pathBuilderA, 16.0f, 16.0f, 12.0f);
