...
public final class CasinoKt {
    ...
    public static final ImageVector getCasino(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Casino", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.x(pathBuilderJ, 5.0f, 5.0f, 14.0f, 14.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB2 = a.b(7.5f, 7.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB3 = a.b(12.0f, 12.0f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB4 = a.b(16.5f, 16.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB5 = a.b(16.5f, 7.5f, -1.5f, 0.0f);
        pathBuilderB5.arcToRelative(1.5f, 1.5f, 0.0f, true, true, 3.0f, 0.0f);
        pathBuilderB5.arcToRelative(1.5f, 1.5f, 0.0f, true, true, -3.0f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderB5.getNodes(), defaultFillType6, "", solidColor6, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw6, iM3813getBevelLxFBmk86, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
