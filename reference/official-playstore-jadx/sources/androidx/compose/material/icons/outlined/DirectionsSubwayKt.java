...
public final class DirectionsSubwayKt {
    ...
    public static final ImageVector getDirectionsSubway(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DirectionsSubway", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-4.0f, 0.0f, -8.0f, 0.5f, -8.0f, 4.0f);
        ...
        a.p(pathBuilderA, 17.66f, 5.0f, 6.43f, 5.0f);
        pathBuilderA.curveToRelative(0.61f, -0.52f, 2.06f, -1.0f, 5.57f, -1.0f);
        pathBuilderA.curveToRelative(3.71f, 0.0f, 5.12f, 0.46f, 5.66f, 1.0f);
        d.k(pathBuilderA, 11.0f, 7.0f, 3.0f);
        pathBuilderA.lineTo(6.0f, 10.0f);
        f.n(pathBuilderA, 6.0f, 7.0f, 5.0f);
        a.C(pathBuilderA, 13.0f, 7.0f, 5.0f, 3.0f);
        d.q(pathBuilderA, -5.0f, 13.0f, 7.0f);
        pathBuilderA.moveTo(16.5f, 17.0f);
        pathBuilderA.horizontalLineToRelative(-9.0f);
        pathBuilderA.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        b.A(pathBuilderA, 6.0f, 12.0f, 12.0f, 3.5f);
