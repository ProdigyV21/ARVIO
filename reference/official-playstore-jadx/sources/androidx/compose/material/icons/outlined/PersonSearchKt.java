...
public final class PersonSearchKt {
    ...
    public static final ImageVector getPersonSearch(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PersonSearch", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(6.0f, 5.79f, 6.0f, 8.0f);
        pathBuilderA.curveTo(6.0f, 10.21f, 7.79f, 12.0f, 10.0f, 12.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(10.0f, 6.0f);
        pathBuilderA.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilderA.curveToRelative(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        pathBuilderA.reflectiveCurveTo(8.0f, 9.1f, 8.0f, 8.0f);
        pathBuilderA.curveTo(8.0f, 6.9f, 8.9f, 6.0f, 10.0f, 6.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(4.0f, 18.0f);
        pathBuilderA2.curveToRelative(0.22f, -0.72f, 3.31f, -2.0f, 6.0f, -2.0f);
        pathBuilderA2.curveToRelative(0.0f, -0.7f, 0.13f, -1.37f, 0.35f, -1.99f);
        pathBuilderA2.curveTo(7.62f, 13.91f, 2.0f, 15.27f, 2.0f, 18.0f);
        pathBuilderA2.verticalLineToRelative(2.0f);
        pathBuilderA2.horizontalLineToRelative(9.54f);
        pathBuilderA2.curveToRelative(-0.52f, -0.58f, -0.93f, -1.25f, -1.19f, -2.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderA2, 4.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw3 = companion2.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk83 = companion3.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA3 = c.a(19.43f, 18.02f);
        pathBuilderA3.curveTo(19.79f, 17.43f, 20.0f, 16.74f, 20.0f, 16.0f);
        ...
        pathBuilderA3.curveToRelative(0.0f, 2.21f, 1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderA3.curveToRelative(0.74f, 0.0f, 1.43f, -0.22f, 2.02f, -0.57f);
        pathBuilderA3.curveToRelative(0.93f, 0.93f, 1.62f, 1.62f, 2.57f, 2.57f);
        pathBuilderA3.lineTo(22.0f, 20.59f);
        pathBuilderA3.curveTo(20.5f, 19.09f, 21.21f, 19.79f, 19.43f, 18.02f);
        pathBuilderA3.close();
        pathBuilderA3.moveTo(16.0f, 18.0f);
        pathBuilderA3.curveToRelative(-1.1f, 0.0f, -2.0f, -0.9f, -2.0f, -2.0f);
        pathBuilderA3.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderA3.reflectiveCurveToRelative(2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilderA3.curveTo(18.0f, 17.1f, 17.1f, 18.0f, 16.0f, 18.0f);
        pathBuilderA3.close();
