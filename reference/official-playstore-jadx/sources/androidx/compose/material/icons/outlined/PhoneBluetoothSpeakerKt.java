...
public final class PhoneBluetoothSpeakerKt {
    ...
    public static final ImageVector getPhoneBluetoothSpeaker(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PhoneBluetoothSpeaker", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(20.0f, 15.5f);
        ...
        b.f(pathBuilderA, 1.51f, 14.71f, 9.5f);
        pathBuilderA.lineTo(17.0f, 7.21f);
        ...
        d.l(pathBuilderA, 14.0f, 8.79f, 0.71f, 0.71f);
        pathBuilderA.moveTo(18.0f, 2.91f);
        pathBuilderA.lineToRelative(0.94f, 0.94f);
        d.C(pathBuilderA, -0.94f, 0.94f, 18.0f, 2.91f);
        pathBuilderA.moveTo(18.0f, 7.21f);
        pathBuilderA.lineToRelative(0.94f, 0.94f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderA, -0.94f, 0.94f, 18.0f, 7.21f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
