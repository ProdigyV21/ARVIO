...
public final class WorkHistoryKt {
    ...
    public static final ImageVector getWorkHistory(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WorkHistory", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(4.0f, 19.0f, 8.0f, 16.0f, 3.29f);
        pathBuilderA.curveToRelative(0.72f, 0.22f, 1.4f, 0.54f, 2.0f, 0.97f);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.11f, -0.89f, -2.0f, -2.0f, -2.0f);
        pathBuilderA.horizontalLineToRelative(-4.0f);
        pathBuilderA.curveTo(8.89f, 2.0f, 8.0f, 2.89f, 8.0f, 4.0f);
        pathBuilderA.verticalLineToRelative(2.0f);
        pathBuilderA.horizontalLineTo(4.0f);
        pathBuilderA.curveTo(2.89f, 6.0f, 2.01f, 6.89f, 2.01f, 8.0f);
        pathBuilderA.lineTo(2.0f, 19.0f);
        pathBuilderA.curveToRelative(0.0f, 1.11f, 0.89f, 2.0f, 2.0f, 2.0f);
        pathBuilderA.horizontalLineToRelative(7.68f);
        pathBuilderA.curveToRelative(-0.3f, -0.62f, -0.5f, -1.29f, -0.6f, -2.0f);
        w.a.v(pathBuilderA, 4.0f, 10.0f, 4.0f, 4.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.p(pathBuilderA, 2.0f, -4.0f, 4.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
