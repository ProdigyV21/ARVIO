...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DownloadForOffline", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 14.59f, 8.59f, 16.0f, 10.0f);
        pathBuilderA.lineToRelative(-4.0f, 4.0f);
        pathBuilderA.lineToRelative(-4.0f, -4.0f);
        pathBuilderA.lineToRelative(1.41f, -1.41f);
        b.n(pathBuilderA, 11.0f, 10.17f, 6.0f, 2.0f);
        y.a.n(pathBuilderA, 4.17f, 14.59f, 8.59f);
        a.A(pathBuilderA, 17.0f, 17.0f, 7.0f, -2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderA, 10.0f, 17.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
