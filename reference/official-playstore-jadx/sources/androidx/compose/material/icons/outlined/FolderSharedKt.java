...
public final class FolderSharedKt {
    ...
    public static final ImageVector getFolderShared(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FolderShared", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderG.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        b.w(pathBuilderG, 11.0f, 17.0f, 8.0f, -1.0f);
