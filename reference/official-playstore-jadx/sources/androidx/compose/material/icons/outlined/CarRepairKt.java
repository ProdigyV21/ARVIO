...
public final class CarRepairKt {
    ...
    public static final ImageVector getCarRepair(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.CarRepair", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderB = a.b(9.0f, 10.5f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = a.b(15.0f, 10.5f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderA = a.a(5.78f, 16.0f, 0.44f);
        pathBuilderA.curveTo(6.65f, 16.0f, 7.0f, 15.64f, 7.0f, 15.19f);
        w.a.j(pathBuilderA, 14.0f, 10.0f, 1.19f);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.0f, -1.34f, -4.03f, -1.56f, -4.69f);
        pathBuilderA.curveToRelative(-0.05f, -0.16f, -0.12f, -0.29f, -0.19f, -0.4f);
        pathBuilderA.curveToRelative(-0.02f, -0.02f, -0.03f, -0.04f, -0.05f, -0.07f);
        pathBuilderA.curveTo(16.82f, 3.01f, 16.28f, 3.0f, 16.28f, 3.0f);
        pathBuilderA.horizontalLineTo(7.72f);
        pathBuilderA.curveToRelative(0.0f, 0.0f, -0.54f, 0.01f, -0.92f, 0.54f);
        pathBuilderA.curveTo(6.78f, 3.56f, 6.77f, 3.58f, 6.75f, 3.6f);
        pathBuilderA.curveTo(6.68f, 3.71f, 6.61f, 3.84f, 6.56f, 4.0f);
        pathBuilderA.curveTo(6.34f, 4.66f, 5.0f, 8.69f, 5.0f, 8.69f);
        pathBuilderA.verticalLineToRelative(6.5f);
        pathBuilderA.curveTo(5.0f, 15.64f, 5.35f, 16.0f, 5.78f, 16.0f);
        a.g(pathBuilderA, 8.33f, 5.0f, 7.34f);
        pathBuilderA.lineToRelative(0.23f, 0.69f);
        pathBuilderA.lineTo(16.33f, 7.0f);
        w.a.w(pathBuilderA, 7.67f, 8.33f, 5.0f);
        e.o(pathBuilderA, 7.0f, 9.01f, 9.0f, 10.0f);
        pathBuilderA.verticalLineToRelative(0.01f);
        pathBuilderA.verticalLineTo(12.0f);
        pathBuilderA.horizontalLineTo(7.0f);
        pathBuilderA.verticalLineTo(9.01f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderR = a.r(4.0f, 17.01f, 0.0f, 1.99f);
        pathBuilderR.lineToRelative(7.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, 3.0f);
        pathBuilderR.lineToRelative(2.0f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, -3.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 7.0f, 0.0f, 0.0f, -1.99f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw4, iM3813getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
