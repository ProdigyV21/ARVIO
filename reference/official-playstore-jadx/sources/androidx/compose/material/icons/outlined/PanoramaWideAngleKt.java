...
public final class PanoramaWideAngleKt {
    ...
    public static final ImageVector getPanoramaWideAngle(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PanoramaWideAngle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-0.24f, 3.58f, -0.71f, 5.36f);
