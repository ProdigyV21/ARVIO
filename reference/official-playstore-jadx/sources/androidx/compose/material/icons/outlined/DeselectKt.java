...
public final class DeselectKt {
    ...
    public static final ImageVector getDeselect(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Deselect", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a0.b.l(pathBuilderH, 17.0f, 7.17f, 2.0f, 2.0f);
        b.q(pathBuilderH, 15.0f, 2.0f, 2.0f, -1.17f);
