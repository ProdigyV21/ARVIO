...
public final class CloudQueueKt {
    ...
    public static final ImageVector getCloudQueue(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.CloudQueue", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.horizontalLineToRelative(0.71f);
        pathBuilderA.curveTo(7.37f, 7.69f, 9.48f, 6.0f, 12.0f, 6.0f);
