...
public final class NearbyOffKt {
    ...
    public static final ImageVector getNearbyOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NearbyOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderJ, 21.19f, 21.19f, -1.41f, 1.41f);
