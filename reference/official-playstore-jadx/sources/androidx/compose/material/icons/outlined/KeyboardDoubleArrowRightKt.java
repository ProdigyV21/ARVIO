...
public final class KeyboardDoubleArrowRightKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowRight(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardDoubleArrowRight", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(6.41f, 6.0f, -1.41f, 1.41f);
        ...
        PathBuilder pathBuilderR2 = a.r(13.0f, 6.0f, -1.41f, 1.41f);
