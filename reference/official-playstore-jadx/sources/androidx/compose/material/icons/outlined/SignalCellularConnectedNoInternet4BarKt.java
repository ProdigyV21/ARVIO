...
public final class SignalCellularConnectedNoInternet4BarKt {
    ...
    public static final ImageVector getSignalCellularConnectedNoInternet4Bar(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SignalCellularConnectedNoInternet4Bar", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        e.m(pathBuilderK, 2.0f, 22.0f, 16.0f, 8.0f);
        pathBuilderK.horizontalLineToRelative(4.0f);
        pathBuilderK.verticalLineTo(2.0f);
        pathBuilderK.lineTo(2.0f, 22.0f);
        pathBuilderK.close();
