...
public final class BoltKt {
    ...
    public static final ImageVector getBolt(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Bolt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderG.curveToRelative(-0.88f, 0.0f, -0.33f, -0.75f, -0.31f, -0.78f);
        pathBuilderG.curveTo(8.48f, 10.94f, 10.42f, 7.54f, 13.01f, 3.0f);
        e.C(pathBuilderG, 1.0f, -1.0f, 7.0f, 3.51f);
        pathBuilderG.curveToRelative(0.4f, 0.0f, 0.62f, 0.19f, 0.4f, 0.66f);
        pathBuilderG.curveTo(12.97f, 17.55f, 11.0f, 21.0f, 11.0f, 21.0f);
        pathBuilderG.close();
