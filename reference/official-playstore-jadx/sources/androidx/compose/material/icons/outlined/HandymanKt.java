...
public final class HandymanKt {
    ...
    public static final ImageVector getHandyman(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Handyman", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderC, 18.84f, 19.59f, -4.24f, -4.24f);
        pathBuilderC.lineToRelative(0.71f, -0.71f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderC, 4.24f, 4.24f, 18.84f, 19.59f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        d.C(pathBuilderR, 5.15f, -5.15f, 17.34f, 10.19f);
        pathBuilderR.moveTo(9.36f, 15.34f);
        pathBuilderR.lineToRelative(-4.24f, 4.24f);
        pathBuilderR.lineToRelative(-0.71f, -0.71f);
        pathBuilderR.lineToRelative(4.24f, -4.24f);
        pathBuilderR.lineToRelative(0.0f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.f(pathBuilderR, 9.36f, 15.34f, 9.36f, 15.34f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
