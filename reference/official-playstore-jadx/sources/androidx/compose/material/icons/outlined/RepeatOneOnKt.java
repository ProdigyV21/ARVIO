...
public final class RepeatOneOnKt {
    ...
    public static final ImageVector getRepeatOneOn(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RepeatOneOn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.D(pathBuilderQ, 2.0f, 19.0f, 10.0f, 10.5f);
        b.r(pathBuilderQ, 9.0f, 3.0f, 6.0f, -1.5f);
        e.y(pathBuilderQ, -4.5f, 10.0f, 17.0f, 10.0f);
        pathBuilderQ.lineToRelative(-1.41f, -1.42f);
