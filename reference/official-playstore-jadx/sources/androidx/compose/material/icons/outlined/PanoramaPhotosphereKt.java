...
public final class PanoramaPhotosphereKt {
    ...
    public static final ImageVector getPanoramaPhotosphere(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PanoramaPhotosphere", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(21.0f, 9.91f);
        pathBuilderA.curveTo(21.0f, 9.91f, 21.0f, 9.91f, 21.0f, 9.91f);
        pathBuilderA.lineToRelative(0.0f, 4.19f);
