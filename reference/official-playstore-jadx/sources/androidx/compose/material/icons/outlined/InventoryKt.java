...
public final class InventoryKt {
    ...
    public static final ImageVector getInventory(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Inventory", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderK.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        d.z(pathBuilderK, 6.0f, -2.0f, 5.0f, 5.0f);
        ...
        PathBuilder pathBuilderR = a.r(21.0f, 11.5f, -5.49f, 5.5f);
        pathBuilderR.lineToRelative(-3.01f, -3.0f);
        pathBuilderR.lineToRelative(-1.5f, 1.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, 4.51f, 4.5f, 6.99f, -7.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
