...
public final class FormatIndentIncreaseKt {
    ...
    public static final ImageVector getFormatIndentIncrease(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.FormatIndentIncrease", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        a.C(pathBuilderA, 11.0f, 17.0f, 10.0f, -2.0f);
