...
public final class LabelOffKt {
    ...
    public static final ImageVector getLabelOff(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.LabelOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        f.v(pathBuilderR, 2.0f, 1.99f, 16.0f);
        ...
        c.B(pathBuilderR, 14.97f, 17.0f, 5.0f, 7.03f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 14.97f, 17.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
