...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.AutoMirrored.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.DirectionsBike", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(5.0f, 22.0f);
        ...
        pathBuilderA.reflectiveCurveTo(6.9f, 20.5f, 5.0f, 20.5f);
        pathBuilderA.reflectiveCurveTo(1.5f, 18.9f, 1.5f, 17.0f);
        pathBuilderA.reflectiveCurveToRelative(1.6f, -3.5f, 3.5f, -3.5f);
        a.p(pathBuilderA, 7.8f, 11.2f, 11.0f, 14.0f);
        e.l(pathBuilderA, 5.0f, 2.0f, -6.2f);
        pathBuilderA.lineToRelative(-2.2f, -2.3f);
        pathBuilderA.lineToRelative(2.4f, -2.4f);
        pathBuilderA.lineToRelative(0.8f, 0.8f);
        pathBuilderA.curveToRelative(1.3f, 1.3f, 3.0f, 2.1f, 5.1f, 2.1f);
        pathBuilderA.lineTo(19.1f, 9.0f);
        pathBuilderA.curveToRelative(-1.5f, 0.0f, -2.7f, -0.6f, -3.6f, -1.5f);
