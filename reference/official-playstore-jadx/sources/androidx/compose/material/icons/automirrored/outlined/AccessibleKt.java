...
public final class AccessibleKt {
    ...
    public static final ImageVector getAccessible(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.Accessible", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderI.close();
        pathBuilderI.moveTo(10.0f, 20.0f);
        ...
        pathBuilderI.horizontalLineToRelative(-2.07f);
