...
public final class GradingKt {
    ...
    public static final ImageVector getGrading(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.Grading", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        PathBuilder pathBuilderA2 = a.a(5.0f, 13.0f, 14.0f);
        ...
        pathBuilderA2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderA2.verticalLineToRelative(0.0f);
        pathBuilderA2.curveTo(4.0f, 12.55f, 4.45f, 13.0f, 5.0f, 13.0f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderA3 = a.a(5.0f, 17.0f, 5.0f);
        ...
        pathBuilderA3.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderA3.verticalLineToRelative(0.0f);
        pathBuilderA3.curveTo(4.0f, 16.55f, 4.45f, 17.0f, 5.0f, 17.0f);
        pathBuilderA3.close();
        ...
        PathBuilder pathBuilderA4 = a.a(5.0f, 21.0f, 5.0f);
        pathBuilderA4.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderA4.verticalLineToRelative(0.0f);
        pathBuilderA4.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderA4.horizontalLineTo(5.0f);
        pathBuilderA4.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderA4.verticalLineToRelative(0.0f);
        pathBuilderA4.curveTo(4.0f, 20.55f, 4.45f, 21.0f, 5.0f, 21.0f);
        pathBuilderA4.close();
        ...
        PathBuilder pathBuilderR = a.r(15.41f, 18.17f, -0.71f, -0.71f);
        ...
        pathBuilderR.lineToRelative(0.0f, 0.0f);
        pathBuilderR.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 15.41f, 18.17f), defaultFillType5, "", solidColor5, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw5, iM3813getBevelLxFBmk85, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderJ = a.j(4.0f, 4.0f, 4.0f, 4.0f);
        ...
        pathBuilderJ.curveTo(4.45f, 3.0f, 4.0f, 3.45f, 4.0f, 4.0f);
        pathBuilderJ.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderJ.getNodes(), defaultFillType6, "", solidColor6, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw6, iM3813getBevelLxFBmk86, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
