...
public final class StickyNote2Kt {
    ...
    public static final ImageVector getStickyNote2(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.StickyNote2", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        b.w(pathBuilderQ, 7.0f, 8.0f, 10.0f, 2.0f);
        c.l(pathBuilderQ, 7.0f, 8.0f, 12.0f, 14.0f);
        c.k(pathBuilderQ, 7.0f, -2.0f, 5.0f, 14.0f);
        e.o(pathBuilderQ, 14.0f, 19.5f, 14.0f, 5.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderQ, 14.0f, 19.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
