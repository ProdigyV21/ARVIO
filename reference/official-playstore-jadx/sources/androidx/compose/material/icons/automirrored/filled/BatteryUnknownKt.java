...
public final class BatteryUnknownKt {
    ...
    public static final ImageVector getBatteryUnknown(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.BatteryUnknown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        b.w(pathBuilderJ, 12.95f, 17.95f, -1.9f, -1.9f);
        b.B(pathBuilderJ, 1.9f, 1.9f, 14.3f, 12.69f);
