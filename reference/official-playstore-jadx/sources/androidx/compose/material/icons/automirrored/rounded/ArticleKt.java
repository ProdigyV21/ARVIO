...
public final class ArticleKt {
    ...
    public static final ImageVector getArticle(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.Article", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        w.a.r(pathBuilderQ, 13.0f, 17.0f, 8.0f);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.curveTo(14.0f, 16.55f, 13.55f, 17.0f, 13.0f, 17.0f);
        ...
        w.a.r(pathBuilderQ, 16.0f, 9.0f, 8.0f);
        pathBuilderQ.curveTo(7.45f, 9.0f, 7.0f, 8.55f, 7.0f, 8.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.horizontalLineToRelative(8.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.curveTo(17.0f, 8.55f, 16.55f, 9.0f, 16.0f, 9.0f);
        pathBuilderQ.close();
