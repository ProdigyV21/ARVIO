...
public final class AirplaneTicketKt {
    ...
    public static final ImageVector getAirplaneTicket(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.AirplaneTicket", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        a.z(pathBuilderQ, 17.73f, 13.3f, -8.86f, 2.36f);
