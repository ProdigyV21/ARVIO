...
public final class DvrKt {
    ...
    public static final ImageVector getDvr(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.Dvr", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.p(pathBuilderJ, 18.0f, 8.0f, 9.0f, 8.0f);
        pathBuilderJ.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderJ.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderJ.horizontalLineToRelative(9.0f);
        pathBuilderJ.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderJ.reflectiveCurveToRelative(-0.45f, -1.0f, -1.0f, -1.0f);
        a.p(pathBuilderJ, 18.0f, 12.0f, 9.0f, 12.0f);
        pathBuilderJ.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderJ.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderJ.horizontalLineToRelative(9.0f);
        pathBuilderJ.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderJ.reflectiveCurveToRelative(-0.45f, -1.0f, -1.0f, -1.0f);
        a.p(pathBuilderJ, 7.0f, 8.0f, 5.0f, 8.0f);
        w.a.z(pathBuilderJ, 2.0f, 2.0f, 7.0f, 8.0f);
        pathBuilderJ.moveTo(7.0f, 12.0f);
