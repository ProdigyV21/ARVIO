...
public final class AirplaneTicketKt {
    ...
    public static final ImageVector getAirplaneTicket(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.AirplaneTicket", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(8.87f, 15.66f);
        pathBuilderQ.lineToRelative(-1.66f, -2.88f);
        pathBuilderQ.lineToRelative(0.93f, -0.25f);
        pathBuilderQ.lineToRelative(1.26f, 0.99f);
        pathBuilderQ.lineToRelative(2.39f, -0.64f);
        pathBuilderQ.lineToRelative(-2.4f, -4.16f);
        pathBuilderQ.lineToRelative(1.4f, -0.38f);
        pathBuilderQ.lineToRelative(4.01f, 3.74f);
        pathBuilderQ.lineToRelative(2.44f, -0.65f);
        pathBuilderQ.curveToRelative(0.51f, -0.14f, 1.04f, 0.17f, 1.18f, 0.68f);
        pathBuilderQ.curveToRelative(0.13f, 0.51f, -0.17f, 1.04f, -0.69f, 1.19f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderQ, 8.87f, 15.66f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
