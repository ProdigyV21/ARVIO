...
public final class AccessibleForwardKt {
    ...
    public static final ImageVector getAccessibleForward(Icons.AutoMirrored.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.AccessibleForward", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        a.g(pathBuilderA, 20.0f, 13.5f, -3.86f);
        ...
        pathBuilderA.lineTo(8.22f, 10.0f);
        pathBuilderA.lineToRelative(1.92f, 0.53f);
        pathBuilderA.lineToRelative(0.65f, -1.53f);
        pathBuilderA.lineTo(13.0f, 9.0f);
        pathBuilderA.lineToRelative(-3.12f, 7.0f);
        a.h(pathBuilderA, 18.0f, 16.0f, 5.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.c(pathBuilderA, -7.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
