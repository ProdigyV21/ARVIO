...
public final class BluetoothSearchingKt {
    ...
    public static final ImageVector getBluetoothSearching(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.BluetoothSearching", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderR.curveToRelative(0.0f, -0.82f, -0.16f, -1.59f, -0.43f, -2.31f);
