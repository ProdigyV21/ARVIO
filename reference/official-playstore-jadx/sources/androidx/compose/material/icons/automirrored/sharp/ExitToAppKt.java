...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(Icons.AutoMirrored.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.ExitToApp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        a.A(pathBuilderJ, 21.0f, 3.0f, 3.0f, 6.0f);
        w.a.C(pathBuilderJ, 2.0f, 5.0f, 14.0f, 14.0f);
        w.a.A(pathBuilderJ, 5.0f, -4.0f, 3.0f, 6.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.e(pathBuilderJ, 18.0f, 3.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
