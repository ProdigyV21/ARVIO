...
public final class FactCheckKt {
    ...
    public static final ImageVector getFactCheck(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.FactCheck", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        w.a.r(pathBuilderQ, 9.0f, 17.0f, 6.0f);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.curveTo(10.0f, 16.55f, 9.55f, 17.0f, 9.0f, 17.0f);
        w.a.r(pathBuilderQ, 9.0f, 13.0f, 6.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.horizontalLineToRelative(3.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.curveTo(10.0f, 12.55f, 9.55f, 13.0f, 9.0f, 13.0f);
        w.a.r(pathBuilderQ, 9.0f, 9.0f, 6.0f);
        pathBuilderQ.curveTo(5.45f, 9.0f, 5.0f, 8.55f, 5.0f, 8.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.horizontalLineToRelative(3.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.curveTo(10.0f, 8.55f, 9.55f, 9.0f, 9.0f, 9.0f);
        a.z(pathBuilderQ, 18.7f, 11.12f, -3.17f, 3.17f);
        pathBuilderQ.curveToRelative(-0.39f, 0.39f, -1.03f, 0.39f, -1.42f, 0.0f);
        ...
        pathBuilderQ.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderQ.lineToRelative(0.01f, 0.01f);
        pathBuilderQ.curveTo(19.09f, 10.1f, 19.09f, 10.74f, 18.7f, 11.12f);
        pathBuilderQ.close();
