...
public final class HelpCenterKt {
    ...
    public static final ImageVector getHelpCenter(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.HelpCenter", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.01f, 18.0f);
        ...
        pathBuilderQ.curveToRelative(-0.1f, 0.18f, -0.16f, 0.32f, -0.19f, 0.63f);
        pathBuilderQ.curveToRelative(-0.05f, 0.45f, -0.45f, 0.78f, -0.9f, 0.78f);
        pathBuilderQ.horizontalLineTo(12.0f);
        pathBuilderQ.curveToRelative(-0.52f, 0.0f, -0.93f, -0.44f, -0.88f, -0.96f);
        pathBuilderQ.curveToRelative(0.03f, -0.34f, 0.11f, -0.69f, 0.3f, -1.03f);
        ...
        pathBuilderQ.curveToRelative(-0.71f, 0.0f, -1.18f, 0.36f, -1.47f, 0.79f);
        pathBuilderQ.curveToRelative(-0.25f, 0.36f, -0.69f, 0.53f, -1.1f, 0.36f);
        pathBuilderQ.lineToRelative(0.0f, 0.0f);
        pathBuilderQ.curveTo(8.91f, 8.64f, 8.72f, 8.0f, 9.04f, 7.54f);
        pathBuilderQ.curveTo(9.65f, 6.65f, 10.67f, 6.0f, 11.99f, 6.0f);
