...
public final class ArrowRightAltKt {
    ...
    public static final ImageVector getArrowRightAlt(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.ArrowRightAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderQ = a.q(16.01f, 11.0f, 5.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderQ.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderQ.horizontalLineToRelative(11.01f);
        pathBuilderQ.verticalLineToRelative(1.79f);
        pathBuilderQ.curveToRelative(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.35f);
        pathBuilderQ.lineToRelative(2.78f, -2.79f);
        pathBuilderQ.curveToRelative(0.19f, -0.2f, 0.19f, -0.51f, 0.0f, -0.71f);
        pathBuilderQ.lineToRelative(-2.78f, -2.79f);
        pathBuilderQ.curveToRelative(-0.31f, -0.32f, -0.85f, -0.09f, -0.85f, 0.35f);
