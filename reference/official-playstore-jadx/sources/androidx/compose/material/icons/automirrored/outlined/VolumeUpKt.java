...
public final class VolumeUpKt {
    ...
    public static final ImageVector getVolumeUp(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.VolumeUp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c.z(pathBuilderA, 10.0f, 8.83f, 16.5f, 12.0f);
