...
public final class AssignmentReturnKt {
    ...
    public static final ImageVector getAssignmentReturn(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.AssignmentReturn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderA.lineToRelative(-4.65f, -4.65f);
        pathBuilderA.curveToRelative(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        a.h(pathBuilderA, 12.0f, 8.0f, 3.0f, 4.0f);
