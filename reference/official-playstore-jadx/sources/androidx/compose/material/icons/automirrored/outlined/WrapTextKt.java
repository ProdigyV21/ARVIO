...
public final class WrapTextKt {
    ...
    public static final ImageVector getWrapText(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.WrapText", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = d.a(4.0f, 19.0f, 6.0f, -2.0f);
        d.f(pathBuilderA, 4.0f, 17.0f, 2.0f);
        pathBuilderA.moveTo(20.0f, 5.0f);
        a.h(pathBuilderA, 4.0f, 5.0f, 2.0f, 16.0f);
        c.z(pathBuilderA, 20.0f, 5.0f, 17.0f, 11.0f);
