...
public final class MobileScreenShareKt {
    ...
    public static final ImageVector getMobileScreenShare(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.MobileScreenShare", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderJ.verticalLineToRelative(-18.0f);
        pathBuilderJ.curveTo(19.0f, 1.85f, 18.1f, 1.0f, 17.0f, 1.0f);
