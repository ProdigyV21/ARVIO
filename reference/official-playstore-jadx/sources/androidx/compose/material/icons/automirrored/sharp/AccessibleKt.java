...
public final class AccessibleKt {
    ...
    public static final ImageVector getAccessible(Icons.AutoMirrored.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.Accessible", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderI.curveToRelative(-0.37f, -0.21f, -0.78f, -0.31f, -1.25f, -0.25f);
        pathBuilderI.curveTo(10.73f, 7.15f, 10.0f, 8.07f, 10.0f, 9.1f);
        b.A(pathBuilderI, 10.0f, 17.0f, 7.0f, 5.0f);
        a.o(pathBuilderI, 2.0f, -7.5f, -5.0f, -3.45f);
