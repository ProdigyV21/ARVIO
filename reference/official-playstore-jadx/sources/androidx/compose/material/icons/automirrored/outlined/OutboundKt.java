...
public final class OutboundKt {
    ...
    public static final ImageVector getOutbound(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.Outbound", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c.z(pathBuilderA, 12.0f, 2.0f, 13.88f, 11.54f);
