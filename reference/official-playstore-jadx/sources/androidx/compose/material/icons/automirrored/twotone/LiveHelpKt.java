...
public final class LiveHelpKt {
    ...
    public static final ImageVector getLiveHelp(Icons.AutoMirrored.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.LiveHelp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        PathBuilder pathBuilderG = c.g(5.0f, 18.0f, 4.83f, 0.59f, 0.59f);
        pathBuilderG.lineTo(12.0f, 20.17f);
        pathBuilderG.lineToRelative(1.59f, -1.59f);
        pathBuilderG.lineToRelative(0.58f, -0.58f);
        pathBuilderG.lineTo(19.0f, 18.0f);
        pathBuilderG.lineTo(19.0f, 4.0f);
        d.f(pathBuilderG, 5.0f, 4.0f, 14.0f);
        a.C(pathBuilderG, 13.0f, 17.0f, -2.0f, -2.0f);
        b.B(pathBuilderG, 2.0f, 2.0f, 12.0f, 5.0f);
        pathBuilderG.curveToRelative(2.21f, 0.0f, 4.0f, 1.79f, 4.0f, 4.0f);
        pathBuilderG.curveToRelative(0.0f, 2.5f, -3.0f, 2.75f, -3.0f, 5.0f);
        pathBuilderG.horizontalLineToRelative(-2.0f);
        pathBuilderG.curveToRelative(0.0f, -3.25f, 3.0f, -3.0f, 3.0f, -5.0f);
        pathBuilderG.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderG.reflectiveCurveToRelative(-2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilderG.lineTo(8.0f, 9.0f);
        ...
        c.z(pathBuilderA, 21.0f, 4.0f, 19.0f, 18.0f);
        ...
        b.g(pathBuilderA, 5.0f, 4.0f, 14.0f, 14.0f);
        a.C(pathBuilderA, 11.0f, 15.0f, 2.0f, 2.0f);
        f.x(pathBuilderA, -2.0f, 12.0f, 7.0f);
        pathBuilderA.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
