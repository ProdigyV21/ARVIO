...
public final class NoteKt {
    ...
    public static final ImageVector getNote(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.Note", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        pathBuilderR.lineToRelative(16.0f, -0.01f);
        pathBuilderR.curveToRelative(1.1f, 0.0f, 2.0f, -0.89f, 2.0f, -1.99f);
        b.f(pathBuilderR, -8.0f, 15.0f, 5.5f);
