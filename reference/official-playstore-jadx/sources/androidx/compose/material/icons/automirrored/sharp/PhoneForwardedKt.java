...
public final class PhoneForwardedKt {
    ...
    public static final ImageVector getPhoneForwarded(Icons.AutoMirrored.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.PhoneForwarded", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        e.D(pathBuilderR, 4.0f, 4.0f, 13.21f, 17.37f);
        ...
        pathBuilderR.lineTo(3.03f, 3.0f);
        pathBuilderR.curveTo(2.45f, 13.18f, 10.82f, 21.55f, 21.0f, 20.97f);
        pathBuilderR.verticalLineToRelative(-5.51f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.t(pathBuilderR, -5.27f, -0.61f, -2.52f, 2.52f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
