...
public final class AddToHomeScreenKt {
    ...
    public static final ImageVector getAddToHomeScreen(Icons.AutoMirrored.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.AddToHomeScreen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        e.x(pathBuilderJ, 5.0f, 10.0f, 14.0f, 8.0f);
        ...
        pathBuilderJ.close();
        pathBuilderJ.moveTo(11.0f, 15.0f);
        ...
        pathBuilderJ.lineTo(3.7f, 14.89f);
        ...
        pathBuilderJ.lineTo(10.0f, 11.41f);
