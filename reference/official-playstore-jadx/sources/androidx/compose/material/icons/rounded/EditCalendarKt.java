...
public final class EditCalendarKt {
    ...
    public static final ImageVector getEditCalendar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EditCalendar", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.t(pathBuilderQ, 1.0f, 8.0f, 3.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        ...
        pathBuilderQ.lineToRelative(-5.01f, 5.01f);
        pathBuilderQ.curveToRelative(-0.18f, 0.18f, -0.44f, 0.29f, -0.7f, 0.29f);
        pathBuilderQ.horizontalLineTo(14.5f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(-1.21f);
        pathBuilderQ.curveToRelative(0.0f, -0.27f, 0.11f, -0.52f, 0.29f, -0.71f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.e(pathBuilderQ, 5.01f, -5.01f, 21.42f, 17.7f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
