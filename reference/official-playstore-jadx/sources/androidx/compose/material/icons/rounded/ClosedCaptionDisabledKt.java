...
public final class ClosedCaptionDisabledKt {
    ...
    public static final ImageVector getClosedCaptionDisabled(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ClosedCaptionDisabled", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.verticalLineToRelative(-0.5f);
        ...
        e.n(pathBuilderQ, -0.17f, -1.83f, -1.83f, 10.5f);
        ...
        pathBuilderQ.moveTo(20.49f, 21.9f);
        pathBuilderQ.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderQ.lineToRelative(-1.9f, -1.9f);
        ...
        pathBuilderQ.lineTo(2.1f, 4.93f);
        pathBuilderQ.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderQ.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderQ.lineToRelative(16.97f, 16.97f);
        pathBuilderQ.curveTo(20.88f, 20.88f, 20.88f, 21.51f, 20.49f, 21.9f);
        a.p(pathBuilderQ, 11.0f, 13.83f, 10.17f, 13.0f);
