...
public final class _5gKt {
    ...
    public static final ImageVector get_5g(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._5g", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderK = a.k(18.0f, 13.0f, 1.0f, 2.0f, -5.0f);
        ...
        pathBuilderK.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderK.verticalLineToRelative(0.0f);
        pathBuilderK.curveTo(17.0f, 12.55f, 17.45f, 13.0f, 18.0f, 13.0f);
        pathBuilderK.close();
        ...
        PathBuilder pathBuilderH = d.h(4.0f, 13.0f, 4.0f, 2.0f, 4.0f);
        ...
        pathBuilderH.horizontalLineToRelative(4.0f);
        ...
        b.u(pathBuilderH, 5.0f, 9.0f, 4.0f);
        pathBuilderH.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderH.verticalLineToRelative(0.0f);
        pathBuilderH.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderH.horizontalLineTo(4.0f);
        pathBuilderH.curveTo(3.45f, 7.0f, 3.0f, 7.45f, 3.0f, 8.0f);
        pathBuilderH.verticalLineToRelative(4.0f);
        pathBuilderH.curveTo(3.0f, 12.55f, 3.45f, 13.0f, 4.0f, 13.0f);
        pathBuilderH.close();
