...
public final class PictureAsPdfKt {
    ...
    public static final ImageVector getPictureAsPdf(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PictureAsPdf", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.horizontalLineToRelative(2.0f);
        pathBuilderJ.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        b.f(pathBuilderJ, 3.0f, 20.5f, 7.75f);
        pathBuilderJ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        a.h(pathBuilderJ, 19.0f, 8.5f, 1.0f, 0.75f);
        ...
        pathBuilderJ.lineTo(19.0f, 11.0f);
        pathBuilderJ.verticalLineToRelative(1.25f);
        pathBuilderJ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderJ.reflectiveCurveToRelative(-0.75f, -0.34f, -0.75f, -0.75f);
        ...
        pathBuilderJ.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        b.w(pathBuilderJ, 9.0f, 9.5f, 1.0f, -1.0f);
        d.f(pathBuilderJ, 9.0f, 8.5f, 1.0f);
        pathBuilderJ.moveTo(3.0f, 6.0f);
        ...
        pathBuilderJ.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        b.w(pathBuilderJ, 14.0f, 11.5f, 1.0f, -3.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.s(pathBuilderJ, -1.0f, 3.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
