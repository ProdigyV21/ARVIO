...
public final class DrawKt {
    ...
    public static final ImageVector getDraw(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Draw", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = a.r(18.85f, 10.39f, 1.06f, -1.06f);
        pathBuilderR.curveToRelative(0.78f, -0.78f, 0.78f, -2.05f, 0.0f, -2.83f);
        pathBuilderR.lineTo(18.5f, 5.09f);
        pathBuilderR.curveToRelative(-0.78f, -0.78f, -2.05f, -0.78f, -2.83f, 0.0f);
        d.C(pathBuilderR, -1.06f, 1.06f, 18.85f, 10.39f);
        pathBuilderR.moveTo(13.19f, 7.56f);
        pathBuilderR.lineToRelative(-9.05f, 9.05f);
        pathBuilderR.curveTo(4.05f, 16.7f, 4.0f, 16.83f, 4.0f, 16.96f);
        pathBuilderR.verticalLineToRelative(3.54f);
        pathBuilderR.curveTo(4.0f, 20.78f, 4.22f, 21.0f, 4.5f, 21.0f);
        pathBuilderR.horizontalLineToRelative(3.54f);
        pathBuilderR.curveToRelative(0.13f, 0.0f, 0.26f, -0.05f, 0.35f, -0.15f);
        d.C(pathBuilderR, 9.05f, -9.05f, 13.19f, 7.56f);
        ...
        pathBuilderR.curveTo(5.74f, 5.0f, 5.2f, 5.61f, 5.17f, 5.64f);
        pathBuilderR.curveTo(4.82f, 6.05f, 4.19f, 6.1f, 3.77f, 5.76f);
        pathBuilderR.curveTo(3.36f, 5.42f, 3.28f, 4.81f, 3.62f, 4.38f);
        pathBuilderR.curveTo(3.73f, 4.24f, 4.76f, 3.0f, 7.0f, 3.0f);
