...
public final class FileOpenKt {
    ...
    public static final ImageVector getFileOpen(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FileOpen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(22.66f, 17.0f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderQ.horizontalLineToRelative(-1.24f);
        pathBuilderQ.lineToRelative(2.24f, 2.24f);
        ...
        pathBuilderQ.lineToRelative(0.0f, 1.24f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.verticalLineTo(17.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.horizontalLineToRelative(3.66f);
        pathBuilderQ.curveTo(22.21f, 16.0f, 22.66f, 16.45f, 22.66f, 17.0f);
        pathBuilderQ.close();
