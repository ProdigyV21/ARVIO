...
public final class AdsClickKt {
    ...
    public static final ImageVector getAdsClick(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdsClick", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 18.23f, 16.26f, 2.27f, -0.76f);
        pathBuilderA.curveToRelative(0.46f, -0.15f, 0.45f, -0.81f, -0.01f, -0.95f);
        pathBuilderA.lineToRelative(-7.6f, -2.28f);
        pathBuilderA.curveToRelative(-0.38f, -0.11f, -0.74f, 0.24f, -0.62f, 0.62f);
        pathBuilderA.lineToRelative(2.28f, 7.6f);
        pathBuilderA.curveToRelative(0.14f, 0.47f, 0.8f, 0.48f, 0.95f, 0.01f);
        pathBuilderA.lineToRelative(0.76f, -2.27f);
        pathBuilderA.lineToRelative(3.91f, 3.91f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 18.23f, 16.26f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
