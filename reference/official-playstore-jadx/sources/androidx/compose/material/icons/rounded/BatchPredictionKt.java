...
public final class BatchPredictionKt {
    ...
    public static final ImageVector getBatchPrediction(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BatchPrediction", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 12.0f, 20.5f, 12.0f, 20.5f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        w.a.j(pathBuilderQ, 19.0f, 2.0f, 0.5f);
        pathBuilderQ.curveTo(13.0f, 20.05f, 12.55f, 20.5f, 12.0f, 20.5f);
        a.g(pathBuilderQ, 13.0f, 18.0f, -2.0f);
