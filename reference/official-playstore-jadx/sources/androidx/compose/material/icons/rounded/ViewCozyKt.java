...
public final class ViewCozyKt {
    ...
    public static final ImageVector getViewCozy(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ViewCozy", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderQ, 10.75f, 16.75f, -3.0f);
        ...
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(3.0f);
        pathBuilderQ.curveTo(11.25f, 16.53f, 11.03f, 16.75f, 10.75f, 16.75f);
        a.g(pathBuilderQ, 10.75f, 11.25f, -3.0f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(-3.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderQ.horizontalLineToRelative(3.0f);
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(3.0f);
        pathBuilderQ.curveTo(11.25f, 11.03f, 11.03f, 11.25f, 10.75f, 11.25f);
        a.g(pathBuilderQ, 16.25f, 16.75f, -3.0f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(-3.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderQ.horizontalLineToRelative(3.0f);
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(3.0f);
        pathBuilderQ.curveTo(16.75f, 16.53f, 16.53f, 16.75f, 16.25f, 16.75f);
        a.g(pathBuilderQ, 16.25f, 11.25f, -3.0f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(-3.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderQ.horizontalLineToRelative(3.0f);
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(3.0f);
        pathBuilderQ.curveTo(16.75f, 11.03f, 16.53f, 11.25f, 16.25f, 11.25f);
        pathBuilderQ.close();
