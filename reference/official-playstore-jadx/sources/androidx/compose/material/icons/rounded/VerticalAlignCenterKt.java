...
public final class VerticalAlignCenterKt {
    ...
    public static final ImageVector getVerticalAlignCenter(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.VerticalAlignCenter", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderS = c.s(9.21f, 19.0f, 11.0f, 19.0f, 3.0f);
        ...
        pathBuilderS.horizontalLineToRelative(1.79f);
        pathBuilderS.curveToRelative(0.45f, 0.0f, 0.67f, -0.54f, 0.35f, -0.85f);
        pathBuilderS.lineToRelative(-2.79f, -2.79f);
        pathBuilderS.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderS.lineToRelative(-2.79f, 2.79f);
        pathBuilderS.curveToRelative(-0.31f, 0.31f, -0.09f, 0.85f, 0.36f, 0.85f);
        a.p(pathBuilderS, 14.79f, 5.0f, 13.0f, 5.0f);
        pathBuilderS.lineTo(13.0f, 2.0f);
        pathBuilderS.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderS.reflectiveCurveToRelative(-1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderS.verticalLineToRelative(3.0f);
        pathBuilderS.lineTo(9.21f, 5.0f);
        pathBuilderS.curveToRelative(-0.45f, 0.0f, -0.67f, 0.54f, -0.36f, 0.85f);
        pathBuilderS.lineToRelative(2.79f, 2.79f);
        pathBuilderS.curveToRelative(0.2f, 0.2f, 0.51f, 0.2f, 0.71f, 0.0f);
        pathBuilderS.lineToRelative(2.79f, -2.79f);
        pathBuilderS.curveToRelative(0.32f, -0.31f, 0.1f, -0.85f, -0.35f, -0.85f);
        pathBuilderS.close();
        pathBuilderS.moveTo(4.0f, 12.0f);
        pathBuilderS.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
