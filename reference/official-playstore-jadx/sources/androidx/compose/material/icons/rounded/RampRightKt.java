...
public final class RampRightKt {
    ...
    public static final ImageVector getRampRight(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RampRight", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(11.0f, 20.55f, 11.45f, 21.0f, 12.0f, 21.0f);
        pathBuilderA.close();
