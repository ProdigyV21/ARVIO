...
public final class BiotechKt {
    ...
    public static final ImageVector getBiotech(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Biotech", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA2.lineToRelative(0.25f, 0.68f);
        pathBuilderA2.curveToRelative(0.19f, 0.52f, 0.76f, 0.79f, 1.28f, 0.6f);
        pathBuilderA2.curveToRelative(0.19f, 0.52f, 0.76f, 0.79f, 1.28f, 0.6f);
        pathBuilderA2.curveToRelative(0.52f, -0.19f, 0.79f, -0.76f, 0.6f, -1.28f);
        pathBuilderA2.curveToRelative(0.52f, -0.19f, 0.79f, -0.76f, 0.6f, -1.28f);
        pathBuilderA2.lineTo(14.1f, 3.54f);
        pathBuilderA2.curveToRelative(-0.19f, -0.52f, -0.76f, -0.79f, -1.28f, -0.6f);
        pathBuilderA2.curveToRelative(-0.19f, -0.52f, -0.76f, -0.79f, -1.28f, -0.6f);
        pathBuilderA2.curveToRelative(-0.52f, 0.19f, -0.79f, 0.76f, -0.6f, 1.28f);
        pathBuilderA2.curveToRelative(-0.52f, 0.19f, -0.79f, 0.76f, -0.6f, 1.28f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA2, 10.56f, 5.51f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
