...
public final class HexagonKt {
    ...
    public static final ImageVector getHexagon(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Hexagon", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderQ = a.q(16.05f, 3.0f, 7.95f);
        pathBuilderQ.curveTo(7.24f, 3.0f, 6.58f, 3.38f, 6.22f, 4.0f);
        pathBuilderQ.lineToRelative(-4.04f, 7.0f);
        pathBuilderQ.curveToRelative(-0.36f, 0.62f, -0.36f, 1.38f, 0.0f, 2.0f);
        pathBuilderQ.lineToRelative(4.04f, 7.0f);
        pathBuilderQ.curveToRelative(0.36f, 0.62f, 1.02f, 1.0f, 1.73f, 1.0f);
        pathBuilderQ.horizontalLineToRelative(8.09f);
        pathBuilderQ.curveToRelative(0.71f, 0.0f, 1.37f, -0.38f, 1.73f, -1.0f);
        pathBuilderQ.lineToRelative(4.04f, -7.0f);
        pathBuilderQ.curveToRelative(0.36f, -0.62f, 0.36f, -1.38f, 0.0f, -2.0f);
        pathBuilderQ.lineToRelative(-4.04f, -7.0f);
        pathBuilderQ.curveTo(17.42f, 3.38f, 16.76f, 3.0f, 16.05f, 3.0f);
        pathBuilderQ.close();
