...
public final class ColorizeKt {
    ...
    public static final ImageVector getColorize(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Colorize", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.lineToRelative(-1.23f, -1.21f);
        pathBuilderR.curveToRelative(-0.39f, -0.39f, -1.02f, -0.38f, -1.41f, 0.0f);
        pathBuilderR.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderR.lineToRelative(0.72f, 0.72f);
        pathBuilderR.lineToRelative(-8.77f, 8.77f);
        pathBuilderR.curveToRelative(-0.1f, 0.1f, -0.15f, 0.22f, -0.15f, 0.36f);
        pathBuilderR.verticalLineToRelative(4.04f);
        pathBuilderR.curveToRelative(0.0f, 0.28f, 0.22f, 0.5f, 0.5f, 0.5f);
        pathBuilderR.horizontalLineToRelative(4.04f);
        ...
        pathBuilderR.lineToRelative(3.12f, -3.12f);
        pathBuilderR.curveToRelative(0.41f, -0.4f, 0.41f, -1.03f, 0.02f, -1.42f);
