...
public final class WarningAmberKt {
    ...
    public static final ImageVector getWarningAmber(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WarningAmber", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.moveTo(2.74f, 18.0f);
        pathBuilderJ.curveToRelative(-0.77f, 1.33f, 0.19f, 3.0f, 1.73f, 3.0f);
        pathBuilderJ.horizontalLineToRelative(15.06f);
        pathBuilderJ.curveToRelative(1.54f, 0.0f, 2.5f, -1.67f, 1.73f, -3.0f);
        pathBuilderJ.lineTo(13.73f, 4.99f);
        pathBuilderJ.curveToRelative(-0.77f, -1.33f, -2.69f, -1.33f, -3.46f, 0.0f);
        c.z(pathBuilderJ, 2.74f, 18.0f, 11.0f, 11.0f);
        ...
        pathBuilderJ.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderJ.reflectiveCurveToRelative(-1.0f, 0.45f, -1.0f, 1.0f);
        b.w(pathBuilderJ, 11.0f, 16.0f, 2.0f, 2.0f);
