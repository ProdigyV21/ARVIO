...
public final class VerifiedUserKt {
    ...
    public static final ImageVector getVerifiedUser(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.VerifiedUser", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.lineTo(21.0f, 6.3f);
        ...
        a.p(pathBuilderR, 9.29f, 16.29f, 6.7f, 13.7f);
        ...
        pathBuilderR.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderR.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderR.lineToRelative(-6.59f, 6.59f);
        pathBuilderR.curveToRelative(-0.38f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderR.close();
