...
public final class _1kKt {
    ...
    public static final ImageVector get_1k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._1k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 9.25f, 15.0f, 9.25f, 15.0f);
        ...
        pathBuilderQ.curveTo(7.34f, 10.5f, 7.0f, 10.16f, 7.0f, 9.75f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(7.0f, 9.34f, 7.34f, 9.0f, 7.75f, 9.0f);
        ...
        a.p(pathBuilderQ, 15.59f, 15.0f, 15.59f, 15.0f);
        ...
        pathBuilderQ.curveTo(12.34f, 15.0f, 12.0f, 14.66f, 12.0f, 14.25f);
        pathBuilderQ.verticalLineToRelative(-4.5f);
        pathBuilderQ.curveTo(12.0f, 9.34f, 12.34f, 9.0f, 12.75f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderQ.verticalLineToRelative(1.5f);
        pathBuilderQ.lineToRelative(1.54f, -1.98f);
        pathBuilderQ.curveTo(15.17f, 9.1f, 15.38f, 9.0f, 15.59f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.58f, 0.0f, 0.91f, 0.66f, 0.56f, 1.12f);
        pathBuilderQ.lineTo(14.75f, 12.0f);
        pathBuilderQ.lineToRelative(1.41f, 1.88f);
        pathBuilderQ.curveTo(16.5f, 14.34f, 16.17f, 15.0f, 15.59f, 15.0f);
        pathBuilderQ.close();
