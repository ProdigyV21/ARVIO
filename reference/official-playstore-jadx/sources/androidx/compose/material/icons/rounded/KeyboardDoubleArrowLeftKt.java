...
public final class KeyboardDoubleArrowLeftKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowLeft(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowLeft", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(18.29f, 17.29f, 18.29f, 17.29f);
        pathBuilderJ.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderJ.lineTo(14.42f, 12.0f);
        ...
        pathBuilderJ.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderJ.lineToRelative(4.59f, 4.59f);
        pathBuilderJ.curveTo(17.27f, 17.68f, 17.9f, 17.68f, 18.29f, 17.29f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderJ2 = a.j(11.7f, 17.29f, 11.7f, 17.29f);
        pathBuilderJ2.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderJ2.lineTo(7.83f, 12.0f);
        ...
        pathBuilderJ2.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderJ2.lineToRelative(4.59f, 4.59f);
        pathBuilderJ2.curveTo(10.68f, 17.68f, 11.31f, 17.68f, 11.7f, 17.29f);
        pathBuilderJ2.close();
