...
public final class WomanKt {
    ...
    public static final ImageVector getWoman(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Woman", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(16.45f, 14.63f, -2.52f, -6.32f);
        pathBuilderR.curveToRelative(-0.32f, -0.79f, -1.08f, -1.3f, -1.94f, -1.31f);
        pathBuilderR.curveToRelative(-0.85f, 0.0f, -1.62f, 0.51f, -1.94f, 1.31f);
        pathBuilderR.lineToRelative(-2.52f, 6.32f);
        pathBuilderR.curveTo(7.28f, 15.29f, 7.77f, 16.0f, 8.47f, 16.0f);
        ...
        pathBuilderR.verticalLineToRelative(-5.0f);
        pathBuilderR.horizontalLineToRelative(1.53f);
        pathBuilderR.curveTo(16.23f, 16.0f, 16.72f, 15.29f, 16.45f, 14.63f);
        pathBuilderR.close();
