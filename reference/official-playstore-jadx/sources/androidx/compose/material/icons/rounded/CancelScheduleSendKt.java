...
public final class CancelScheduleSendKt {
    ...
    public static final ImageVector getCancelScheduleSend(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CancelScheduleSend", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineTo(2.4f, 3.6f);
        pathBuilderA.curveTo(1.74f, 3.31f, 1.01f, 3.8f, 1.01f, 4.51f);
        pathBuilderA.lineTo(1.0f, 9.2f);
        pathBuilderA.curveToRelative(0.0f, 0.47f, 0.33f, 0.88f, 0.78f, 0.98f);
        pathBuilderA.lineTo(10.0f, 12.0f);
        pathBuilderA.lineToRelative(-8.22f, 1.83f);
        pathBuilderA.curveTo(1.33f, 13.93f, 1.0f, 14.33f, 1.0f, 14.8f);
        pathBuilderA.lineToRelative(0.01f, 4.68f);
        pathBuilderA.curveToRelative(0.0f, 0.72f, 0.73f, 1.2f, 1.39f, 0.92f);
        pathBuilderA.lineToRelative(6.68f, -2.86f);
        ...
        PathBuilder pathBuilderA2 = c.a(18.62f, 14.38f);
        pathBuilderA2.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderA2.lineToRelative(-1.41f, 1.41f);
        pathBuilderA2.lineToRelative(-1.41f, -1.41f);
        pathBuilderA2.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderA2.reflectiveCurveToRelative(-0.2f, 0.51f, 0.0f, 0.71f);
        pathBuilderA2.lineToRelative(1.41f, 1.41f);
        pathBuilderA2.lineToRelative(-1.41f, 1.41f);
        ...
        pathBuilderA2.lineToRelative(-1.41f, -1.41f);
        pathBuilderA2.lineToRelative(1.41f, -1.41f);
        pathBuilderA2.curveTo(18.82f, 14.89f, 18.82f, 14.57f, 18.62f, 14.38f);
        pathBuilderA2.close();
