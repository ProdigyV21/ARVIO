...
public final class NorthWestKt {
    ...
    public static final ImageVector getNorthWest(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.NorthWest", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderJ = a.j(6.0f, 15.0f, 6.0f, 15.0f);
        pathBuilderJ.curveToRelative(0.56f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderJ.verticalLineTo(8.41f);
        pathBuilderJ.lineTo(17.89f, 19.3f);
        ...
        pathBuilderJ.lineTo(8.41f, 7.0f);
        ...
        pathBuilderJ.curveTo(5.45f, 5.0f, 5.0f, 5.45f, 5.0f, 6.0f);
        pathBuilderJ.verticalLineTo(14.0f);
        pathBuilderJ.curveTo(5.0f, 14.55f, 5.45f, 15.0f, 6.0f, 15.0f);
        pathBuilderJ.close();
