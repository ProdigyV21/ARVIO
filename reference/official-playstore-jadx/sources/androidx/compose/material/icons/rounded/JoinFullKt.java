...
public final class JoinFullKt {
    ...
    public static final ImageVector getJoinFull(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.JoinFull", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(12.68f, 6.8f);
        ...
        pathBuilderA.curveTo(15.0f, 10.85f, 14.65f, 8.56f, 12.68f, 6.8f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(7.5f, 12.0f);
        ...
        pathBuilderA2.curveTo(7.73f, 16.16f, 7.5f, 12.97f, 7.5f, 12.0f);
        pathBuilderA2.close();
        ...
        pathBuilderA3.curveToRelative(2.8f, 2.34f, 3.03f, 5.53f, 3.03f, 6.5f);
        pathBuilderA3.curveToRelative(0.0f, 0.97f, -0.23f, 4.16f, -3.03f, 6.5f);
