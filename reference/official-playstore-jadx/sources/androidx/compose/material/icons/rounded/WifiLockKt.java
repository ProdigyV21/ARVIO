...
public final class WifiLockKt {
    ...
    public static final ImageVector getWifiLock(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WifiLock", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(3.78f, 5.6f, 0.79f, 8.24f);
        pathBuilderA.curveTo(0.35f, 8.63f, 0.32f, 9.3f, 0.73f, 9.71f);
        pathBuilderA.lineToRelative(5.62f, 5.63f);
        pathBuilderA.lineToRelative(4.94f, 4.95f);
        ...
        pathBuilderA.horizontalLineToRelative(2.94f);
