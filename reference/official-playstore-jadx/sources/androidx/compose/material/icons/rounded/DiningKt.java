...
public final class DiningKt {
    ...
    public static final ImageVector getDining(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Dining", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(11.0f, 10.3f);
        pathBuilderQ.curveToRelative(0.0f, 0.93f, -0.64f, 1.71f, -1.5f, 1.93f);
        pathBuilderQ.verticalLineToRelative(6.02f);
        pathBuilderQ.curveTo(9.5f, 18.66f, 9.16f, 19.0f, 8.75f, 19.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveTo(8.34f, 19.0f, 8.0f, 18.66f, 8.0f, 18.25f);
        pathBuilderQ.verticalLineToRelative(-6.02f);
