...
public final class _4mpKt {
    ...
    public static final ImageVector get_4mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._4mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.n(pathBuilderQ, 17.75f, 12.5f, 10.75f, 10.0f);
        pathBuilderQ.horizontalLineToRelative(-2.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.verticalLineTo(6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveTo(11.0f, 5.84f, 11.0f, 6.25f);
        c.i(pathBuilderQ, 8.5f, 1.5f, 6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveTo(14.0f, 5.84f, 14.0f, 6.25f);
        pathBuilderQ.verticalLineTo(8.5f);
        pathBuilderQ.horizontalLineToRelative(0.25f);
        pathBuilderQ.curveTo(14.66f, 8.5f, 15.0f, 8.84f, 15.0f, 9.25f);
        pathBuilderQ.reflectiveCurveTo(14.66f, 10.0f, 14.25f, 10.0f);
        pathBuilderQ.horizontalLineTo(14.0f);
        pathBuilderQ.verticalLineToRelative(0.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderQ.reflectiveCurveTo(12.5f, 11.16f, 12.5f, 10.75f);
        pathBuilderQ.close();
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, v.b.i(pathBuilderQ, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
