...
public final class _1kPlusKt {
    ...
    public static final ImageVector get_1kPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._1kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 8.25f, 15.0f, 8.25f, 15.0f);
        ...
        pathBuilderQ.curveTo(9.0f, 14.66f, 8.66f, 15.0f, 8.25f, 15.0f);
        a.p(pathBuilderQ, 13.54f, 14.73f, 12.0f, 12.75f);
        pathBuilderQ.verticalLineToRelative(1.55f);
        pathBuilderQ.curveToRelative(0.0f, 0.39f, -0.31f, 0.7f, -0.7f, 0.7f);
        pathBuilderQ.horizontalLineTo(11.2f);
        ...
        pathBuilderQ.curveTo(11.69f, 9.0f, 12.0f, 9.31f, 12.0f, 9.7f);
        pathBuilderQ.verticalLineToRelative(1.55f);
        pathBuilderQ.lineToRelative(1.54f, -1.98f);
        pathBuilderQ.curveTo(13.67f, 9.1f, 13.88f, 9.0f, 14.09f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.58f, 0.0f, 0.91f, 0.66f, 0.56f, 1.12f);
        pathBuilderQ.lineTo(13.25f, 12.0f);
        pathBuilderQ.lineToRelative(1.41f, 1.88f);
        pathBuilderQ.curveTo(15.0f, 14.34f, 14.67f, 15.0f, 14.09f, 15.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveTo(13.88f, 15.0f, 13.67f, 14.9f, 13.54f, 14.73f);
