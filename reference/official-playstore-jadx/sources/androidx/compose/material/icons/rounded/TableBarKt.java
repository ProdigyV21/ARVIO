...
public final class TableBarKt {
    ...
    public static final ImageVector getTableBar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.TableBar", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(-0.99f, 2.47f);
        pathBuilderA.curveTo(6.27f, 19.34f, 6.71f, 20.0f, 7.37f, 20.0f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.38f, 0.0f, 0.72f, -0.23f, 0.86f, -0.58f);
        pathBuilderA.lineTo(9.2f, 17.0f);
        pathBuilderA.horizontalLineToRelative(5.6f);
        pathBuilderA.lineToRelative(0.97f, 2.42f);
        pathBuilderA.curveToRelative(0.14f, 0.35f, 0.48f, 0.58f, 0.86f, 0.58f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.66f, 0.0f, 1.11f, -0.66f, 0.86f, -1.27f);
        pathBuilderA.lineToRelative(-0.99f, -2.47f);
