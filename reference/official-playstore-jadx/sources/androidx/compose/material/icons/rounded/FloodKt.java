...
public final class FloodKt {
    ...
    public static final ImageVector getFlood(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Flood", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-1.54f, 0.0f, -1.96f, 0.62f, -2.67f, 0.88f);
        pathBuilderA.curveTo(2.27f, 20.03f, 2.0f, 20.4f, 2.0f, 20.83f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.0f, 0.71f, 0.72f, 1.19f, 1.38f, 0.94f);
        pathBuilderA.curveTo(4.15f, 21.48f, 4.49f, 21.0f, 5.34f, 21.0f);
        pathBuilderA.curveToRelative(1.24f, 0.0f, 1.38f, 1.0f, 3.33f, 1.0f);
        pathBuilderA.curveToRelative(1.95f, 0.0f, 2.1f, -1.0f, 3.34f, -1.0f);
        pathBuilderA.curveToRelative(1.22f, 0.0f, 1.4f, 1.0f, 3.33f, 1.0f);
        pathBuilderA.curveToRelative(1.93f, 0.0f, 2.1f, -1.0f, 3.33f, -1.0f);
        pathBuilderA.curveToRelative(0.84f, 0.0f, 1.18f, 0.47f, 1.95f, 0.77f);
        pathBuilderA.curveToRelative(0.66f, 0.26f, 1.38f, -0.23f, 1.38f, -0.94f);
        pathBuilderA.verticalLineToRelative(-0.01f);
        pathBuilderA.curveToRelative(0.0f, -0.42f, -0.27f, -0.8f, -0.67f, -0.94f);
        pathBuilderA.curveTo(20.62f, 19.62f, 20.21f, 19.0f, 18.67f, 19.0f);
        pathBuilderA.close();
        ...
        pathBuilderA2.curveToRelative(1.95f, 0.0f, 2.09f, -1.0f, 3.33f, -1.0f);
        pathBuilderA2.curveToRelative(0.82f, 0.0f, 1.17f, 0.46f, 1.93f, 0.76f);
        pathBuilderA2.curveToRelative(0.66f, 0.26f, 1.38f, -0.23f, 1.38f, -0.94f);
        pathBuilderA2.verticalLineToRelative(0.0f);
        pathBuilderA2.curveToRelative(0.0f, -0.42f, -0.26f, -0.79f, -0.65f, -0.94f);
        pathBuilderA2.curveToRelative(-0.29f, -0.11f, -0.54f, -0.27f, -0.83f, -0.43f);
        pathBuilderA2.lineToRelative(-2.02f, -7.53f);
        pathBuilderA2.lineToRelative(1.17f, 0.47f);
        pathBuilderA2.curveToRelative(0.51f, 0.21f, 1.09f, -0.04f, 1.29f, -0.55f);
        pathBuilderA2.verticalLineToRelative(0.0f);
        pathBuilderA2.curveToRelative(0.21f, -0.51f, -0.05f, -1.1f, -0.57f, -1.29f);
        pathBuilderA2.lineToRelative(-9.24f, -3.54f);
        pathBuilderA2.curveToRelative(-0.81f, -0.31f, -1.72f, -0.06f, -2.27f, 0.61f);
        pathBuilderA2.lineToRelative(-6.23f, 7.7f);
        pathBuilderA2.curveToRelative(-0.35f, 0.43f, -0.28f, 1.06f, 0.16f, 1.4f);
        pathBuilderA2.lineToRelative(0.0f, 0.0f);
        pathBuilderA2.curveToRelative(0.43f, 0.34f, 1.06f, 0.26f, 1.39f, -0.17f);
        pathBuilderA2.lineToRelative(0.78f, -1.0f);
        pathBuilderA2.lineToRelative(0.93f, 3.48f);
        pathBuilderA2.curveToRelative(-0.18f, -0.02f, -0.35f, -0.05f, -0.56f, -0.05f);
        pathBuilderA2.curveToRelative(-1.54f, 0.0f, -1.95f, 0.62f, -2.66f, 0.88f);
        pathBuilderA2.curveTo(2.27f, 15.53f, 2.0f, 15.91f, 2.0f, 16.33f);
        pathBuilderA2.verticalLineToRelative(0.0f);
        pathBuilderA2.curveToRelative(0.0f, 0.7f, 0.69f, 1.19f, 1.35f, 0.95f);
        pathBuilderA2.curveToRelative(0.8f, -0.29f, 1.18f, -0.78f, 2.0f, -0.78f);
