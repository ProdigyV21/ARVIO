...
public final class TipsAndUpdatesKt {
    ...
    public static final ImageVector getTipsAndUpdates(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.TipsAndUpdates", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(5.45f, 17.0f, 5.0f, 17.45f, 5.0f, 18.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.5f, 9.5f);
