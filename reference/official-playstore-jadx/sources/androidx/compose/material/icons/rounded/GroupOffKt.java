...
public final class GroupOffKt {
    ...
    public static final ImageVector getGroupOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.GroupOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderA, 7.24f, 4.41f, 21.19f, 21.19f);
        pathBuilderA.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA.reflectiveCurveToRelative(-1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderA.lineToRelative(-2.99f, -2.99f);
        pathBuilderA.curveTo(16.6f, 19.85f, 16.32f, 20.0f, 16.0f, 20.0f);
        ...
        pathBuilderA.lineTo(9.17f, 12.0f);
        ...
        pathBuilderA.reflectiveCurveToRelative(1.02f, -0.39f, 1.41f, 0.0f);
        c.z(pathBuilderA, 21.19f, 21.19f, 18.89f, 16.07f);
        pathBuilderA.curveToRelative(-0.29f, -1.22f, -1.13f, -2.19f, -2.23f, -2.94f);
        pathBuilderA.curveTo(19.42f, 13.53f, 23.0f, 14.82f, 23.0f, 17.0f);
        pathBuilderA.verticalLineToRelative(2.0f);
        pathBuilderA.curveToRelative(0.0f, 0.32f, -0.15f, 0.6f, -0.38f, 0.79f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 18.89f, 16.07f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
