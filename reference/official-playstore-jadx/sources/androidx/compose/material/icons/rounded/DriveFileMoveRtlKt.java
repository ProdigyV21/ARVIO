...
public final class DriveFileMoveRtlKt {
    ...
    public static final ImageVector getDriveFileMoveRtl(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DriveFileMoveRtl", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderG, 11.15f, 16.15f, -2.79f, -2.79f);
        pathBuilderG.curveToRelative(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        pathBuilderG.lineToRelative(2.79f, -2.79f);
        pathBuilderG.curveTo(11.46f, 9.54f, 12.0f, 9.76f, 12.0f, 10.21f);
        pathBuilderG.verticalLineTo(12.0f);
        ...
        pathBuilderG.curveTo(12.0f, 16.24f, 11.46f, 16.46f, 11.15f, 16.15f);
        pathBuilderG.close();
