...
public final class AudioFileKt {
    ...
    public static final ImageVector getAudioFile(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AudioFile", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.w(pathBuilderR, 15.0f, 13.0f, -2.0f, 3.61f);
        pathBuilderR.curveToRelative(0.0f, 1.28f, -1.0f, 2.41f, -2.28f, 2.39f);
        pathBuilderR.curveToRelative(-1.44f, -0.02f, -2.56f, -1.39f, -2.13f, -2.91f);
        pathBuilderR.curveToRelative(0.21f, -0.72f, 0.8f, -1.31f, 1.53f, -1.51f);
        pathBuilderR.curveToRelative(0.7f, -0.19f, 1.36f, -0.05f, 1.88f, 0.29f);
        ...
        pathBuilderR.curveTo(16.0f, 12.55f, 15.55f, 13.0f, 15.0f, 13.0f);
        pathBuilderR.close();
