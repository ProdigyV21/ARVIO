...
public final class FilterDramaKt {
    ...
    public static final ImageVector getFilterDrama(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FilterDrama", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.r(pathBuilderA, 19.0f, 18.0f, 6.17f);
        pathBuilderA.curveToRelative(-2.09f, 0.0f, -3.95f, -1.53f, -4.15f, -3.61f);
        pathBuilderA.curveTo(1.79f, 12.01f, 3.66f, 10.0f, 6.0f, 10.0f);
        pathBuilderA.curveToRelative(1.92f, 0.0f, 3.53f, 1.36f, 3.91f, 3.17f);
        pathBuilderA.curveToRelative(0.1f, 0.48f, 0.5f, 0.83f, 0.98f, 0.83f);
        pathBuilderA.curveToRelative(0.61f, 0.0f, 1.11f, -0.55f, 0.99f, -1.15f);
        pathBuilderA.curveToRelative(-0.43f, -2.24f, -2.11f, -4.03f, -4.29f, -4.63f);
        pathBuilderA.curveToRelative(1.1f, -1.46f, 2.89f, -2.37f, 4.89f, -2.2f);
        pathBuilderA.curveToRelative(2.88f, 0.25f, 5.01f, 2.82f, 5.01f, 5.71f);
        pathBuilderA.verticalLineTo(12.0f);
        pathBuilderA.horizontalLineToRelative(1.37f);
        pathBuilderA.curveToRelative(1.45f, 0.0f, 2.79f, 0.97f, 3.07f, 2.4f);
        pathBuilderA.curveToRelative(0.39f, 1.91f, -1.08f, 3.6f, -2.93f, 3.6f);
        pathBuilderA.close();
