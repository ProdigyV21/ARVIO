...
public final class YardKt {
    ...
    public static final ImageVector getYard(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Yard", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.curveToRelative(-2.83f, 0.0f, -5.21f, -1.97f, -5.84f, -4.61f);
        pathBuilderQ.curveToRelative(-0.18f, -0.74f, 0.49f, -1.4f, 1.23f, -1.23f);
        pathBuilderQ.curveTo(10.03f, 13.79f, 12.0f, 16.17f, 12.0f, 19.0f);
        pathBuilderQ.curveToRelative(0.0f, -2.83f, 1.97f, -5.21f, 4.61f, -5.84f);
        pathBuilderQ.curveToRelative(0.74f, -0.18f, 1.4f, 0.49f, 1.23f, 1.23f);
        pathBuilderQ.curveTo(17.21f, 17.03f, 14.83f, 19.0f, 12.0f, 19.0f);
        pathBuilderQ.close();
