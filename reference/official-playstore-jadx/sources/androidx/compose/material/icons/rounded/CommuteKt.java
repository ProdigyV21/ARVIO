...
public final class CommuteKt {
    ...
    public static final ImageVector getCommute(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Commute", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.lineToRelative(-0.77f, 0.77f);
        pathBuilderJ.curveToRelative(-0.28f, 0.28f, -0.28f, 0.72f, 0.0f, 1.0f);
        pathBuilderJ.reflectiveCurveToRelative(0.72f, 0.28f, 1.0f, 0.0f);
        b.A(pathBuilderJ, 7.0f, 18.0f, 2.0f, -5.0f);
        pathBuilderJ.lineTo(4.5f, 13.0f);
        ...
        pathBuilderJ.verticalLineToRelative(5.24f);
        ...
        pathBuilderJ.reflectiveCurveToRelative(0.99f, -0.44f, 1.0f, -0.99f);
        d.l(pathBuilderJ, 22.0f, 13.77f, -1.43f, -4.11f);
        pathBuilderJ.moveTo(12.77f, 10.0f);
        pathBuilderJ.horizontalLineToRelative(6.48f);
        pathBuilderJ.curveToRelative(0.21f, 0.0f, 0.4f, 0.14f, 0.47f, 0.34f);
        pathBuilderJ.lineToRelative(0.69f, 2.0f);
        pathBuilderJ.curveToRelative(0.11f, 0.32f, -0.13f, 0.66f, -0.47f, 0.66f);
        pathBuilderJ.horizontalLineToRelative(-7.85f);
        pathBuilderJ.curveToRelative(-0.34f, 0.0f, -0.58f, -0.34f, -0.47f, -0.66f);
        pathBuilderJ.lineToRelative(0.69f, -2.0f);
        pathBuilderJ.curveToRelative(0.05f, -0.2f, 0.24f, -0.34f, 0.46f, -0.34f);
        pathBuilderJ.close();
