...
public final class PanoramaWideAngleSelectKt {
    ...
    public static final ImageVector getPanoramaWideAngleSelect(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PanoramaWideAngleSelect", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 3.03f, 0.45f, 5.06f, 1.0f, 7.0f);
