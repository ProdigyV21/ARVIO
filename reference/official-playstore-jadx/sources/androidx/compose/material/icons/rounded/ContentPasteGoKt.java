...
public final class ContentPasteGoKt {
    ...
    public static final ImageVector getContentPasteGo(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ContentPasteGo", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.r(pathBuilderA, 5.0f, 2.0f, 6.0f, 2.0f);
        ...
        PathBuilder pathBuilderR = a.r(21.29f, 16.29f, -2.58f, -2.58f);
        ...
        pathBuilderR.lineToRelative(0.87f, 0.88f);
        ...
        pathBuilderR.curveTo(21.68f, 17.31f, 21.68f, 16.68f, 21.29f, 16.29f);
        pathBuilderR.close();
