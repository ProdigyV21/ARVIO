...
public final class AirlineSeatLegroomReducedKt {
    ...
    public static final ImageVector getAirlineSeatLegroomReduced(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AirlineSeatLegroomReduced", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-1.3f, 0.0f, -2.26f, -1.22f, -1.94f, -2.49f);
        pathBuilderA.lineTo(15.0f, 14.0f);
        ...
        a.u(pathBuilderA, 5.0f, 12.0f, 4.0f);
