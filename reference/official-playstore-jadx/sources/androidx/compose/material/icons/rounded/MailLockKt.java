...
public final class MailLockKt {
    ...
    public static final ImageVector getMailLock(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MailLock", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = e.a(22.0f, 9.97f, 6.0f);
        ...
        pathBuilderA.verticalLineToRelative(-5.03f);
        pathBuilderA.curveToRelative(0.0f, -2.76f, 2.24f, -5.0f, 5.0f, -5.0f);
        a.x(pathBuilderA, 22.0f, 19.6f, 8.25f);
        pathBuilderA.lineToRelative(-6.54f, 4.09f);
        pathBuilderA.curveToRelative(-0.65f, 0.41f, -1.47f, 0.41f, -2.12f, 0.0f);
        pathBuilderA.lineTo(4.4f, 8.25f);
        pathBuilderA.curveTo(4.15f, 8.09f, 4.0f, 7.82f, 4.0f, 7.53f);
        ...
        pathBuilderA.curveTo(19.27f, 6.46f, 20.0f, 6.86f, 20.0f, 7.53f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(20.0f, 7.82f, 19.85f, 8.09f, 19.6f, 8.25f);
        pathBuilderA.close();
        ...
        b.w(pathBuilderI, 22.0f, 15.0f, -2.0f, -1.0f);
        pathBuilderI.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
