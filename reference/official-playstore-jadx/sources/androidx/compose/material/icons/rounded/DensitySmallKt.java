...
public final class DensitySmallKt {
    ...
    public static final ImageVector getDensitySmall(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DensitySmall", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(3.0f, 3.0f, 3.0f, 3.0f);
        ...
        pathBuilderJ.curveTo(3.45f, 2.0f, 3.0f, 2.45f, 3.0f, 3.0f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderA = a.a(4.0f, 22.0f, 16.0f);
        ...
        PathBuilder pathBuilderA2 = a.a(4.0f, 16.0f, 16.0f);
        ...
        pathBuilderA2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderA2.verticalLineToRelative(0.0f);
        pathBuilderA2.curveTo(3.0f, 15.55f, 3.45f, 16.0f, 4.0f, 16.0f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderA3 = a.a(4.0f, 10.0f, 16.0f);
        ...
        pathBuilderA3.curveTo(3.45f, 8.0f, 3.0f, 8.45f, 3.0f, 9.0f);
        pathBuilderA3.verticalLineToRelative(0.0f);
        pathBuilderA3.curveTo(3.0f, 9.55f, 3.45f, 10.0f, 4.0f, 10.0f);
        pathBuilderA3.close();
