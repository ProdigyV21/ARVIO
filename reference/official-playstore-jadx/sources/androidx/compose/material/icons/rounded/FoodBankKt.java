...
public final class FoodBankKt {
    ...
    public static final ImageVector getFoodBank(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FoodBank", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.close();
        pathBuilderR.moveTo(12.5f, 12.5f);
        ...
        pathBuilderR.horizontalLineToRelative(0.0f);
        pathBuilderR.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        w.a.y(pathBuilderR, 2.5f, 10.0f, 10.0f);
        pathBuilderR.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderR.horizontalLineToRelative(0.0f);
        pathBuilderR.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        f.t(pathBuilderR, 2.5f, 0.5f, 10.0f);
        pathBuilderR.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderR.horizontalLineToRelative(0.0f);
        pathBuilderR.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        f.r(pathBuilderR, 12.5f, 14.5f, 18.0f);
        pathBuilderR.lineTo(14.5f, 18.0f);
        pathBuilderR.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        ...
        pathBuilderR.curveToRelative(0.0f, -0.88f, 0.57f, -1.63f, 1.36f, -1.89f);
        pathBuilderR.curveTo(14.67f, 9.5f, 15.0f, 9.75f, 15.0f, 10.09f);
        pathBuilderR.verticalLineToRelative(7.41f);
        pathBuilderR.curveTo(15.0f, 17.78f, 14.78f, 18.0f, 14.5f, 18.0f);
        pathBuilderR.close();
