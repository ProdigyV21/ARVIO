...
public final class BookOnlineKt {
    ...
    public static final ImageVector getBookOnline(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BookOnline", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderQ, 17.0f, 1.0f, 7.0f, 6.0f);
        d.z(pathBuilderQ, 10.0f, 12.0f, 7.0f, 6.0f);
        ...
        a.p(pathBuilderQ, 12.0f, 14.5f, 12.0f, 14.5f);
        ...
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(12.5f, 14.28f, 12.28f, 14.5f, 12.0f, 14.5f);
        a.p(pathBuilderQ, 12.0f, 12.5f, 12.0f, 12.5f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(12.5f, 12.28f, 12.28f, 12.5f, 12.0f, 12.5f);
        a.p(pathBuilderQ, 12.0f, 10.5f, 12.0f, 10.5f);
        pathBuilderQ.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(12.5f, 10.28f, 12.28f, 10.5f, 12.0f, 10.5f);
        pathBuilderQ.close();
