...
public final class FireExtinguisherKt {
    ...
    public static final ImageVector getFireExtinguisher(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FireExtinguisher", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.moveTo(17.0f, 4.23f);
        pathBuilderA.verticalLineToRelative(3.54f);
        pathBuilderA.curveToRelative(0.0f, 0.63f, -0.58f, 1.11f, -1.21f, 0.98f);
        pathBuilderA.lineToRelative(-1.94f, -0.41f);
        pathBuilderA.curveToRelative(0.0f, 0.02f, 0.0f, 0.01f, -0.01f, 0.03f);
        pathBuilderA.curveToRelative(1.54f, 0.62f, 2.71f, 1.98f, 3.06f, 3.63f);
        ...
        pathBuilderA.lineTo(5.49f, 6.6f);
        pathBuilderA.curveTo(5.2f, 6.54f, 5.0f, 6.29f, 5.0f, 6.0f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.0f, -0.29f, 0.2f, -0.54f, 0.49f, -0.6f);
        pathBuilderA.lineToRelative(3.88f, -0.81f);
        pathBuilderA.curveTo(9.87f, 3.65f, 10.86f, 3.0f, 12.0f, 3.0f);
        pathBuilderA.curveToRelative(0.7f, 0.0f, 1.34f, 0.25f, 1.85f, 0.66f);
        pathBuilderA.lineToRelative(1.94f, -0.41f);
        pathBuilderA.curveTo(16.42f, 3.12f, 17.0f, 3.6f, 17.0f, 4.23f);
        pathBuilderA.close();
