...
public final class PlayCircleFilledKt {
    ...
    public static final ImageVector getPlayCircleFilled(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PlayCircleFilled", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        d.k(pathBuilderA, 10.0f, 15.5f, -7.0f);
        pathBuilderA.curveToRelative(0.0f, -0.41f, 0.47f, -0.65f, 0.8f, -0.4f);
        pathBuilderA.lineToRelative(4.67f, 3.5f);
