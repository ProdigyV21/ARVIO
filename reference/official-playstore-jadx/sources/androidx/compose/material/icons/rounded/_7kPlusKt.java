...
public final class _7kPlusKt {
    ...
    public static final ImageVector get_7kPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._7kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        w.a.r(pathBuilderQ, 7.95f, 15.0f, 7.76f);
        ...
        pathBuilderQ.curveTo(5.5f, 9.34f, 5.83f, 9.0f, 6.25f, 9.0f);
        ...
        pathBuilderQ.curveTo(8.56f, 14.79f, 8.27f, 15.0f, 7.95f, 15.0f);
        a.p(pathBuilderQ, 14.59f, 15.0f, 14.59f, 15.0f);
