...
public final class LoyaltyKt {
    ...
    public static final ImageVector getLoyalty(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Loyalty", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderR, 17.27f, 15.27f, -3.92f, 3.92f);
        pathBuilderR.curveToRelative(-0.2f, 0.2f, -0.51f, 0.2f, -0.71f, 0.0f);
        pathBuilderR.lineToRelative(-3.92f, -3.92f);
        pathBuilderR.curveToRelative(-0.57f, -0.58f, -0.87f, -1.43f, -0.67f, -2.34f);
        pathBuilderR.curveToRelative(0.19f, -0.88f, 0.89f, -1.61f, 1.76f, -1.84f);
        pathBuilderR.curveToRelative(0.94f, -0.25f, 1.85f, 0.04f, 2.44f, 0.65f);
        pathBuilderR.lineToRelative(0.75f, 0.72f);
