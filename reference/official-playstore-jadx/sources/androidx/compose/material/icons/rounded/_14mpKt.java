...
public final class _14mpKt {
    ...
    public static final ImageVector get_14mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._14mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        b.n(pathBuilderQ, 17.75f, 12.0f, 9.0f, 6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveToRelative(0.75f, 0.34f, 0.75f, 0.75f);
        b.y(pathBuilderQ, 8.5f, 15.0f, 6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveToRelative(0.75f, 0.34f, 0.75f, 0.75f);
        ...
        pathBuilderQ.reflectiveCurveTo(17.16f, 10.0f, 16.75f, 10.0f);
        pathBuilderQ.horizontalLineTo(16.5f);
        pathBuilderQ.verticalLineToRelative(0.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderQ.reflectiveCurveTo(15.0f, 11.16f, 15.0f, 10.75f);
        pathBuilderQ.verticalLineTo(10.0f);
        pathBuilderQ.horizontalLineToRelative(-2.0f);
        pathBuilderQ.curveTo(12.45f, 10.0f, 12.0f, 9.55f, 12.0f, 9.0f);
        pathBuilderQ.close();
