...
public final class EditLocationKt {
    ...
    public static final ImageVector getEditLocation(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EditLocation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderA, 9.73f, 13.5f, 8.5f, -1.44f);
        pathBuilderA.lineToRelative(3.93f, -3.92f);
        pathBuilderA.lineToRelative(1.43f, 1.43f);
        pathBuilderA.lineToRelative(-3.77f, 3.78f);
        pathBuilderA.curveTo(9.99f, 13.45f, 9.87f, 13.5f, 9.73f, 13.5f);
        a.z(pathBuilderA, 15.28f, 8.16f, -0.7f, 0.7f);
        pathBuilderA.lineToRelative(-1.44f, -1.44f);
        pathBuilderA.lineToRelative(0.7f, -0.7f);
        pathBuilderA.curveToRelative(0.15f, -0.15f, 0.39f, -0.15f, 0.54f, 0.0f);
        pathBuilderA.lineToRelative(0.9f, 0.9f);
        pathBuilderA.curveTo(15.43f, 7.77f, 15.43f, 8.01f, 15.28f, 8.16f);
        pathBuilderA.close();
