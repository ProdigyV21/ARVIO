...
public final class TableRestaurantKt {
    ...
    public static final ImageVector getTableRestaurant(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.TableRestaurant", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.horizontalLineToRelative(2.2f);
        pathBuilderR.lineToRelative(-1.05f, 7.88f);
        pathBuilderR.curveTo(4.07f, 19.47f, 4.53f, 20.0f, 5.13f, 20.0f);
        pathBuilderR.horizontalLineToRelative(0.0f);
        pathBuilderR.curveToRelative(0.5f, 0.0f, 0.92f, -0.37f, 0.98f, -0.86f);
        pathBuilderR.lineTo(6.67f, 15.0f);
        pathBuilderR.horizontalLineToRelative(10.67f);
        pathBuilderR.lineToRelative(0.55f, 4.14f);
        pathBuilderR.curveToRelative(0.07f, 0.49f, 0.49f, 0.86f, 0.98f, 0.86f);
        pathBuilderR.horizontalLineToRelative(0.0f);
        pathBuilderR.curveToRelative(0.6f, 0.0f, 1.06f, -0.53f, 0.98f, -1.12f);
        pathBuilderR.lineTo(18.8f, 11.0f);
