...
public final class SupportAgentKt {
    ...
    public static final ImageVector getSupportAgent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SupportAgent", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = c.a(21.0f, 12.22f);
        pathBuilderA.curveTo(21.0f, 6.73f, 16.74f, 3.0f, 12.0f, 3.0f);
        pathBuilderA.curveToRelative(-4.69f, 0.0f, -9.0f, 3.65f, -9.0f, 9.28f);
        pathBuilderA.curveTo(2.4f, 12.62f, 2.0f, 13.26f, 2.0f, 14.0f);
        pathBuilderA.verticalLineToRelative(2.0f);
        pathBuilderA.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderA.lineToRelative(0.0f, -4.81f);
        pathBuilderA.curveToRelative(0.0f, -3.83f, 2.95f, -7.18f, 6.78f, -7.29f);
        pathBuilderA.curveToRelative(3.96f, -0.12f, 7.22f, 3.06f, 7.22f, 7.0f);
        ...
        pathBuilderA.curveToRelative(0.59f, -0.31f, 1.0f, -0.92f, 1.0f, -1.64f);
        pathBuilderA.verticalLineToRelative(-2.3f);
        pathBuilderA.curveTo(22.0f, 13.14f, 21.59f, 12.53f, 21.0f, 12.22f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(18.0f, 11.03f);
        pathBuilderA2.curveTo(17.52f, 8.18f, 15.04f, 6.0f, 12.05f, 6.0f);
        pathBuilderA2.curveToRelative(-3.03f, 0.0f, -6.29f, 2.51f, -6.03f, 6.45f);
        pathBuilderA2.curveToRelative(2.47f, -1.01f, 4.33f, -3.21f, 4.86f, -5.89f);
        pathBuilderA2.curveTo(12.19f, 9.19f, 14.88f, 11.0f, 18.0f, 11.03f);
        pathBuilderA2.close();
