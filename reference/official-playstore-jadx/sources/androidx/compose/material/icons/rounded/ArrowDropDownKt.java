...
public final class ArrowDropDownKt {
    ...
    public static final ImageVector getArrowDropDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowDropDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = a.r(8.71f, 11.71f, 2.59f, 2.59f);
        ...
        pathBuilderR.horizontalLineTo(9.41f);
        pathBuilderR.curveToRelative(-0.89f, 0.0f, -1.33f, 1.08f, -0.7f, 1.71f);
        pathBuilderR.close();
