...
public final class SystemUpdateAltKt {
    ...
    public static final ImageVector getSystemUpdateAlt(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SystemUpdateAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderR = a.r(12.35f, 15.65f, 2.79f, -2.79f);
        ...
        pathBuilderR.horizontalLineTo(9.21f);
        ...
        a.g(pathBuilderR, 21.0f, 3.0f, -5.01f);
        pathBuilderR.curveToRelative(-0.54f, 0.0f, -0.99f, 0.45f, -0.99f, 0.99f);
        pathBuilderR.curveToRelative(0.0f, 0.55f, 0.45f, 0.99f, 0.99f, 0.99f);
        ...
        pathBuilderR.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderR.verticalLineTo(5.99f);
        pathBuilderR.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderR.horizontalLineToRelative(4.01f);
        pathBuilderR.curveToRelative(0.54f, 0.0f, 0.99f, -0.45f, 0.99f, -0.99f);
        pathBuilderR.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -0.99f, -1.0f);
