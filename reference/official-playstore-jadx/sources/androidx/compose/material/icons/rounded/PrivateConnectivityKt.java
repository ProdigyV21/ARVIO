...
public final class PrivateConnectivityKt {
    ...
    public static final ImageVector getPrivateConnectivity(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PrivateConnectivity", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(21.55f, 13.0f, 22.0f, 12.55f, 22.0f, 12.0f);
        pathBuilderA.close();
