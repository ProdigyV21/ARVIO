...
public final class _2kKt {
    ...
    public static final ImageVector get_2k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._2k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderQ, 10.0f, 12.5f, 8.0f, 1.0f);
        pathBuilderQ.horizontalLineToRelative(2.25f);
        ...
        a0.a.i(pathBuilderQ, 2.0f, -1.0f, 7.25f);
        pathBuilderQ.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.verticalLineToRelative(1.5f);
        pathBuilderQ.curveTo(11.0f, 12.05f, 10.55f, 12.5f, 10.0f, 12.5f);
