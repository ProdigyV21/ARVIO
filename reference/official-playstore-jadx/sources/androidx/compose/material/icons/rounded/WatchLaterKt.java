...
public final class WatchLaterKt {
    ...
    public static final ImageVector getWatchLater(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WatchLater", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 15.55f, 15.8f, -4.08f, -2.51f);
        pathBuilderA.curveToRelative(-0.3f, -0.18f, -0.48f, -0.5f, -0.48f, -0.85f);
        pathBuilderA.verticalLineTo(7.75f);
        pathBuilderA.curveTo(11.0f, 7.34f, 11.34f, 7.0f, 11.75f, 7.0f);
        pathBuilderA.reflectiveCurveToRelative(0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderA.verticalLineToRelative(4.45f);
        pathBuilderA.lineToRelative(3.84f, 2.31f);
        pathBuilderA.curveToRelative(0.36f, 0.22f, 0.48f, 0.69f, 0.26f, 1.05f);
        pathBuilderA.curveTo(16.38f, 15.91f, 15.91f, 16.02f, 15.55f, 15.8f);
        pathBuilderA.close();
