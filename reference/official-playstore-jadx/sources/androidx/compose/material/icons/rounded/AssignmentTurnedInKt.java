...
public final class AssignmentTurnedInKt {
    ...
    public static final ImageVector getAssignmentTurnedIn(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AssignmentTurnedIn", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        a.p(pathBuilderA, 9.29f, 16.29f, 6.7f, 13.7f);
