...
public final class Man3Kt {
    ...
    public static final ImageVector getMan3(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Man3", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(11.65f, 5.9f, 10.1f, 4.35f);
        ...
        pathBuilderJ.lineToRelative(1.54f, 1.54f);
        pathBuilderJ.curveToRelative(0.2f, 0.2f, 0.2f, 0.51f, 0.0f, 0.71f);
        pathBuilderJ.lineTo(12.35f, 5.9f);
        pathBuilderJ.curveTo(12.16f, 6.09f, 11.84f, 6.09f, 11.65f, 5.9f);
        pathBuilderJ.close();
