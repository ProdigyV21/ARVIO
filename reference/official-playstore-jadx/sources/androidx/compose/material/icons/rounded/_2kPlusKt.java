...
public final class _2kPlusKt {
    ...
    public static final ImageVector get_2kPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._2kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(10.0f, 11.5f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.n(pathBuilderQ, 7.5f, 1.0f, 1.75f);
        ...
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        a0.a.i(pathBuilderQ, 1.5f, -1.0f, 6.75f);
        pathBuilderQ.curveTo(6.34f, 10.5f, 6.0f, 10.16f, 6.0f, 9.75f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(6.0f, 9.34f, 6.34f, 9.0f, 6.75f, 9.0f);
        pathBuilderQ.horizontalLineTo(9.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        f.r(pathBuilderQ, 11.5f, 14.04f, 14.73f);
        ...
        pathBuilderQ.curveTo(11.0f, 9.34f, 11.34f, 9.0f, 11.75f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderQ.verticalLineToRelative(1.5f);
        pathBuilderQ.lineToRelative(1.54f, -1.98f);
        ...
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveTo(14.38f, 15.0f, 14.17f, 14.9f, 14.04f, 14.73f);
