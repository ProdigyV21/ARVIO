...
public final class CommentBankKt {
    ...
    public static final ImageVector getCommentBank(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CommentBank", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 18.24f, 11.55f, 16.5f, 10.5f);
        pathBuilderQ.lineToRelative(-1.74f, 1.05f);
        pathBuilderQ.curveToRelative(-0.33f, 0.2f, -0.76f, -0.04f, -0.76f, -0.43f);
        w.a.j(pathBuilderQ, 4.0f, 5.0f, 7.12f);
        pathBuilderQ.curveTo(19.0f, 11.51f, 18.58f, 11.75f, 18.24f, 11.55f);
        pathBuilderQ.close();
