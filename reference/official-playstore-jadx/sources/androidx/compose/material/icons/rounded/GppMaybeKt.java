...
public final class GppMaybeKt {
    ...
    public static final ImageVector getGppMaybe(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.GppMaybe", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderR, 12.0f, 16.0f, 12.0f, 16.0f);
        ...
        pathBuilderR.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderR.verticalLineToRelative(0.0f);
        pathBuilderR.curveTo(13.0f, 15.55f, 12.55f, 16.0f, 12.0f, 16.0f);
        a.p(pathBuilderR, 12.0f, 12.0f, 12.0f, 12.0f);
        pathBuilderR.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        ...
        pathBuilderR.curveTo(13.0f, 11.55f, 12.55f, 12.0f, 12.0f, 12.0f);
        pathBuilderR.close();
