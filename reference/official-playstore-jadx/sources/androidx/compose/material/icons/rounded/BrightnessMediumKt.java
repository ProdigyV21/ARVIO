...
public final class BrightnessMediumKt {
    ...
    public static final ImageVector getBrightnessMedium(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BrightnessMedium", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderR.curveToRelative(0.78f, 0.78f, 2.05f, 0.78f, 2.83f, 0.0f);
        pathBuilderR.lineToRelative(1.9f, -1.9f);
        pathBuilderR.lineTo(18.0f, 20.0f);
        pathBuilderR.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        b.f(pathBuilderR, -2.69f, 12.0f, 16.9f);
