...
public final class PeopleKt {
    ...
    public static final ImageVector getPeople(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.People", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(16.0f, 11.0f);
        pathBuilderA.curveToRelative(1.66f, 0.0f, 2.99f, -1.34f, 2.99f, -3.0f);
        pathBuilderA.reflectiveCurveTo(17.66f, 5.0f, 16.0f, 5.0f);
        ...
        pathBuilderA.curveToRelative(1.66f, 0.0f, 2.99f, -1.34f, 2.99f, -3.0f);
        pathBuilderA.reflectiveCurveTo(9.66f, 5.0f, 8.0f, 5.0f);
        pathBuilderA.reflectiveCurveTo(5.0f, 6.34f, 5.0f, 8.0f);
        pathBuilderA.reflectiveCurveToRelative(1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.curveToRelative(0.0f, -2.33f, -4.67f, -3.5f, -7.0f, -3.5f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.0f, 13.0f);
        pathBuilderA.curveToRelative(-0.29f, 0.0f, -0.62f, 0.02f, -0.97f, 0.05f);
        pathBuilderA.curveToRelative(0.02f, 0.01f, 0.03f, 0.03f, 0.04f, 0.04f);
        pathBuilderA.curveToRelative(1.14f, 0.83f, 1.93f, 1.94f, 1.93f, 3.41f);
        pathBuilderA.lineTo(17.0f, 18.0f);
