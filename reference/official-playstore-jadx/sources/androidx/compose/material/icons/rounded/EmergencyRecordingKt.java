...
public final class EmergencyRecordingKt {
    ...
    public static final ImageVector getEmergencyRecording(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EmergencyRecording", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(-2.13f, -1.23f);
        pathBuilderA.curveTo(5.39f, 10.49f, 5.22f, 9.88f, 5.5f, 9.4f);
        pathBuilderA.curveToRelative(0.28f, -0.48f, 0.89f, -0.64f, 1.37f, -0.37f);
        ...
        pathBuilderA.lineToRelative(2.13f, 1.23f);
        pathBuilderA.curveTo(14.61f, 13.51f, 14.78f, 14.12f, 14.5f, 14.6f);
        pathBuilderA.close();
