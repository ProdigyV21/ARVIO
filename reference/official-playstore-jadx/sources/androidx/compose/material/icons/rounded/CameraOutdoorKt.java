...
public final class CameraOutdoorKt {
    ...
    public static final ImageVector getCameraOutdoor(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CameraOutdoor", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(19.6f, 16.85f, 20.0f, 16.61f, 20.0f, 16.23f);
        pathBuilderA.verticalLineToRelative(-2.46f);
        pathBuilderA.curveToRelative(0.0f, -0.38f, -0.4f, -0.62f, -0.73f, -0.44f);
        b.s(pathBuilderA, 18.0f, 14.0f, 13.0f);
        pathBuilderA.moveTo(10.8f, 3.9f);
        ...
        pathBuilderA.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        a.D(pathBuilderA, 6.0f, -9.0f, 6.0f, -4.5f);
        pathBuilderA.lineToRelative(6.0f, 4.5f);
        a.m(pathBuilderA, 0.0f, 1.0f, 2.0f, -1.0f);
