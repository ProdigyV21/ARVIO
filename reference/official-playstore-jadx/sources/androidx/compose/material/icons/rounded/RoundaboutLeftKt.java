...
public final class RoundaboutLeftKt {
    ...
    public static final ImageVector getRoundaboutLeft(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RoundaboutLeft", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(0.0f, -5.09f);
        ...
        pathBuilderA.lineTo(2.71f, 9.71f);
        pathBuilderA.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        ...
        pathBuilderA.curveTo(17.0f, 20.55f, 16.55f, 21.0f, 16.0f, 21.0f);
        pathBuilderA.close();
