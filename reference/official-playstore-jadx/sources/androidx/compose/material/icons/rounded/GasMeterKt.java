...
public final class GasMeterKt {
    ...
    public static final ImageVector getGasMeter(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.GasMeter", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderB = e.b(16.0f, 4.0f, -1.0f, 3.0f);
        pathBuilderB.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        f.t(pathBuilderB, 1.0f, -2.0f, 3.0f);
        pathBuilderB.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        ...
        pathBuilderB.curveTo(5.79f, 4.0f, 4.0f, 5.79f, 4.0f, 8.0f);
        ...
        pathBuilderB.curveTo(20.0f, 5.79f, 18.21f, 4.0f, 16.0f, 4.0f);
        pathBuilderB.close();
        pathBuilderB.moveTo(12.0f, 18.0f);
        pathBuilderB.curveToRelative(-1.38f, 0.0f, -2.5f, -1.1f, -2.5f, -2.46f);
        pathBuilderB.curveToRelative(0.0f, -1.02f, 0.38f, -1.35f, 2.12f, -3.35f);
        pathBuilderB.curveToRelative(0.2f, -0.23f, 0.56f, -0.23f, 0.75f, 0.0f);
        pathBuilderB.curveToRelative(1.73f, 1.99f, 2.12f, 2.34f, 2.12f, 3.35f);
        pathBuilderB.curveTo(14.5f, 16.9f, 13.38f, 18.0f, 12.0f, 18.0f);
        a.r(pathBuilderB, 15.0f, 10.0f, 9.0f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
