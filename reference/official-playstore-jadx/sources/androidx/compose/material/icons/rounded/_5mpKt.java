...
public final class _5mpKt {
    ...
    public static final ImageVector get_5mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._5mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.reflectiveCurveTo(14.16f, 7.0f, 13.75f, 7.0f);
        a.n(pathBuilderQ, 11.5f, 1.0f, 2.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.verticalLineToRelative(1.5f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderQ.horizontalLineToRelative(-2.75f);
        pathBuilderQ.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveTo(10.34f, 10.0f, 10.75f, 10.0f);
        f.f(pathBuilderQ, 13.0f, 9.0f, 11.0f);
        pathBuilderQ.moveTo(12.5f, 17.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderQ.reflectiveCurveTo(11.0f, 18.17f, 11.0f, 17.75f);
        w.a.j(pathBuilderQ, 14.0f, -1.0f, 2.25f);
        pathBuilderQ.curveTo(10.0f, 16.67f, 9.66f, 17.0f, 9.25f, 17.0f);
        pathBuilderQ.reflectiveCurveTo(8.5f, 16.67f, 8.5f, 16.25f);
        w.a.j(pathBuilderQ, 14.0f, -1.0f, 3.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderQ.reflectiveCurveTo(6.0f, 18.17f, 6.0f, 17.75f);
