...
public final class _18mpKt {
    ...
    public static final ImageVector get_18mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._18mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.d(13.5f, 9.0f, 1.5f, 1.5f, -1.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        w.a.r(pathBuilderQ, 7.75f, 5.5f, 9.0f);
        ...
        pathBuilderQ.reflectiveCurveTo(8.5f, 11.16f, 8.5f, 10.75f);
        pathBuilderQ.verticalLineTo(7.0f);
        pathBuilderQ.horizontalLineTo(7.75f);
        pathBuilderQ.curveTo(7.34f, 7.0f, 7.0f, 6.66f, 7.0f, 6.25f);
        pathBuilderQ.reflectiveCurveTo(7.34f, 5.5f, 7.75f, 5.5f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.5f, 17.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        w.a.k(pathBuilderQ, 17.75f, 12.0f, 10.5f, -4.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        ...
        pathBuilderQ.curveTo(12.45f, 11.5f, 12.0f, 11.05f, 12.0f, 10.5f);
        pathBuilderQ.close();
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderQ, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.d(13.5f, 6.5f, 1.5f, 1.5f, -1.5f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m3498getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3803getButtKaPHkGw(), companion3.m3813getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
