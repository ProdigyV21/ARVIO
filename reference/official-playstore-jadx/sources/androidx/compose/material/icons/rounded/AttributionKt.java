...
public final class AttributionKt {
    ...
    public static final ImageVector getAttribution(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Attribution", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineTo(9.25f, 14.0f);
        ...
        pathBuilderA.lineTo(13.25f, 14.5f);
        pathBuilderA.horizontalLineToRelative(1.0f);
