...
public final class StopScreenShareKt {
    ...
    public static final ImageVector getStopScreenShare(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.StopScreenShare", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderG = c.g(23.0f, 18.0f, -1.2f, 1.79f, 1.79f);
        pathBuilderG.curveToRelative(0.24f, -0.18f, 0.41f, -0.46f, 0.41f, -0.79f);
        pathBuilderG.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilderG.close();
        pathBuilderG.moveTo(3.23f, 2.28f);
        ...
        pathBuilderG.lineToRelative(0.84f, 0.86f);
        pathBuilderG.reflectiveCurveToRelative(-0.66f, 0.57f, -0.66f, 1.47f);
        pathBuilderG.curveTo(2.0f, 6.92f, 2.0f, 16.0f, 2.0f, 16.0f);
        pathBuilderG.lineToRelative(0.01f, 0.01f);
        pathBuilderG.curveToRelative(0.0f, 1.09f, 0.88f, 1.98f, 1.97f, 1.99f);
        pathBuilderG.lineTo(1.0f, 18.0f);
        pathBuilderG.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderG.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderG.horizontalLineToRelative(17.13f);
        ...
        c.z(pathBuilderG, 3.23f, 2.28f, 7.0f, 15.0f);
        pathBuilderG.curveToRelative(0.31f, -1.48f, 0.94f, -2.93f, 2.08f, -4.05f);
        pathBuilderG.lineToRelative(1.59f, 1.59f);
        pathBuilderG.curveTo(9.13f, 12.92f, 7.96f, 13.71f, 7.0f, 15.0f);
        d.k(pathBuilderG, 13.0f, 9.13f, -0.98f);
        pathBuilderG.curveToRelative(0.0f, -0.44f, 0.52f, -0.66f, 0.84f, -0.37f);
        pathBuilderG.lineTo(15.0f, 8.87f);
        pathBuilderG.lineToRelative(1.61f, 1.5f);
        pathBuilderG.curveToRelative(0.21f, 0.2f, 0.21f, 0.53f, 0.0f, 0.73f);
        pathBuilderG.lineToRelative(-0.89f, 0.83f);
        pathBuilderG.lineToRelative(5.58f, 5.58f);
        pathBuilderG.curveToRelative(0.43f, -0.37f, 0.7f, -0.9f, 0.7f, -1.51f);
        pathBuilderG.lineTo(22.0f, 6.0f);
        pathBuilderG.curveToRelative(0.0f, -1.09f, -0.89f, -1.98f, -1.98f, -1.98f);
        pathBuilderG.lineTo(7.8f, 4.02f);
        pathBuilderG.lineToRelative(5.14f, 5.13f);
        pathBuilderG.curveToRelative(0.02f, -0.01f, 0.04f, -0.02f, 0.06f, -0.02f);
        pathBuilderG.close();
