...
public final class BusAlertKt {
    ...
    public static final ImageVector getBusAlert(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BusAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(3.0f, 21.33f, 3.67f, 22.0f, 4.5f, 22.0f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveTo(5.33f, 22.0f, 6.0f, 21.33f, 6.0f, 20.5f);
        a.j(pathBuilderA, 20.0f, 8.0f, 0.5f);
        ...
        v.a.x(pathBuilderA, 4.0f, 6.5f, 17.0f);
        ...
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA, 15.0f, 14.67f, 15.0f, 15.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.reflectiveCurveToRelative(0.5f, 0.22f, 0.5f, 0.5f);
        f.r(pathBuilderA2, 6.5f, 18.5f, 8.5f);
        pathBuilderA2.curveTo(18.5f, 8.78f, 18.28f, 9.0f, 18.0f, 9.0f);
        pathBuilderA2.reflectiveCurveToRelative(-0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilderA2.reflectiveCurveTo(17.72f, 8.0f, 18.0f, 8.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA2, 18.5f, 8.22f, 18.5f, 8.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
