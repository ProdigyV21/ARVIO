...
public final class DevicesFoldKt {
    ...
    public static final ImageVector getDevicesFold(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DevicesFold", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.43f, -1.47f, -2.4f, -2.79f, -1.84f);
        ...
        a.g(pathBuilderA, 20.0f, 19.0f, -5.33f);
