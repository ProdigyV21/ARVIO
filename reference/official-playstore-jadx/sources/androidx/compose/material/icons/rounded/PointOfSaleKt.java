...
public final class PointOfSaleKt {
    ...
    public static final ImageVector getPointOfSale(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PointOfSale", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderQ, 16.5f, 6.0f, -9.0f);
        pathBuilderQ.curveTo(7.22f, 6.0f, 7.0f, 5.78f, 7.0f, 5.5f);
        pathBuilderQ.verticalLineToRelative(-1.0f);
        pathBuilderQ.curveTo(7.0f, 4.22f, 7.22f, 4.0f, 7.5f, 4.0f);
        pathBuilderQ.horizontalLineToRelative(9.0f);
        pathBuilderQ.curveTo(16.78f, 4.0f, 17.0f, 4.22f, 17.0f, 4.5f);
        pathBuilderQ.verticalLineToRelative(1.0f);
        pathBuilderQ.curveTo(17.0f, 5.78f, 16.78f, 6.0f, 16.5f, 6.0f);
        w.a.r(pathBuilderQ, 20.0f, 22.0f, 4.0f);
        pathBuilderQ.curveToRelative(-1.1f, 0.0f, -2.0f, -0.9f, -2.0f, -2.0f);
