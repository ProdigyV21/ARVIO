...
public final class FaceRetouchingOffKt {
    ...
    public static final ImageVector getFaceRetouchingOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FaceRetouchingOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderR = a.r(2.6f, 4.43f, 1.48f, 1.48f);
        pathBuilderR.curveTo(2.51f, 7.95f, 1.7f, 10.6f, 2.1f, 13.46f);
        pathBuilderR.curveToRelative(0.62f, 4.33f, 4.11f, 7.82f, 8.44f, 8.44f);
        pathBuilderR.curveToRelative(2.85f, 0.41f, 5.51f, -0.41f, 7.55f, -1.98f);
        ...
        pathBuilderR.lineTo(4.01f, 3.01f);
        pathBuilderR.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderR.lineToRelative(0.0f, 0.0f);
        pathBuilderR.curveTo(2.21f, 3.41f, 2.21f, 4.04f, 2.6f, 4.43f);
        pathBuilderR.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderR, 16.66f, 18.49f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw3, iM3813getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
