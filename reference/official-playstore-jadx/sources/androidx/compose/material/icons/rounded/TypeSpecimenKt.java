...
public final class TypeSpecimenKt {
    ...
    public static final ImageVector getTypeSpecimen(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.TypeSpecimen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(3.0f, 6.0f, 3.0f, 6.0f);
        pathBuilderJ.curveTo(2.45f, 6.0f, 2.0f, 6.45f, 2.0f, 7.0f);
        ...
        pathBuilderJ.curveTo(4.0f, 6.45f, 3.55f, 6.0f, 3.0f, 6.0f);
        pathBuilderJ.close();
        ...
        a.z(pathBuilderQ, 16.46f, 14.01f, -0.63f, -1.82f);
        pathBuilderQ.horizontalLineToRelative(-3.63f);
        pathBuilderQ.lineToRelative(-0.65f, 1.82f);
        pathBuilderQ.curveToRelative(-0.1f, 0.29f, -0.38f, 0.48f, -0.68f, 0.48f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(-0.51f, 0.0f, -0.86f, -0.51f, -0.68f, -0.98f);
        pathBuilderQ.lineToRelative(2.73f, -7.27f);
        pathBuilderQ.curveTo(13.08f, 5.8f, 13.52f, 5.5f, 14.0f, 5.5f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.48f, 0.0f, 0.92f, 0.3f, 1.09f, 0.75f);
        pathBuilderQ.lineToRelative(2.73f, 7.27f);
        pathBuilderQ.curveToRelative(0.18f, 0.47f, -0.17f, 0.98f, -0.68f, 0.98f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveTo(16.83f, 14.5f, 16.56f, 14.31f, 16.46f, 14.01f);
        pathBuilderQ.close();
