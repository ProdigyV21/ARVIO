...
public final class MediationKt {
    ...
    public static final ImageVector getMediation(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Mediation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = a.a(18.0f, 13.0f, -5.06f);
        pathBuilderA.curveToRelative(-0.34f, 3.1f, -2.26f, 5.72f, -4.94f, 7.05f);
        pathBuilderA.curveToRelative(-0.03f, 1.81f, -1.66f, 3.23f, -3.55f, 2.9f);
        pathBuilderA.curveToRelative(-1.2f, -0.21f, -2.19f, -1.2f, -2.4f, -2.4f);
        pathBuilderA.curveTo(1.71f, 18.65f, 3.16f, 17.0f, 5.0f, 17.0f);
        ...
        pathBuilderA.curveTo(1.7f, 10.66f, 3.16f, 9.0f, 5.0f, 9.0f);
        pathBuilderA.curveToRelative(1.3f, 0.0f, 2.4f, 0.84f, 2.82f, 2.0f);
        pathBuilderA.horizontalLineToRelative(3.1f);
        pathBuilderA.curveTo(10.6f, 8.77f, 9.23f, 6.9f, 7.33f, 5.86f);
        pathBuilderA.curveToRelative(-0.64f, 0.8f, -1.67f, 1.28f, -2.81f, 1.1f);
        pathBuilderA.curveTo(3.29f, 6.77f, 2.26f, 5.77f, 2.05f, 4.54f);
        pathBuilderA.curveTo(1.72f, 2.65f, 3.17f, 1.0f, 5.0f, 1.0f);
        ...
        pathBuilderA.lineToRelative(-2.79f, 2.79f);
        pathBuilderA.curveTo(18.54f, 15.46f, 18.0f, 15.24f, 18.0f, 14.79f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.i(pathBuilderA, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
