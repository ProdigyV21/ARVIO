...
public final class AltRouteKt {
    ...
    public static final ImageVector getAltRoute(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AltRoute", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderR, 10.15f, 5.15f, 7.35f, 2.35f);
        pathBuilderR.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderR.lineTo(3.85f, 5.15f);
        pathBuilderR.curveTo(3.54f, 5.46f, 3.76f, 6.0f, 4.21f, 6.0f);
        pathBuilderR.horizontalLineToRelative(1.81f);
        pathBuilderR.curveTo(6.04f, 6.81f, 6.1f, 7.54f, 6.21f, 8.17f);
        pathBuilderR.lineToRelative(1.94f, -0.49f);
        pathBuilderR.curveTo(8.08f, 7.2f, 8.03f, 6.63f, 8.02f, 6.0f);
        pathBuilderR.horizontalLineToRelative(1.78f);
        pathBuilderR.curveTo(10.24f, 6.0f, 10.46f, 5.46f, 10.15f, 5.15f);
        a.z(pathBuilderR, 20.15f, 5.15f, -2.79f, -2.79f);
        pathBuilderR.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderR.lineToRelative(-2.79f, 2.79f);
        pathBuilderR.curveTo(13.54f, 5.46f, 13.76f, 6.0f, 14.21f, 6.0f);
        pathBuilderR.horizontalLineToRelative(1.78f);
        ...
        pathBuilderR.horizontalLineToRelative(1.8f);
        pathBuilderR.curveTo(20.24f, 6.0f, 20.46f, 5.46f, 20.15f, 5.15f);
        pathBuilderR.close();
