...
public final class Shop2Kt {
    ...
    public static final ImageVector getShop2(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Shop2", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(2.0f, 9.0f, 2.0f, 9.0f);
        ...
        pathBuilderJ.curveTo(3.0f, 9.45f, 2.55f, 9.0f, 2.0f, 9.0f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderA = e.a(18.0f, 5.0f, 3.0f);
        ...
        y.a.g(pathBuilderA, 2.0f, 5.0f, 11.0f);
        pathBuilderA.curveToRelative(0.0f, 1.11f, 0.89f, 2.0f, 2.0f, 2.0f);
        pathBuilderA.horizontalLineToRelative(14.0f);
        pathBuilderA.curveToRelative(1.11f, 0.0f, 2.0f, -0.89f, 2.0f, -2.0f);
        c.n(pathBuilderA, 5.0f, 18.0f, 12.0f, 3.0f);
        f.w(pathBuilderA, 4.0f, 2.0f, -4.0f, 3.0f);
        pathBuilderA.moveTo(12.0f, 14.09f);
        pathBuilderA.verticalLineTo(8.91f);
        pathBuilderA.curveToRelative(0.0f, -0.39f, 0.44f, -0.63f, 0.77f, -0.42f);
        pathBuilderA.lineToRelative(4.07f, 2.59f);
        pathBuilderA.curveToRelative(0.31f, 0.2f, 0.31f, 0.65f, 0.0f, 0.84f);
        pathBuilderA.lineToRelative(-4.07f, 2.59f);
        pathBuilderA.curveTo(12.44f, 14.72f, 12.0f, 14.48f, 12.0f, 14.09f);
        pathBuilderA.close();
