...
public final class VideoCameraBackKt {
    ...
    public static final ImageVector getVideoCameraBack(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.VideoCameraBack", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.z(pathBuilderA, 18.0f, 10.48f, 5.6f, 15.2f);
        ...
        pathBuilderA.lineToRelative(2.23f, -2.97f);
        pathBuilderA.curveToRelative(0.2f, -0.27f, 0.6f, -0.27f, 0.8f, 0.0f);
        ...
        pathBuilderA.curveTo(5.59f, 16.0f, 5.35f, 15.53f, 5.6f, 15.2f);
        pathBuilderA.close();
