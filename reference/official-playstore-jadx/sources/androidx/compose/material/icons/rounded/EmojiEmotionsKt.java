...
public final class EmojiEmotionsKt {
    ...
    public static final ImageVector getEmojiEmotions(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EmojiEmotions", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(22.0f, 6.48f, 17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(16.71f, 14.72f);
        pathBuilderA.curveTo(15.8f, 16.67f, 14.04f, 18.0f, 12.0f, 18.0f);
        pathBuilderA.reflectiveCurveToRelative(-3.8f, -1.33f, -4.71f, -3.28f);
        pathBuilderA.curveTo(7.13f, 14.39f, 7.37f, 14.0f, 7.74f, 14.0f);
        pathBuilderA.horizontalLineToRelative(8.52f);
        pathBuilderA.curveTo(16.63f, 14.0f, 16.87f, 14.39f, 16.71f, 14.72f);
        pathBuilderA.close();
