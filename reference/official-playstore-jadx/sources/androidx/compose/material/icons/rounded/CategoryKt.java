...
public final class CategoryKt {
    ...
    public static final ImageVector getCategory(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Category", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(11.15f, 3.4f, 7.43f, 9.48f);
        pathBuilderJ.curveToRelative(-0.41f, 0.66f, 0.07f, 1.52f, 0.85f, 1.52f);
        pathBuilderJ.horizontalLineToRelative(7.43f);
        pathBuilderJ.curveToRelative(0.78f, 0.0f, 1.26f, -0.86f, 0.85f, -1.52f);
        pathBuilderJ.lineTo(12.85f, 3.4f);
        pathBuilderJ.curveToRelative(-0.39f, -0.64f, -1.31f, -0.64f, -1.7f, 0.0f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderA = a.a(4.0f, 21.5f, 6.0f);
