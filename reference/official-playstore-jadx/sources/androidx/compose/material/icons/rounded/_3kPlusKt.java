...
public final class _3kPlusKt {
    ...
    public static final ImageVector get_3kPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._3kPlus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(10.0f, 14.0f);
        pathBuilderQ.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderQ.horizontalLineTo(6.25f);
        ...
        f.r(pathBuilderQ, 14.0f, 14.59f, 15.0f);
        pathBuilderQ.lineTo(14.59f, 15.0f);
        ...
        pathBuilderQ.lineToRelative(-0.03f, -4.49f);
        pathBuilderQ.curveTo(10.96f, 9.34f, 11.3f, 9.0f, 11.72f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.41f, 0.0f, 0.75f, 0.33f, 0.75f, 0.74f);
        pathBuilderQ.lineToRelative(0.03f, 1.51f);
        pathBuilderQ.lineToRelative(1.54f, -1.98f);
        pathBuilderQ.curveTo(14.17f, 9.1f, 14.38f, 9.0f, 14.59f, 9.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.58f, 0.0f, 0.91f, 0.66f, 0.56f, 1.12f);
        pathBuilderQ.lineTo(13.75f, 12.0f);
        pathBuilderQ.lineToRelative(1.41f, 1.88f);
        pathBuilderQ.curveTo(15.5f, 14.34f, 15.17f, 15.0f, 14.59f, 15.0f);
