...
public final class _24mpKt {
    ...
    public static final ImageVector get_24mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._24mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        a.B(pathBuilderQ, 16.0f, 17.75f, 10.0f, 17.5f);
        pathBuilderQ.verticalLineToRelative(0.75f);
        pathBuilderQ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderQ.reflectiveCurveTo(16.0f, 11.16f, 16.0f, 10.75f);
        ...
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveToRelative(0.75f, 0.34f, 0.75f, 0.75f);
        b.y(pathBuilderQ, 8.5f, 16.0f, 6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.reflectiveCurveToRelative(0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderQ.verticalLineTo(8.5f);
        pathBuilderQ.horizontalLineToRelative(0.25f);
        pathBuilderQ.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderQ, 18.16f, 10.0f, 17.75f, 10.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
