...
public final class _7mpKt {
    ...
    public static final ImageVector get_7mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._7mp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        f.r(pathBuilderQ, 17.75f, 12.38f, 11.5f);
        pathBuilderQ.curveToRelative(-0.56f, 0.0f, -0.97f, -0.54f, -0.8f, -1.08f);
        pathBuilderQ.lineTo(12.62f, 7.0f);
        pathBuilderQ.horizontalLineToRelative(-1.87f);
        pathBuilderQ.curveTo(10.34f, 7.0f, 10.0f, 6.66f, 10.0f, 6.25f);
        pathBuilderQ.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderQ.horizontalLineToRelative(2.75f);
        pathBuilderQ.curveToRelative(0.67f, 0.0f, 1.15f, 0.65f, 0.96f, 1.29f);
        pathBuilderQ.lineToRelative(-1.28f, 4.12f);
        pathBuilderQ.curveTo(13.07f, 11.26f, 12.75f, 11.5f, 12.38f, 11.5f);
        pathBuilderQ.close();
