...
public final class AddAlertKt {
    ...
    public static final ImageVector getAddAlert(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AddAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA2 = d.a(19.0f, 17.0f, -1.0f, -7.0f);
        pathBuilderA2.curveToRelative(0.0f, -2.79f, -1.91f, -5.14f, -4.5f, -5.8f);
        pathBuilderA2.verticalLineTo(3.5f);
        pathBuilderA2.curveTo(13.5f, 2.67f, 12.83f, 2.0f, 12.0f, 2.0f);
        pathBuilderA2.reflectiveCurveToRelative(-1.5f, 0.67f, -1.5f, 1.5f);
        pathBuilderA2.verticalLineToRelative(0.7f);
        pathBuilderA2.curveTo(7.91f, 4.86f, 6.0f, 7.21f, 6.0f, 10.0f);
        ...
        pathBuilderA2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderA2.reflectiveCurveTo(19.55f, 17.0f, 19.0f, 17.0f);
        b.w(pathBuilderA2, 14.0f, 13.0f, -1.0f, 1.0f);
        ...
        pathBuilderA2.horizontalLineToRelative(1.0f);
        pathBuilderA2.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, e.u(pathBuilderA2, 14.55f, 13.0f, 14.0f, 13.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw2, iM3813getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
