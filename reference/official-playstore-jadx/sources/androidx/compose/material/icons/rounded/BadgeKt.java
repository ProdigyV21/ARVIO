...
public final class BadgeKt {
    ...
    public static final ImageVector getBadge(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Badge", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderB, 12.0f, 18.0f, 6.0f, -0.43f);
        ...
        pathBuilderB.moveTo(17.25f, 16.5f);
        ...
        pathBuilderB.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveTo(18.0f, 16.16f, 17.66f, 16.5f, 17.25f, 16.5f);
        a.g(pathBuilderB, 17.25f, 13.5f, -2.5f);
        pathBuilderB.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderB.horizontalLineToRelative(2.5f);
        pathBuilderB.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveTo(18.0f, 13.16f, 17.66f, 13.5f, 17.25f, 13.5f);
        pathBuilderB.close();
