...
public final class LockOpenKt {
    ...
    public static final ImageVector getLockOpen(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LockOpen", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(-2.28f, 0.0f, -4.27f, 1.54f, -4.84f, 3.75f);
        pathBuilderA.curveToRelative(-0.14f, 0.54f, 0.18f, 1.08f, 0.72f, 1.22f);
        pathBuilderA.curveToRelative(0.53f, 0.14f, 1.08f, -0.18f, 1.22f, -0.72f);
        pathBuilderA.curveTo(9.44f, 3.93f, 10.63f, 3.0f, 12.0f, 3.0f);
