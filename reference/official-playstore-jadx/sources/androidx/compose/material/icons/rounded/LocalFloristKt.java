...
public final class LocalFloristKt {
    ...
    public static final ImageVector getLocalFlorist(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocalFlorist", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(12.0f, 22.0f);
        pathBuilderA.curveToRelative(4.56f, 0.0f, 8.33f, -3.4f, 8.92f, -7.8f);
        pathBuilderA.curveToRelative(0.09f, -0.64f, -0.48f, -1.21f, -1.12f, -1.12f);
        pathBuilderA.curveToRelative(-4.4f, 0.59f, -7.8f, 4.36f, -7.8f, 8.92f);
        pathBuilderA.close();
        ...
        pathBuilderA.reflectiveCurveToRelative(1.12f, -2.5f, 2.5f, -2.5f);
        pathBuilderA.close();
        pathBuilderA.moveTo(3.08f, 14.2f);
        pathBuilderA.curveTo(3.67f, 18.6f, 7.44f, 22.0f, 12.0f, 22.0f);
        pathBuilderA.curveToRelative(0.0f, -4.56f, -3.4f, -8.33f, -7.8f, -8.92f);
