...
public final class DirectionsBusKt {
    ...
    public static final ImageVector getDirectionsBus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DirectionsBus", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveTo(8.0f, 20.33f, 8.0f, 19.5f);
        b.A(pathBuilderA, 8.0f, 19.0f, 8.0f, 0.5f);
