...
public final class IcecreamKt {
    ...
    public static final ImageVector getIcecream(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Icecream", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(3.83f, 7.31f);
        pathBuilderA.curveToRelative(0.38f, 0.72f, 1.41f, 0.71f, 1.78f, -0.01f);
        pathBuilderA.lineToRelative(3.73f, -7.31f);
