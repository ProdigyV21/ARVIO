...
public final class ExpandCircleDownKt {
    ...
    public static final ImageVector getExpandCircleDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ExpandCircleDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 15.79f, 11.71f, -3.08f, 3.08f);
        ...
        pathBuilderA.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderA.curveTo(16.18f, 10.68f, 16.18f, 11.32f, 15.79f, 11.71f);
        pathBuilderA.close();
