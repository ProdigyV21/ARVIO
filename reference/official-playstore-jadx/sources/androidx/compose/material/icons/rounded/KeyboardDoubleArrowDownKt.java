...
public final class KeyboardDoubleArrowDownKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowDown", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(17.29f, 5.71f, 17.29f, 5.71f);
        pathBuilderJ.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderJ.lineTo(12.0f, 9.58f);
        pathBuilderJ.lineTo(8.11f, 5.7f);
        pathBuilderJ.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        ...
        pathBuilderJ.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderJ.lineToRelative(4.59f, -4.59f);
        pathBuilderJ.curveTo(17.68f, 6.73f, 17.68f, 6.1f, 17.29f, 5.71f);
        pathBuilderJ.close();
        ...
        PathBuilder pathBuilderJ2 = a.j(17.29f, 12.3f, 17.29f, 12.3f);
        pathBuilderJ2.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderJ2.lineTo(12.0f, 16.17f);
        ...
        pathBuilderJ2.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderJ2.lineToRelative(4.59f, -4.59f);
        pathBuilderJ2.curveTo(17.68f, 13.32f, 17.68f, 12.69f, 17.29f, 12.3f);
        pathBuilderJ2.close();
