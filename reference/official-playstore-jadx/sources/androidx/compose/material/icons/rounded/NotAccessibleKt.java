...
public final class NotAccessibleKt {
    ...
    public static final ImageVector getNotAccessible(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.NotAccessible", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.lineToRelative(4.9f, 4.9f);
        pathBuilderA.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA.curveTo(20.88f, 21.51f, 20.88f, 20.88f, 20.49f, 20.49f);
        pathBuilderA.close();
        pathBuilderA.moveTo(18.16f, 10.93f);
        ...
        pathBuilderA.curveTo(18.42f, 13.0f, 19.0f, 12.53f, 19.0f, 11.9f);
        pathBuilderA.curveTo(19.0f, 11.42f, 18.64f, 11.01f, 18.16f, 10.93f);
        pathBuilderA.close();
