...
public final class HdKt {
    ...
    public static final ImageVector getHd(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Hd", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.verticalLineToRelative(4.5f);
        pathBuilderJ.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        a.p(pathBuilderJ, 13.5f, 9.0f, 17.0f, 9.0f);
        ...
        b.w(pathBuilderJ, 14.5f, 13.5f, 2.0f, -3.0f);
