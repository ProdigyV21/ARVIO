...
public final class SensorsOffKt {
    ...
    public static final ImageVector getSensorsOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SensorsOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(5.68f, 18.32f);
        pathBuilderA.curveToRelative(-0.42f, 0.42f, -1.12f, 0.39f, -1.5f, -0.08f);
        pathBuilderA.curveTo(2.82f, 16.53f, 2.0f, 14.36f, 2.0f, 12.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.89f, 0.66f, 3.63f, 1.76f, 5.0f);
        pathBuilderA.curveTo(6.08f, 17.39f, 6.04f, 17.96f, 5.68f, 18.32f);
        pathBuilderA.close();
        pathBuilderA.moveTo(15.46f, 8.54f);
        ...
        pathBuilderA.curveTo(16.63f, 8.14f, 15.9f, 8.1f, 15.46f, 8.54f);
        pathBuilderA.close();
        pathBuilderA.moveTo(18.32f, 5.68f);
        ...
        pathBuilderA.curveToRelative(0.0f, -2.36f, -0.82f, -4.53f, -2.18f, -6.24f);
        pathBuilderA.curveTo(19.44f, 5.29f, 18.74f, 5.26f, 18.32f, 5.68f);
        pathBuilderA.close();
