...
public final class DisabledByDefaultKt {
    ...
    public static final ImageVector getDisabledByDefault(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DisabledByDefault", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderI, 16.3f, 16.29f, 16.3f, 16.29f);
        pathBuilderI.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderI.lineTo(12.0f, 13.41f);
        pathBuilderI.lineToRelative(-2.89f, 2.89f);
        pathBuilderI.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        ...
        pathBuilderI.lineTo(7.7f, 9.11f);
        pathBuilderI.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderI.lineToRelative(0.0f, 0.0f);
        pathBuilderI.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderI.lineTo(12.0f, 10.59f);
        pathBuilderI.lineToRelative(2.89f, -2.88f);
        pathBuilderI.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        pathBuilderI.lineToRelative(0.0f, 0.0f);
        pathBuilderI.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderI.lineTo(13.41f, 12.0f);
        pathBuilderI.lineToRelative(2.89f, 2.88f);
        pathBuilderI.curveTo(16.68f, 15.27f, 16.68f, 15.91f, 16.3f, 16.29f);
        pathBuilderI.close();
