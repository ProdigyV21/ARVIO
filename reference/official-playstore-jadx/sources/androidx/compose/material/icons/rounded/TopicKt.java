...
public final class TopicKt {
    ...
    public static final ImageVector getTopic(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Topic", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.r(pathBuilderG, 13.0f, 16.0f, 7.0f);
        ...
        pathBuilderG.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderG.curveTo(14.0f, 15.55f, 13.55f, 16.0f, 13.0f, 16.0f);
        a.r(pathBuilderG, 17.0f, 12.0f, 7.0f);
        pathBuilderG.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderG.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderG.horizontalLineToRelative(10.0f);
        pathBuilderG.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderG.curveTo(18.0f, 11.55f, 17.55f, 12.0f, 17.0f, 12.0f);
        pathBuilderG.close();
