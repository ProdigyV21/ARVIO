...
public final class MedicalInformationKt {
    ...
    public static final ImageVector getMedicalInformation(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MedicalInformation", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.D(pathBuilderB, -2.0f, 4.0f, 7.0f, 16.0f);
        ...
        pathBuilderB.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderB.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        f.r(pathBuilderB, 16.0f, 13.75f, 14.5f);
        pathBuilderB.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderB.reflectiveCurveTo(13.34f, 13.0f, 13.75f, 13.0f);
        pathBuilderB.horizontalLineToRelative(4.5f);
        pathBuilderB.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderB.reflectiveCurveToRelative(-0.34f, 0.75f, -0.75f, 0.75f);
        a.x(pathBuilderB, 13.75f, 13.75f, 17.5f);
        pathBuilderB.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderB.reflectiveCurveTo(13.34f, 16.0f, 13.75f, 16.0f);
        pathBuilderB.horizontalLineToRelative(2.5f);
        pathBuilderB.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderB.reflectiveCurveToRelative(-0.34f, 0.75f, -0.75f, 0.75f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderB, 13.75f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
