...
public final class SettingsBrightnessKt {
    ...
    public static final ImageVector getSettingsBrightness(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SettingsBrightness", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 17.15f, 12.35f, 16.0f, 13.5f);
        ...
        pathBuilderQ.lineToRelative(-1.15f, 1.15f);
        pathBuilderQ.curveToRelative(-0.2f, 0.2f, -0.51f, 0.2f, -0.71f, 0.0f);
        pathBuilderQ.lineTo(10.5f, 16.0f);
        pathBuilderQ.horizontalLineToRelative(-2.0f);
        pathBuilderQ.curveTo(8.22f, 16.0f, 8.0f, 15.78f, 8.0f, 15.5f);
        pathBuilderQ.verticalLineToRelative(-2.0f);
        pathBuilderQ.lineToRelative(-1.15f, -1.15f);
        pathBuilderQ.curveToRelative(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        pathBuilderQ.lineTo(8.0f, 10.5f);
        pathBuilderQ.verticalLineToRelative(-2.0f);
        pathBuilderQ.curveTo(8.0f, 8.22f, 8.22f, 8.0f, 8.5f, 8.0f);
        pathBuilderQ.horizontalLineToRelative(2.0f);
        pathBuilderQ.lineToRelative(1.15f, -1.15f);
        pathBuilderQ.curveToRelative(0.2f, -0.2f, 0.51f, -0.2f, 0.71f, 0.0f);
        pathBuilderQ.lineTo(13.5f, 8.0f);
        pathBuilderQ.horizontalLineToRelative(2.0f);
        pathBuilderQ.curveTo(15.78f, 8.0f, 16.0f, 8.22f, 16.0f, 8.5f);
        pathBuilderQ.verticalLineToRelative(2.0f);
        pathBuilderQ.lineToRelative(1.15f, 1.15f);
        pathBuilderQ.curveTo(17.34f, 11.84f, 17.34f, 12.16f, 17.15f, 12.35f);
        d.k(pathBuilderQ, 12.0f, 9.0f, 6.0f);
        pathBuilderQ.curveToRelative(1.66f, 0.0f, 3.0f, -1.34f, 3.0f, -3.0f);
        pathBuilderQ.curveTo(15.0f, 10.34f, 13.66f, 9.0f, 12.0f, 9.0f);
        pathBuilderQ.close();
