...
public final class SwitchLeftKt {
    ...
    public static final ImageVector getSwitchLeft(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SwitchLeft", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderS.moveTo(3.71f, 11.29f);
        pathBuilderS.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderS.lineToRelative(4.59f, 4.59f);
        pathBuilderS.curveTo(8.92f, 17.92f, 10.0f, 17.48f, 10.0f, 16.59f);
        pathBuilderS.verticalLineTo(7.41f);
        pathBuilderS.curveToRelative(0.0f, -0.89f, -1.08f, -1.34f, -1.71f, -0.71f);
        c.z(pathBuilderS, 3.71f, 11.29f, 14.0f, 7.41f);
        pathBuilderS.verticalLineToRelative(9.17f);
        pathBuilderS.curveToRelative(0.0f, 0.89f, 1.08f, 1.34f, 1.71f, 0.71f);
        pathBuilderS.lineToRelative(4.59f, -4.59f);
        pathBuilderS.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderS.lineToRelative(-4.59f, -4.59f);
        pathBuilderS.curveTo(15.08f, 6.08f, 14.0f, 6.52f, 14.0f, 7.41f);
        pathBuilderS.close();
