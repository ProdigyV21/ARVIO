...
public final class LocationOffKt {
    ...
    public static final ImageVector getLocationOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocationOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(2.71f, 3.56f);
        pathBuilderA.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA.lineToRelative(2.47f, 2.47f);
        pathBuilderA.curveTo(5.07f, 7.95f, 5.0f, 8.47f, 5.0f, 9.0f);
        pathBuilderA.curveToRelative(0.0f, 4.17f, 4.42f, 9.92f, 6.23f, 12.11f);
        pathBuilderA.curveToRelative(0.4f, 0.48f, 1.13f, 0.48f, 1.53f, 0.0f);
        pathBuilderA.curveToRelative(0.65f, -0.78f, 1.62f, -2.01f, 2.61f, -3.46f);
