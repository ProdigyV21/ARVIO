...
public final class AdUnitsKt {
    ...
    public static final ImageVector getAdUnits(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdUnits", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        w.a.r(pathBuilderQ, 16.0f, 19.0f, 8.0f);
        ...
        pathBuilderQ.curveTo(17.0f, 18.55f, 16.55f, 19.0f, 16.0f, 19.0f);
        pathBuilderQ.close();
        ...
        PathBuilder pathBuilderQ2 = a.q(15.0f, 6.0f, 9.0f);
        pathBuilderQ2.curveTo(8.45f, 6.0f, 8.0f, 6.45f, 8.0f, 7.0f);
        ...
        pathBuilderQ2.verticalLineToRelative(0.0f);
        pathBuilderQ2.curveTo(16.0f, 6.45f, 15.55f, 6.0f, 15.0f, 6.0f);
        pathBuilderQ2.close();
