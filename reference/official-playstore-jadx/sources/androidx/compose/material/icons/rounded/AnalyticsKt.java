...
public final class AnalyticsKt {
    ...
    public static final ImageVector getAnalytics(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Analytics", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderQ, 8.0f, 17.0f, 8.0f, 17.0f);
        ...
        pathBuilderQ.verticalLineToRelative(3.0f);
        pathBuilderQ.curveTo(9.0f, 16.55f, 8.55f, 17.0f, 8.0f, 17.0f);
        a.p(pathBuilderQ, 12.0f, 17.0f, 12.0f, 17.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.verticalLineToRelative(-1.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.verticalLineToRelative(1.0f);
        pathBuilderQ.curveTo(13.0f, 16.55f, 12.55f, 17.0f, 12.0f, 17.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.0f, 12.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderQ.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderQ.reflectiveCurveTo(12.55f, 12.0f, 12.0f, 12.0f);
        a.p(pathBuilderQ, 16.0f, 17.0f, 16.0f, 17.0f);
        pathBuilderQ.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
