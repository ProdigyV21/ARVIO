...
public final class FlipToFrontKt {
    ...
    public static final ImageVector getFlipToFront(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FlipToFront", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.g(pathBuilderA, 18.0f, 15.0f, -8.0f);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        b.w(pathBuilderA, 11.0f, 21.0f, 2.0f, -2.0f);
