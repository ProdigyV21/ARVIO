...
public final class FilePresentKt {
    ...
    public static final ImageVector getFilePresent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FilePresent", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(16.0f, 15.0f);
        pathBuilderQ.curveToRelative(0.0f, 2.34f, -2.01f, 4.21f, -4.39f, 3.98f);
        pathBuilderQ.curveTo(9.53f, 18.78f, 8.0f, 16.92f, 8.0f, 14.83f);
        pathBuilderQ.lineToRelative(0.0f, -5.19f);
        pathBuilderQ.curveToRelative(0.0f, -1.31f, 0.94f, -2.5f, 2.24f, -2.63f);
        pathBuilderQ.curveTo(11.74f, 6.86f, 13.0f, 8.03f, 13.0f, 9.5f);
        ...
        pathBuilderQ.verticalLineTo(9.5f);
        pathBuilderQ.curveTo(11.0f, 9.22f, 10.78f, 9.0f, 10.5f, 9.0f);
        pathBuilderQ.reflectiveCurveTo(10.0f, 9.22f, 10.0f, 9.5f);
        pathBuilderQ.verticalLineToRelative(5.39f);
        pathBuilderQ.curveToRelative(0.0f, 1.0f, 0.68f, 1.92f, 1.66f, 2.08f);
        pathBuilderQ.curveTo(12.92f, 17.18f, 14.0f, 16.21f, 14.0f, 15.0f);
        pathBuilderQ.verticalLineToRelative(-3.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        b.n(pathBuilderQ, 15.0f, 14.0f, 7.0f, 4.0f);
        pathBuilderQ.lineToRelative(4.0f, 4.0f);
        pathBuilderQ.horizontalLineToRelative(-3.0f);
        pathBuilderQ.curveTo(14.45f, 8.0f, 14.0f, 7.55f, 14.0f, 7.0f);
        pathBuilderQ.close();
