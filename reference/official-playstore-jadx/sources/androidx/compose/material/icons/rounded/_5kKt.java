...
public final class _5kKt {
    ...
    public static final ImageVector get_5k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._5k", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderQ, 10.25f, 10.5f, 8.0f, 1.0f);
        ...
        a0.a.w(pathBuilderQ, 9.5f, -1.0f, 7.25f);
        pathBuilderQ.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
