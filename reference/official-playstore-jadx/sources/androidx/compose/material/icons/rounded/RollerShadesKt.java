...
public final class RollerShadesKt {
    ...
    public static final ImageVector getRollerShades(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RollerShades", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        f.l(pathBuilderA, 20.0f, 6.0f, 19.0f, -6.0f);
        pathBuilderA.horizontalLineToRelative(5.0f);
        pathBuilderA.verticalLineToRelative(1.8f);
        pathBuilderA.curveToRelative(-0.4f, 0.3f, -0.8f, 0.8f, -0.8f, 1.4f);
        pathBuilderA.curveToRelative(0.0f, 1.0f, 0.8f, 1.8f, 1.8f, 1.8f);
        pathBuilderA.reflectiveCurveToRelative(1.8f, -0.8f, 1.8f, -1.8f);
        pathBuilderA.curveToRelative(0.0f, -0.6f, -0.3f, -1.1f, -0.8f, -1.4f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, b.d(pathBuilderA, 13.0f, 5.0f, 6.0f, 6.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
