...
public final class MonitorHeartKt {
    ...
    public static final ImageVector getMonitorHeart(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MonitorHeart", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        b.m(pathBuilderJ, 7.38f, 13.0f, 2.0f, 5.0f);
        ...
        pathBuilderQ.curveToRelative(0.38f, 0.0f, 0.73f, 0.21f, 0.89f, 0.55f);
        pathBuilderQ.lineTo(10.0f, 13.76f);
        pathBuilderQ.lineToRelative(3.11f, -6.21f);
        pathBuilderQ.curveToRelative(0.34f, -0.68f, 1.45f, -0.68f, 1.79f, 0.0f);
        b.p(pathBuilderQ, 16.62f, 11.0f, 22.0f, 6.0f);
