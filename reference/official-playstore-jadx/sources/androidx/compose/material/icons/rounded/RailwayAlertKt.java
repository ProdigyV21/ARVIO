...
public final class RailwayAlertKt {
    ...
    public static final ImageVector getRailwayAlert(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RailwayAlert", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(4.11f, 20.93f, 4.0f, 21.13f, 4.0f, 21.35f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(4.0f, 21.71f, 4.29f, 22.0f, 4.65f, 22.0f);
        ...
        pathBuilderA2.curveTo(17.5f, 8.22f, 17.72f, 8.0f, 18.0f, 8.0f);
