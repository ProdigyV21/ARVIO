...
public final class ReportGmailerrorredKt {
    ...
    public static final ImageVector getReportGmailerrorred(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ReportGmailerrorred", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderJ = a.j(20.71f, 7.98f, 16.03f, 3.3f);
        pathBuilderJ.curveToRelative(-0.19f, -0.19f, -0.45f, -0.3f, -0.71f, -0.3f);
        pathBuilderJ.horizontalLineTo(8.68f);
        ...
        pathBuilderJ.verticalLineTo(8.68f);
        pathBuilderJ.curveToRelative(0.01f, -0.26f, -0.1f, -0.52f, -0.28f, -0.7f);
        a.p(pathBuilderJ, 19.0f, 14.9f, 14.9f, 19.0f);
        pathBuilderJ.horizontalLineTo(9.1f);
        pathBuilderJ.lineTo(5.0f, 14.9f);
        pathBuilderJ.verticalLineTo(9.1f);
        pathBuilderJ.lineTo(9.1f, 5.0f);
        pathBuilderJ.horizontalLineToRelative(5.8f);
        pathBuilderJ.lineTo(19.0f, 9.1f);
        pathBuilderJ.verticalLineToRelative(5.8f);
        pathBuilderJ.close();
