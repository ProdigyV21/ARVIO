...
public final class GroupsKt {
    ...
    public static final ImageVector getGroups(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Groups", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(12.0f, 12.75f);
        pathBuilderA.curveToRelative(1.63f, 0.0f, 3.07f, 0.39f, 4.24f, 0.9f);
        pathBuilderA.curveToRelative(1.08f, 0.48f, 1.76f, 1.56f, 1.76f, 2.73f);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.18f, 0.68f, -2.26f, 1.76f, -2.73f);
        pathBuilderA.curveTo(8.93f, 13.14f, 10.37f, 12.75f, 12.0f, 12.75f);
        pathBuilderA.close();
        ...
        pathBuilderA.lineTo(0.0f, 17.0f);
        pathBuilderA.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderA.lineToRelative(3.5f, 0.0f);
        pathBuilderA.verticalLineToRelative(-1.61f);
        ...
        pathBuilderA.lineToRelative(3.5f, 0.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        c.z(pathBuilderA, 24.0f, 16.43f, 12.0f, 6.0f);
        ...
        pathBuilderA.curveTo(9.0f, 7.34f, 10.34f, 6.0f, 12.0f, 6.0f);
        pathBuilderA.close();
