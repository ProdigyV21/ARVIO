...
public final class PeopleOutlineKt {
    ...
    public static final ImageVector getPeopleOutline(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PeopleOutline", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.close();
        pathBuilderA.moveTo(9.0f, 13.75f);
        ...
        c.z(pathBuilderA, 4.34f, 17.0f, 16.04f, 13.81f);
