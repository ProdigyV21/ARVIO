...
public final class SentimentSatisfiedAltKt {
    ...
    public static final ImageVector getSentimentSatisfiedAlt(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SentimentSatisfiedAlt", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.41f, 13.89f);
        pathBuilderA.curveToRelative(-0.35f, -0.22f, -0.82f, -0.11f, -1.03f, 0.24f);
        pathBuilderA.curveToRelative(-0.74f, 1.17f, -2.0f, 1.87f, -3.38f, 1.87f);
        pathBuilderA.reflectiveCurveToRelative(-2.64f, -0.7f, -3.38f, -1.88f);
        pathBuilderA.curveToRelative(-0.22f, -0.35f, -0.68f, -0.46f, -1.03f, -0.24f);
        pathBuilderA.curveToRelative(-0.35f, 0.22f, -0.46f, 0.68f, -0.24f, 1.03f);
        pathBuilderA.curveTo(8.37f, 16.54f, 10.1f, 17.5f, 12.0f, 17.5f);
        pathBuilderA.reflectiveCurveToRelative(3.63f, -0.97f, 4.65f, -2.58f);
        pathBuilderA.curveToRelative(0.22f, -0.35f, 0.11f, -0.81f, -0.24f, -1.03f);
        pathBuilderA.close();
