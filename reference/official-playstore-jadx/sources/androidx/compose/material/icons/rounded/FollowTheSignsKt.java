...
public final class FollowTheSignsKt {
    ...
    public static final ImageVector getFollowTheSigns(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FollowTheSigns", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.p(pathBuilderA, 5.75f, 8.9f, 3.23f, 21.81f);
        pathBuilderA.curveTo(3.11f, 22.43f, 3.58f, 23.0f, 4.21f, 23.0f);
        pathBuilderA.horizontalLineTo(4.3f);
        pathBuilderA.curveToRelative(0.47f, 0.0f, 0.88f, -0.33f, 0.98f, -0.79f);
        pathBuilderA.lineTo(6.85f, 15.0f);
        pathBuilderA.lineTo(9.0f, 17.0f);
        pathBuilderA.verticalLineToRelative(5.0f);
        pathBuilderA.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderA.verticalLineToRelative(-6.14f);
        ...
        pathBuilderA.curveToRelative(1.07f, 1.32f, 2.58f, 2.23f, 4.31f, 2.51f);
        ...
        pathBuilderA.curveToRelative(-1.49f, -0.25f, -2.75f, -1.15f, -3.51f, -2.38f);
        ...
        pathBuilderA.lineToRelative(-4.63f, 1.9f);
        pathBuilderA.curveTo(2.25f, 8.2f, 2.0f, 8.57f, 2.0f, 8.97f);
        ...
        a.z(pathBuilderA, 20.15f, 5.85f, -1.28f, 1.29f);
        pathBuilderA.curveToRelative(-0.31f, 0.32f, -0.85f, 0.09f, -0.85f, -0.35f);
        pathBuilderA.verticalLineTo(6.25f);
        pathBuilderA.horizontalLineToRelative(-2.76f);
        ...
        pathBuilderA.lineToRelative(1.28f, 1.29f);
        pathBuilderA.curveTo(20.34f, 5.34f, 20.34f, 5.66f, 20.15f, 5.85f);
        pathBuilderA.close();
