...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DownloadForOffline", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.u(pathBuilderA, 11.0f, 10.0f, 7.0f);
        ...
        pathBuilderA.lineToRelative(-2.79f, -2.79f);
        pathBuilderA.curveTo(8.54f, 10.54f, 8.76f, 10.0f, 9.21f, 10.0f);
        a.s(pathBuilderA, 11.0f, 16.0f, 17.0f, 8.0f);
        pathBuilderA.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        ...
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(17.0f, 16.55f, 16.55f, 17.0f, 16.0f, 17.0f);
        pathBuilderA.close();
