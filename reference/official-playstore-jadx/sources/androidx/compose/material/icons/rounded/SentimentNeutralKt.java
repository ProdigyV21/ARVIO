...
public final class SentimentNeutralKt {
    ...
    public static final ImageVector getSentimentNeutral(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SentimentNeutral", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderA = a.a(9.75f, 15.5f, 4.5f);
        ...
        pathBuilderA.curveToRelative(-0.41f, 0.0f, -0.75f, 0.34f, -0.75f, 0.75f);
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, c.h(pathBuilderA, 0.34f, 0.75f, 0.75f, 0.75f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
