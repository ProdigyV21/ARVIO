...
public final class MarkEmailUnreadKt {
    ...
    public static final ImageVector getMarkEmailUnread(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MarkEmailUnread", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(19.0f, 10.0f);
        pathBuilderA.curveToRelative(1.13f, 0.0f, 2.16f, -0.39f, 3.0f, -1.02f);
        ...
        pathBuilderA.lineToRelative(4.77f, -2.98f);
