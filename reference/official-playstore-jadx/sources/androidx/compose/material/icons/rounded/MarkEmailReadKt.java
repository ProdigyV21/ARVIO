...
public final class MarkEmailReadKt {
    ...
    public static final ImageVector getMarkEmailRead(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MarkEmailRead", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(18.05f, 21.29f);
        ...
        pathBuilderA.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        c.z(pathBuilderA, 18.05f, 21.29f, 12.08f, 20.0f);
        ...
        pathBuilderA.curveTo(21.09f, 12.25f, 20.08f, 12.0f, 19.0f, 12.0f);
        pathBuilderA.curveToRelative(-3.87f, 0.0f, -7.0f, 3.13f, -7.0f, 7.0f);
        pathBuilderA.curveTo(12.0f, 19.34f, 12.03f, 19.67f, 12.08f, 20.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(11.47f, 12.67f);
        pathBuilderA.curveToRelative(0.32f, 0.2f, 0.74f, 0.2f, 1.06f, 0.0f);
        pathBuilderA.lineToRelative(7.07f, -4.42f);
        pathBuilderA.curveTo(19.85f, 8.09f, 20.0f, 7.82f, 20.0f, 7.53f);
        pathBuilderA.curveToRelative(0.0f, -0.67f, -0.73f, -1.07f, -1.3f, -0.72f);
        pathBuilderA.lineTo(12.0f, 11.0f);
        pathBuilderA.lineTo(5.3f, 6.81f);
        pathBuilderA.curveTo(4.73f, 6.46f, 4.0f, 6.86f, 4.0f, 7.53f);
        pathBuilderA.curveToRelative(0.0f, 0.29f, 0.15f, 0.56f, 0.4f, 0.72f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, d.o(pathBuilderA, 11.47f, 12.67f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
