...
public final class ArrowCircleUpKt {
    ...
    public static final ImageVector getArrowCircleUp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowCircleUp", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveTo(2.0f, 17.52f, 6.48f, 22.0f, 12.0f, 22.0f);
        c.z(pathBuilderA, 12.0f, 22.0f, 11.0f, 12.0f);
        ...
        pathBuilderA.lineToRelative(-2.79f, 2.79f);
        pathBuilderA.curveTo(8.54f, 11.46f, 8.76f, 12.0f, 9.21f, 12.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m4024addPathoIyEayM$default(builder, a.l(pathBuilderA, 11.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
