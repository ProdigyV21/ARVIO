...
public final class CheckroomKt {
    ...
    public static final ImageVector getCheckroom(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Checkroom", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderS.curveToRelative(-1.76f, -0.4f, -3.37f, 0.53f, -4.02f, 1.98f);
        pathBuilderS.curveTo(8.5f, 6.74f, 8.98f, 7.5f, 9.71f, 7.5f);
        pathBuilderS.horizontalLineToRelative(0.0f);
        pathBuilderS.curveToRelative(0.39f, 0.0f, 0.75f, -0.22f, 0.9f, -0.57f);
        pathBuilderS.curveTo(10.84f, 6.38f, 11.37f, 6.0f, 12.0f, 6.0f);
        ...
        pathBuilderS.lineToRelative(0.0f, 1.76f);
