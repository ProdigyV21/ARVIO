...
public final class Timer10SelectKt {
    ...
    public static final ImageVector getTimer10Select(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Timer10Select", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c.C(pathBuilderQ, 2.5f, 8.0f, 3.0f, 9.5f);
        pathBuilderQ.curveTo(3.0f, 18.33f, 3.67f, 19.0f, 4.5f, 19.0f);
        pathBuilderQ.horizontalLineToRelative(0.0f);
        pathBuilderQ.curveTo(5.33f, 19.0f, 6.0f, 18.33f, 6.0f, 17.5f);
        pathBuilderQ.verticalLineTo(7.0f);
        pathBuilderQ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderQ.horizontalLineTo(2.5f);
        pathBuilderQ.curveTo(1.67f, 5.0f, 1.0f, 5.67f, 1.0f, 6.5f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveTo(1.0f, 7.33f, 1.67f, 8.0f, 2.5f, 8.0f);
        pathBuilderQ.close();
        ...
        v.a.n(pathBuilderQ, 21.0f, 1.0f, -3.0f);
        ...
        v.a.n(pathBuilderQ, 19.0f, -1.0f, 3.0f);
        pathBuilderQ.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderQ.verticalLineToRelative(0.0f);
        pathBuilderQ.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
