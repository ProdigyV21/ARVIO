...
public final class VideogameAssetOffKt {
    ...
    public static final ImageVector getVideogameAssetOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.VideogameAssetOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(20.7f, 17.87f);
        pathBuilderA.curveTo(21.46f, 17.59f, 22.0f, 16.85f, 22.0f, 16.0f);
        pathBuilderA.verticalLineTo(8.0f);
        pathBuilderA.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.w(pathBuilderA, 8.83f, 20.7f, 17.87f);
        ...
        v.a.p(pathBuilderA, 20.49f, 20.49f, 3.51f, 3.51f);
        ...
        c.C(pathBuilderA, 10.0f, 13.0f, 9.0f, 1.0f);
        ...
        pathBuilderA.verticalLineToRelative(-1.0f);
        pathBuilderA.curveToRelative(0.0f, -0.05f, 0.01f, -0.11f, 0.01f, -0.16f);
        pathBuilderA.lineToRelative(3.14f, 3.14f);
        pathBuilderA.curveTo(10.11f, 12.99f, 10.05f, 13.0f, 10.0f, 13.0f);
        pathBuilderA.close();
