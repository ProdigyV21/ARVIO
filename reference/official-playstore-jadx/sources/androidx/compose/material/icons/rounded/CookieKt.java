...
public final class CookieKt {
    ...
    public static final ImageVector getCookie(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Cookie", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m3498getBlack0d7_KjU(), null);
        int iM3803getButtKaPHkGw = StrokeCap.INSTANCE.m3803getButtKaPHkGw();
        int iM3813getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3813getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.a(21.27f, 10.9f);
        pathBuilderA.curveToRelative(-1.21f, -0.33f, -2.31f, -1.46f, -2.29f, -2.89f);
        pathBuilderA.curveToRelative(0.01f, -0.56f, -0.4f, -1.02f, -0.96f, -1.01f);
        pathBuilderA.curveTo(15.83f, 7.03f, 14.0f, 5.22f, 14.0f, 3.02f);
        pathBuilderA.curveToRelative(0.0f, -0.49f, -0.35f, -0.9f, -0.84f, -0.96f);
        pathBuilderA.curveTo(6.53f, 1.22f, 2.0f, 6.81f, 2.0f, 12.0f);
        pathBuilderA.curveToRelative(0.0f, 5.52f, 4.48f, 10.0f, 10.0f, 10.0f);
        pathBuilderA.curveToRelative(5.61f, 0.0f, 10.11f, -4.62f, 10.0f, -10.18f);
        pathBuilderA.curveTo(21.99f, 11.38f, 21.69f, 11.01f, 21.27f, 10.9f);
        pathBuilderA.close();
