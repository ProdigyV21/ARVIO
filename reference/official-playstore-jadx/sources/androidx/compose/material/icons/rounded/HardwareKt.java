...
public final class HardwareKt {
    ...
    public static final ImageVector getHardware(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Hardware", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderN = a.n(17.59f, 3.41f, 15.0f, 6.0f, 5.0f);
        pathBuilderN.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderN.horizontalLineTo(9.0f);
        pathBuilderN.curveTo(6.24f, 3.0f, 4.0f, 5.24f, 4.0f, 8.0f);
        a0.a.j(pathBuilderN, 5.0f, 3.0f, 6.0f, 8.0f);
        pathBuilderN.lineToRelative(2.59f, 2.59f);
        pathBuilderN.curveToRelative(0.26f, 0.26f, 0.62f, 0.41f, 1.0f, 0.41f);
        pathBuilderN.horizontalLineToRelative(0.01f);
        pathBuilderN.curveTo(19.37f, 11.0f, 20.0f, 10.37f, 20.0f, 9.59f);
        pathBuilderN.verticalLineTo(4.41f);
        pathBuilderN.curveTo(20.0f, 3.63f, 19.37f, 3.0f, 18.59f, 3.0f);
        pathBuilderN.horizontalLineToRelative(-0.01f);
        pathBuilderN.curveTo(18.21f, 3.0f, 17.85f, 3.15f, 17.59f, 3.41f);
        pathBuilderN.close();
        ImageVector.Builder.m4024addPathoIyEayM$default(builder, pathBuilderN.getNodes(), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3803getButtKaPHkGw, iM3813getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
