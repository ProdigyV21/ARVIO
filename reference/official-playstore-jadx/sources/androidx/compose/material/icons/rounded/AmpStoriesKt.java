...
public final class AmpStoriesKt {
    ...
    public static final ImageVector getAmpStories(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AmpStories", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        PathBuilder pathBuilderQ = a.q(15.0f, 4.0f, 9.0f);
        pathBuilderQ.curveTo(7.9f, 4.0f, 7.0f, 4.9f, 7.0f, 6.0f);
        ...
        pathBuilderQ.curveTo(17.0f, 4.9f, 16.1f, 4.0f, 15.0f, 4.0f);
        pathBuilderQ.close();
        ...
        pathBuilderA.curveTo(5.0f, 6.45f, 4.55f, 6.0f, 4.0f, 6.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = c.a(20.0f, 6.0f);
        ...
        pathBuilderA2.curveTo(21.0f, 6.45f, 20.55f, 6.0f, 20.0f, 6.0f);
        pathBuilderA2.close();
