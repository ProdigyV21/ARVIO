...
public final class ContentPasteOffKt {
    ...
    public static final ImageVector getContentPasteOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ContentPasteOff", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.lineToRelative(0.9f, 0.9f);
        pathBuilderJ.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderJ.lineToRelative(0.0f, 0.0f);
        pathBuilderJ.curveTo(20.88f, 21.51f, 20.88f, 20.88f, 20.49f, 20.49f);
        w.a.u(pathBuilderJ, 5.0f, 19.0f, 7.83f);
        w.a.e(pathBuilderJ, 16.17f, 19.0f, 5.0f);
        e.o(pathBuilderJ, 17.0f, 8.0f, 5.0f, 2.0f);
        a0.a.l(pathBuilderJ, 11.17f, 2.0f, 2.0f, 5.0f);
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderJ.horizontalLineToRelative(-4.18f);
