...
public final class HearingKt {
    ...
    public static final ImageVector getHearing(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Hearing", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(2.56f, 0.0f, 4.63f, 1.85f, 4.95f, 4.31f);
        pathBuilderA.curveToRelative(0.06f, 0.4f, 0.41f, 0.69f, 0.82f, 0.69f);
        pathBuilderA.horizontalLineToRelative(0.34f);
        pathBuilderA.curveToRelative(0.5f, 0.0f, 0.89f, -0.44f, 0.83f, -0.94f);
        pathBuilderA.curveTo(20.49f, 4.59f, 17.61f, 2.0f, 14.0f, 2.0f);
        ...
        pathBuilderA.curveToRelative(1.84f, 0.0f, 3.39f, -1.24f, 3.86f, -2.93f);
        pathBuilderA.curveToRelative(0.14f, -0.54f, -0.25f, -1.07f, -0.81f, -1.07f);
        pathBuilderA.horizontalLineToRelative(-0.35f);
        pathBuilderA.curveToRelative(-0.38f, 0.0f, -0.68f, 0.27f, -0.81f, 0.63f);
        pathBuilderA.curveToRelative(-0.26f, 0.79f, -1.01f, 1.37f, -1.89f, 1.37f);
        pathBuilderA.close();
        pathBuilderA.moveTo(6.97f, 1.97f);
        pathBuilderA.curveToRelative(-0.43f, -0.43f, -1.12f, -0.39f, -1.5f, 0.07f);
        pathBuilderA.curveTo(3.93f, 3.94f, 3.0f, 6.36f, 3.0f, 9.0f);
        pathBuilderA.reflectiveCurveToRelative(0.93f, 5.06f, 2.47f, 6.95f);
        pathBuilderA.curveToRelative(0.38f, 0.46f, 1.07f, 0.5f, 1.49f, 0.08f);
        pathBuilderA.curveToRelative(0.36f, -0.36f, 0.39f, -0.93f, 0.07f, -1.32f);
        pathBuilderA.curveTo(5.77f, 13.16f, 5.0f, 11.17f, 5.0f, 9.0f);
        pathBuilderA.reflectiveCurveToRelative(0.77f, -4.16f, 2.04f, -5.7f);
        pathBuilderA.curveToRelative(0.33f, -0.4f, 0.29f, -0.97f, -0.07f, -1.33f);
        pathBuilderA.close();
