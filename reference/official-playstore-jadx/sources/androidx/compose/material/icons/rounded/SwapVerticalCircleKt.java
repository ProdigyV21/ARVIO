...
public final class SwapVerticalCircleKt {
    ...
    public static final ImageVector getSwapVerticalCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SwapVerticalCircle", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 6.5f, 9.0f, 3.15f, -3.15f);
        ...
        pathBuilderA.moveTo(14.35f, 18.15f);
        pathBuilderA.curveToRelative(-0.2f, 0.2f, -0.51f, 0.2f, -0.71f, 0.0f);
