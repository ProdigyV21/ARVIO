...
public final class IndeterminateCheckBoxKt {
    ...
    public static final ImageVector getIndeterminateCheckBox(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.IndeterminateCheckBox", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderJ.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.p(pathBuilderJ, 16.0f, 13.0f, 8.0f, 13.0f);
