...
public final class InventoryKt {
    ...
    public static final ImageVector getInventory(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Inventory", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        d.z(pathBuilderA, 6.0f, -2.0f, 5.0f, 5.0f);
        ...
        PathBuilder pathBuilderA2 = c.a(21.75f, 12.25f);
        pathBuilderA2.curveToRelative(-0.41f, -0.41f, -1.09f, -0.41f, -1.5f, 0.0f);
        pathBuilderA2.lineTo(15.51f, 17.0f);
        pathBuilderA2.lineToRelative(-2.26f, -2.25f);
        pathBuilderA2.curveToRelative(-0.41f, -0.41f, -1.08f, -0.41f, -1.5f, 0.0f);
        pathBuilderA2.lineToRelative(0.0f, 0.0f);
        pathBuilderA2.curveToRelative(-0.41f, 0.41f, -0.41f, 1.09f, 0.0f, 1.5f);
        pathBuilderA2.lineToRelative(3.05f, 3.04f);
        pathBuilderA2.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA2.lineToRelative(5.53f, -5.54f);
        pathBuilderA2.curveTo(22.16f, 13.34f, 22.16f, 12.66f, 21.75f, 12.25f);
        pathBuilderA2.close();
