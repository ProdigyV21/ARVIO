...
public final class PersonAddAlt1Kt {
    ...
    public static final ImageVector getPersonAddAlt1(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PersonAddAlt1", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilderA.verticalLineToRelative(-1.0f);
        pathBuilderA.curveTo(17.0f, 15.34f, 11.67f, 14.0f, 9.0f, 14.0f);
        pathBuilderA.close();
