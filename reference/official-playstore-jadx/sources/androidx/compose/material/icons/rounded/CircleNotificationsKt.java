...
public final class CircleNotificationsKt {
    ...
    public static final ImageVector getCircleNotifications(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CircleNotifications", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.r(pathBuilderA, 16.0f, 16.0f, 8.0f);
        ...
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(17.0f, 15.55f, 16.55f, 16.0f, 16.0f, 16.0f);
        pathBuilderA.close();
