...
public final class WhereToVoteKt {
    ...
    public static final ImageVector getWhereToVote(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WhereToVote", Dp.m5678constructorimpl(24.0f), Dp.m5678constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        a.z(pathBuilderA, 10.23f, 12.66f, -1.41f, -1.41f);
        ...
        pathBuilderA.curveTo(11.26f, 13.05f, 10.62f, 13.05f, 10.23f, 12.66f);
        pathBuilderA.close();
