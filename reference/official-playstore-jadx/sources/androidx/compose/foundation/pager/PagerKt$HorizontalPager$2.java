...
public final class PagerKt$HorizontalPager$2 extends r implements p<Composer, Integer, t0> {
    ...
    public PagerKt$HorizontalPager$2(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i10, float f10, Alignment.Vertical vertical, SnapFlingBehavior snapFlingBehavior, boolean z, boolean z5, l<? super Integer, ? extends Object> lVar, NestedScrollConnection nestedScrollConnection, r7.r<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, t0> rVar, int i11, int i12, int i13) {
        super(2);
