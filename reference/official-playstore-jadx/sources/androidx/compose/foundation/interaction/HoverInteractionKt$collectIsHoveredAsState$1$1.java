...
public final class HoverInteractionKt$collectIsHoveredAsState$1$1 extends j implements p<k0, d<? super t0>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            na.j<Interaction> interactions = this.$this_collectIsHoveredAsState.getInteractions();
            final MutableState<Boolean> mutableState = this.$isHovered;
            k kVar = new k() { // from class: androidx.compose.foundation.interaction.HoverInteractionKt$collectIsHoveredAsState$1$1.1
                @Override // na.k
                ...
                public final Object emit(Interaction interaction, d<? super t0> dVar) {
                    if (interaction instanceof HoverInteraction.Enter) {
                        ...
                        arrayListW.remove(((HoverInteraction.Exit) interaction).getEnter());
                    }
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((HoverInteractionKt$collectIsHoveredAsState$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
