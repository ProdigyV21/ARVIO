...
public final class DragInteractionKt$collectIsDraggedAsState$1$1 extends j implements p<k0, d<? super t0>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            na.j<Interaction> interactions = this.$this_collectIsDraggedAsState.getInteractions();
            final MutableState<Boolean> mutableState = this.$isDragged;
            k kVar = new k() { // from class: androidx.compose.foundation.interaction.DragInteractionKt$collectIsDraggedAsState$1$1.1
                @Override // na.k
                ...
                public final Object emit(Interaction interaction, d<? super t0> dVar) {
                    if (interaction instanceof DragInteraction.Start) {
                        ...
                        arrayListW.remove(((DragInteraction.Stop) interaction).getStart());
                    } else if (interaction instanceof DragInteraction.Cancel) {
                        arrayListW.remove(((DragInteraction.Cancel) interaction).getStart());
                    }
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((DragInteractionKt$collectIsDraggedAsState$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
