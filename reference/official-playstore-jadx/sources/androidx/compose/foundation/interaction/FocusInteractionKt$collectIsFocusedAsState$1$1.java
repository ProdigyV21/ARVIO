...
public final class FocusInteractionKt$collectIsFocusedAsState$1$1 extends j implements p<k0, d<? super t0>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            na.j<Interaction> interactions = this.$this_collectIsFocusedAsState.getInteractions();
            final MutableState<Boolean> mutableState = this.$isFocused;
            k kVar = new k() { // from class: androidx.compose.foundation.interaction.FocusInteractionKt$collectIsFocusedAsState$1$1.1
                @Override // na.k
                ...
                public final Object emit(Interaction interaction, d<? super t0> dVar) {
                    if (interaction instanceof FocusInteraction.Focus) {
                        ...
                        arrayListW.remove(((FocusInteraction.Unfocus) interaction).getFocus());
                    }
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((FocusInteractionKt$collectIsFocusedAsState$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
