...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo483calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j10) {
        int iMinIntrinsicWidth = this.width == IntrinsicSize.Min ? measurable.minIntrinsicWidth(Constraints.m5645getMaxHeightimpl(j10)) : measurable.maxIntrinsicWidth(Constraints.m5645getMaxHeightimpl(j10));
        if (iMinIntrinsicWidth < 0) {
            iMinIntrinsicWidth = 0;
        }
        return Constraints.INSTANCE.m5656fixedWidthOenEA2s(iMinIntrinsicWidth);
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i10) {
        return this.width == IntrinsicSize.Min ? intrinsicMeasurable.minIntrinsicWidth(i10) : intrinsicMeasurable.maxIntrinsicWidth(i10);
    }
