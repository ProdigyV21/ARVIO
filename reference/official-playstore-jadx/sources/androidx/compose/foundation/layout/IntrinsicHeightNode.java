...
final class IntrinsicHeightNode extends IntrinsicSizeModifier {
    ...
    public long mo483calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j10) {
        int iMinIntrinsicHeight = this.height == IntrinsicSize.Min ? measurable.minIntrinsicHeight(Constraints.m5646getMaxWidthimpl(j10)) : measurable.maxIntrinsicHeight(Constraints.m5646getMaxWidthimpl(j10));
        if (iMinIntrinsicHeight < 0) {
            iMinIntrinsicHeight = 0;
        }
        return Constraints.INSTANCE.m5655fixedHeightOenEA2s(iMinIntrinsicHeight);
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i10) {
        return this.height == IntrinsicSize.Min ? intrinsicMeasurable.minIntrinsicHeight(i10) : intrinsicMeasurable.maxIntrinsicHeight(i10);
    }
