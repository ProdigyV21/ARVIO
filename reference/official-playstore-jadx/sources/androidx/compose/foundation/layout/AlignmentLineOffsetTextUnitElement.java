...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public /* synthetic */ AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine, long j10, long j11, l lVar, h hVar) {
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && p.a(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m5862equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m5862equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return TextUnit.m5866hashCodeimpl(this.after) + ((TextUnit.m5866hashCodeimpl(this.before) + (this.alignmentLine.hashCode() * 31)) * 31);
    }
    ...
    private AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine, long j10, long j11, l<? super InspectorInfo, t0> lVar) {
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m430setBeforeR2X_6o(this.before);
        node.m429setAfterR2X_6o(this.after);
    }
}
