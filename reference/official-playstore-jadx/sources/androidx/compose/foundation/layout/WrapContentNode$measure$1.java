...
public final class WrapContentNode$measure$1 extends r implements l<Placeable.PlacementScope, t0> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m4669place70tqf50$default(placementScope, this.$placeable, ((IntOffset) this.this$0.getAlignmentCallback().invoke(IntSize.m5836boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection())).getPackedValue(), 0.0f, 2, null);
    }
}
