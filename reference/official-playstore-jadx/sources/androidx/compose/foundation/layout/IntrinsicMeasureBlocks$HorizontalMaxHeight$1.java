...
public final class IntrinsicMeasureBlocks$HorizontalMaxHeight$1 extends r implements q<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends IntrinsicMeasurable> list, int i10, int i11) {
        return Integer.valueOf(RowColumnImplKt.intrinsicSize(list, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, i10, i11, LayoutOrientation.Horizontal, LayoutOrientation.Vertical));
    }
}
