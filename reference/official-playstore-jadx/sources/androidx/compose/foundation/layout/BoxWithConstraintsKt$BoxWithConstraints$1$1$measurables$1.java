...
public final class BoxWithConstraintsKt$BoxWithConstraints$1$1$measurables$1 extends r implements p<Composer, Integer, t0> {
    ...
    public BoxWithConstraintsKt$BoxWithConstraints$1$1$measurables$1(q<? super BoxWithConstraintsScope, ? super Composer, ? super Integer, t0> qVar, BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl) {
        super(2);
        this.$content = qVar;
