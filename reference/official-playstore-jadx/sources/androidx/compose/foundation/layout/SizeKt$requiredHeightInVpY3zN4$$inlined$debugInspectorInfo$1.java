...
public final class SizeKt$requiredHeightInVpY3zN4$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        a0.c.e(this.$min$inlined, inspectorInfo.getProperties(), "min", inspectorInfo).set("max", Dp.m5676boximpl(this.$max$inlined));
    }
}
