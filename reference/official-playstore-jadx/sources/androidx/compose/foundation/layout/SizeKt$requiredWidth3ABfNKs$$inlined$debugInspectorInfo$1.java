...
public final class SizeKt$requiredWidth3ABfNKs$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Dp.m5676boximpl(this.$width$inlined));
    }
}
