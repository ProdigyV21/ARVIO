...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m731childConstraintsJhjzzOo(int slot, int span) {
        int i10;
        if (span == 1) {
    ...
    public final LazyStaggeredGridMeasuredItem m732getAndMeasurejy6DScQ(int index, long span) {
        ...
        int i13 = ((int) (span & 4294967295L)) - i10;
        int i14 = length - i12;
        int i15 = i13 > i14 ? i14 : i13;
        return createItem(index, i12, i15, key, contentType, this.measureScope.mo691measure0kLqBqw(index, m731childConstraintsJhjzzOo(i12, i15)));
    }
