...
public final class LazyStaggeredGridState$Companion$Saver$1 extends r implements p<SaverScope, LazyStaggeredGridState, List<? extends int[]>> {
    ...
    public final List<int[]> invoke(SaverScope saverScope, LazyStaggeredGridState lazyStaggeredGridState) {
        return t7.a.E(lazyStaggeredGridState.getScrollPosition().getIndices(), lazyStaggeredGridState.getScrollPosition().getScrollOffsets());
    }
}
