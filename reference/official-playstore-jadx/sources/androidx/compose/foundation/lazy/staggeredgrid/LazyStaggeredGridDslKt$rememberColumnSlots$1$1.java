...
public final class LazyStaggeredGridDslKt$rememberColumnSlots$1$1 extends r implements p<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m715invoke0kLqBqw((Density) obj, ((Constraints) obj2).getValue());
    }

    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
    public final LazyStaggeredGridSlots m715invoke0kLqBqw(Density density, long j10) {
        ...
        int[] iArrCalculateCrossAxisCellSizes = staggeredGridCells.calculateCrossAxisCellSizes(density, iM5646getMaxWidthimpl, density.mo279roundToPx0680j_4(horizontal.getSpacing()));
        int[] iArr = new int[iArrCalculateCrossAxisCellSizes.length];
        horizontal.arrange(density, iM5646getMaxWidthimpl, iArrCalculateCrossAxisCellSizes, layoutDirection, iArr);
