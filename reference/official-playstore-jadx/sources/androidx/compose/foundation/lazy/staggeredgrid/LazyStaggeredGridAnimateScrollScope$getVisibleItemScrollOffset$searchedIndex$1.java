...
public final class LazyStaggeredGridAnimateScrollScope$getVisibleItemScrollOffset$searchedIndex$1 extends r implements l<LazyStaggeredGridItemInfo, Integer> {
    final /* synthetic */ int $index;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridAnimateScrollScope$getVisibleItemScrollOffset$searchedIndex$1(int i10) {
        super(1);
        this.$index = i10;
    }
