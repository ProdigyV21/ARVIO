...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m668getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i10, int i11, long j10, int i12, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m669getAndMeasure3p2s80s(i10, i11, j10);
    }
    ...
    public final LazyGridMeasuredItem m669getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo691measure0kLqBqw = this.measureScope.mo691measure0kLqBqw(index, constraints);
        if (Constraints.m5644getHasFixedWidthimpl(constraints)) {
            iM5647getMinHeightimpl = Constraints.m5648getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m5643getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("does not have fixed height");
            }
            iM5647getMinHeightimpl = Constraints.m5647getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, iM5647getMinHeightimpl, mainAxisSpacing, listMo691measure0kLqBqw);
    }
