...
@e(c = "androidx.compose.foundation.lazy.LazyListState$updateScrollDeltaForPostLookahead$2$2", f = "LazyListState.kt", l = {504}, m = "invokeSuspend")
public final class LazyListState$updateScrollDeltaForPostLookahead$2$2 extends j implements p<k0, d<? super t0>, Object> {
    int label;
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((LazyListState$updateScrollDeltaForPostLookahead$2$2) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
