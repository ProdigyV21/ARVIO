...
public final class SelectionHandlesKt {
    ...
    static {
        float f10 = 25;
        HandleWidth = Dp.m5678constructorimpl(f10);
        HandleHeight = Dp.m5678constructorimpl(f10);
    }

    /* JADX INFO: renamed from: getAdjustedCoordinates-k-4lQ0M, reason: not valid java name */
    public static final long m974getAdjustedCoordinatesk4lQ0M(long j10) {
        return OffsetKt.Offset(Offset.m3236getXimpl(j10), Offset.m3237getYimpl(j10) - 1.0f);
    }
