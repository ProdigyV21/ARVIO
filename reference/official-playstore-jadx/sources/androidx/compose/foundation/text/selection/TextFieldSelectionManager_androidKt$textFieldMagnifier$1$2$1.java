...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1 extends r implements l<r7.a<? extends Offset>, Modifier> {
    final /* synthetic */ Density $density;
    final /* synthetic */ MutableState<IntSize> $magnifierSize$delegate;

    /* JADX INFO: renamed from: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1$1, reason: invalid class name */
    ...
    public static final class AnonymousClass1 extends r implements l<Density, Offset> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            return Offset.m3225boximpl(m1043invoketuRUvjQ((Density) obj));
        }

        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1043invoketuRUvjQ(Density density) {
            return ((Offset) this.$center.invoke()).getPackedValue();
        }
    }

    /* JADX INFO: renamed from: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1$2, reason: invalid class name */
    ...
    public static final class AnonymousClass2 extends r implements l<DpSize, t0> {
        ...
        @Override // r7.l
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m1044invokeEaSLcWc(((DpSize) obj).getPackedValue());
            return t0.f22605a;
        }

        /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1044invokeEaSLcWc(long j10) {
            MutableState<IntSize> mutableState = this.$magnifierSize$delegate;
            Density density = this.$density;
            TextFieldSelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState, IntSizeKt.IntSize(density.mo279roundToPx0680j_4(DpSize.m5776getWidthD9Ej5fM(j10)), density.mo279roundToPx0680j_4(DpSize.m5774getHeightD9Ej5fM(j10))));
        }
    }
