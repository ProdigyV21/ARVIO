...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(TextFieldScrollerPosition textFieldScrollerPosition, int i10, TransformedText transformedText, a<TextLayoutResultProxy> aVar) {
    ...
    public final VerticalScrollLayoutModifier copy(TextFieldScrollerPosition scrollerPosition, int cursorOffset, TransformedText transformedText, a<TextLayoutResultProxy> textLayoutResultProvider) {
    ...
    public boolean equals(Object other) {
        ...
        return p.a(this.scrollerPosition, verticalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == verticalScrollLayoutModifier.cursorOffset && p.a(this.transformedText, verticalScrollLayoutModifier.transformedText) && p.a(this.textLayoutResultProvider, verticalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo29measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j10) {
        ...
        return MeasureScope.CC.q(measureScope, placeableMo4631measureBRTryo0.getWidth(), iMin, null, new VerticalScrollLayoutModifier$measure$1(measureScope, this, placeableMo4631measureBRTryo0, iMin), 4, null);
    }
