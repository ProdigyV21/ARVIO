...
public final class MinLinesConstrainer {
    ...
    public static final class Companion {
        ...
        public final MinLinesConstrainer from(MinLinesConstrainer minMaxUtil, LayoutDirection layoutDirection, TextStyle paramStyle, Density density, FontFamily.Resolver fontFamilyResolver) {
            if (minMaxUtil != null && layoutDirection == minMaxUtil.getLayoutDirection() && p.a(paramStyle, minMaxUtil.getInputTextStyle()) && density.getDensity() == minMaxUtil.getDensity().getDensity() && fontFamilyResolver == minMaxUtil.getFontFamilyResolver()) {
                return minMaxUtil;
            }
            MinLinesConstrainer minLinesConstrainer = MinLinesConstrainer.last;
            if (minLinesConstrainer != null && layoutDirection == minLinesConstrainer.getLayoutDirection() && p.a(paramStyle, minLinesConstrainer.getInputTextStyle()) && density.getDensity() == minLinesConstrainer.getDensity().getDensity() && fontFamilyResolver == minLinesConstrainer.getFontFamilyResolver()) {
    ...
    public final long m930coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m5084ParagraphUdtVg6A$default(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, null, null, 1, false, 96, null).getHeight();
            height2 = ParagraphKt.m5084ParagraphUdtVg6A$default(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, null, null, 2, false, 96, null).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM5647getMinHeightimpl = a.M((height2 * (minLines - 1)) + height);
            if (iM5647getMinHeightimpl < 0) {
                iM5647getMinHeightimpl = 0;
            }
            int iM5645getMaxHeightimpl = Constraints.m5645getMaxHeightimpl(inConstraints);
            if (iM5647getMinHeightimpl > iM5645getMaxHeightimpl) {
                iM5647getMinHeightimpl = iM5645getMaxHeightimpl;
            }
        } else {
            iM5647getMinHeightimpl = Constraints.m5647getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m5648getMinWidthimpl(inConstraints), Constraints.m5646getMaxWidthimpl(inConstraints), iM5647getMinHeightimpl, Constraints.m5645getMaxHeightimpl(inConstraints));
    }
