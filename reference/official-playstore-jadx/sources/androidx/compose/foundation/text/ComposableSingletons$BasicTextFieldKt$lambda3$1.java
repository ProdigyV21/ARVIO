...
public final class ComposableSingletons$BasicTextFieldKt$lambda3$1 extends r implements q<p<? super Composer, ? super Integer, ? extends t0>, Composer, Integer, t0> {
    ...
    public final void invoke(p<? super Composer, ? super Integer, t0> pVar, Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(434140383, i10, -1, "androidx.compose.foundation.text.ComposableSingletons$BasicTextFieldKt.lambda-3.<anonymous> (BasicTextField.kt:338)");
        }
