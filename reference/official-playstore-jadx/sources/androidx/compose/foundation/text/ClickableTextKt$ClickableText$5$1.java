...
public final class ClickableTextKt$ClickableText$5$1 extends r implements l<TextLayoutResult, t0> {
    final /* synthetic */ MutableState<TextLayoutResult> $layoutResult;
    final /* synthetic */ l<TextLayoutResult, t0> $onTextLayout;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ClickableTextKt$ClickableText$5$1(MutableState<TextLayoutResult> mutableState, l<? super TextLayoutResult, t0> lVar) {
        super(1);
