...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m791CutCornerShape0680j_4(float f10) {
        return CutCornerShape(CornerSizeKt.m790CornerSize0680j_4(f10));
    }

    /* JADX INFO: renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m792CutCornerShapea9UjIt4(float f10, float f11, float f12, float f13) {
        return new CutCornerShape(CornerSizeKt.m790CornerSize0680j_4(f10), CornerSizeKt.m790CornerSize0680j_4(f11), CornerSizeKt.m790CornerSize0680j_4(f12), CornerSizeKt.m790CornerSize0680j_4(f13));
    }

    /* JADX INFO: renamed from: CutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ CutCornerShape m793CutCornerShapea9UjIt4$default(float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return m792CutCornerShapea9UjIt4(f10, f11, f12, f13);
    }
