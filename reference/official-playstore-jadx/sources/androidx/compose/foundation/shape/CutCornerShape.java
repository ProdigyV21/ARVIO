...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo781createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3305getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m3305getWidthimpl(size), topStart);
        float f11 = layoutDirection == layoutDirection2 ? bottomEnd : bottomStart;
        Path.lineTo(Size.m3305getWidthimpl(size), Size.m3302getHeightimpl(size) - f11);
        Path.lineTo(Size.m3305getWidthimpl(size) - f11, Size.m3302getHeightimpl(size));
        if (layoutDirection == layoutDirection2) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m3302getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3302getHeightimpl(size) - bottomEnd);
        Path.close();
    ...
    public boolean equals(Object other) {
        ...
        return p.a(getTopStart(), cutCornerShape.getTopStart()) && p.a(getTopEnd(), cutCornerShape.getTopEnd()) && p.a(getBottomEnd(), cutCornerShape.getBottomEnd()) && p.a(getBottomStart(), cutCornerShape.getBottomStart());
    }
