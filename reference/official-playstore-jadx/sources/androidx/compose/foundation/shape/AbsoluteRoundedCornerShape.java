...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m785toRadiusBz7bX_o(float f10) {
    ...
    public Outline mo781createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        return ((topStart + topEnd) + bottomEnd) + bottomStart == 0.0f ? new Outline.Rectangle(SizeKt.m3326toRectuvyYCjk(size)) : new Outline.Rounded(RoundRectKt.m3288RoundRectZAM2FJo(SizeKt.m3326toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
    ...
    public boolean equals(Object other) {
        ...
        return p.a(getTopStart(), absoluteRoundedCornerShape.getTopStart()) && p.a(getTopEnd(), absoluteRoundedCornerShape.getTopEnd()) && p.a(getBottomEnd(), absoluteRoundedCornerShape.getBottomEnd()) && p.a(getBottomStart(), absoluteRoundedCornerShape.getBottomStart());
    }
