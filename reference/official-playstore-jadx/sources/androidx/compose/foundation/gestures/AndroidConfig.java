...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo291calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j10) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3225boximpl = Offset.m3225boximpl(Offset.INSTANCE.m3252getZeroF1C5BW0());
        int size = changes.size();
        for (int i10 = 0; i10 < size; i10++) {
            offsetM3225boximpl = Offset.m3225boximpl(Offset.m3241plusMKHz9U(offsetM3225boximpl.getPackedValue(), changes.get(i10).getScrollDelta()));
        }
        return Offset.m3243timestuRUvjQ(offsetM3225boximpl.getPackedValue(), -density.mo285toPx0680j_4(Dp.m5678constructorimpl(64)));
    }
}
