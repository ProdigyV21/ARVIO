...
@f7.e(c = "androidx.compose.foundation.gestures.MouseWheelScrollNode$1$1$2$1$1", f = "Scrollable.kt", l = {684}, m = "invokeSuspend")
public final class MouseWheelScrollNode$1$1$2$1$1 extends j implements p<k0, d7.d<? super t0>, Object> {
    ...
    @f7.e(c = "androidx.compose.foundation.gestures.MouseWheelScrollNode$1$1$2$1$1$1", f = "Scrollable.kt", l = {}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MouseWheelScrollNode$1$1$2$1$1(ScrollingLogic scrollingLogic, long j10, d7.d<? super MouseWheelScrollNode$1$1$2$1$1> dVar) {
        super(2, dVar);
        this.$this_with = scrollingLogic;
        this.$scrollAmount = j10;
    }
    ...
    public final Object invoke(k0 k0Var, d7.d<? super t0> dVar) {
        return ((MouseWheelScrollNode$1$1$2$1$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
