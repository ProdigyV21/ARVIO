...
public final class SelectableKt$selectableXHw0xAI$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public SelectableKt$selectableXHw0xAI$$inlined$debugInspectorInfo$1(boolean z, boolean z5, Role role, a aVar) {
        super(1);
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        c.f(this.$enabled$inlined, c.f(this.$selected$inlined, inspectorInfo.getProperties(), "selected", inspectorInfo), "enabled", inspectorInfo).set("role", this.$role$inlined);
