...
public final class ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1(boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z5, Role role, l lVar) {
        super(1);
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        c.f(this.$value$inlined, inspectorInfo.getProperties(), "value", inspectorInfo).set("interactionSource", this.$interactionSource$inlined);
