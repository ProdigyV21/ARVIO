...
public final class ToggleableKt$toggleableXHw0xAI$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public ToggleableKt$toggleableXHw0xAI$$inlined$debugInspectorInfo$1(boolean z, boolean z5, Role role, l lVar) {
        super(1);
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        c.f(this.$enabled$inlined, c.f(this.$value$inlined, inspectorInfo.getProperties(), "value", inspectorInfo), "enabled", inspectorInfo).set("role", this.$role$inlined);
