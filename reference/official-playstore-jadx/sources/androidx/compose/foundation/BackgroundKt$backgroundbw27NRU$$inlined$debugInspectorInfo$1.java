...
public final class BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1 extends r implements l<InspectorInfo, t0> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Color.m3462boximpl(this.$color$inlined));
        inspectorInfo.getProperties().set(TtmlNode.ATTR_TTS_COLOR, Color.m3462boximpl(this.$color$inlined));
