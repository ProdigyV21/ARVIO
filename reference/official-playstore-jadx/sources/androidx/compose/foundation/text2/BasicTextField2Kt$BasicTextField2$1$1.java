...
public final class BasicTextField2Kt$BasicTextField2$1$1 extends r implements l<TextFieldValue, t0> {
    ...
    public BasicTextField2Kt$BasicTextField2$1$1(l<? super String, t0> lVar, MutableState<TextFieldValue> mutableState) {
        super(1);
    ...
    public final void invoke(TextFieldValue textFieldValue) {
        if (!p.a(textFieldValue.getText(), BasicTextField2Kt.BasicTextField2$lambda$2(this.$valueWithSelection$delegate).getText())) {
