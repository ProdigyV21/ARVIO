...
public final class TextFieldCoreModifierNode$measureVerticalScroll$1 extends r implements l<Placeable.PlacementScope, t0> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        if (iM1105calculateOffsetToFollow5zctL8 >= 0) {
            cursorRectInScroller = TextFieldCoreModifierKt.getCursorRectInScroller(this.$this_measureVerticalScroll, iM1105calculateOffsetToFollow5zctL8, this.this$0.textLayoutState.getLayoutResult(), this.$this_measureVerticalScroll.getLayoutDirection() == LayoutDirection.Rtl, this.$placeable.getWidth());
        } else {
            cursorRectInScroller = null;
        }
        this.this$0.updateScrollState(cursorRectInScroller, this.$height, this.$placeable.getHeight());
        if (this.this$0.isFocused) {
            this.this$0.previousSelection = TextRange.m5180boximpl(selectionInChars);
        }
        Placeable.PlacementScope.placeRelative$default(placementScope, this.$placeable, 0, -this.this$0.scrollState.getValue(), 0.0f, 4, null);
    }
}
