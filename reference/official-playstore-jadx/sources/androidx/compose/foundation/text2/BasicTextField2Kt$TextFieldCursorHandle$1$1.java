...
public final class BasicTextField2Kt$TextFieldCursorHandle$1$1 extends r implements l<SemanticsPropertyReceiver, t0> {
    ...
    public final void invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, this.$cursorHandleState.m1150getPositionF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
    }
}
