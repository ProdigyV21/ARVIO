...
public final class OneDimensionalFocusSearchKt$generateAndSearchChildren$1 extends r implements l<BeyondBoundsLayout.BeyondBoundsScope, Boolean> {
    ...
    public OneDimensionalFocusSearchKt$generateAndSearchChildren$1(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i10, l<? super FocusTargetNode, Boolean> lVar) {
        super(1);
    ...
    public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
        boolean zM3193searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m3193searchChildren4C6V_qg(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound);
        Boolean boolValueOf = Boolean.valueOf(zM3193searchChildren4C6V_qg);
        if (zM3193searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
            return boolValueOf;
        }
        return null;
    }
