...
public final class ComposableSingletons$AndroidDialog_androidKt {
    ...
    public static p<Composer, Integer, t0> f54lambda1 = ComposableLambdaKt.composableLambdaInstance(210148896, false, ComposableSingletons$AndroidDialog_androidKt$lambda1$1.INSTANCE);

    /* JADX INFO: renamed from: getLambda-1$ui_release, reason: not valid java name */
    public final p<Composer, Integer, t0> m5935getLambda1$ui_release() {
        return f54lambda1;
    }
}
