...
public final class AndroidView_androidKt$AndroidView$3$1<T> extends r implements p<LayoutNode, l<? super T, ? extends t0>, t0> {
    ...
    public final void invoke(LayoutNode layoutNode, l<? super T, t0> lVar) {
        AndroidView_androidKt.requireViewFactoryHolder(layoutNode).setUpdateBlock(lVar);
    }
}
