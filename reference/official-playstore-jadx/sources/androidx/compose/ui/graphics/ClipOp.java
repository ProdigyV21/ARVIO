...
public final class ClipOp {
    ...
    private static final int Difference = m3454constructorimpl(0);
    private static final int Intersect = m3454constructorimpl(1);
    ...
    public static final /* synthetic */ ClipOp m3453boximpl(int i10) {
        return new ClipOp(i10);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3454constructorimpl(int i10) {
        return i10;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3455equalsimpl(int i10, Object obj) {
        return (obj instanceof ClipOp) && i10 == ((ClipOp) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3456equalsimpl0(int i10, int i11) {
        return i10 == i11;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3457hashCodeimpl(int i10) {
        return i10;
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3458toStringimpl(int i10) {
        return m3456equalsimpl0(i10, Difference) ? "Difference" : m3456equalsimpl0(i10, Intersect) ? "Intersect" : "Unknown";
    }
