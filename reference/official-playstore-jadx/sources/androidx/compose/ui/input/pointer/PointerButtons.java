...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m4450boximpl(int i10) {
        return new PointerButtons(i10);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m4451constructorimpl(int i10) {
        return i10;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4452equalsimpl(int i10, Object obj) {
        return (obj instanceof PointerButtons) && i10 == ((PointerButtons) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4453equalsimpl0(int i10, int i11) {
        return i10 == i11;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m4454hashCodeimpl(int i10) {
        return i10;
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4455toStringimpl(int i10) {
        return a0.c.k("PointerButtons(packedValue=", i10, ')');
    }

    public boolean equals(Object obj) {
        return m4452equalsimpl(this.packedValue, obj);
    }
