...
public final class PointerIcon_androidKt {
    ...
    private static final PointerIcon pointerIconCrosshair = new AndroidPointerIconType(AnalyticsListener.EVENT_AUDIO_ENABLED);
    private static final PointerIcon pointerIconText = new AndroidPointerIconType(AnalyticsListener.EVENT_AUDIO_DECODER_INITIALIZED);
