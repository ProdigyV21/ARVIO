...
public final class SuspendingPointerInputModifierNodeImpl$onPointerEvent$1 extends j implements p<k0, d<? super t0>, Object> {
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            k2.c.G(obj);
            p<PointerInputScope, d<? super t0>, Object> pointerInputHandler = this.this$0.getPointerInputHandler();
            SuspendingPointerInputModifierNodeImpl suspendingPointerInputModifierNodeImpl = this.this$0;
            this.label = 1;
            Object objInvoke = pointerInputHandler.invoke(suspendingPointerInputModifierNodeImpl, this);
    ...
    public final Object invoke(k0 k0Var, d<? super t0> dVar) {
        return ((SuspendingPointerInputModifierNodeImpl$onPointerEvent$1) create(k0Var, dVar)).invokeSuspend(t0.f22605a);
    }
}
