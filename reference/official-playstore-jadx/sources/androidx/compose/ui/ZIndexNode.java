...
public final class ZIndexNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo55measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j10) {
        ...
        return MeasureScope.CC.q(measureScope, placeableMo4631measureBRTryo0.getWidth(), placeableMo4631measureBRTryo0.getHeight(), null, new ZIndexNode$measure$1(placeableMo4631measureBRTryo0, this), 4, null);
    }
    ...
    public String toString() {
        return a0.c.n(new StringBuilder("ZIndexModifier(zIndex="), this.zIndex, ')');
    }
}
