...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m3261getSizeNHjbRc$annotations() {
    }
    ...
    public final boolean m3262containsk4lQ0M(long offset) {
    ...
    public final long m3263getBottomCenterF1C5BW0() {
    ...
    public final long m3267getCenterLeftF1C5BW0() {
    ...
    public final long m3268getCenterRightF1C5BW0() {
    ...
    public final long m3269getSizeNHjbRc() {
    ...
    public final long m3270getTopCenterF1C5BW0() {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + c.b(this.right, c.b(this.top, Float.floatToIntBits(this.left) * 31, 31), 31);
    }
    ...
    public final Rect m3273translatek4lQ0M(long offset) {
        return new Rect(Offset.m3236getXimpl(offset) + this.left, Offset.m3237getYimpl(offset) + this.top, Offset.m3236getXimpl(offset) + this.right, Offset.m3237getYimpl(offset) + this.bottom);
    }
