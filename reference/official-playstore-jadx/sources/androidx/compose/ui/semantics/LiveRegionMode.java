...
public final class LiveRegionMode {
    ...
    private static final int Polite = m5008constructorimpl(0);
    private static final int Assertive = m5008constructorimpl(1);
    ...
    public static final /* synthetic */ LiveRegionMode m5007boximpl(int i10) {
        return new LiveRegionMode(i10);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m5008constructorimpl(int i10) {
        return i10;
    }
    ...
    public static String m5012toStringimpl(int i10) {
        return m5010equalsimpl0(i10, Polite) ? "Polite" : m5010equalsimpl0(i10, Assertive) ? "Assertive" : "Unknown";
    }

    public boolean equals(Object obj) {
        return m5009equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5011hashCodeimpl(this.value);
    }

    public String toString() {
        return m5012toStringimpl(this.value);
    }
