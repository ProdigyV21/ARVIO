...
public final class VerbatimTtsAnnotation extends TtsAnnotation {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof VerbatimTtsAnnotation) && p.a(this.verbatim, ((VerbatimTtsAnnotation) other).verbatim);
    }
    ...
    public String toString() {
        return c.u(new StringBuilder("VerbatimTtsAnnotation(verbatim="), this.verbatim, ')');
    }
}
