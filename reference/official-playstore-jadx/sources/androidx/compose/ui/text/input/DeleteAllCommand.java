...
public final class DeleteAllCommand implements EditCommand {
    ...
    public int hashCode() {
        return l0.f19747a.b(DeleteAllCommand.class).hashCode();
    }
