...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int getAndroidTypefaceStyle(boolean z, boolean z5) {
        if (z5 && z) {
            return 3;
        }
        if (z) {
    ...
    public static final int m5257getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i10) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5302equalsimpl0(i10, FontStyle.INSTANCE.m5308getItalic_LCdwA()));
    }
}
