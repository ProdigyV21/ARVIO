...
public final class AndroidComposeViewAccessibilityDelegateCompat$sendSubtreeChangeAccessibilityEvents$semanticsNode$1 extends kotlin.jvm.internal.r implements r7.l<LayoutNode, Boolean> {
    ...
    public final Boolean invoke(LayoutNode layoutNode) {
        return Boolean.valueOf(layoutNode.getNodes().m4800hasH91voCI$ui_release(NodeKind.m4843constructorimpl(8)));
    }
}
