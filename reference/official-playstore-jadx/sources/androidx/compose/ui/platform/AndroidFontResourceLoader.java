...
public final class AndroidFontResourceLoader implements Font.ResourceLoader {
    ...
    public Typeface load(Font font) {
        if (font instanceof ResourceFont) {
            return Build.VERSION.SDK_INT >= 26 ? AndroidFontResourceLoaderHelper.INSTANCE.create(this.context, ((ResourceFont) font).getResId()) : i0.q.b(this.context, ((ResourceFont) font).getResId());
        }
