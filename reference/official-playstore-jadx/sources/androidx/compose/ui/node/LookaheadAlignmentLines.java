...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public long mo4708calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j10) {
        long position = nodeCoordinator.getLookaheadDelegate().getPosition();
        return Offset.m3241plusMKHz9U(OffsetKt.Offset(IntOffset.m5802getXimpl(position), IntOffset.m5803getYimpl(position)), j10);
    }
