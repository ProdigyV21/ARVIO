...
public final class NodeMeasuringIntrinsics {
    ...
    public static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable mo4631measureBRTryo0(long constraints) {
            ...
            int iM5646getMaxWidthimpl = LayoutKt.LargeDimension;
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                int iMaxIntrinsicWidth = this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m5645getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m5645getMaxHeightimpl(constraints));
                if (Constraints.m5641getHasBoundedHeightimpl(constraints)) {
                    iM5646getMaxWidthimpl = Constraints.m5645getMaxHeightimpl(constraints);
                }
                return new EmptyPlaceable(iMaxIntrinsicWidth, iM5646getMaxWidthimpl);
            }
            int iMaxIntrinsicHeight = this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m5646getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m5646getMaxWidthimpl(constraints));
            if (Constraints.m5642getHasBoundedWidthimpl(constraints)) {
                iM5646getMaxWidthimpl = Constraints.m5646getMaxWidthimpl(constraints);
            }
            return new EmptyPlaceable(iM5646getMaxWidthimpl, iMaxIntrinsicHeight);
        }
    ...
    public interface MeasureBlock {
        ...
        MeasureResult mo4637measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j10);
    }

    private NodeMeasuringIntrinsics() {
    }

    public final int maxHeight$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int w6) {
        return measureBlock.mo4637measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w6, 0, 0, 13, null)).get$h();
    }

    public final int maxWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h3) {
        return measureBlock.mo4637measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h3, 7, null)).get$w();
    }

    public final int minHeight$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int w6) {
        return measureBlock.mo4637measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w6, 0, 0, 13, null)).get$h();
    }

    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h3) {
        return measureBlock.mo4637measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h3, 7, null)).get$w();
    }
