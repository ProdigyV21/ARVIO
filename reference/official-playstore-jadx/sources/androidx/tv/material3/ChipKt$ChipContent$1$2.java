...
public final class ChipKt$ChipContent$1$2 extends kotlin.jvm.internal.r implements r7.q<AnimatedVisibilityScope, Composer, Integer, x6.t0> {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final /* synthetic */ r7.p f5594i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChipKt$ChipContent$1$2(r7.p pVar) {
        super(3);
        this.f5594i = pVar;
    }
    ...
    public final void invoke(AnimatedVisibilityScope animatedVisibilityScope, Composer composer, int i10) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1201881928, i10, -1, "androidx.tv.material3.ChipContent.<anonymous>.<anonymous> (Chip.kt:456)");
        }
        ...
        composer.startReplaceableGroup(-1212503031);
        r7.p pVar = this.f5594i;
        if (pVar != null) {
