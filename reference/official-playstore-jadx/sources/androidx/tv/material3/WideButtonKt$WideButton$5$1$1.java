...
public final class WideButtonKt$WideButton$5$1$1 extends kotlin.jvm.internal.r implements r7.p<Composer, Integer, x6.t0> {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final /* synthetic */ r7.p f5790i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WideButtonKt$WideButton$5$1$1(r7.p pVar) {
        super(2);
        this.f5790i = pVar;
    }
    ...
    public final void invoke(Composer composer, int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(488962207, i10, -1, "androidx.tv.material3.WideButton.<anonymous>.<anonymous>.<anonymous> (WideButton.kt:194)");
        }
        Modifier modifierM531paddingVpY3zN4$default = PaddingKt.m531paddingVpY3zN4$default(Modifier.INSTANCE, 0.0f, c.f5866e, 1, null);
        ...
        if (a0.c.B(this.f5790i, composer, 0)) {
