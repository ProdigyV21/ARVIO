...
public final class LazyGridDslKt$itemsIndexed$10 extends kotlin.jvm.internal.r implements r7.r<q0, Integer, Composer, Integer, x6.t0> {
    @Override // r7.r
    ...
    public final void invoke(q0 q0Var, int i10, Composer composer, int i11) {
        ...
        if ((i12 & 147) == 146 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1162644004, i12, -1, "androidx.tv.foundation.lazy.grid.itemsIndexed.<anonymous> (LazyGridDsl.kt:635)");
            }
            throw null;
        }
    }
