...
public final class LazyGridDslKt$items$10 extends kotlin.jvm.internal.r implements r7.r<q0, Integer, Composer, Integer, x6.t0> {
    @Override // r7.r
    ...
    public final void invoke(q0 q0Var, int i10, Composer composer, int i11) {
        ...
        if ((i12 & 147) == 146 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1495328553, i12, -1, "androidx.tv.foundation.lazy.grid.items.<anonymous> (LazyGridDsl.kt:597)");
            }
            throw null;
        }
    }
