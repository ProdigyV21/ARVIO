...
public final class LazyDslKt$itemsIndexed$8 extends kotlin.jvm.internal.r implements r7.r<c0, Integer, Composer, Integer, t0> {
    @Override // r7.r
    ...
    public final void invoke(c0 c0Var, int i10, Composer composer, int i11) {
        ...
        if ((i12 & 147) == 146 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1508072950, i12, -1, "androidx.tv.foundation.lazy.list.itemsIndexed.<anonymous> (LazyDsl.kt:219)");
            }
            throw null;
        }
    }
