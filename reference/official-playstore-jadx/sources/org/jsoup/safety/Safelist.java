...
public class Safelist {
    ...
    public static Safelist basic() {
        return new Safelist().addTags(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "b", "blockquote", "br", "cite", "code", "dd", CmcdConfiguration.KEY_DEADLINE, "dt", "em", CmcdData.OBJECT_TYPE_INIT_SEGMENT, "li", "ol", TtmlNode.TAG_P, "pre", "q", "small", TtmlNode.TAG_SPAN, "strike", "strong", "sub", "sup", "u", "ul").addAttributes(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "href").addAttributes("blockquote", "cite").addAttributes("q", "cite").addProtocols(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "href", "ftp", "http", "https", "mailto").addProtocols("blockquote", "cite", "http", "https").addProtocols("cite", "cite", "http", "https").addEnforcedAttribute(CmcdData.OBJECT_TYPE_AUDIO_ONLY, LinkHeader.Parameters.Rel, "nofollow");
    }
    ...
    public static Safelist relaxed() {
        return new Safelist().addTags(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "b", "blockquote", "br", MediaTrack.ROLE_CAPTION, "cite", "code", "col", "colgroup", "dd", TtmlNode.TAG_DIV, CmcdConfiguration.KEY_DEADLINE, "dt", "em", "h1", "h2", "h3", "h4", "h5", "h6", CmcdData.OBJECT_TYPE_INIT_SEGMENT, "img", "li", "ol", TtmlNode.TAG_P, "pre", "q", "small", TtmlNode.TAG_SPAN, "strike", "strong", "sub", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "u", "ul").addAttributes(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "href", LinkHeader.Parameters.Title).addAttributes("blockquote", "cite").addAttributes("col", TtmlNode.TAG_SPAN, "width").addAttributes("colgroup", TtmlNode.TAG_SPAN, "width").addAttributes("img", "align", "alt", "height", "src", LinkHeader.Parameters.Title, "width").addAttributes("ol", TtmlNode.START, LinkHeader.Parameters.Type).addAttributes("q", "cite").addAttributes("table", "summary", "width").addAttributes("td", "abbr", "axis", "colspan", "rowspan", "width").addAttributes("th", "abbr", "axis", "colspan", "rowspan", "scope", "width").addAttributes("ul", LinkHeader.Parameters.Type).addProtocols(CmcdData.OBJECT_TYPE_AUDIO_ONLY, "href", "ftp", "http", "https", "mailto").addProtocols("blockquote", "cite", "http", "https").addProtocols("cite", "cite", "http", "https").addProtocols("img", "src", "http", "https").addProtocols("q", "cite", "http", "https");
    }

    public static Safelist simpleText() {
        return new Safelist().addTags("b", "em", CmcdData.OBJECT_TYPE_INIT_SEGMENT, "strong", "u");
    }
