...
public final class a implements Interpolator {
    ...
    public a(float[] fArr) {
        this.f19041a = fArr;
        this.f19042b = 1.0f / (fArr.length - 1);
    }
